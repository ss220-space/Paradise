...
CREATE TABLE `ban` (
  ...
  `server_port` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `round_id` int(11) UNSIGNED NULL,
  `role` varchar(32) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `expiration_time` datetime NULL DEFAULT NULL,
  `applies_to_admins` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `reason` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `ckey` varchar(32) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `ip` varchar(32) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `computerid` varchar(32) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  ...
  `adminwho` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `edits` text COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `unbanned_datetime` datetime NULL DEFAULT NULL,
  `unbanned_ckey` varchar(32) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `unbanned_ip` varchar(32) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `unbanned_computerid` varchar(32) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
