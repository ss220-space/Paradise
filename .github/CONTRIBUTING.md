# Руководство по внесению вклада в проект SS13

Перед вами руководство по внесению вклада в билд **Dark Paradise** проекта [SS13](https://github.com/KINGDICE666/DarkParadise). Здесь вы найдёте как советы по работе с Github, так и стандарты разработки/написания кода, которые являются обязательными для ознакомления и знания.
...
Перед вами руководство по внесению вклада в билд **Dark Paradise** проекта **SS13**. Здесь вы найдёте как советы по работе с Github, так и стандарты разработки/написания кода.
