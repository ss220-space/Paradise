...
[DOCUMENTATION]: https://kingdice666.github.io/DarkParadise/
...
Это даёт новым разработчикам интерактивный справочник [DOCUMENTATION], который они могут просматривать, чтобы лучше понять структуру кодовой базы SS13 и её API.

**Вся документация ведётся на анлийском!** (за редким исключением)

## Документирование кода на SS13
...
На SS13 мы делаем это, добавляя файлы Markdown внутрь директории `code`, которые также будут отображены и добавлены в дерево модулей. Структура этих файлов намеренно не определена, так что вы можете быть настолько свободны и гибки, насколько захотите.
