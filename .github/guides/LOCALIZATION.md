# Руководство по локализации проекта SS13

**Автор** — [LittleBoobs](https://github.com/littleboobs)

Руководство описывает стандарты локализации и работы с текстом на русском языке в проекте [SS13](https://github.com/KINGDICE666/DarkParadise). Его основная цель — обеспечить единство и согласованность текстов внутри проекта, а также упростить процесс проведения ревью.
