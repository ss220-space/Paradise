...
#define MAP_TRANSITION_CONFIG list(\
DECLARE_LEVEL(CENTCOMM, UNAFFECTED, list(ADMIN_LEVEL, BLOCK_TELEPORT, IMPEDES_MAGIC, ZTRAIT_NOPHASE)),\
DECLARE_LEVEL(ADMIN_ZONE, UNAFFECTED, list(ADMIN_LEVEL, BLOCK_TELEPORT, IMPEDES_MAGIC, ZTRAIT_NOPHASE)))
#endif
