...
export const UmbrMenu = (_props: unknown) => {
  ...
  return (
    <Section title="Умбра">
      ...
      <b>Теневой захват</b>: Открывается от{' '}
      <i>
        500 <span color="red">ед. крови</span>
      </i>
      , выпускает теневую руку, которая притягивает жертву при попадании,
      либо притягивает вас, при попадании в стенку. Тушит свет.
      <p>
        <b>Полная сила</b>
        <Divider />
...
export const GarMenu = (_props: unknown) => {
  ...
  return (
    <Section title="Гаргантюа">
      ...
      <p>
        <b>Демоническая хватка</b>: Открывается от 300{' '}
        <i>
          <span color="red">ед. крови</span>
        </i>
      ...
      <p>
        <b>Кровавый вал III</b>: Открывается от 600{' '}
        <i>
          <span color="red">ед. крови</span>
        </i>
        , игнорирует замедление от урона и переломы за дополнительную цену.
      </p>
      <p>
        <b>Рывок</b>: Открывается от 600{' '}
        <i>
          <span color="red">ед. крови</span>
        </i>
        , Вы получаете способность делать рывок в вашу цель, разрушая и
        отталкивая все, во что врежетесь.
      </p>
      <p>
        <b>Полная сила</b>
        <Divider />
        <b>Кровавое перенасыщение</b>: Вы получаете способность получить полную
        невозможность умереть или получить оглушение за большую цену кровью.
      </p>
