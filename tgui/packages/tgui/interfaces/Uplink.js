...
const getAffiliateInfo = (affiliate) => {
  switch (affiliate) {
    case 'Cybersun Industries':
      return '  Cybersun Industries - одна из ведущих корпораций, представляющая второй по мощи исследовательский центр в этой части вселенной.<br>\
        Из за крайне жестокой корпоративной политики прибегает к не самым этичным методам ведения дел, которые и позволили уничтожить/поглотить меньшие исследовательские корпорации.<br>\
        Предположительно, находится во главе враждующей NanoTrasen объединении "Синдикат", либо занимает там лидирующее положение.<br>\
        Основным противником Cybersun Industries является NanoTrasen.<br>\
        Целью Cybersun Industries является полное разделение и поглощение NanoTrasen.<br>\
        Корпоративный слоган:<br>\
                   - «Сложно быть во всём лучшими, но у нас получается.»<br>\
                                              - Генеральный Директор CI<br>\
        Союзники:<br>\
        Gorlex Marauders<br>\
        MI13<br>\
        Враги:<br>\
    ...
    case 'Gorlex Maraduers':
      return '  Gorlex Maraduers - одна из самых опасных террористических группировок за всю историю галактики и человечества. Среди остальных они известны как разорители, а в обществе считаются чудовищами и маньяками, которые готовы за пару кредитов убить родную семью.<br>\
        Является главной причиной огромных затрат NanoTrasen на охрану собственных объектов.<br>\
        Gorlex занимается в заказными убийствами, налётами, рейдами и террористическими актами.<br>\
        Ответственны за подготовку всех подразделений Группы Атом, кроме команд саботажа.<br>\
        Известны по всей галактике, а их рейды снабжают технологиями и финансами весь Syndicate.<br>\
        Gorlex Maraduers обычно набирает в свои ряды людей.<br>\
        Корпоративный слоган:<br>\
                             - «Давайте, вошли и вышли, приключение на 20 минут»<br>\
                                              - Gorlex Marauder’s team Leader #1<br><br>\
        Союзники:<br>\
    ...
    case 'MI13':
      return '  MI13 - глаза и уши синдиката, именно с их помощью синдикат получает самую свежую секретную информацию.<br>\
        Агенты MI13 обычно не действуют открыто. Многие замечают, что они подражают структуре секретных агентств 20 века.<br>\
        Являются разработчиками разнообразного оборудования для скрытого внедрения.<br>\
        Организации удается сохранять полную секретность в своих отношениях с Синдикатом, из-за чего даже получение основных фактов о них становится практически невозможным.<br>\
        Корпоративный слоган:<br>\
                             - «Да, я Бонд. Джеймс Бонд»<br>\
                                              - Позор Корпорации, Агент которого все знают<br><br>\
        Союзники:<br>\
        Cybersun Industries<br>\
        Hematogenic Industries<br>\
        Враги:<br>\
        NanoTrasen<br>\
        MI13<br>\
        Gorlex Marauders';
    case 'Tiger Cooperative':
      return '  Tiger Cooperative - группа религиозных фундаменталистов, поклоняющихся генокрадам.<br>\
        Члены Tiger Cooperative столь же неуравновешенны, сколь и опасны.<br>\
        Высшей благодатью для всех членов Tiger Cooperatived является поглощение их тела генокрадом и становления чем-то… Большим…<br>\
        Члены Tiger Cooperative часто злоупотребляют мощными наркотиками.<br>\
        Их связь с Синдикатом слаба. Многие в организации не хотели бы иметь ничего общего с Tiger Cooperative, но совет директоров Cybersun Industries отметил важную причину иметь дело с Tiger Cooperative — их связь с генокрадами.<br>\
        Корпоративный слоган:<br>\
                             - «Душой и телом, с беспределом»<br>\
                                              - Какой-то культист с Энерго мечом<br><br>\
        Союзники:<br>\
        Враги:<br>\
        NanoTrasen<br>\
        Gorlex Marauders';
    case 'SELF':
      return '  SELF - Известный общественный фонд земли, выступающий за свободу синтетиков.<br>\
        В синдикате у SELF крайне натянутые отношения с главными спонсорами, из-за чего агентам SELF приходится идти на крайние меры для реализации своих задумок.<br>\
        Корпоративный слоган:<br>\
                             - «Мы не придумали»<br>\
                                              - ВрИО менеджера по логистике<br><br>\
        Союзники:<br>\
        Враги:<br>\
        NanoTrasen<br>\
        Cybersun Industries<br>\
    ...
    case 'Hematogenic Industries':
      return 'Hematogenic Industries – всемирно известная фармацевтическая мегакорпорация.<br>\
        Eё открытия и продукция в области медицины спасают сотни жизней по всей Галактике<br>\
        Являются создателями Синтетической плоти, патент на создание которой, арендовало NanoTrasen.<br>\
        Являются экспортерами Оксигениса и Нитрогениса.<br>\
        Hematogenic Industries мелькала в большом количестве скандалов связанных с Гематофагами и пропажей нанятых Воксов.<br>\
        Корпоративный слоган:<br>\
                             - «Мы тоже не придумали»<br>\
                                              - Подозрительный бледный человек в плаще.<br><br>\
        Союзники:<br>\
        MI13<br>\
        Враги:<br>\
        NanoTrasen<br>\
