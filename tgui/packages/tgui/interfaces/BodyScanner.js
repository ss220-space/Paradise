...
const abnormalities = [
  ['hasBorer', 'bad', 'Во фронтальной коре обнаружена крупная опухоль, потенциально злокачественная. Рекомендуется хирургическое вмешательство.'],
  ...
  ['nearsighted', 'average', 'Обнаружено смещение зрительной сетчатки.'],
];
            ...
            <Table.Cell
              ...
              <Box display="inline">
                {reduceOrganStatus([
                  ...
                  !!o.status.dead && <Box color="bad" bold>ТРУП</Box>,
                ])}
            ...
            <Table.Cell
              ...
              <Box display="inline">
                {reduceOrganStatus([
                  ...
                  !!o.dead && <Box color="bad" bold>ТРУП</Box>,
                ])}
              </Box>
            </Table.Cell>
          </Table.Row>
