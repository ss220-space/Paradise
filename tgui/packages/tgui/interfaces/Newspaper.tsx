    ...
    <Window width={800} height={600} theme="paper" title="Газета Грифон">
      <Window.Content scrollable>
        ...
        <Box textAlign="center" fontSize="12px" color="#666" m={2} mt={0}>
          ...
          \&quot;Нанотрейзен\&quot;. Служит основным источником новостей,
          объявлений и полезной информации для всех членов экипажа.
        </Box>
        ...
        {currentStories.length > 0 ? (
          ...
          <Box textAlign="center" fontSize="18px" color="#666" mb={2}>
...
const WantedBlock = (properties: WantedBlockProps) => {
