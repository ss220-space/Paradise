...
import { HelpDummy, HoverHelp } from './Hypertorus/helpers';
...
export const ReactorMonitor = (props) => {
  const logScale = (value: number): number =>
    Math.log2(16 + Math.max(0, value)) - 4;
