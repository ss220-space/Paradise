        ...
        <Flex.Item direction="row">
          <Button
            ...
            <Tooltip
              ...
              \nПользуясь встроенным контроллером шатла, вы всегда сможете призвать его к себе и вернуться назад. \
          ...
          <Button
            ...
            <Tooltip
              ...
              \nДля того, чтобы успешно похи- тить людей. У вас на шатле есть скафандры, а на базе запас на- ручников, кислорода и балло- нов. \
          ...
          <NoticeBox className="NoticeBox_blue" success={0} danger={0} align="center">
            ...
            <Button
              ...
              <Tooltip
                ...
                \nСтоимость активации: 4500 ед. энергии."}
                position="right" />
            </Button>
            <Button
              ...
              <Tooltip
                ...
                \nАктивный хамелион слабо увеличивает пассивный расход энергии."}
                position="right" />
            </Button>
            <Button
          ...
          <NoticeBox success={0} danger={0} align="center">
            ...
            <Button
              ...
              <Tooltip
                ...
                \nСтоимость активации: 2000 ед. энергии."}
                position="right" />
            </Button>
            <Button
            ...
            <Button
              ...
              onClick={() => act("give_ability", { style: "energynet", row: "5" })}>
              <img
                height="64px"
                width="64px"
          ...
          <NoticeBox className="NoticeBox_red" success={0} danger={0} align="center">
            <Button
              ...
              <Tooltip
                ...
                \nСтоимость выстрела: 450 ед. энергии."}
                position="bottom-right" />
            </Button>
            <Button
            ...
            <Button
              ...
              <Tooltip
                ...
                \nНе забывайте о защищающем от света режиме важего визора. Он может помочь не ослепнуть, при подрыве подобных устройств.\
            ...
            <Button
              ...
              onClick={() => act("give_ability", { style: "cloning", row: "4" })}>
              <img
                height="64px"
                width="64px"
...
export const ShuttleConsole = (properties, context) => {
  ...
  return (
    <Section title="Управление шаттлом" style={{ "text-align": "center" }}
      buttons={<Button
        content="?"
        tooltip={"Панель для удалённого управление вашим личным шатлом. \
        Так же показывает вашу текущую позицию и позицию самого шатла!"}
        ...
        <LabeledList>
          ...
          {!!data.shuttle && (// only show this stuff if there's a shuttle
            !!data.docking_ports_len && (
              <LabeledList.Item label={"Отправить шатл"}>
