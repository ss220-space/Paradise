...
export const HemoMenu = (props, context) => {
  ...
  return (
    <Section title="Гемомансер">
      ...
      <p>
        <b>Когти</b>: Открывается от 150{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Кровавый барьер</b>: Открывается от 250{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Кровавые щупальца</b>: Открывается от 250{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Погружение в кровь</b>: Открывается от 400{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Чутьё хищника</b>: Открывается от 600{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Извержение крови</b>: Открывается от 800{' '}
        <i>
          <font color="red">крови</font>
        </i>
...
export const UmbrMenu = (props, context) => {
  ...
  return (
    <Section title="Умбра">
      ...
      <p>
        <b>Покров тьмы</b>: Открывается от 150{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Теневой якорь</b>: Открывается от 250{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Теневая ловушка</b>: Открывается от 250{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Тёмный проход</b>: Открывается от 400{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Погасить</b>: Открывается от 600{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <b>Теневой бокс</b>: Открывается от 800{' '}
      <i>
        <font color="red">крови</font>
      </i>
...
export const GarMenu = (props, context) => {
  ...
  return (
    <Section title="Гаргантюа">
      ...
      <p>
        <b>Сейсмический топот</b>: Открывается от 250{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Прилив крови</b>: Открывается от 250{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Подавляющая сила</b>: Открывается от 600{' '}
        <i>
          <font color="red">крови</font>
        </i>
...
export const DantMenu = (props, context) => {
  ...
  return (
    <Section title="Данталион">
      ...
      <p>
        <b>Подчинение</b>: Открывается от 150{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        ...
        Количество рабов будет расти при достижении 400{' '}
        <i>
          <font color="red">крови</font>
        </i>
        , 600{' '}
      ...
      <p>
        <b>Рабская коммуна</b>: Открывается от 150{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Подпространственный обмен</b>: Открывается от 150{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Умиротворение</b>: Открывается от 250{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Приманка</b>: Открывается от 400{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Сплотить рабов</b>: Открывается от 600{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Кровавые узы</b>: Открывается от 800{' '}
        <i>
          <font color="red">крови</font>
        </i>
...
export const BestMenu = (props, context) => {
  ...
  return (
    <Section title="Бестия">
      ...
      <p>
        <b>Посмотреть трофеи</b>: Открывается от 150{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Иссечение</b>: Открывается от 150{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        ...
        Предел будет увеличиваться при достижении 600{' '}
        <i>
          <font color="red">крови</font>
        </i>{' '}
      ...
      <p>
        <b>Зараженный трофей</b>: Открывается от 150{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Пометить добычу</b>: Открывается от 250{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Метаморфоза - Летучие мыши</b>: Открывается от 400{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Анабиоз</b>: Открывается от 600{' '}
        <i>
          <font color="red">крови</font>
        </i>
      ...
      <p>
        <b>Призыв летучих мышей</b>: Открывается от 600{' '}
        <i>
          <font color="red">крови</font>
        </i>
