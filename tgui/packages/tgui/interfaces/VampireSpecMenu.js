...
export const VampireSpecMenu = (props, context) => {
  ...
  const [activeTab, setActiveTab] = useLocalState(context, 'activeTab', 'hemomancer'); // Устанавливаем начальную вкладку

  // Функция для рендеринга содержимого в зависимости от активной вкладки
  const renderMenu = () => {
    switch (activeTab) {
      case 'hemomancer':
  ...
  return (
    <Window width={1500} height={820} theme="nologo">
      <Window.Content scrollable>
        ...
        <Divider />
        {renderMenu()} {/* Рендерим содержимое активной вкладки */}
      </Window.Content>
    </Window>
  );
};
