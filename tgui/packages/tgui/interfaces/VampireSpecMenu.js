...
import { Button, Section, Stack, Divider, Box } from '../components';
...
export const VampireSpecMenu = (props, context) => {
  ...
  const [activeTab, setActiveTab] = useLocalState(context, 'activeTab', 'hemomancer');

  return (
    <Window width={700} height={880} resizable theme="ntos_spooky">
      <Window.Content scrollable>
        ...
        <Divider />
        {activeTab === 'hemomancer' && (
          <Section title="Hemomancer">
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              <img
                src={`data:image/jpeg;base64,${hemomancer_icon}`}
                alt="Umbrae"
                style={{
                  width: '256px',
                  height: '256px',
            ...
            <p><b>Predator senses</b>: Unlocked at 600 blood, allows you to sniff out anyone within the same sector as you.</p>
            <p><b>Blood eruption</b>: Unlocked at 800 blood, allows you to manipulate all nearby blood splatters, in 4 tiles around you, into spikes that impale anyone stood on top of them.</p>
            <p><b>Full power</b><Divider /><b>The blood bringers rite</b>: When toggled you will rapidly drain the blood of everyone who is nearby and use it to heal yourself slightly and remove any incapacitating effects rapidly.</p>
        ...
        {activeTab === 'umbrae' && (
          <Section title="Umbrae">
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              <img
                src={`data:image/jpeg;base64,${umbrae_icon}`}
                alt="Umbrae"
                style={{
                  width: '256px',
                  height: '256px',
            ...
            <p><b>Shadow snare</b>: Unlocked at 250 blood, allows you to summon a trap that when crossed blinds and ensnares the victim. This trap is hard to see, but withers in the light.</p>
            ...
            <p><b>Shadow boxing</b>: Unlocked at 800 blood, sends out shadow clones towards a target, damaging them while you remain in range.</p>
            <p><b>Full power</b><Divider /><b>Eternal darkness</b>: When toggled, you consume yourself in unholy darkness, only the strongest of lights will be able to see through it. It will also cause nearby creatures to freeze.</p>
        ...
        {activeTab === 'gargantua' && (
          <Section title="Gargantua">
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              <img
                src={`data:image/jpeg;base64,${gargantua_icon}`}
                alt="Gargantua"
                style={{
                  width: '256px',
                  height: '256px',
            ...
            <p><b>Seismic stomp</b>: Unlocked at 250 blood, allows you to stomp the ground to send out a shockwave, knocking people back.</p>
            ...
            <p><b>Demonic grasp</b>: Unlocked at 800 blood, allows you to send out a demonic hand to snare someone. If you are on disarm/grab intent you will push/pull the target, respectively.</p>
            <p><b>Full Power</b><Divider /><b>Charge</b>: You gain the ability to charge at a target, destroying and knocking back pretty much anything you collide with.</p>
        ...
        {activeTab === 'dantalion' && (
          <Section title="Dantalion">
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              <img
                src={`data:image/jpeg;base64,${dantalion_icon}`}
                alt="Dantalion"
                style={{
                  width: '256px',
                  height: '256px',
            ...
            <p><b>Subspace swap</b>: Unlocked at 250 blood, allows you to swap positions with a target.</p>
            ...
            <p><b>Rally thralls</b>: Unlocked at 600 blood, removes all incapacitating effects from nearby thralls.</p>
            <p><b>Blood bond</b>: Unlocked at 800 blood, when cast, all nearby thralls become linked to you. If anyone in the network takes damage, it is shared equally between everyone in the network. If a thrall goes out of range, they will be removed from the network.</p>
            <p><b>Full Power</b><Divider /><b>Mass Hysteria</b>: Casts a powerful illusion that blinds then makes everyone nearby perceive others to look like random animals.</p>
        ...
        {activeTab === 'bestia' && (
          <Section title="Bestia">
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              <img
                src={`data:image/jpeg;base64,${bestia_icon}`}
                alt="Bestia"
                style={{
                  width: '256px',
                  height: '256px',
            ...
            <p><b>Dissect Cap</b>: You can only harvest one organ trophy at a time. This can be increased at 600 blood and at full power to a max of 3 trophies per victim.</p>
            <p><b>Infected Trophy</b>: Unlocked at 150 blood, allows you to stun enemies from a safe distance and infect them with the deadly Grave Fever.</p>
            <p><b>Lunge</b>: Unlocked at 250 blood, allows you to rapidly close distance to a victim or escape a dangerous situation.</p>
            <p><b>Mark the Prey</b>: Unlocked at 250 blood, allows you to mark a victim which drastically reduces their movement speed and forces them to take spontaneous actions.</p>
            <p><b>Metamorphosis - Bats</b>: Unlocked at 400 blood, allows you to shapeshift into the deadly and vicious space bats swarm.</p>
            <p><b>Anabiosis</b>: Unlocked at 600 blood, ancient technique which allows you to cure almost any wounds while sleeping in a coffin.</p>
            <p><b>Summon Bats</b>: Unlocked at 800 blood, allows you to call extraplanar space bats to aid you in combat.</p>
            <p><b>Full Power</b><Divider /><b>Metamorphosis - Hound</b>: Allows you to shapeshift into the ultimate form of bluespace entity which took over your soul.</p>
