...
export const HemoMenu = (props, context) => {
  ...
  return (
      <Section title="Гемомансер">
        ...
        <p>
          <b>Когти</b>: Открывается от 150 <i><font color='red'>крови</font></i>, позволяет призвать пару смертоносных когтей,
        ...
        <p>
          <b>Кровавые щупальца</b>: Открывается от 250 <i><font color='red'>крови</font></i>, после небольшой задержки позволяет
          вам замедлить всех внутри выбранной области 3x3.
        </p>
        <p>
          <b>Погружение в кровь</b>: Открывается от 400 <i><font color='red'>крови</font></i>, позволяет непродолжительное время передвигаться с большой скоростью,
          игнорируя все препятствия, кроме стен и космоса, а также оставляя за собой кровавый след.
        </p>
        <p>
          <b>Чутьё хищника</b>: Открывается от 600 <i><font color='red'>крови</font></i>, позволяет вам почувствовать кого-угодно
...
export const UmbrMenu = (props, context) => {
  ...
  return (
      <Section title="Умбра">
        ...
        <p>
          <b>Покров тьмы</b>: Открывается от 150 <i><font color='red'>крови</font></i>,
        ...
        <p>
          <b>Теневой якорь</b>: Открывается от 250 <i><font color='red'>крови</font></i>, активация создает на месте
        ...
        <p>
          <b>Тёмный проход</b>: Открывается от 400 <i><font color='red'>крови</font></i>, позволяет вам
          телепортироваться в любое место в пределах видимости.
        </p>
        <p>
          <b>Погасить</b>: Открывается от 600 <i><font color='red'>крови</font></i>, позволяет вам выводить из строя
          любые электрические источники света, а также глоушрумы.
        </p>
          <b>Теневой бокс</b>: Открывается от 800 <i><font color='red'>крови</font></i>, создает
          теневых клонов, которые будут атаковать цель, пока вы находитесь рядом.
        <p>
          <b>Полная сила</b>
          <Divider/>
          <b>Вечная тьма</b>: после включения вы расстворяетесь в нечестивой темноте,
...
export const GarMenu = (props, context) => {
  ...
  return (
      <Section title="Гаргантюа">
        ...
        <p>
          <b>Кровавый вал</b>: Открывается от 150 <i><font color='red'>крови</font></i>, увеличивает
        ...
        <p>
          <b>Кровавый вал II</b>: Открывается от 400 <i><font color='red'>крови</font></i>, увеличивает весь урон
          в ближнем бою на 10.
        </p>
        <p>
          <b>Подавляющая сила</b>: Открывается от 600 <i><font color='red'>крови</font></i>,
        ...
        <p>
          <b>Полная сила</b>
          <Divider />
          <b>Рывок</b>: Вы получаете способность делать рывок в вашу цель, разрушая и отталкивая все, во что врежетесь.
        </p>
...
export const DantMenu = (props, context) => {
  ...
  return (
      <Section title="Данталион">
        ...
        <p>
          <b>Подчинение</b>: Открывается от 150 <i><font color='red'>крови</font></i>,
        ...
        <p>
          <b>Рабская коммуна</b>: Открывается от 150 <i><font color='red'>крови</font></i>,
        ...
        <p>
          <b>Кровавые узы</b>: Открывается от 800 <i><font color='red'>крови</font></i>,
...
export const BestMenu = (props, context) => {
  ...
  return (
      <Section title="Бестия">
        ...
        <p>
          <b>Посмотреть трофеи</b>: Открывается от 150 <i><font color='red'>крови</font></i>,
          позволяет вам проверить количество трофеев, а также все пассивные эффекты, что они дают.
        </p>
        <p>
          <b>Иссечение</b>: Открывается от 150 <i><font color='red'>крови</font></i>, вдобавок к крови позволяет вам
          поглощать органы в качестве трофеев для расширения ваших возможностей.
        </p>
        <p>
          <b>Предел иссечения</b>: за раз вы можете поглотить максимум один орган.
        ...
        <p>
          <b>Рывок</b>: Открывается от 250 <i><font color='red'>крови</font></i>,
          позволяет быстро сократить расстояние между вами и целью или сбежать из опасной ситуации.
        </p>
        <p>
          <b>Пометить добычу</b>: Открывается от 250 <i><font color='red'>крови</font></i>,
          позволяет вам отметить жертву, уменьшив ее скорость и заставив ее путаться в ногах.
        </p>
        <p>
          <b>Метаморфоза - Летучие мыши</b>: Открывается от 400 <i><font color='red'>крови</font></i>,
        ...
        <p>
          <b>Полная сила</b>
          <Divider />
          <b>Метаморфоза - Гончая</b>: Позволяет вам обратиться в совершенную форму
