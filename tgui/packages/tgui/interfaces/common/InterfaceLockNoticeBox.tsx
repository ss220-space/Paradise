...
type InterfaceLockProps = Partial<
  {
    accessText: string;
    onLockStatusChange: (l?: boolean) => void;
  } & InterfaceLockData
>;
 ...
 */
export const InterfaceLockNoticeBox = (props: InterfaceLockProps) => {
  const { act, data } = useBackend<InterfaceLockData>();
  const {
