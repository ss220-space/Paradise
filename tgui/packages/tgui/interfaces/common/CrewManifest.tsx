    ...
    group.length > 0 && (
      <Table>
        <Table.Row header color="white">
          <Table.Cell width="35%" textAlign="left">Имя</Table.Cell>
          <Table.Cell width="50%" textAlign="center">Должность</Table.Cell>
          <Table.Cell width="15%" textAlign="right">Статус</Table.Cell>
        </Table.Row>
        ...
        {group.map((person: Person) => (
          ...
          >
            <Table.Cell textAlign="left">{decodeHtmlEntities(person.name)}</Table.Cell>
            <Table.Cell textAlign="center">{decodeHtmlEntities(person.rank)}</Table.Cell>
            <Table.Cell textAlign="right">{person.active}</Table.Cell>
          </Table.Row>
        ))}
      </Table>
    )
