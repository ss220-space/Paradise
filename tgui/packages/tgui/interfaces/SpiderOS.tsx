...
К тому же позволяя вам самим общаться с ними.`,
  },
  {
    ...
    tooltipContent: `Порой клану нужны сведения, которыми могут обладать люди, работающие на объекте вашей миссии. \
...
\nДля успешного похищения людей на вашем шаттле есть скафандры, а на базе — запас наручников, кислорода и баллонов. \
\nТак же напоминаем, что ваши перчатки способны направлять в людей электрический импульс, эффективно станя их на короткое время. `,
  },
  {
    ...
    tooltipContent: `Иногда у нас заказывают саботаж искусственного интеллекта на объектах операции. Это соложный процесс, требующий основательной подготовки. \
\nПредпочитаемый кланом метод — создание уязвимости прямо в загрузочной для законов, позволяющей вывести ИИ из строя. \
В результате такого метода мы можем легко перегрузить ИИ абсурдными законами, но это ограничивает нас: для взлома подходят консоли только в самой загрузочной.
Также взлом задача нелёгкая — системы защиты есть везде. А процесс занимает время... Не удивляйтесь, если ИИ будет противодействовать вашим попыткам его сломать.`,
  },
  {
    icon_state: 'ninja_borg',
    tooltipTitle: 'Саботаж роботов',
    tooltipContent: `Иногда, оценивая ваши шансы на выполнение миссии для их увеличения на объектах, \
что используют роботов для своих целей, мы даём вам особый "Улучшающий" их прибор, встроенный в ваши перчатки. \
\nПри взломе киборга таким прибором (взлом занимает некоторое время), вы получите лояльного клану и вам лично \
слугу, способного на оказание помощи как в саботаже станции, так и в вашем лечении. \
\nТакже робот будет оснащён личной катаной, устройством маскировки, пинпоинтером указывающим ему на вас и генератором электрических сюрикенов. \
Помните, что катана робота не способна обеспечить его блюспейс транслокацию!`,
  },
  {
    icon_state: 'server',
    tooltipTitle: 'Саботаж исследований',
    tooltipContent: `На научных объектах всегда есть своя команда учёных и множество данных, которые приходится где-то хранить. \
В качестве такого объекта обычно выступают сервера. А как известно, корпорации вечно грызутся за знания, что нам на руку. \
...
Скорее всего о вашей попытке взлома будет оповещён местный ИИ. Будьте готовы к этому.`,
  },
  {
    ...
    tooltipContent: `Иногда богатые шишки платят за услуги защиты определённого гуманоида. Если вам досталась такая цель, помните следующее:
...
\n * Не важно кто или что охотится на вашего подзащитного, но для объекта, где проходит миссия, вы всегда нежеланное лицо. \
...
Не портите нашу репутацию в глазах наших клиентов!`,
  },
  {
    ...
    tooltipContent: `Как бы это ни было тривиально, иногда клан нуждается в деньгах. Или, даже возможно, вы задолжали нам. \
В таком случае мы, скорее всего, дадим вам задачу достать для нас эти деньги на следующей вашей миссии. \
\nДля вас эта задача не трудная, но трудоёмкая. Помните, что вы натренированы в искусстве незаметных карманных краж. \
Вы можете использовать это для кражи чужих карт и обналичивания их счетов. Либо можете метить выше и ограбить хранилища или счета самого объекта вашей миссии.
...
В таких случаях вам придётся проявить креативность и добиться того, чтобы вашу жертву по законным основаниям упекли за решётку. \
...
Также она автоматически применяется многими другими модулями, если вы того пожелаете.
...
Не стоит недооценивать внимательность других существ.
...
Также в процессе смещает вас и ваших клонов в случайном направлении в радиусе пары метров.
Пользуйтесь осторожно. Случайное смещение может запереть вас за четырьмя стенами. Будьте к этому готовы!
Клоны существуют примерно 20 секунд, а также имеют шанс размножится, атакуя противников.
...
Перезарядка: Отсутствует.`,
    ...
    },
    {
      ...
      title: 'ФОРМА ДУХА',
      content: `Вы воздействуете на стабильность собственного тела посредством этой экспериментальной технологии.
...
Перезарядка: 25 секунд.`,
  ...
  При передозировке препарат становится слишком опасным для пользователя. Не вводите больше 30 ед. в ваш организм!
  ...
  Перезарядка: 1 секунда.`,
    ...
    },
    {
      ...
      icon_state: 'cloning',
      title: 'ВТОРОЙ ШАНС',
      content: `В прошлом многие убийцы, провалив свои миссии, совершали самоубийства или оказывались в лапах врага.
  ...
  Также они пролетают через стекло, как и обычные лазерные снаряды.
  Стоимость выстрела: 300 ед. энергии.`,
    ...
    },
    {
      ...
      content: `Мгновенно вводит в вас мощную экспериментальную сыворотку, ускоряющую вас в бою и помогающую быстрее восстановиться от оглушающих эффектов.
  Костюм производит сыворотку с использованием урана, что, к сожалению, даёт неприятный побочный эффект, в виде накопления радия в организме пользователя.
  ...
  Из ловушки легко выбраться. Достаточно сломать её любым предметом.
  ...
  Также сеть легко покинуть другим путём, например телепортацией.
  ...
  Перерезание шеи — мгновенно обезглавливает лежащую жертву катаной во вспомогательной руке.
  ...
  Также вы обучаетесь с определённым шансом отражать сняряды врагов обратно.`,
      tooltipPosition: 'right',
    },
  ],
};
  ...
  return (
    <Section
      ...
      buttons={
        ...
        Ведь удобство при ношении костюма жизненно важно для настоящего убийцы!'
          }
      ...
      <LabeledList.Item label={'Концентрация'}>
        <Box>
          ...
          <Button
            textAlign="center"
            tooltip={
              'Включение или отключение интерфейса, отображающиего вашу концентрацию для применения боевого искусства.'
            }
      ...
      <Flex.Item grow={1} width="100%" m={1} my={0}>
        <NoticeBox success align="center" fontSize={'14px'}>
          <LabeledList>
              ...
              <Button
                ...
                tooltip={
                  'С настройкой "Шарф" ваш капюшон больше не будет прикрывать волосы.\
                            ...
                            Уточнение: нано-волокна также будут прикрывать вашу голову и от других головных уборов \
            ...
            <LabeledList.Item label="Заряд костюма">
              ...
              <Button
                textAlign="center"
                tooltip={
                  'Включение или отключение интерфейса, отображающего заряд вашего костюма.'
                }
                tooltipPosition="top-start"
                icon={'question'}
                iconSize={0.8}
          ...
          <Button
            ...
            tooltip={
              'Позволяет вам включить костюм и получить доступ к применению всех функций, заложенных в нём. \
              \nУчтите, что вы не сможете приобрести любые модули, когда костюм будет активирован. \
              \nТакже включённый костюм пассивно потребляет заряд для поддержания работы всех функций и модулей.\
  ...
  return (
    <Section
      ...
      buttons={
        <Button
          tooltip={
            'Молодым убийцам часто нелегко освоится в полевых условиях, даже после интенсивных тренировок. \
          ...
          <Flex.Item width="33%" shrink={1}>
            <Section
              ...
              buttons={
                <Button
                  tooltip={
                    'Ярость, недоступная обычным людям. Сила, скорость и орудия выше их понимания. Разите их как хищник, что разит свою добычу. Покажите им холодный вкус стали!'
                  }
                  tooltipPosition="bottom"
                  icon={'question'}
                  iconSize={0.8}
  ...
  return (
    <Section
      ...
      buttons={
        ...
        Также показывает вашу текущую позицию и позицию самого шаттла!'
          }
          tooltipPosition="right"
          icon={'question'}
          iconSize={0.8}
