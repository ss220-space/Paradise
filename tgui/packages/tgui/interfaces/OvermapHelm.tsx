          ...
          <Section fill scrollable>
            ...
            {tab === 'dock' && (
              <>
                ...
                {!is_shuttle && !is_pod && (
                  <NoticeBox mt={1}>
                    Станция не стыкуется как шаттл. Прыжок — только стоя на
                    клетке портала.
                  </NoticeBox>
                )}
                {!!is_pod && (
                  <>
                    <NoticeBox mt={1}>
                      Отстыковка в космосе — у края сектора (≈10 тайлов до
                      перехода) или у посадочного маяка. С Лаваленда взлёт
                      только у маяка (5 тайлов). Посадка на Лаваленд — только
                      на маяк.
                    </NoticeBox>
                    {!!at_station && (
                      <>
