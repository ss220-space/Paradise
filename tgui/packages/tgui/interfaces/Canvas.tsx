...
import { KEY_F, KEY_G } from 'common/keycodes';
          ...
          {!!data.paint_tool_palette && (
            <Flex.Item>
              <Tooltip
                content={
                  `
                  Щелкните правой кнопкой мыши по пикселю на холсте, чтобы скопировать его цвет.
                ` +
                  (data.editable
                    ? `
                  \n Щелкните левой кнопкой мыши по палитре
                  в нижней части интерфейса, чтобы выбрать цвет,
                  или введите новый цвет, щелкнув правой кнопкой мыши. \n
                  Инструменты могут требовать нажатия сочетания клавиш.
                `
                    : '')
                }
              >
