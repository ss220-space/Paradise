GLOBAL_LIST_INIT(admin_readable_planes, list(
	...
	"BELOW_GAME_PLANE" = BELOW_GAME_PLANE,
	"CULT_VEIL_PLANE" = CULT_VEIL_PLANE,
...
GLOBAL_LIST_INIT(admin_readable_layers, list(
	...
	// Game layers
	"GRASS_UNDER_LAYER" = GRASS_UNDER_LAYER,
	"MAP_EDITOR_TURF_LAYER" = MAP_EDITOR_TURF_LAYER,
	"PLATING_LAYER" = PLATING_LAYER,
	"ABOVE_PLATING_LAYER" = ABOVE_PLATING_LAYER,
	"TRANSPARENT_PLATING_LAYER" = TRANSPARENT_PLATING_LAYER,
	"TRANSPARENT_GIRDER_LAYER" = TRANSPARENT_GIRDER_LAYER,
	"ABOVE_TRANSPARENT_TURF_LAYER" = ABOVE_TRANSPARENT_TURF_LAYER,
	"CLEANABLES_LAYER" = CLEANABLES_LAYER,
	...
	"ABOVE_ICYOVERLAY_LAYER" = ABOVE_ICYOVERLAY_LAYER,
	...
	"HOLOPAD_LAYER" = HOLOPAD_LAYER,
	"CONVEYOR_LAYER" = CONVEYOR_LAYER,
	...
	"PROJECTILE_HIT_THRESHOLD_LAYER" = PROJECTILE_HIT_THRESHOLD_LAYER,
	...
	"BEHIND_MOB_LAYER" = BEHIND_MOB_LAYER,
	...
	// HUD layers
	"HUD_LAYER" = HUD_LAYER,
	"BUILDMOD_LAYER" = BUILDMOD_LAYER,
	"BLOODY_SCREEN_LAYER" = BLOODY_SCREEN_LAYER,
