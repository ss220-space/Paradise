...
GLOBAL_LIST_INIT(traits_by_type, list(
	/datum/mind = list(
		...
		"TRAIT_NO_WIZARD_CLOTHES" = TRAIT_NO_WIZARD_CLOTHES
	),
	...
	/mob = list(
		...
		"TRAIT_BLOCK_METABOLIZE" = TRAIT_BLOCK_METABOLIZE,
		"TRAIT_BLOCK_STAMINA_REGEN" = TRAIT_BLOCK_STAMINA_REGEN,
		...
		"TRAIT_FORCE_GRASPED" = TRAIT_FORCE_GRASPED,
		...
		"TRAIT_HEALS_FROM_SWARMER_CORES" = TRAIT_HEALS_FROM_SWARMER_CORES,
		...
		"TRAIT_NINJA_INVISIBILITY" = TRAIT_NINJA_INVISIBILITY,
	...
	/datum/controller/subsystem/processing/station = list(
		"STATION_TRAIT_ACCUMULATOR_RIFLE_ARMORY" = STATION_TRAIT_ACCUMULATOR_RIFLE_ARMORY,
		"STATION_TRAIT_AUTOMATIC_LASER_ARMORY" = STATION_TRAIT_AUTOMATIC_LASER_ARMORY,
		...
		"STATION_TRAIT_HITSCAN_ARMORY" = STATION_TRAIT_HITSCAN_ARMORY,
