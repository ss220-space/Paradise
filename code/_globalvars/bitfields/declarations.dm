...
DEFINE_BITFIELD(pass_flags, PASS_FLAGS_LIST)

DEFINE_BITFIELD(pass_flags_self, PASS_FLAGS_LIST)
...
DEFINE_BITFIELD(gas_type, list(
	...
	"LINDA_SPAWN_HYDROGEN" = LINDA_SPAWN_HYDROGEN,
	"LINDA_SPAWN_WATER_VAPOR" = LINDA_SPAWN_WATER_VAPOR,
	"LINDA_SPAWN_TRITIUM" = LINDA_SPAWN_TRITIUM,
	"LINDA_SPAWN_BZ" = LINDA_SPAWN_BZ,
	"LINDA_SPAWN_PLUOXIUM" = LINDA_SPAWN_PLUOXIUM,
	"LINDA_SPAWN_MIASMA" = LINDA_SPAWN_MIASMA,
	"LINDA_SPAWN_FREON" = LINDA_SPAWN_FREON,
	"LINDA_SPAWN_NITRIUM" = LINDA_SPAWN_NITRIUM,
	"LINDA_SPAWN_HEALIUM" = LINDA_SPAWN_HEALIUM,
	"LINDA_SPAWN_PROTO_NITRATE" = LINDA_SPAWN_PROTO_NITRATE,
	"LINDA_SPAWN_ZAUKER" = LINDA_SPAWN_ZAUKER,
	"LINDA_SPAWN_HALON" = LINDA_SPAWN_HALON,
	"LINDA_SPAWN_HELIUM" = LINDA_SPAWN_HELIUM,
	"LINDA_SPAWN_ANTINOBLIUM" = LINDA_SPAWN_ANTINOBLIUM,
	"LINDA_SPAWN_HYPER_NOBLIUM" = LINDA_SPAWN_HYPER_NOBLIUM,
))
