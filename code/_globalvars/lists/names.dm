...
GLOBAL_LIST_INIT(isp_blacklist, world.file2list("strings/names/isp_blacklist.txt"))
GLOBAL_LIST_INIT(isp_whitelist, world.file2list("strings/names/isp_whitelist.txt"))
