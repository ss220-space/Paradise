...
GLOBAL_LIST_INIT(all_taipan_jobs, list(JOB_TITLE_TAIPAN_SCIENTIST,JOB_TITLE_TAIPAN_MEDIC,JOB_TITLE_TAIPAN_BOTANIST,JOB_TITLE_TAIPAN_CARGO,JOB_TITLE_TAIPAN_CHEF,JOB_TITLE_TAIPAN_ENGINEER,JOB_TITLE_TAIPAN_COMMS,JOB_TITLE_TAIPAN_RD,JOB_TITLE_TAIPAN_ROBOT))
