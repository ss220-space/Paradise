...
/atom/movable/plane_master_controller/game
	...
	controlled_planes = list(FLOOR_PLANE, GAME_PLANE, LIGHTING_PLANE, O_LIGHTING_VISUAL_PLANE, LIGHTING_PLANE_ADDITIVE, PLANE_SPACE_PARALLAX, PLANE_SPACE, OPENSPACE_PLANE)
