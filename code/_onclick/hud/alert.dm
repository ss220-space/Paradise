...
/obj/screen/alert/fat/vampire
	...
	ru_name = "Ожирение"
	ru_desc = "Вы выпили столько крови, что пузо уже не влезает в штаны. Бегайте теперь по станции кругами, чтобы похудеть."
	icon_state = "v_fat"
...
/obj/screen/alert/full/vampire
	...
	ru_name = "Пресыщение"
	ru_desc = "Вы чувствуете спокойствие и приятную насыщенность. Но жажда крови обязательно вернётся…"
	icon_state = "v_full"
...
/obj/screen/alert/well_fed/vampire
	...
	ru_name = "Сытость"
	ru_desc = "Вы вполне сыты, но могли бы выпить ещё немного крови."
	icon_state = "v_well_fed"

/obj/screen/alert/fed/vampire
	name = "Fed"
	desc = "You feel moderately satisfied, but a bit more blood wouldn't hurt."
	ru_name = "Удовлетворённость"
	ru_desc = "Вы не голодны, но испить ещё немного крови не помешало бы."
	icon_state = "v_fed"
...
/obj/screen/alert/hungry/vampire
	...
	ru_name = "Недоедание"
	ru_desc = "Вы жаждете отведать свежей крови."
	icon_state = "v_hungry"
...
/obj/screen/alert/starving/vampire
	...
	ru_name = "Жажда"
	ru_desc = "Вас наполняет жажда. Она приносит физическую боль. Вам тяжело передвигаться."
