...
/atom/movable/screen/alert/not_enough_oxy
	name = "Удушение (Недостаток  O2)"
	desc = "Вам не хватает кислорода. Найдите пригодный для дыхания воздух, прежде чем потерять сознание! В рюкзаке у вас есть баллон с кислородом и маска."
	icon_state = "not_enough_oxy"

/atom/movable/screen/alert/too_much_oxy
	name = "Удушение (Избыток O2)"
	desc = "В воздухе слишком много кислорода, и вы вдыхаете его! Найдите нормальный воздух, пока не отключились!"
	icon_state = "too_much_oxy"

/atom/movable/screen/alert/not_enough_nitro
    name = "Удушение (Недостаток N)"
    desc = "Вам не хватает азота. Найдите нормальный воздух, пока не отключились!"
    icon_state = "not_enough_nitro"

/atom/movable/screen/alert/too_much_nitro
    name = "Удушение (Избыток N)"
    desc = "Слишком много азота в воздухе, и вы вдыхаете его! Найдите нормальный воздух, пока не отключились!"
    icon_state = "too_much_nitro"

/atom/movable/screen/alert/not_enough_co2
	name = "Удушение (Недостаток CO2)"
	desc = "Вам не хватает углекислого газа. Найдите нормальный воздух, пока не отключились!"
	icon_state = "not_enough_co2"

/atom/movable/screen/alert/too_much_co2
	name = "Удушение (Избыток CO2)"
	desc = "Слишком много углекислого газа в воздухе, и вы вдыхаете его! Найдите нормальный воздух, пока не отключились!"
	icon_state = "too_much_co2"

/atom/movable/screen/alert/not_enough_tox
	name = "Удушение (Недостаток Плазмы)"
	desc = "Вам не хватает плазмы. Найдите нормальный воздух, пока не отключились!"
	icon_state = "not_enough_tox"

/atom/movable/screen/alert/too_much_tox
	name = "Удушение (Плазма)"
	desc = "В воздухе горючая токсичная плазма, и вы её вдыхаете! Найдите пригодный для дыхания воздух, прежде чем потерять сознание! В рюкзаке у вас есть баллон с кислородом и маска."
...
/atom/movable/screen/alert/hunger/well_fed/machine
	name = "Высокий заряд"
	desc = "Вы почти полностью заряжены, но ещё чуть-чуть можно."
...
/atom/movable/screen/alert/hot/robot
    desc = "Воздух вокруг вас слишком горячий для гуманоидов. Будьте осторожны и не подвергайте их воздействию окружающей среды."
...
/atom/movable/screen/alert/cold/robot
    desc = "Воздух вокруг вас слишком холодный для гуманоидов. Будьте осторожны и не подвергайте их воздействию окружающей среды."
...
/atom/movable/screen/alert/drunk
	name = "Опъянение"
	desc = "Алкоголь нарушает речь, моторику и мышление."
	icon_state = "drunk"

/atom/movable/screen/alert/embeddedobject
	name = "Застрявший предмет"
	desc = "В вашем теле застрял инородный предмет, вызывающий кровотечение. Он может выпасть сам, но операция безопаснее. \
			Если рискнёте, кликните на себя в режиме помощи, чтобы вытащить его."
...
/atom/movable/screen/alert/asleep
	name = "Уснул"
	desc = "Вы уснули. Подождите немного, и проснётесь. Если, конечно, не умрёте — ведь вы беспомощны."
	icon_state = "asleep"
...
/atom/movable/screen/alert/fire
	name = "В огне"
	desc = "Ты горишь! Падай, катайся или беги в вакуум, чтобы потушить пламя."
	icon_state = "fire"
...
/atom/movable/screen/alert/direction_lock
	...
	desc = "Вы можете смотреть только в одну сторону, что замедляет движение. Кликните сюда, чтобы разблокировать поворот."
...
/atom/movable/screen/alert/alien_tox
	name = "Плазма"
	desc = "В воздухе горючая плазма. Если она воспламенится, тебе не поздоровится."
...
// This alert is temporarily gonna be thrown for all hot air but one day it will be used for literally being on fire
	name = "Перегрев"
	desc = "Слишком жарко! Беги в космос или хотя бы подальше от огня. Нахождение на траве восстановит твоё здоровье."
	icon_state = "alien_fire"
	alerttooltipstyle = "alien"

/atom/movable/screen/alert/alien_vulnerable
	name = "Королева мертва"
	desc = "Ваша королева убита. Теперь вы страдаете от замедления и потери связи с ульем. \
			Новая королева не появится, пока вы не восстановитесь."
...
/atom/movable/screen/alert/nofactory
	name = "Нет фабрики"
	desc = "У вас нет фабрики, и вы медленно умираешь!"
...
/atom/movable/screen/alert/nocell
	...
	desc = "Нет батареи. Модули недоступны до её установки. Обратитесь в робототехнику."
	icon_state = "nocell"

/atom/movable/screen/alert/emptycell
	name = "Разряжено"
	desc = "Батарея полностью разряжена. Модули недоступны до подзарядки. \
			Зарядные станции есть в робототехнике, дормиториях и на спутнике ИИ."
	icon_state = "emptycell"

/atom/movable/screen/alert/lowcell
	name = "Низкий заряд"
	desc = "Батарея почти разряжена. Зарядные станции есть в робототехнике, дормиториях и на спутнике ИИ."
	icon_state = "lowcell"

//Diona Nymph
/atom/movable/screen/alert/nymph
	name = "Слияние с гештальтом"
	desc = "Вы слились с дионическим гештальтом и стали частью его биомассы. Но ещё можете попытаться выбраться."
...
/atom/movable/screen/alert/newlaw
	...
	desc = "Законы этого юнита могли быть изменены. Убедитесь, что ваши действия соответствуют актуальным законам."
	icon_state = "newlaw"
	timeout = 300
...
/atom/movable/screen/alert/mech_maintenance
	...
	desc = "Активированы протоколы обслуживания. Большинство действий недоступно."
	icon_state = "locked"
...
/atom/movable/screen/alert/cancharge
	name = "Рывок готов"
	desc = "Вы готовы мгновенно ускориться в выбранном направлении"
...
/atom/movable/screen/alert/notify_cloning
	name = "Воскрешение"
	desc = "Кто-то пытается вас оживить. Вернитесь в своё тело, если хотите возродиться!"
	icon_state = "template"
	timeout = 300
...
/atom/movable/screen/alert/notify_action
	name = "Тело создано"
	desc = "Тело создано. Вы можете в него вселиться."
	icon_state = "template"
	timeout = 30 SECONDS
...
/atom/movable/screen/alert/restrained/buckled
	name = "Пристёгнут"
	desc = "Вас пристегнули. Нажмите на уведомление, чтобы отстегнуться (если не в наручниках)."
	icon_state = "buckled"

/atom/movable/screen/alert/restrained/handcuffed
	name = "В наручниках"
	desc = "Вы в наручниках и не можете действовать. Если вас потащат, вы не сможете сопротивляться. Нажмите на уведомление, чтобы освободиться."

/atom/movable/screen/alert/restrained/legcuffed
	name = "Ноги скованы"
	desc = "Ваши ноги скованы и сильно замедлены. Нажмите на уведомление, чтобы освободиться.."
