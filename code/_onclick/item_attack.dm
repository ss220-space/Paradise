...
/obj/proceed_attack_results(obj/item/item, mob/living/user, params)
	...
	if(!item.force)
		user.visible_message(
			span_warning("[user] аккуратно тыкнул[GEND_ENDING_A_O_I(user)] [declent_ru(ACCUSATIVE)] [item.declent_ru(INSTRUMENTAL)]."),
			span_warning("Вы аккуратно тыкнули [declent_ru(ACCUSATIVE)] [item.declent_ru(INSTRUMENTAL)]."),
		)
		return .
	user.visible_message(
		span_danger("[user] ударил[GEND_ENDING_A_O_I(user)] [declent_ru(ACCUSATIVE)] [item.declent_ru(INSTRUMENTAL)]!"),
...
/mob/living/proc/send_item_attack_message(obj/item/item, mob/living/user, def_zone)
	...
	if(!item.force)
		visible_message(
			span_warning("[user] аккуратно тыкнул[GEND_ENDING_A_O_I(user)] [declent_ru(ACCUSATIVE)] [item.declent_ru(INSTRUMENTAL)]."),
			span_warning("[user] аккуратно тыкнул[GEND_ENDING_A_O_I(user)] вас [item.declent_ru(INSTRUMENTAL)]."),
			ignored_mobs = user,
		)
	...
	visible_message(
		span_danger("[user] [message_verb][GEND_ENDING_A_O_I(user)] [declent_ru(ACCUSATIVE)] [item.declent_ru(INSTRUMENTAL)]!"),
		span_userdanger("[user] [message_verb][GEND_ENDING_A_O_I(user)] вас [item.declent_ru(INSTRUMENTAL)]!"),
		ignored_mobs = user,
	)
