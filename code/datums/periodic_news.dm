...
/datum/news_announcement/revolution_inciting_event/paycuts_suspicion
	round_time = 60*10
	message = {"Утекли сообщения о том, что Nanotrasen Inc. планирует ввести сокращение зарплат
				на многих своих исследовательских станциях в системе Tau Ceti. По всей видимости, эти станции
...
/datum/news_announcement/revolution_inciting_event/paycuts_confirmation
	...
	message = {"Ранее ходившие слухи о сокращении зарплат на исследовательских станциях
				в системе Tau Ceti подтвердились. Однако, что шокирует, сокращения затронут только
...
/datum/news_announcement/revolution_inciting_event/human_experiments
	...
	message = {"Поступили шокирующие сообщения о проведении экспериментов над людьми.
				Согласно беженцу с одной из исследовательских станций в системе Tau Ceti, их станция,
				...
				а неквалифицированный персонал, насильно вовлечённый в эксперименты. О их гибели Nanotrasen Inc. сообщала
...
/datum/news_announcement/bluespace_research/announcement
	...
	message = {"Новая область исследований, пытающаяся объяснить несколько интересных аномалий пространства-времени,
				...
				на орбите в системе Tau Ceti, пятнадцать теперь специально оборудованы для экспериментов и изучения эффектов Блюспейса.
...
/datum/news_announcement/food_riots/breaking_news
	...
	message = {"Экстренные новости: В колонии на астероиде «Убежище» в системе «Тенебру Люпус» вспыхнули продовольственные бунты.
				Это произошло всего через несколько часов после того, как представители Nanotrasen объявили о прекращении торговли
				с колонией, сославшись на возросшее присутствие «враждебных фракций», что сделало торговлю слишком опасной.
				Представители Nanotrasen не предоставили подробностей об этих фракциях. Подробнее об этом в начале часа."}
	round_time = 60 * 10
...
/datum/news_announcement/food_riots/more
	...
	message = {"Подробнее о продовольственных бунтах в колонии «Убежище»: Совет Убежища осудил уход Nanotrasen
				из колонии, заявив, что «не было никакого увеличения активности против Nanotrasen, и что «единственная причина ухода
				Nanotrasen — это полное истощение залежей плазмы в системе «Тенебру Люпус». Теперь нам почти нечего им предложить».
				Представители Nanotrasen опровергли эти обвинения, назвав их «дополнительным доказательством» анти-Nanotrasen настроений в колонии.
