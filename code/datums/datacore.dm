...
*/
	...
	switch(job_clothes)
		if(JOB_TITLE_HOP)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "hop_alt_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
		if(JOB_TITLE_REPRESENTATIVE)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "officer_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "laceups"), ICON_UNDERLAY)
		if(JOB_TITLE_BLUESHIELD)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "officer_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "jackboots"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/gloves.dmi', "swat_gl"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "blueshield"), ICON_OVERLAY)
		if(JOB_TITLE_JUDGE)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "really_black_suit_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "laceups"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "judge"), ICON_OVERLAY)
		if(JOB_TITLE_BARTENDER)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "ba_suit_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_BOTANIST)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "hydroponics_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_CHEF)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "chef_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_JANITOR)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "janitor_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_LIBRARIAN)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "red_suit_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_CLOWN)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "clown_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "clown"), ICON_UNDERLAY)
		if(JOB_TITLE_MIME)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "mime_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_QUARTERMASTER)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "qm_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
		if(JOB_TITLE_CARGOTECH)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "cargotech_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_MINER)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "explorer_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "explorer"), ICON_UNDERLAY)
		if(JOB_TITLE_MINING_MEDIC)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "mining_medic_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
		if("Lawyer")
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "internalaffairs_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
		if(JOB_TITLE_CHAPLAIN)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "chapblack_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_RD)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "director_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_open"), ICON_OVERLAY)
		if(JOB_TITLE_SCIENTIST)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "toxinswhite_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_tox_open"), ICON_OVERLAY)
		if(JOB_TITLE_SCIENTIST_STUDENT)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "student_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_tox_open"), ICON_OVERLAY)
		if(JOB_TITLE_CHEMIST)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "chemistrywhite_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_chem_open"), ICON_OVERLAY)
		if(JOB_TITLE_CMO)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "cmo_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_cmo_open"), ICON_OVERLAY)
		if(JOB_TITLE_DOCTOR)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "medical_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_open"), ICON_OVERLAY)
		if(JOB_TITLE_CORONER)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "scrubsblack_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_mort_open"), ICON_OVERLAY)
		if(JOB_TITLE_GENETICIST)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "geneticswhite_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_gen_open"), ICON_OVERLAY)
		if(JOB_TITLE_VIROLOGIST)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "virologywhite_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_vir_open"), ICON_OVERLAY)
		if(JOB_TITLE_PSYCHIATRIST)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "psych_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "laceups"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_open"), ICON_UNDERLAY)
		if(JOB_TITLE_PARAMEDIC)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "paramedic_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		if(JOB_TITLE_INTERN)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "intern_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "white"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_open"), ICON_OVERLAY)
		if(JOB_TITLE_CAPTAIN)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "captain_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
		if(JOB_TITLE_HOS)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "hosred_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "jackboots"), ICON_UNDERLAY)
		if(JOB_TITLE_WARDEN)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "warden_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "jackboots"), ICON_UNDERLAY)
		if(JOB_TITLE_DETECTIVE)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "detective_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "detective"), ICON_OVERLAY)
		if(JOB_TITLE_PILOT)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "secred_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "jackboots"), ICON_UNDERLAY)
		...
		if(JOB_TITLE_OFFICER)
			...
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "jackboots"), ICON_UNDERLAY)
		if(JOB_TITLE_CHIEF)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "chief_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/belt.dmi', "utility"), ICON_OVERLAY)
		if(JOB_TITLE_ENGINEER)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "engine_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "orange"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/belt.dmi', "utility"), ICON_OVERLAY)
		if(JOB_TITLE_ATMOSTECH)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "atmos_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/belt.dmi', "utility"), ICON_OVERLAY)
		if(JOB_TITLE_MECHANIC)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "mechanic_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "orange"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/belt.dmi', "utility"), ICON_OVERLAY)
		if(JOB_TITLE_ENGINEER_TRAINEE)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "trainee_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "orange"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/belt.dmi', "utility"), ICON_OVERLAY)
		if(JOB_TITLE_ROBOTICIST)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "robotics_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/mob/clothing/suit.dmi', "labcoat_open"), ICON_OVERLAY)
		if("Syndicate Agent")
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "syndicate_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
		...
		if(JOB_TITLE_PRISONER)
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "orange_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "orange"), ICON_UNDERLAY)
		else if(H.mind && (H.mind.assigned_role in get_all_centcom_jobs()))
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "officer_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "laceups"), ICON_UNDERLAY)
		else
			clothes_s = new /icon('icons/mob/clothing/jumpsuit.dmi', "grey_s")
			clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
