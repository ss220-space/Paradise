...
/datum/element/wall_walker/proc/try_pass_wall(mob/living/passing_mob, turf/simulated/wall/bumped_wall)
...
/datum/element/wall_walker/proc/exit_wall(mob/living/passing_mob, turf/simulated/wall/exited_wall)
