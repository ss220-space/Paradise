...
/datum/element/ai_control_examine/proc/on_organ_implanted(obj/item/organ/internal/possibly_noticable, mob/living/carbon/receiver)
	SIGNAL_HANDLER
...
/datum/element/ai_control_examine/proc/make_organ_noticable(organ_slot, obj/item/organ/noticable_organ, mob/living/carbon/human/human_pawn)
	...
	var/body_zone = organ_slot != INTERNAL_ORGAN_BRAIN ? noticable_organ.parent_organ_zone : null
