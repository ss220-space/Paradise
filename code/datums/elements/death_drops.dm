...
/datum/element/death_drops/proc/create_loot(typepath, atom/loot_loc, mob/living/dead, gibbed, spread_px = 4)
	// if(ispath(typepath, /obj/effect/mob_spawn/corpse)) // Похуй потом
...
// /datum/element/death_drops/proc/handle_corpse(typepath, atom/loot_loc, mob/living/dead, gibbed) // Похуй потом
...
// 	body.setToxLoss(dead.get_tox_loss())
// 	body.setOxyLoss(dead.get_oxy_loss())
// 	return body
