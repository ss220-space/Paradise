...
/datum/element/elevation/Attach(datum/target, pixel_shift)
	...
	ADD_TRAIT(target, TRAIT_ELEVATING_OBJECT, UNIQUE_TRAIT_SOURCE(src))
...
/datum/element/elevation/Detach(atom/movable/source)
	...
	REMOVE_TRAIT(source, TRAIT_ELEVATING_OBJECT, UNIQUE_TRAIT_SOURCE(src))
	return ..()
...
/datum/element/elevation/proc/register_turf(atom/movable/source, atom/location)
	...
	ADD_TRAIT(location, TRAIT_TURF_HAS_ELEVATED_OBJ(pixel_shift), UNIQUE_TRAIT_SOURCE(source))

/datum/element/elevation/proc/unregister_turf(atom/movable/source, atom/location)
	if(!isturf(location))
		return
	REMOVE_TRAIT(location, TRAIT_TURF_HAS_ELEVATED_OBJ(pixel_shift), UNIQUE_TRAIT_SOURCE(source))
	if(!HAS_TRAIT(location, TRAIT_TURF_HAS_ELEVATED_OBJ(pixel_shift)))
...
#define ELEVATION_SOURCE(datum) "elevation_[UID_of(datum)]"
