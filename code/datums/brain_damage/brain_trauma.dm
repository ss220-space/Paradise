...
/datum/brain_trauma
	...
	var/gain_text = span_notice("Вы чувствуете что с вашим разумом что-то не так.")
	var/lose_text = span_notice("Вы больше не чувствуете что с вашим разумом что-то не так.")
	var/can_gain = TRUE
