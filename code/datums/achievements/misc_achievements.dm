...
/datum/award/achievement/misc/getting_an_upgrade
	name = "Getting an upgrade" // REQ unique autolate materials
...
/datum/award/achievement/misc/rule9
	name = "Rule 9" // REQ /obj/item/toy/plush/proc/love or smth else
	desc = "Call an admin this is ILLEGAL!!"
	database_id = MEDAL_RULE9
	icon_state = "rule8"

/datum/award/achievement/misc/clickbait
	name = "Clickbait" // REQ pda clickbait
