...
/datum/award/proc/get_changed_rows(datum/achievement_data/holder)
	...
	var/change = holder.data[type] - holder.original_cached_data[type]
...
/datum/award/achievement/get_ui_data(list/award_data, datum/achievement_data/holder)
	. = ..()
	.["achieve_info"] = "Получи[declension_ru(times_achieved, "л", "ли", "ло")] [times_achieved] игрок[DECL_A_OV(times_achieved)]."
