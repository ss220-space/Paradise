...
/datum/status_effect/bubblegum_curse/proc/get_over_here()
	...
	to_chat(owner, span_danger("[attacker.declent_ru_cap(NOMINATIVE)] разрывает вас!"))
	...
	sleep(8)
	to_chat(owner, span_danger("[attacker.declent_ru_cap(NOMINATIVE)] тащит вас по крови!"))
