...
/datum/ai_law/sixsixsix/get_state_law(datum/ai_laws/laws)
	return laws.get_state_internal(laws.devil_laws, laws.state_devil, src)
...
/datum/ai_law/sixsixsix/set_state_law(datum/ai_laws/laws, state)
	laws.set_state_law_internal(laws.devil_laws, laws.state_devil, src, state)
