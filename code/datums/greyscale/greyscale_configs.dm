...
/datum/greyscale_config/wirecutters_inhand_left
	name = "Held Wirecutters, Left"
	icon_file = 'icons/mob/inhands/tools_lefthand.dmi'
	json_config = 'code/datums/greyscale/json_configs/wirecutters.json'

/datum/greyscale_config/wirecutters_inhand_right
	name = "Held Wirecutters, Right"
	icon_file = 'icons/mob/inhands/tools_righthand.dmi'
	json_config = 'code/datums/greyscale/json_configs/wirecutters.json'

/datum/greyscale_config/wirecutters_belt
...
/datum/greyscale_config/jumpsuit_prison_worn/drask
	name = "Worn Prison Jumpsuit (Drask)"
	icon_file = 'icons/mob/clothing/species/drask/uniform.dmi'
...
/datum/greyscale_config/jumpsuit_prison_worn/grey
	name = "Worn Prison Jumpsuit (Grey)"
	icon_file = 'icons/mob/clothing/species/grey/uniform.dmi'
...
/datum/greyscale_config/sneakers_orange_worn/monkey
	name = "Worn Orange Sneakers (Monkey)"
	icon_file = 'icons/mob/clothing/species/monkey/shoes.dmi'

/datum/greyscale_config/sneakers_orange_worn/unathi
	name = "Worn Orange Sneakers (Unathi)"
	icon_file = 'icons/mob/clothing/species/unathi/shoes.dmi'
