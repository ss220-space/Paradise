...
/datum/uplink_item/implants/stamina_boost
	name = "Стамина буст имплант"
	desc = "Имплант, который можно вживить в организм и активировать по желанию. Избавляет от оглушения и восстанавливает выносливость\
			При использовании перегружает организм, временно ограничевая максимальную выносливость."
	item = /obj/item/implanter/stamina_boost
	cost = 12
	can_discount = FALSE
	surplus = 0
