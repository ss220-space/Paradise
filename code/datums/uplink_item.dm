...
/datum/uplink_item/jobspecific/missilemedium
	...
	desc = "Эта ракетная установка используются на высококлассных экзоскелетах, таких как \"Mauler\" и \"Marauder\". \
			Она обладаёт гораздо большей мощностью, чем ракетные установки, которые можно создать в фабрикаторе экзоскелетов. \
...
/datum/uplink_item/jobspecific/contortionist
	...
	desc = "Этот комбинезон обладаёт высокой гибкостью, что позволяет с лёгкостью перемещаться в вентиляционных трубах станции. \
...
/datum/uplink_item/dangerous/minotaur
	...
	desc = "Современный дробовик с магнитным механизмом питания, способный стрелять очередями. В зависимости от типа барабана, он может вмещать от 12 до 24 патронов, \
			...
			Обладаёт большим разнообразием боеприпасов, и выбор подходящего вида во многом определяет эффективность дробовика и стиль ведения боя."
...
/datum/uplink_item/dangerous/pistol
	...
	desc = "Полностью заряженный пистолет, оснащённый магазином на 8 патронов калибра 10 мм. Обладаёт большим разнообразием боеприпасов. \
...
/datum/uplink_item/dangerous/sniper
	...
	desc = "Полностью заряженная винтовка со снайперским прицелом, оснащённая магазином на 5 патронов .50 калибра. Совместима с глушителем. \
			Требует использования обоих рук для стрельбы. Обладаёт огромной убойной силой и бронепробитием в зависимости от типа патрона. \
...
/datum/uplink_item/support/rover
	...
	desc = "Модернизированный экзоскелет \"Durand\", созданный для нужд синдиката, оснащён следующими модулями: \
			...
			Обладаёт способностью создавать энергетические барьеры, преодолеть которые могут лишь члены синдиката."
...
/datum/uplink_item/support/reinforcement/medical_borg
	...
	desc = "Обладаёт ограниченным наступательным потенциалом, но с лихвой компенсирует его возможностями поддержки. \
...
/datum/uplink_item/ammo/rocketHEDP
	...
	desc = "Ракета для реактивного гранатомёта PML-9. Она обладаёт высокой проникающей способностью, \
...
/datum/uplink_item/stealthy_weapons/cameraflash
	...
	desc = "Флешер, который выглядит как фотоаппарат, обладаёт всеми функциями обычного флешера, но при этом имеет несколько преимуществ. \
...
/datum/uplink_item/explosives/atmosfiregrenades
	...
	desc = "Коробка, содержащая 2 кластерные гранаты наполненные газообразной плазмой. \
			При активации высвобождаёт плазму, которая, воспламеняясь, уничтожает всё на своём пути."
...
/datum/uplink_item/suits/hardsuit/elite
	...
	desc = "Усовершенствованная версия знаменитого ИКСа Синдиката, выполненная в мрачном чёрном цвете. Обладаёт компактными размерами и легко помещается в сумку. \
			...
			В отличие от своего предшественника, он обладаёт полной защитой от термического воздействия и обладаёт превосходной броней. \
...
/datum/uplink_item/suits/hardsuit/shielded
	...
	desc = "Знаменитый ИКС, выполненный в зловещих чёрно-красных тонах, отличается компактными размерами по сравнению с ИКСами НаноТрейзнен и \
			...
			В отличие от обычного ИКСа Синдиката, этот обладаёт энергетическим щитом, который способен блокировать любые атаки, как в ближнем, так и в дальнем бою. \
