...
/datum/uplink_item/suits/magboot
	...
	desc = "Модуль для МЭК, представляет из себя доработанную версию стандартных магнитных ботинок. Не способен защитить пользователя \
			...
			пользователя. Данный модуль изначально предустановлен в МЭКы Синдиката."
...
/datum/uplink_item/suits/elite_magboot
	...
	desc = "Модуль для МЭК, представляющий из себя украденную \"Киберсан\" технологию магбутсов. Удерживающие магниты \
			последнего поколения позволяют пользователю не скользить на космической смазке, при этом предоставляя те же самые \
			преимущества, что и продвинутые магбутсы. Не забудьте, что вам, для начала, необходимо удалить из вашего МЭКа \
			старые магбутсы с помощью лома."
...
/datum/uplink_item/suits/chameleon_module
	...
	desc = "Модуль для МЭК, использует технологию хамелеон для маскировки выключенного МЭКа под обычный рюкзак. \
...
/datum/uplink_item/suits/modsuit_elite
	...
	desc = "МЭК, выполненный в зловещих чёрных тонах. Продвинутая версия МЭК Синдиката. Практически точная копия \
			легендарных костюмов отряда \"АТОМ\" за исключением того, что модули внутри костюма гораздо хуже тех, что \
			предоставляются оперативникам. Чрезвычайно крепкий и *чрезвычайно* дорогой. Члены экипажа при виде данного \
			МЭКа впадает в сильную панику, так что не удивляйтесь, если за вами начнет вести охоту вся станция."
...
/datum/uplink_item/suits/elite_mod
	...
	desc = "Легендарный МЭК, выполненный в зловещих чёрных тонах. Продвинутая версия МЭК Синдиката. Предоставляет превосходную \
			защиту от всех угроз, при этом не замедляя пользователя. Двухрежимная система старых ИКСов была полностью убрана, \
			в связи с чем необходимость жонглировать режимами в бою полностью отпала. Обладает повышенной модульной \
			вместимостью, позволяя настроить костюм под предпочтения пользователя."
...
/datum/uplink_item/suits/shielded
	...
	desc = "Модуль персонального защитного силового поля для МЭК, который способен блокировать любые атаки, как в ближнем, \
			так и в дальнем бою. Щит имеет три заряда и со временем восстанавливается, но из-за малого количества зарядов \
			носитель всё ещё может внезапно оказаться смертен."
...
/datum/uplink_item/suits/shock_absorber
	...
	desc = "Модуль для МЭК, использующий продвинутую технологию поглощения ударных волн для защиты пользователя от шока, \
			вызываемого дубинками службы безопасности. Внимание: модуль не защитит пользователя от урона по выносливости, однако \
...
/datum/uplink_item/bundles_TC/medical
	...
	desc = "Сумка, в которой находятся: боевая аптечка Синдиката, автомендор с синтплотью, боевой гипоспрей, боевой компактный \
			дефибриллятор, боевой ручной дефибриллятор, имплант медицинской лучевой пушки, имплант хирургических инструментов, \
			отвертка, автоимплантер, элитный МЭК Синдиката, портативный анализатор тела, медицинская шина, инъектор с нанокальцием."
