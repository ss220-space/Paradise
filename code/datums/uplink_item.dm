...
/datum/uplink_item/jobspecific/clowngrenade
	...
	desc = "Граната, которая взрывается с оглушительным ГУДКОМ! \
...
/datum/uplink_item/jobspecific/acrobatic_shoes
	...
	desc = "Пара модернизированных клоунских башмаки, оснащенных инновационным прыгающим механизмом, работающим на основе технологии \"хонк-спейс\". \
...
/datum/uplink_item/jobspecific/bipki
	...
	desc = "Отсосите мне, и я расскажу, что внутри."
...
/datum/uplink_item/jobspecific/caneshotgun
	...
	desc = "Однозарядный дробовик, оснащённый устройством, которое имитирует трость. В комплект входят шесть специальных шрапнельных патронов, \
			заставляющие жертву молчать, а также один патрон, уже заряженный в патронник. Кроме того, этот дробовик может использовать и обычные патроны."
...
/datum/uplink_item/jobspecific/CQC_upgrade
	...
	desc = "Специальный имплант для шеф-поваров, который позволяет им нарушать правила безопасности и использовать CQC за пределами кухни. \
			Убедитесь, есть ли у вас имплант CQC, который дает вам возможность использовать это боевое искусство."
...
/datum/uplink_item/jobspecific/holomine
	...
	desc = "Проектор, позволяющий устанавливать до пяти оглушающих мин, обладает дополнительным ЭМИ эффектом. \
...
/datum/uplink_item/jobspecific/cat_grenade
	name = "Граната доставки дикиз кисок"
	desc = "Представляет собой устройство, в котором находятся 5 дегидратированных кисок аналогично дегидратированным обезьянам, \
			которые после взрыва будут регидратированы небольшим резервуаром воды, содержащимся внутри гранаты. \
			Затем эти киски будут нападать на все, что попадется им на глаза."
...
/datum/uplink_item/jobspecific/syndiemmi
	name = "НКИ Синдиката"
	desc = "Разработанный синдикатом Нейронный Компьютерный Интерфейс, который навязывает законы Синдиката любому мозгу, помещенному в него."
...
/datum/uplink_item/jobspecific/etwenty
	...
	desc = "На первый взгляд это обычный кубик, но те, кто не боится рисковать, обнаружат, что он обладает поистине взрывным эффектом! Кубик оснащён четырёхсекундным таймером."
...
/datum/uplink_item/jobspecific/contortionist
	...
	desc = "Этот комбинезон обладает высокой гибкостью, что позволяет с лёгкостью перемещаться в вентиляционных трубах станции. \
			...
			Кроме того, для передвижения внутри вам потребуются свободные руки."
...
/datum/uplink_item/jobspecific/energizedfireaxe
	...
	desc = "Пожарный топор, обладающий мощным энергетическим зарядом. Способен отбросить человека назад и на некоторое время оглушить. \
...
/datum/uplink_item/racial/plasma_chameleon
	...
	desc = "Комплект одежды, оснащённый технологией \"хамелеон\", которая позволяет изменять её внешний вид. \
			...
			В набор также входит дополнительный штамп \"хамелеон\". Предназначен только для плазмолюдов."
...
/datum/uplink_item/racial/second_chance
	...
	desc = "Имплант, активируемый по желанию, позволяет имитировать смерть, вызывая взрыв. \
			После активации он полностью залечивает все раны своего оператора и телепортирует его в безопасное место."
...
/datum/uplink_item/racial/agent_belt
	name = "Пояс похитителя"
	desc = "Пояс с инструментами, используемый агентами-похитителями. Он включает в себя полный набор инопланетных инструментов."
	item = /obj/item/storage/belt/military/abductor/full
	cost = 16
	race = list(SPECIES_GREY)

/datum/uplink_item/racial/silencer
	name = "Глушилка похитителя"
...
/datum/uplink_item/dangerous/minotaur
	...
	desc = "Современный дробовик с магнитным механизмом питания, способный стрелять очередями. В зависимости от типа барабана, он может вмещать от 12 до 24 патронов, \
			что делает его идеальным для борьбы с большими группами людей в узких коридорах или в ближнем бою. \
			Обладает большим разнообразием боеприпасов, и выбор подходящего вида во многом определяет эффективность дробовика и стиль ведения боя."
...
/datum/uplink_item/dangerous/deagle
	...
	desc = "Легендарный мощный пистолет с магазином на 7 патронов калибра .50AE."
...
/datum/uplink_item/dangerous/smg
	name = "Пистолет-пулемет C-20r"
	desc = "Полностью заряженный пистолет-пулемет, оснащённый магазином на 20 патронов  .45 калибра. \
			Имеет два режима стрельбы: полуавтоматический и с отсечкой по 2 патрона. Совместим с глушителем, и к нему можно прикрепить нож."
...
/datum/uplink_item/dangerous/carbine
	name = "Карабин М-90gl"
	desc = "Полностью заряженный трехзарядный карабин, оснащённый магазином калибра 5.56 мм на 30 патронов. \
...
/datum/uplink_item/dangerous/machinegun
	...
	desc = "Полностью заряженный пулемет с ленточным питанием, оснащённый лентой на 50 патронов калибра 5.56х45 мм. \
			Требует использования обоих рук для стрельбы. Имеет два режима стрельбы: полуавтоматический и с отсечкой по 3 патрона."
...
/datum/uplink_item/dangerous/rapid
	...
	desc = "Позволяют владельцу наносить удары с невероятной скоростью. Однако они не увеличивают скорость атаки оружием."
...
/datum/uplink_item/dangerous/flamethrower
	...
	desc = "Оснащён канистрой плазмы, украденной с одной из станций Nanotrasen. \
			Идеальное для борьбы с большими группами людей в узких коридорах. Будьте остроумны, когда используете его, если не хотите себя поджечь!"
...
/datum/uplink_item/dangerous/powerfist
	name = "Силовой кулак"
	desc = "Представляет собой металлическую перчатку с встроенным поршнем, который приводится в действие с помощью балона с газом. \
			...
			Отвертка используется для извлечения прикрепленных баллонов."
	item = /obj/item/melee/powerfist
	cost = 18

/datum/uplink_item/dangerous/chainsaw
	name = "Бензопила"
	desc = "Великолепная бензопила, которая с лёгкостью распиливает деревья... \
			Бензопила оснащена невероятно удобной рукоятью, которая обеспечивает надёжное удержание и исключает риск случайного выронить её во время работы."
...
/datum/uplink_item/dangerous/foamsmg
	name = "Игрушечный пистолет-пулемет \"Донксофт\" C-20r"
	desc = "Полностью заряженный игрушечный пистолет-пулемет, оснащённый магазином на 20 усиленных пенных патронов. \
...
/datum/uplink_item/dangerous/foammachinegun
	...
	desc = "Полностью заряженный игрушечный пулемет с ленточным питанием, оснащённый лентой на 50 усиленных пенных патронов. \
			Предназначен для выведения из строя цели, не причиняя ей вреда. \
			Способен ненадолго вывести цель из строя всего одним залпом. Требует использования обоих рук для стрельбы. \
			Имеет два режима стрельбы: полуавтоматический и с отсечкой по 3 патрона."
...
/datum/uplink_item/ammo/pistol
	name = "\"Стечкин\" — 2 стандартных магазина калибра 10 мм"
...
/datum/uplink_item/ammo/pistolap
	name = "\"Стечкин\" — бронебойный магазин 10 мм"
...
/datum/uplink_item/ammo/uzi_ammobag
	...
	desc = "Сумка, содержащая 10 магазинов на 30 патронов калибра 9 мм. Молоко для детей с Лесной улицы."
	item = /obj/item/storage/backpack/duffel/syndie/ammo/uzi
	cost = 70 // normally 100
	uplinktypes = list(UPLINK_TYPE_NUCLEAR, UPLINK_TYPE_SST)

/datum/uplink_item/ammo/smg
	name = "Пистолет-пулемет C-20r — магазин .45"
	desc = "Магазин на 20 патронов .45 калибра. \
			Эти патроны обладают высокой ударной силой, способной сбить с ног большинство целей, однако они не наносят серьёзных повреждений."
	item = /obj/item/ammo_box/magazine/smgm45
	cost = 10
	uplinktypes = list(UPLINK_TYPE_NUCLEAR, UPLINK_TYPE_SST)

/datum/uplink_item/ammo/smg_ammobag
	name = "Пистолет-пулемет C-20r — сумка с магазинами .45"
...
/datum/uplink_item/ammo/machinegun
	name = "Ручной пулемёт L6 SAW — лента 5.56x45 мм"
	desc = "Лента на 50 патронов калибра 5.56x45 мм."
...
/datum/uplink_item/ammo/LMG_ammobag
	name = "Ручной пулемёт L6 SAW — сумка с лентами 5.56x45 мм"
	desc = "Сумка, содержащая 5 лент на 50 патронов калибра 5.56x45 мм. Ни слова по-русски."
...
/datum/uplink_item/ammo/sniper/soporific
	...
	desc = "Магазин на 5 усыпляющих патронов .50 калибра. Снотворное действует мгновенно, и его нельзя обнаружить с помощью сканера. \
...
/datum/uplink_item/ammo/sniper/explosive
	...
	desc = "Магазин на 5 разрывных патронов .50 калибра. При попадании в цель эти патроны взрываются, нанося серьёзный урон."
...
/datum/uplink_item/ammo/sniper/penetrator
	...
	desc = "Магазин на 5 бронебойных патронов .50 калибра. В отличие от стандартных патронов, эти наносят чуть меньше урона и не способны отрывать конечности. \
			Однако их высокая пробивная сила позволяет им легко проходить сквозь стены и поражать несколько целей подряд."
...
/datum/uplink_item/ammo/rocketHE
	name = "Реактивный гранатомёт — осколочно-фугасная ракета 84 мм (HE)"
	desc = "Ракета для реактивного гранатомёта PML-9. Этот снаряд может вызвать мощный взрыв, \
			который способен причинить значительный ущерб станции и нанести серьёзные повреждения экипажу. \
...
/datum/uplink_item/ammo/rocketHEDP
	name = "Реактивный гранатомёт — осколочно-фугасная ракета двойного назначения 84 мм (HEDP)"
	desc = "Ракета для реактивного гранатомёта PML-9. Она обладает высокой проникающей способностью, \
...
/datum/uplink_item/stealthy_weapons/foampistol
	...
	desc = "Полностью заряженный игрушечный пистолет, оснащённый магазином на 8 усиленных пенных патронов. \
...
/datum/uplink_item/stealthy_weapons/false_briefcase
	...
	desc = "Модифицированный портфель, позволяющий спрятать оружие внутри, что дает возможность стрелять, не вынимая его. \
...
/datum/uplink_item/explosives/t4
	...
	desc = "Взрывчатка повышенной мощности с направленным действием. Эффективно разрушает даже укреплённые стены, но не воздушных шлюзов."
...
/datum/uplink_item/explosives/syndicate_bomb
	...
	desc = "Бомба Синдиката, оснащенная настраиваемым таймером, с минимальным временем задержки в 90 секунд. При заказе бомбы вы получите небольшой маячок, \
			...
			Взрыв нанесёт серьёзный ущерб станции."
...
/datum/uplink_item/device_tools/emag
	...
	desc = "Представляет собой карту, также известную как ЕМАГ, которая способна активировать скрытые функции в электронных устройствах, \
...
/datum/uplink_item/device_tools/access_tuner
	name = "Тюнер доступа"
	desc = "Небольшое устройство, предназначенное для удаленного управления воздушными шлюзами. \
...
/datum/uplink_item/device_tools/black_vest
	name = "Боевая разгрузка — черный жилет"
...
/datum/uplink_item/device_tools/bonerepair
	...
	desc = "Коробка, содержащая 1 инъектор и руководство по применению. \
			...
			Не рекомендуется применять вместе с стимуляторами и наркотиками."
...
/datum/uplink_item/device_tools/syndicate_teleporter
	...
	desc = "Портативное устройство, способное телепортировать пользователя на расстояние от 4 до 8 тайлов вперёд. \
			...
			Устройство имеет 4 заряда, которые со временем восполняются, и подвержено ЭМИ."
...
/datum/uplink_item/device_tools/medkit
	...
	desc = "Аптечка, выполненная в зловещих чёрно-красных тонах. В её состав входит продвинутый анализатор здоровья, \
			медицинский ИЛС с ночным зрением, автомендер с 200 юнитами синтплоти и боевой гипоспрей, в состав которого входят \
			эпинефрин, разбавленный омнизин и глюкозосолевой раствор."
...
/datum/uplink_item/device_tools/powersink
	...
	desc = "Устройство, предназначенное для отключения питания станции, потребляет огромное количество энергии — 2 мегаватта в секунду! \
			...
			Если количество энергии, потребляемой поглотителем, превысит 10 мегаватт, произойдёт мощный взрыв."
	item = /obj/item/powersink
	cost = 40

/datum/uplink_item/device_tools/singularity_beacon
	name = "Силовой маяк"
	desc = "Устройство, притягивающее к себе сингулярность и теслу после того, как они покинут зону содержания. \
			Чтобы его подключить, необходимо установить его на узел и закрепить с помощью отвёртки, а затем включить."
...
/datum/uplink_item/device_tools/ion_caller
	...
	desc = "Портативное устройство, позволяющее активировать ионную пушку, которая перезаряжается каждые 15 минут. \
			Оно может изменять законы станционного ИИ, что приведет к обнаружению вас системой безопасности НаноТрейзнен, или же вызывать перебои в телекоммуникациях."
...
/datum/uplink_item/device_tools/advpinpointer
	...
	desc = "Устройство, предназначенное для поиска целей, имеет три режима работы. Оно способно указывать направление до введенных координат \
			...
			Цвет стрелки на экране устройства показывает расстояние до цели: красный — далеко, синий — среднее, зеленый — близко."
...
/datum/uplink_item/device_tools/medgun
	...
	desc = "Высокотехнологичное медицинское устройство, способное лечить как механические, так и термические травмы, а также сращивать кости. \
...
/datum/uplink_item/implants/storage
	...
	desc = "Имплант, который можно вживить в организм и активировать по желанию. \
			Создает небольшой подпространственный карман, в который можно поместить 2 предмета нормального размера. \
...
/datum/uplink_item/badass/syndiecash
	name = "Портфель Синдиката полный наличных"
...
/datum/uplink_item/bundles_TC/c20r
	name = "Набор — Пистолет-пулемет C-20r"
	desc = "Сумка, в которой находятся: пистолет-пулемет C-20r, 4 магазина по 20 патронов .45 калибра и универсальный глушитель."
...
/datum/uplink_item/contractor/balloon
	name = "Фирменный воздушный шар \"Контрактор\""
	desc = "Изящный воздушный шар, выполненный в черно-золотых тонах и украшенный символикой Контракторов. \
...
/datum/uplink_item/contractor/baton
	...
	desc = "Компактная специализированная дубинка, которую выдают контракторам Синдиката. \
...
/datum/uplink_item/contractor/fulton
	...
	desc = "Устройство, похожее на шахтёрский набор, но предназначенное для работы на космической станции. Оно используется для транспортировки целей в труднодоступные места."
...
/datum/uplink_item/contractor/pinpointer
	name = "Целеуказатель контрактора"
...
/datum/uplink_item/contractor/zippo
	name = "Фирменная зажигалка \"Контрактор\""
	desc = "Изящная зажигалка, оформленная в черно-золотых тонах и украшенная символикой Контракторов. \
