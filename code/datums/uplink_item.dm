...
/datum/uplink_item/racial/ghostface_kit
	name = "Ghostface kit"
	desc = "Все, что нужно, дабы повторить всем известное призрачное лицо! Включает в себя немного бронированный черный балахон, бронированную маску с функцией сокрытия голоса и сверх-острый аутентичный нож."
...
/datum/uplink_item/racial/devilghostface_kit
	...
	desc = "Все, что нужно, дабы повторить менее известное демоническое призрачное лицо! Включает в себя немного бронированный черный балахон, бронированную маску с функцией сокрытия голоса и сверх-острый аутентичный нож."
