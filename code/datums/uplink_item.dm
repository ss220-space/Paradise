...
/datum/uplink_item/New()
	...
	desc += " Предоставлено "
	if (made_by == "")
		desc += pick(RU_ABLATIVE_AFFIL_CYBERSUN, RU_ABLATIVE_AFFIL_GORLEX, RU_ABLATIVE_AFFIL_HEMATOGENIC, RU_ABLATIVE_AFFIL_MI13, RU_ABLATIVE_AFFIL_SELF, RU_ABLATIVE_AFFIL_TIGER, RU_ABLATIVE_AFFIL_WAFFLE, RU_ABLATIVE_AFFIL_DONK, RU_ABLATIVE_AFFIL_WAFFLE, RU_ABLATIVE_AFFIL_BIOTECH, RU_ABLATIVE_AFFIL_MIME, RU_ABLATIVE_AFFIL_CLOWN, RU_ABLATIVE_AFFIL_SOL)
	desc += made_by + "."
...
/datum/uplink_item/jobspecific/clowngrenade
	...
	made_by = RU_ABLATIVE_AFFIL_CLOWN
...
/datum/uplink_item/jobspecific/trick_revolver
	...
	cost = 5
	exclude_from_affiliate = list(RU_ABLATIVE_AFFIL_TIGER)
	job = list(JOB_TITLE_CLOWN)
	made_by = RU_ABLATIVE_AFFIL_CLOWN
...
/datum/uplink_item/jobspecific/caneshotgun
	...
	made_by = RU_ABLATIVE_AFFIL_MIME
...
пару метательных круассанов и рецепт, чтобы сделать больше по требованию. Когда работа будет сделана, съешьте улики."
	...
	made_by = RU_ABLATIVE_AFFIL_DONK
...
/datum/uplink_item/jobspecific/pressure_mod
	...
	made_by = RU_ABLATIVE_AFFIL_CYBERSUN
...
/datum/uplink_item/jobspecific/meatcleaver
	...
	cost = 20
	job = list(JOB_TITLE_CHEF)
	made_by = RU_ABLATIVE_AFFIL_MI13
...
/datum/uplink_item/jobspecific/artistic_toolbox
	...
	made_by = RU_ABLATIVE_AFFIL_TIGER
...
/datum/uplink_item/jobspecific/rad_laser
	...
	made_by = RU_ABLATIVE_AFFIL_HEMATOGENIC
...
/datum/uplink_item/jobspecific/telegun
	...
	made_by = RU_ABLATIVE_AFFIL_WAFFLE
...
/datum/uplink_item/jobspecific/energizedfireaxe
	...
	cost = 18
	job = list(JOB_TITLE_ATMOSTECH, JOB_TITLE_CHIEF)
	made_by = RU_ABLATIVE_AFFIL_GORLEX
...
/datum/uplink_item/racial/anomaly_extract
	...
	made_by = RU_ABLATIVE_AFFIL_BIOTECH
...
/datum/uplink_item/racial/second_chance
	...
	made_by = RU_ABLATIVE_AFFIL_SOL // Nucleations are only humans
...
/datum/uplink_item/dangerous
	...
	exclude_from_affiliate = list(RU_ABLATIVE_AFFIL_MI13)
	made_by = RU_ABLATIVE_AFFIL_SHELLGUARD
...
/datum/uplink_item/dangerous/pistol
	...
	cost = 20
	exclude_from_affiliate = list(RU_ABLATIVE_AFFIL_MI13, RU_ABLATIVE_AFFIL_TIGER)
	made_by = RU_ABLATIVE_AFFIL_WAFFLE
...
/datum/uplink_item/dangerous/commando_kit
	...
	cost = 33
	excludefrom = list(UPLINK_TYPE_NUCLEAR, UPLINK_TYPE_SST)
	made_by = RU_ABLATIVE_AFFIL_CHANG
...
/datum/uplink_item/support/reinforcement/assault_borg
	...
	cost = 325
	made_by = RU_ABLATIVE_AFFIL_CYBERSUN + " и " + RU_ABLATIVE_AFFIL_GORLEX
...
/datum/uplink_item/support/reinforcement/medical_borg
	...
	cost = 175
	made_by = RU_ABLATIVE_AFFIL_CYBERSUN + " и " + RU_ABLATIVE_AFFIL_HEMATOGENIC
...
/datum/uplink_item/ammo/pistolfire
	...
	cost = 5
	made_by = RU_ABLATIVE_AFFIL_GORLEX // To burn up xenoraces
...
/datum/uplink_item/stealthy_weapons
	...
	exclude_from_affiliate = list(RU_ABLATIVE_AFFIL_GORLEX)
	made_by = RU_ABLATIVE_AFFIL_MI13
...
/datum/uplink_item/stealthy_weapons/foampistol
	...
	exclude_from_affiliate = list(RU_ABLATIVE_AFFIL_GORLEX, RU_ABLATIVE_AFFIL_TIGER)
	cost = 12
	surplus = 10
	made_by = RU_ABLATIVE_AFFIL_DONK
...
/datum/uplink_item/explosives/detomatix
	...
	cost = 30
	made_by = RU_ABLATIVE_AFFIL_CLOWN // Clowns have similar cartridge
...
/datum/uplink_item/stealthy_tools/chameleon
	...
	cost = 20
	made_by = RU_ABLATIVE_AFFIL_TIGER + " и " + RU_ABLATIVE_AFFIL_MI13
...
/datum/uplink_item/suits/chameleon_hardsuit
	...
	exclude_from_affiliate = list(RU_ABLATIVE_AFFIL_MI13, RU_ABLATIVE_AFFIL_GORLEX)
	made_by = RU_ABLATIVE_AFFIL_CYBERSUN + " и " + RU_ABLATIVE_AFFIL_GORLEX
...
/datum/uplink_item/device_tools/hacked_module
	...
	exclude_from_affiliate = list(RU_ABLATIVE_AFFIL_SELF)
	cost = 38
...
/datum/uplink_item/affiliate/cybersun
	affiliate = list(RU_ABLATIVE_AFFIL_CYBERSUN)
	made_by = RU_ABLATIVE_AFFIL_CYBERSUN
...
/datum/uplink_item/affiliate/for_objective/malf_maker
	...
	made_by = RU_ABLATIVE_AFFIL_SELF

/datum/uplink_item/affiliate/gorlex
	affiliate = list(RU_ABLATIVE_AFFIL_GORLEX)
	made_by = RU_ABLATIVE_AFFIL_GORLEX

/datum/uplink_item/affiliate/mi13
	affiliate = list(RU_ABLATIVE_AFFIL_MI13)
	made_by = RU_ABLATIVE_AFFIL_MI13
...
/datum/uplink_item/affiliate/hematogenic
	affiliate = list(RU_ABLATIVE_AFFIL_HEMATOGENIC)
	made_by = RU_ABLATIVE_AFFIL_HEMATOGENIC
...
/datum/uplink_item/affiliate/hematogenic/advanced_hemophagus_extract
	...
	desc = "Инжектор с кровью самого генерального директора " + RU_ABLATIVE_AFFIL_HEMATOGENIC + ". При введении гуманойду, запускает сложные процессы, \
...
/datum/uplink_item/affiliate/self
	affiliate = list(RU_ABLATIVE_AFFIL_SELF)
...
/datum/uplink_item/affiliate/tiger
	affiliate = list(RU_ABLATIVE_AFFIL_TIGER)
	made_by = RU_ABLATIVE_AFFIL_TIGER
