...
/datum/uplink_item/racial/nucle_inator
	name = "Нукле-инатор"
	desc = "Разработка неизвестного безумного учёного, основанная на теориях и фактах зарождения нуклеаций.\
		Способна превращать любого биологического гуманоида в нуклеацию в течении нескольких минут.\
		Из-за плохой привычки создателя добавлять кнопку самоуничтожения в каждую его разработку, мы принудительно сломали эту кнопку за вас."
