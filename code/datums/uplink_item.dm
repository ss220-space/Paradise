...
/datum/uplink_item/implants/emergency_reboot
	...
	desc = "Имплант, который можно вживить в организм и активировать по желанию. При активации приводит пользователя в чувство в случае оглушения или усыпления. Имеет 3 заряда, которые восстанавливаются со временем.
