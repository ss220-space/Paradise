...
/datum/uplink_item/bundles_TC/medical
	...
	desc = "Сумка, в которой находятся: боевая аптечка Синдиката, автомендер с синтплотью, боевой гипоспрей, боевой компактный \
...
/datum/uplink_item/bundles_TC/sniper
	...
	desc = "Портфель, в котором находятся: снайперская винтовка Bubz FX1000, красный галстук, тактический комбинезон и 2 магазина .50 \"Снотворный\"."
