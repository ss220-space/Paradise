...
/datum/uplink_item/implants/warp
	name = "Варп имплант"
	desc = "Имплант, который при вживлении в организм позволяет контролировать блюспейс-потоки, искажая пространство-время. \
	При активации откатывает местоположение пользователя на 10 секунд назад во времени.\
	Примечание: Вопреки распространённому мнению, имплант не вызывает киберпсихоза. Данная информация распространяется дезинформаторами Nanotrasen."
	item = /obj/item/implanter/warp
	cost = 15
