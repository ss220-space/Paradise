...
/datum/uplink_item/implants/adrenal
	...
	desc = "Имплант, который можно вживить в организм и активировать по желанию. Может быть использован до 2 раз, со временем заряды восстанавливаются, потребляя кровь и питательные вещества носителя. Избавляет от оглушения и замедления, восстанавливает выносливость. \
			Кроме того, вы получаете коктейль из стимуляторов, которые лечат вас, ускоряют и делают менее уязвимыми к оглушению. Не рекомендуется использовать более двух раз подряд без должного восстановления организма. Поставляется в коробке вместе с кроваво-красным мелком."
	item = /obj/item/storage/box/syndie_kit/adrenalin_kit
	cost = 44
	can_discount = FALSE
	surplus = 0
...
/datum/uplink_item/badass/bloodred_crayon
	...
	desc = "Мелок, созданый спомощью ред-спейс технологий. На запах и вкус может походить на кровь. Можно употреблять в пищу бесконечно. Насыщает лучше чем другие мелки."
