...
/datum/uplink_item
	...
	var/abstract = 0
	var/list/uplinktypes = list() // Empty list means it is in all the uplinktypes. Otherwise place the uplink type name here.
	var/list/excludefrom = list() // Empty list does nothing. Place the name of uplink type you don't want this item to be available in here. This is so you dont have to list EVERY mode to exclude something.
	var/list/job = null
...
/datum/uplink_item/jobspecific
	...
	cant_discount = TRUE
	excludefrom = list("nuclear", "sst") // Stops the job specific category appearing for nukies
