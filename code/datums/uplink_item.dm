...
/datum/uplink_item/implants/adrenal/prototype
	...
	desc = "Имплант, который можно вживить в организм и активировать по желанию. Может быть активирован 3 раза, но с уменьшенной длительностью. Избавляет от оглушения и замедления, восстанавливает выносливость. \
			Кроме того, вы получаете коктейль из стимуляторов, которые ускоряют и делают менее уязвимыми к оглушению."
