...
/datum/uplink_item/implants/adrenal
	...
	desc = "Имплант, который можно вживить в организм и активировать по желанию. Может быть активирован 2 раза, со временем заряды восстанавливаются, потребляя кровь и питательные элементы носителя. Избавляет от оглушения и замедления, восстанавливает выносливость. \
			Кроме того, вы получаете коктейль из стимуляторов, которые лечат вас, ускоряют и делают менее уязвимыми к оглушению. ОПАСНО применять более чем двух раз без восстановления крови и потребления пищи."
