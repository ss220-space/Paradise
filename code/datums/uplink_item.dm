...
/datum/uplink_item/jobspecific/gatfruit
	...
	desc = "Семена растения Гатфрут, из съеденных плодов получится револьвер калибра .36! Он также содержит 10% серы, 10% углерода, 7% азота, 5% калия."
...
/datum/uplink_item/support/reinforcement/assault_borg
	...
	desc = "Киборг, разработанный и запрограммированный для систематического уничтожения лиц, не входящих в Синдикат. \
			Оснащен самозаряжающимся ручным пулеметом, гранатометом, лазерным мечом, электронным прицелом, точечным указателем, вспышкой и ломом."
...
/datum/uplink_item/support/reinforcement/medical_borg
	...
	desc = "Боевой медицинский киборг. Имеет ограниченный наступательный потенциал, но с лихвой компенсирует это потенциалом в облости поддержки. \
			Оснащен нанитовым гипоспреем, медицинским лучевым ружьем, боевым дефибриллятором, полным хирургическим набором, включающим энергетическую пилу, электромагнитный прицел, точечный указатель и вспышку. \
			Благодаря сумке для хранения органов он может проводить операции так же хорошо, как любой гуманоид."
...
/datum/uplink_item/device_tools/emag
	...
	desc = "Криптографический секвенсор, также известный как ЕМАГ, представляет собой небольшую карту, разблокирующую скрытые функции \
...
/datum/uplink_item/device_tools/spai
	name = "Персональный Искусственный Интеллект Синдиката (СПИИ)"
...
/datum/uplink_item/device_tools/vtec
	name = "Модуль ускорения киборга VTEC"
...
/datum/uplink_item/bundles_TC/cyborg_maint
	...
	desc = "Коробка, содержащая все компоненты киборга необходимые для ремонта."
...
/datum/uplink_item/affiliate/for_objective/blood_harvester
	name = "Сборщик крови"
	desc = "Большой шприц, специально разработаный для быстрого сбора больших объемов крови. Можно использовать только на гуманоидах обладающих душой. Из-за высокой скорости сбора крови, обычно значительно повреждает кровеносную систему цели."
...
/datum/uplink_item/affiliate/tiger/cling_extract
	...
	desc = "Инжектор, вводящий в цель модифицированное яйцо генокрада. После введения зародыш вступает в близкий симбиоз с телом носителя, наделяя того способностями генокрадов."
