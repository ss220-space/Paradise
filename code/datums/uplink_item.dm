...
/datum/uplink_item/device_tools/stasis_generator
	name = "Боевой стазис-генератор 'Усмиритель'"
	desc = "Высокотехнологичное устройство скрытого ношения, создающее невидимое силовое поле, вызывающее неполадки в работе огнестрельного и лазерного оружия. \
			Любое огнестрельное или энергетическое оружие в радиусе действия начинает давать осечки, вынуждая противников переходить в ближний бой."
