...
/proc/getArmor(melee = 0, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 0, fire = 0, acid = 0, magic = 0)
	. = locate(ARMORID)
	if(!.)
		. = new /datum/armor(melee, bullet, laser, energy, bomb, bio, fire, acid, magic)
...
/datum/armor/New(melee_value = 0, bullet_value = 0, laser_value = 0, energy_value = 0, bomb_value = 0, bio_value = 0, fire_value = 0, acid_value = 0, magic_value = 0)
	melee = melee_value
	bullet = bullet_value
	laser = laser_value
	energy = energy_value
