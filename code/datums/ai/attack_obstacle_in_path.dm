...
/datum/ai_behavior/attack_obstructions/proc/attack_in_direction(datum/ai_controller/controller, mob/living/simple_animal/hostile/basic_mob, direction)
	...
	basic_mob.target = next_step
	basic_mob.AttackingTarget()
	return TRUE


/datum/ai_behavior/attack_obstructions/proc/can_smash_object(mob/living/simple_animal/hostile/basic_mob, obj/object)
