...
/datum/idle_behavior/idle_dog/perform_idle_behavior(seconds_per_tick, datum/ai_controller/dog/controller)
	...
	if(controller.blackboard[BB_SIMPLE_CARRY_ITEM] && SPT_PROB(5, seconds_per_tick))
