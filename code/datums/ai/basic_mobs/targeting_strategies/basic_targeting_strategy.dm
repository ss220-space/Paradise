...
/datum/targeting_strategy/basic/can_attack(mob/living/living_mob, atom/the_target, vision_range)
	...
	if(!ignore_sight && !living_mob.can_see(the_target, vision_range)) //Target has moved behind cover and we have lost line of sight to it
		return FALSE
...
// /datum/targeting_strategy/basic/no_gutted_mobs Похуй потом
//
