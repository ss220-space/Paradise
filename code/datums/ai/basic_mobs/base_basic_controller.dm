...
/datum/ai_controller/basic_controller/TryPossessPawn(atom/new_pawn)
	if(!isanimal(new_pawn))
		return AI_CONTROLLER_INCOMPATIBLE

	var/mob/living/simple_animal/basic_mob = new_pawn
...
/datum/ai_controller/basic_controller/proc/update_speed(mob/living/simple_animal/basic_mob)
	SIGNAL_HANDLER
