...
/// Incredibly stripped down version of the overarching `can_ventcrawl` proc on `/mob, just meant for rapid rechecking of a vent. Will be TRUE if not blocked, FALSE otherwise.
