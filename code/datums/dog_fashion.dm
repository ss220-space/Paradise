...
/datum/dog_fashion/head/commissar
	...
	desc = "Best at morale boosting."
	emote_see = list("poses menacingly", "salutes")
	emote_hear = list("orders")
	speak = list("Страх рождает верность!","Где я нужен? Куда принести Его волю?","Именем Императора, будет сделано!","Что вам угодно!","Победа наша!","Я готов служить Императору!","Приказ получен и понят.","Я не подведу.","Вы оказали мне честь.","Клянусь душой, будет выполнено!","Пади перед моим гневом!","В бой!","Только верный сегодня победит!","Их дни сочтены.","Вот прекрасный способ добраться до поля боя. Дальше мы пойдём пешком.","Ты посмел стрелять в меня? В меня?!","В атаку, вы, собаки!","Приди и почувствуй мой гнев!","Император оставил меня.","Я не выполнил приказ!","Рассредоточиться и выйти из боя!","Кто-то поплатится за это головой!","Им не устоять перед нашей мощью!","Отступать - плохое решение.","Пади перед мои гневом!","Уничтожьте их.","Подходи, и встреть свою смерть!","Бойся меня, но повинуйся!","Вам доверена честь служить мне.","Я ухожу. Не подведите меня.","Если ты не хочешь сражаться - будешь расстрелян.","Да будет точен ваш прицел.","За трусость я приговариваю тебя... к смерти.","Вперёд, собаки, к победе!","Павшего ждёт слава.","В атаку!")
