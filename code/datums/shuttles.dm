...
/datum/map_template/shuttle/emergency/narnar
	suffix = "narnar"
	name = "Шаттл «666»"
	description = "Похоже, этот шаттл заблудился в межзвездной тьме, по пути на станцию. \
	 Давайте не будем слишком задумываться о том, откуда взялись все эти тела."
	admin_notes = "Внутри есть симпл-мобы конструкты культа Нарси. Их можно раздать гостам."
...
/datum/map_template/shuttle/admin/hospital
	...
	admin_notes = "Шаттл для щитспавна мед ОБР. ПОСЛЕ СПАВНА УДАЛИТЕ В КОНСОЛИ НАВИГАЦИИ НЕНУЖНЫЕ ЗОНЫ ДЛЯ ПРЫЖКА (jumpto_ports)!!! Корабль ШТУРМОВОЙ,\
	 он может ПРОБИВАТЬ СТАНЦИЮ НА СКВОЗЬ"
...
/datum/map_template/shuttle/admin/armory
	suffix = "armory"
	name = "ОКН «Спецназ»"
	description = "Оборонный корабль исключительной мобильности, используется ОБР\ для оперативного прибытия на станцию. Может использоваться для\
	эвакуации особо важных персон со станции при чрезвычайных ситуациях."
