...
/datum/disease/virus/transformation/proc/do_disease_transformation(mob/living/affected_mob)
...
/datum/disease/virus/transformation/jungle_fever/do_disease_transformation(mob/living/carbon/human/affected_mob)
