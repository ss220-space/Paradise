...
/datum/disease/virus/pierrot_throat/advanced
	...
	desc = "Мутировавший вирус, происходящий от Pierrot’s Throat. Помимо неконтролируемого желания делать хонк, субъект также отращивает неснимаемую маску клоуна. Хонко-мать одобряет."
	severity = DANGEROUS
