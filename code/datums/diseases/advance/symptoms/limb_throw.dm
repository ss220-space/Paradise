...
/datum/symptom/limb_throw/Activate(datum/disease/advance/A)
	if(!spell_learned && A.stage >= 4)
		A.affected_mob.mind?.AddSpell(new /obj/effect/proc_holder/spell/targeted/click/limb_throw)
		spell_learned = TRUE
	return

/datum/symptom/limb_throw/End(datum/disease/advance/A)
	A.affected_mob.mind?.RemoveSpell(/obj/effect/proc_holder/spell/targeted/click/limb_throw)
	spell_learned = FALSE
	return

/obj/effect/proc_holder/spell/targeted/click/limb_throw
	name = "Limb Rejection"
...
/obj/effect/proc_holder/spell/targeted/click/limb_throw/cast(list/targets, mob/living/user = usr)
