...
/obj/effect/proc_holder/spell/bloodcrawl/proc/rise_animation(turf/tele_loc, mob/living/user, atom/exit_point)
	...
	exit_point.visible_message(span_warning("<b>[user.declent_ru_cap(NOMINATIVE)] возникает из [exit_point.declent_ru(GENITIVE)]!</b>"))
...
/obj/effect/proc_holder/spell/bloodcrawl/proc/rise_message(atom/exit_point)
	exit_point.visible_message(span_warning("[exit_point.declent_ru_cap(NOMINATIVE)] начинает пузыриться..."))
