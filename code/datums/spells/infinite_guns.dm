/obj/effect/proc_holder/spell/infinite_guns
	...
	desc = "Зачем перезаряжаться, если у вас есть бесконечное количество пушек? Вызывает бесконечный поток винтовок с затвором. Для использования требуются обе руки."
	school = "conjuration"
