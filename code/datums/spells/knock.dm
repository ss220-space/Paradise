...
/obj/effect/proc_holder/spell/aoe_turf/knock/greater/cast(list/targets, mob/user = usr)
	if(!used)
		...
		GLOB.command_announcement.Announce("Мы убрали все доступы у шлюзов вашей станции. Вы сможете поблагодарить нас позже!", "Приветствуем!", 'sound/misc/announce_dig.ogg', , , "Послание Федерации Космических Волшебников.")
	else
		..()
	return
