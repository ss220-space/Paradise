...
/datum/component/jackboots
	var/static/list/step_sounds = list('sound/effects/jackboot/bigboot1.ogg' = 1, 'sound/effects/jackboot/bigboot2.ogg' = 1, 'sound/effects/jackboot/bigboot3.ogg' = 1, 'sound/effects/jackboot/bigboot4.ogg' = 1, 'sound/effects/jackboot/bigboot5.ogg' = 1)
