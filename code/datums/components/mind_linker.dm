...
/datum/component/mind_linker/proc/link_mob(mob/living/to_link)
	...
	RegisterSignal(to_link, list(COMSIG_LIVING_DEATH, COMSIG_QDELETING), PROC_REF(sig_unlink_mob))
...
/datum/action/innate/linked_speech/New(Target)
	...
	// tg background states (bg_heretic etc.) live in backgrounds.dmi, not master220's actions.dmi.
