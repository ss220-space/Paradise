...
/datum/component/footstep/proc/prepare_step()
	...
	if(!T.footstep || LM.lying || !LM.canmove || LM.resting || LM.buckled || LM.throwing || (LM.movement_type & MOVETYPES_NOT_TOUCHING_GROUND) || istype(LM.loc, /obj/machinery/atmospherics))
		return
