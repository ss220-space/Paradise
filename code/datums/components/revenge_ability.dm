...
/datum/component/revenge_ability/Initialize(obj/effect/proc_holder/spell/ability, datum/targeting_strategy/targeting, min_range = 0, max_range = INFINITY, target_self = FALSE)
	. = ..()
	if(!isliving(parent))
