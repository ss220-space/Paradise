...
/datum/component/callouts/RegisterWithParent()
	...
	RegisterSignal(parent, COMSIG_LIVING_EXAMINE, PROC_REF(on_examines))
	RegisterSignal(parent, COMSIG_CLICK_CTRL, PROC_REF(on_ctrl_click))

/datum/component/callouts/UnregisterFromParent()
	UnregisterSignal(parent, list(COMSIG_MOB_CLICKON, COMSIG_ITEM_EQUIPPED, COMSIG_ITEM_DROPPED, COMSIG_LIVING_EXAMINE, COMSIG_CLICK_CTRL))
