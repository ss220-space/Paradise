...
/datum/component/palette/Initialize(available_space, selected_color)
	...
	RegisterSignal(parent, COMSIG_ITEM_ATTACK_SELF, PROC_REF(on_attack_self_secondary))
...
/datum/component/palette/proc/choice_selected(mob/living/carbon/human/user, choice, params)
