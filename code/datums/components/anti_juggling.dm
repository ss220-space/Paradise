...
/datum/component/anti_juggling/proc/on_fire(datum/source, obj/item/gun/fired_gun)
	SIGNAL_HANDLER

	if(!isgun(fired_gun) || fired_gun.dual_wield)
...
/datum/component/anti_juggling/proc/check_cooldown(datum/source, obj/item/gun/cool_gun)
	SIGNAL_HANDLER
