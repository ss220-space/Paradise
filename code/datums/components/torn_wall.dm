...
/datum/component/torn_wall/proc/try_repair(atom/source, mob/user, obj/item/tool)
	...
	while(tool.use_tool(source, user, 5 SECONDS, amount = 2, volume = 50))
		current_stage--
