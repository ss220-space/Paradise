...
/datum/repository/crew/proc/health_data(turf/T)
	...
	for(var/thing in GLOB.human_list)
		...
		crewmemberData["name"] = H.get_authentification_name(if_no_id="Неизвестно")
		crewmemberData["rank"] = H.get_authentification_rank(if_no_id="Неизвестно", if_no_job="Без должности")
		crewmemberData["assignment"] = H.get_assignment(if_no_id="Неизвестно", if_no_job="Без должности")
