...
/datum/outfit/admin/clown_security/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	...
	if(istype(I))
		var/new_access = list(ACCESS_SECURITY, ACCESS_SECURITY, ACCESS_BRIG, ACCESS_COURT, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE, ACCESS_WEAPONS)
		if(is_physician)
		...
		if(is_warden)
			new_access = list(
				ACCESS_EVA, ACCESS_SECURITY, ACCESS_SECURITY, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_COURT,
...
/obj/item/card/id/security/clown
	...
	access = list(ACCESS_SECURITY, ACCESS_CLOWN, ACCESS_THEATRE, ACCESS_SECURITY, ACCESS_BRIG, ACCESS_COURT, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE, ACCESS_WEAPONS)
