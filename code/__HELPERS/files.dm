...
/proc/wrap_file(filepath)
	if(IsAdminAdvancedProcCall())
		...
		log_and_message_admins("[key_name(usr)] attempted to load files via advanced proc-call")
		return
...
/client/proc/getFiles()
	if(IsAdminAdvancedProcCall())
		...
		log_and_message_admins("[key_name(usr)] attempted to call Shelleo via advanced proc-call")
		return
