...
/**
 * Returns turf relative to A in given direction at set range. Result is bounded to map size.
 ...
 */
/proc/get_turf_pixel(atom/movable/checked_atom) // TODO: Refactor from TG with caching!!
