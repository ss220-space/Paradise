...
/proc/fake_admin_pm(target, msg = "Привет, есть минутка?", fake_admin_name = "Denchigo", fake_admin_rank = "Админ", type_admin_help = "PM", custom_link = "")
	var/msg_to_target += "<span class='adminhelp' size='3'>-- Click the [fake_admin_rank]'s name to reply --</span>\n"
	msg_to_target += chat_box_ahelp(span_adminhelp("<span class='adminhelp'>[type_admin_help] from-<b>[fake_admin_rank] <a href='[custom_link]'>[fake_admin_name]</a></b>:<br><br>[span_emojienabled("[msg]")]<br></span>"))
...
/proc/fake_mentor_pm(target, msg = "Как менять руки?", fake_mentor_name = "кружка", fake_admin_rank = "Ментор", type_admin_help = "Помощь Ментора", custom_link = "")
	var/msg_to_target += "<span class='adminhelp' size='3'>-- Click the [fake_admin_rank]'s name to reply --</span>\n"
	msg_to_target += chat_box_mhelp(span_mentorhelp("<span class='mentorhelp'>[type_admin_help] from-<b>[fake_admin_rank] <a href='[custom_link]'>[fake_mentor_name]</a></b>:<br><br>[span_emojienabled("[msg]")]<br></span>"))
