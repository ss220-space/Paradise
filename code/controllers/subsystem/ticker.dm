...
/datum/controller/subsystem/ticker/proc/choose_lobby_music()
	...
	if(CONFIG_GET(flag/lobby_ss13_music))
		songs = list(
			...
			"https://www.youtube.com/watch?v=YKVmXn-Gv0M", 						// Space Station 13 Music - Title3
			"https://www.youtube.com/watch?v=-K3ztneTQuA",						// Space Station 13 Music - THUNDERDOME (Sector11)
			"https://www.youtube.com/watch?v=9whQIbNmu9s",						// Space Station 13 Music - clown.wmv
			"https://www.youtube.com/watch?v=d7hc_GrZP4Y", 						// Space Station 14 - Tin Tin On Moon Mark II
		)
	else
		songs = list(
