...
/datum/controller/subsystem/nightshift/proc/announce(message)
	GLOB.priority_announcement.Announce(message, new_sound = 'sound/misc/notice2.ogg', new_title = "Автоматическое Объявление Системы Освещения")
...
/datum/controller/subsystem/nightshift/proc/update_nightshift(active, announce = TRUE)
	...
	if(announce)
		if(active)
			...
			announce("Доброе утро, экипаж. Поскольку сейчас дневное время, освещение на борту станции переведено в дневной режим.")
