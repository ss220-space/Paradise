...
/obj/structure/glowshroom/New(loc, obj/item/seeds/newseed, mutate_stats)
	...
	delay = delay - myseed.production * 50 //So the delay goes DOWN with better stats instead of up. :I
...
/obj/structure/glowshroom/proc/Spread()
	...
	for(var/i in 1 to myseed.yield)
		if(prob(1/(generation * generation) * 50))//This formula gives you diminishing returns based on generation. 100% with 1st gen, decreasing to 25%, 11%, 6, 4, 2...
