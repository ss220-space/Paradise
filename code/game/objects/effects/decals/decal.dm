...
/obj/effect/decal/attackby(obj/item/item, mob/user, params)
	if(!iscup(item) && !istype(item, /obj/item/reagent_containers/cup/glass))
...
// I hate it too bestie
	...
	//	var/turf/T = loc
	//	T.RemoveElement(/datum/element/decal, icon, icon_state, dir, null, layer, alpha, color, FALSE, null)
//#endif
