...
/datum/training_task/basic_9_1
	...
	"1 - только данные о том, живы ли вы",
...
/datum/training_task/basic_10_1
	...
	"Можно нажимать ту же клавишу, что и на английской раскладке, находясь на русской, и все будет работать",
...
/datum/training_task/basic_11_1
	description = list("И вот мы добрались до более интересной части обучения - интент (intension)",
	"Интент - это режим взаимодействия вас с окружающим миром",
	"Всего есть 4 интента",
