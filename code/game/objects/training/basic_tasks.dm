/datum/training_task/basic_1_1
	description = list("Здравствуйте и добро пожаловать на начальный курс обучения :tr SS1984 :9 , где вас научат начальным навыкам управления.",
...
/datum/training_task/basic_11_1
	...
	"Интенты можно переключать :tr клавишами 1, 2, 3 и 4 :9 согласно списку выше",
...
/datum/training_task/basic_13_1
	...
	"Однако не забывайте, существует :tr википедия SS1984 :9 , которая поможет вам освоиться как на любой из работ, так и на станции в целом",
