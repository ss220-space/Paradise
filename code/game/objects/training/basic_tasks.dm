/datum/training_task/basic_1_1
	description = list("Здравствуйте и добро пожаловать на начальный курс обучения SS1984 , где вас научат начальным навыкам управления.",
	"Я ваш интеллектуальный помощник в этом нелегком деле.",
	"Давайте начнем с основ передвижения!",
	"Для перемещения используюся клавиши WASD",
...
/datum/training_task/basic_2_1
	...
	"А затем зажмите ЛКМ и перетащите себя на стул",
...
/datum/training_task/basic_3_2
	description = list("Вам выдан ваш ПДА . Он находится в вашем кармане (ячейка внизу справа)",
		...
		"Чтобы достать предмет из кармана в руки, вам требуется нажать ЛКМ по предмету, не имея вещей в активной руке",
...
/datum/training_task/basic_3_6
	description = list("Теперь, держа карту в активной руке, нажмите клавишу Е для того, чтобы быстро экипировать ее в нужный слот",
		...
		"Сейчас вы можете взять ПДА в активную руку и 'использовать' его клавишей Z",
		"На этот раз у вас будет открыто меню ПДА",
		"В ПДА есть немало полезных вещей, однако это вы узнаете позднее",
		"Убедитесь, что меню ПДА закрыто и поместите ПДА в ваш слот для ПДА. Используйте клавишу E",
...
/datum/training_task/basic_4_1
	description = list("А сейчас жизненно важная задача",
		...
		"Нажмите на маску ЛКМ чтобы взять её в руку.")
...
/datum/training_task/basic_4_2
	description = list("Хорошо, теперь наденьте маску на лицо",
		...
		"Первый - держа маску в активной руке нажмите E . Она автоматически наденется на лицо, если сейчас на нем ничего нет",
...
/datum/training_task/basic_4_4
	description = list("Осталось последнее - включить баллон",
		"Конечно можно взять баллон в руку, нажать Z , чтобы открылось меню баллона, и выбрать 'Set internals', но можно и проще",
...
/datum/training_task/basic_5_1
	...
	"Нажмите клавишу B или значок огня в правом верхнем углу.",
...
/datum/training_task/basic_7_1
	...
	"Чтобы потянуть коробку, подойдите к ней и нажмите сочетание клавиш Ctrl и ЛКМ !")
	var/turf/final_turf
...
/datum/training_task/basic_7_2
	...
	"Чтобы отпустить ее, нажмите клавишу C")
	var/turf/final_turf
	var/obj/structure/ore_box/ore_box
...
/datum/training_task/basic_11_1
	...
	"Интенты можно переключать клавишами 1, 2, 3 и 4 согласно списку выше",
...
/datum/training_task/basic_12_1
	...
	"Подойдите поближе, зажмите ЛКМ на члена экипажа и перетащите его на себя, чтобы открыть окно его снаряжения",
...
/datum/training_task/basic_12_4
	...
	"Чтобы метнуть эту отвертку у вас в руке, нажмите клавишу R и кликните ЛКМ слева от вас")
	var/turf/final_turf
...
/datum/training_task/basic_13_1
	...
	"Однако не забывайте, существует википедия SS1984 , которая поможет вам освоиться как на любой из работ, так и на станции в целом",
