/datum/training_task/basic_1_1
	description = list("Здравствуйте и добро пожаловать на начальный курс обучения :tr SS1984 :gc , где вас научат начальным навыкам управления.",
	"Я ваш интеллектуальный помощник в этом нелегком деле.",
	"Давайте начнем с основ передвижения!",
	"Для перемещения используюся клавиши :tr WASD",
	"На клавишу :tr TAB :gc вы можете переключить режим хоткеев.",
...
/datum/training_task/basic_2_1
	...
	"А затем зажмите :tr ЛКМ :gc и перетащите себя на стул",
...
/datum/training_task/basic_3_2
	description = list("Вам выдан ваш :tr ПДА :gc . Он находится в вашем кармане (ячейка внизу справа)",
		"В своих карманах вы можете носить самые разные вещи",
		"Чтобы достать предмет из кармана в руки, вам требуется нажать :tr ЛКМ :gc по предмету, не имея вещей в активной руке",
...
/datum/training_task/basic_3_6
	description = list("Теперь, держа карту в активной руке, нажмите клавишу :tr Е :gc для того, чтобы быстро экипировать ее в нужный слот",
		"Горячая клавиша :tr E :gc подходит для почти любых предметов и позволяет быстро поместить их в нужное место",
...
/datum/training_task/basic_4_1
	description = list("А сейчас жизненно важная задача",
		...
		"Нажмите на маску :tr ЛКМ :gc чтобы взять её в руку.")
...
/datum/training_task/basic_4_2
	description = list("Хорошо, теперь наденьте маску на лицо",
		...
		"Первый - держа маску в активной руке нажмите :tr E :gc . Она автоматически наденется на лицо, если сейчас на нем ничего нет",
...
/datum/training_task/basic_4_3
	description = list("Одной маски будет недостаточно",
		"Достаньте из рюкзака баллон и наденьте его в подходящий слот (можно и с помощью клавиши :tr E :gc )",
...
/datum/training_task/basic_4_4
	description = list("Осталось последнее - включить баллон",
		"Конечно можно взять баллон в руку, нажать :tr Z :gc , чтобы открылось меню баллона, и выбрать 'Set internals', но можно и проще",
...
/datum/training_task/basic_5_1
	...
	"Нажмите клавишу :tr B :gc или значок огня в правом верхнем углу.",
...
/datum/training_task/basic_6_1
	...
	"Оттолкните коробку и встаньте на отмеченную клетку")
	var/turf/final_turf
	user_start_x = 2
...
/datum/training_task/basic_7_1
	...
	"Чтобы потянуть коробку, подойдите к ней и нажмите сочетание клавиш :tr Ctrl и ЛКМ :gc !")
	var/turf/final_turf
...
/datum/training_task/basic_8_1
	...
	"Возьмите монтировку в активную руку и нажмите :tr ЛКМ :gc по стеклу")
	var/turf/final_turf
	user_start_x = 2
...
/datum/training_task/basic_10_1
	...
	"Самый простой способ что-то сказать - нажать клавишу :tr T :gc и написать там то, что вы хотите произнести",
	"В таком случае вашу речь услышат все, кто вас видит и слышит",
	"Если беседа более приватная, нажмите :tr Shift+T :gc чтобы прошептать что-нибудь",
	...
	"Для этого необходимо также нажать :tr T :gc , но перед текстом сообщения добавить маркер нужного канала",
...
/datum/training_task/basic_11_1
	...
	"Интенты можно переключать :tr клавишами 1, 2, 3 и 4 :gc согласно списку выше",
...
/datum/training_task/basic_12_1
	...
	"Какая досада!",
	"Вам нужно снять с него :tr шлем, костюм EVA, маску и баллон :gc .",
	"Этот костюм даст вам достаточную защиту от столь агрессивной для вас среды",
	"Подойдите поближе, зажмите :tr ЛКМ :gc на члена экипажа и перетащите его на себя, чтобы открыть окно его снаряжения",
...
/datum/training_task/basic_12_4
	...
	"Чтобы метнуть эту отвертку у вас в руке, нажмите клавишу :tr R :gc и кликните :tr ЛКМ :gc слева от вас")
	var/turf/final_turf
...
/datum/training_task/basic_13_1
	...
	"Однако не забывайте, существует :tr википедия SS1984 :gc , которая поможет вам освоиться как на любой из работ, так и на станции в целом",
...
/datum/training_task/basic_13_1/instruction_end()
	...
	master.controlled_user.client << browse({"
            <a id='link' href='[CONFIG_GET(string/overflow_server_url)]'>
                LINK
            </a>
