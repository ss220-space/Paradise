...
/datum/training_task/basic_2_1
	description = list("В этой комнате вы научитесь базовому взаимодействию с вещами, перед вами сто+ит стул",
...
/datum/training_task/basic_4_1
	description = list("А сейчас жизненно важная задача",
		...
		"Нажмите на маску :tr ЛКМ :9 чтобы взять ее в руку.")
...
/datum/training_task/basic_4_4
	description = list("Осталось последнее - включить баллон",
		...
		"Если у вас в руких или на себе есть баллон, в левом верхнем углу появляется его иконка",
