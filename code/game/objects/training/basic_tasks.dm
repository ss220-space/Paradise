...
/datum/training_task/basic_2_1
	...
	"Для этого достаточно встать на клетку со стулом и перетащить с помощью :tr  ЛКМ :9 своего персонажа на стул",
...
/datum/training_task/basic_3_2
	description = list("Вам выдан ваш :tr ПДА :9 . Он находится в вашем кармане (ячейка внизу справа)",
		...
		"Для того, чтобы достать предмет из кармана в руки вам требуется нажать :tr ЛКМ :9 по предмету, не имея вещей в активной руке",
...
/datum/training_task/basic_4_1
	description = list("А сейчас жизненно важная задача",
		...
		"Откроется панель с вещами, лежащими в рюкзаке. Нажмите на маску :tr ЛКМ :9 чтобы взять ее в руку")
...
/datum/training_task/basic_4_2
	description = list("Хорошо, теперь наденьте маску на лицо",
		...
		"1 - держа маску в активной руке нажмите :tr E :9 . Она автоматически наденется на лицо, если сейчас на нем ничего нет",
...
/datum/training_task/basic_4_4
	description = list("Осталось последнее - включить баллон",
		"Конечно можно взять баллон в руку, нажать :tr Z :9 , чтобы открылось меню баллона, и там нажать 'Set internals', но можно и проще",
...
/datum/training_task/basic_5_1
	...
	"Нажмите клавишу :tr B :9 или значок огня в правом верхнем углу. Возможно вам придется «потушиться» несколько раз.")
	var/turf/final_turf
	user_start_x = 2
...
/datum/training_task/basic_7_1
	...
	"Чтобы потянуть коробку, подойдите к ней и нажмите сочетание клавиш :tr Ctrl+ЛКМ :9 !")
	var/turf/final_turf
...
/datum/training_task/basic_7_2
	...
	"Что бы ее отпустить коробку нажмите клавишу :tr C")
	var/turf/final_turf
	var/obj/structure/ore_box/ore_box
...
/datum/training_task/basic_12_1
	...
	"Подойдите поближе, зажмите :tr ЛКМ :9 на вульпу и перетащите ее на себя, чтобы открыть окно снаряжения вульпы",
