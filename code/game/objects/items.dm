...
//	causeerrorheresoifixthis
	...
	*/
	...
	var/list/onmob_sheets = list(
		RENDER_ICON_BACK = DEFAULT_ICON_BACK,
		RENDER_ICON_WEAR_MASK = DEFAULT_ICON_WEAR_MASK,
		RENDER_ICON_HANDCUFFS = DEFAULT_ICON_HANDCUFFED,
		RENDER_ICON_BELT = DEFAULT_ICON_BELT,
		RENDER_ICON_WEAR_ID = DEFAULT_ICON_WEAR_ID,
		RENDER_ICON_LEFT_EAR = DEFAULT_ICON_LEFT_EAR,
		RENDER_ICON_GLASSES = DEFAULT_ICON_GLASSES,
		RENDER_ICON_GLOVES = DEFAULT_ICON_GLOVES,
		RENDER_ICON_HEAD = DEFAULT_ICON_HEAD,
		RENDER_ICON_SHOES = DEFAULT_ICON_SHOES,
		RENDER_ICON_OUTER_SUIT = DEFAULT_ICON_OUTER_SUIT,
		RENDER_ICON_JUMPSUIT = DEFAULT_ICON_JUMPSUIT,
		RENDER_ICON_SUIT_STORE = DEFAULT_ICON_SUIT_STORE,
		RENDER_ICON_LEGCUFFS = DEFAULT_ICON_LEGCUFFED,
		RENDER_ICON_RIGHT_EAR = DEFAULT_ICON_RIGHT_EAR,
		RENDER_ICON_TIE = DEFAULT_ICON_TIE,
		RENDER_ICON_COLLAR = DEFAULT_ICON_COLLAR,
		RENDER_ICON_NECK = DEFAULT_ICON_NECK
	)
	var/belt_icon = null
	var/item_state = null
