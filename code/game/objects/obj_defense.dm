...
/obj/bullet_act(obj/projectile/P)
	...
	visible_message(span_danger(pick(list("[declent_ru_cap(NOMINATIVE)] поражен[GEND_A_O_Y(src)] [P.declent_ru(INSTRUMENTAL)]!", "[P.declent_ru_cap(NOMINATIVE)] попадает в [declent_ru(ACCUSATIVE)]!"))), projectile_message = TRUE)
