...
/obj/bullet_act(obj/projectile/P)
	...
	visible_message(span_danger(pick(list("[capitalize(declent_ru(NOMINATIVE))] поражен[GEND_ENDING_A_O_Y(src)] [P.declent_ru(INSTRUMENTAL)]!", "[capitalize(P.declent_ru(NOMINATIVE))] попадает в [declent_ru(ACCUSATIVE)]!"))), projectile_message = TRUE)
