...
/obj/item/toy/plushie/cmoplushie/proc/interaction(mob/user)
	...
	if(tired < 100)
		...
		message = pick("Мой рекорд — 32 шва за 5 минут. Хотите попробовать побить?",
			...
			"Наши роботы дают леденцы. Сосите!")
		...
		message = pick("В вашем теле ровно 5.2 литра крови. Сдайте всё до последней капли.",
			...
			"Это точно медицинская травка.",
			"Интересно, какой звук издаст лёгкое, если на него наступить?",
			"Самая частая причина смерти на станции? Чрезмерное доверие к другим.",
...
/obj/item/toy/plushie/cmoplushie/update_desc()
	...
	desc = "Аккуратная плюшевая кукла со светлыми волосами в миниатюрном синем халате. От неё пахнет антисептиком и... марихуаной?"
