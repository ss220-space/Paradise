...
/obj/item/toy/russian_revolver/trick_revolver/examine(mob/user) //Sneaky sneaky
	. = ..()
	. += "<span class='notice'>Внутри [fake_bullets] патрон[declension_ru(fake_bullets, "", "а", "ов")].</span>"
	. += "<span class='notice'>Из них заряжен[declension_ru(fake_bullets, "", "ы", "ы")] [fake_bullets] патрон[declension_ru(fake_bullets, "", "а", "ов")].</span>"
