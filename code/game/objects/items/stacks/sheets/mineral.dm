...
GLOBAL_LIST_INIT(plastitanium_recipes, list(
	...
	new /datum/stack_recipe_list("Evil airlock assemblies", list(
		...
		new /datum/stack_recipe("Syndie public airlock assembly", /obj/structure/door_assembly/door_assembly_syndie_public, 4, time = 50, one_per_turf = 1, on_floor = 1), 
		new /datum/stack_recipe("Syndie security airlock assembly", /obj/structure/door_assembly/door_assembly_syndie_sec, 4, time = 50, one_per_turf = 1, on_floor = 1),
		new /datum/stack_recipe("Syndie cargo airlock assembly", /obj/structure/door_assembly/door_assembly_syndie_cargo, 4, time = 50, one_per_turf = 1, on_floor = 1),
		new /datum/stack_recipe("Syndie atmospherics airlock assembly", /obj/structure/door_assembly/door_assembly_syndie_atmos, 4, time = 50, one_per_turf = 1, on_floor = 1),
		new /datum/stack_recipe("Syndie research airlock assembly", /obj/structure/door_assembly/door_assembly_syndie_research, 4, time = 50, one_per_turf = 1, on_floor = 1),
		new /datum/stack_recipe("Syndie medical airlock assembly", /obj/structure/door_assembly/door_assembly_syndie_med, 4, time = 50, one_per_turf = 1, on_floor = 1),
		new /datum/stack_recipe("Syndie maintenance airlock assembly", /obj/structure/door_assembly/door_assembly_syndie_maint, 4, time = 50, one_per_turf = 1, on_floor = 1),
