...
GLOBAL_LIST_INIT(cardboard_recipes, list(
	new /datum/stack_recipe_list("Small boxes", list(
		new /datum/stack_recipe("Small Box", /obj/item/storage/box),
		null,
		new /datum/stack_recipe("Human survival", /obj/item/storage/box/survival),
		new /datum/stack_recipe("Vox survival", /obj/item/storage/box/survival_vox),
		new /datum/stack_recipe("Machine survival", /obj/item/storage/box/survival_machine),
		new /datum/stack_recipe("Plasmaman survival", /obj/item/storage/box/survival_plasmaman),
		new /datum/stack_recipe("Engineer survival", /obj/item/storage/box/engineer),
		new /datum/stack_recipe("Miner survival", /obj/item/storage/box/survival_mining),
		null,
		new /datum/stack_recipe("Latex gloves", /obj/item/storage/box/gloves),
		new /datum/stack_recipe("Sterile masks", /obj/item/storage/box/masks),
		new /datum/stack_recipe("Syringes", /obj/item/storage/box/syringes),
		new /datum/stack_recipe("Beakers", /obj/item/storage/box/beakers),
		new /datum/stack_recipe("IV bags", /obj/item/storage/box/iv_bags),
		new /datum/stack_recipe("Glasses", /obj/item/storage/box/rxglasses),
		new /datum/stack_recipe("Pill bottles", /obj/item/storage/box/pillbottles),
		new /datum/stack_recipe("Patch packs", /obj/item/storage/box/patch_packs),
		new /datum/stack_recipe("Body bags", /obj/item/storage/box/bodybags),
		null,
		new /datum/stack_recipe("Replacement tubes", /obj/item/storage/box/lights/tubes),
		new /datum/stack_recipe("Replacement bulbs", /obj/item/storage/box/lights/bulbs),
		new /datum/stack_recipe("Replacement lights", /obj/item/storage/box/lights/mixed),
		null,
		new /datum/stack_recipe("Donk-pockets", /obj/item/storage/box/donkpockets),
		new /datum/stack_recipe("Mouse traps", /obj/item/storage/box/mousetraps),
	)),
	new /datum/stack_recipe_list("Cube boxes", list(
		new /datum/stack_recipe("Monkey cubes", /obj/item/storage/box/monkeycubes),
		new /datum/stack_recipe("Farwa cubes", /obj/item/storage/box/monkeycubes/farwacubes),
		new /datum/stack_recipe("Stok cubes", /obj/item/storage/box/monkeycubes/stokcubes),
		new /datum/stack_recipe("Neaera cubes", /obj/item/storage/box/monkeycubes/neaeracubes),
		new /datum/stack_recipe("Wolpin cubes", /obj/item/storage/box/monkeycubes/wolpincubes),
	)),
