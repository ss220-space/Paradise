...
GLOBAL_LIST_INIT(metal_recipes, list(
	new /datum/stack_recipe("Stool", /obj/structure/chair/stool, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	new /datum/stack_recipe("Barstool", /obj/structure/chair/stool/bar, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	new /datum/stack_recipe("Chair", /obj/structure/chair, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	new /datum/stack_recipe("Barber chair", /obj/structure/chair/barber, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	new /datum/stack_recipe("Wheelchair", /obj/vehicle/ridden/wheelchair, 15, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	new /datum/stack_recipe("Bed", /obj/structure/bed, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	new /datum/stack_recipe("Psychiatrist bed", /obj/structure/bed/psych, 5, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	null,
	new /datum/stack_recipe_list("Sofas", list(
		new /datum/stack_recipe("Sofa (middle)", /obj/structure/chair/sofa, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Sofa (left)", /obj/structure/chair/sofa/left, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Sofa (right)", /obj/structure/chair/sofa/right, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Sofa (corner)", /obj/structure/chair/sofa/corner, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD)
		)),
	new /datum/stack_recipe_list("Corporate sofas", list(
		new /datum/stack_recipe("Sofa (middle)", /obj/structure/chair/sofa/corp, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Sofa (left)", /obj/structure/chair/sofa/corp/left, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Sofa (right)", /obj/structure/chair/sofa/corp/right, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Sofa (corner)", /obj/structure/chair/sofa/corp/corner, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	)),
	new /datum/stack_recipe_list("Shuttle seats",list(
		new /datum/stack_recipe("White shuttle seat", /obj/structure/chair/comfy/shuttle, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Black shuttle seat", /obj/structure/chair/comfy/shuttle/dark, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	)),
	new /datum/stack_recipe_list("Office chairs",list(
		new /datum/stack_recipe("Dark office chair", /obj/structure/chair/office/dark, 5, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Light office chair", /obj/structure/chair/office/light, 5, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	)),
	new /datum/stack_recipe_list("Comfy chairs", list(
		new /datum/stack_recipe("Beige comfy chair", /obj/structure/chair/comfy/beige, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Black comfy chair", /obj/structure/chair/comfy/black, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Blue comfy chair", /obj/structure/chair/comfy/blue, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Brown comfy chair", /obj/structure/chair/comfy/brown, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Green comfy chair", /obj/structure/chair/comfy/green, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Lime comfy chair", /obj/structure/chair/comfy/lime, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Purple comfy chair", /obj/structure/chair/comfy/purp, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Red comfy chair", /obj/structure/chair/comfy/red, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Teal comfy chair", /obj/structure/chair/comfy/teal, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	)),
	null,
	...
	new /datum/stack_recipe("Meatspike frame", /obj/structure/kitchenspike_frame, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	...
	new /datum/stack_recipe_list("Airlock assemblies", list(
		new /datum/stack_recipe("Airtight hatch assembly", /obj/structure/door_assembly/door_assembly_hatch, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Atmospherics airlock assembly", /obj/structure/door_assembly/door_assembly_atmo, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Command airlock assembly", /obj/structure/door_assembly/door_assembly_com, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Engineering airlock assembly", /obj/structure/door_assembly/door_assembly_eng, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("External airlock assembly", /obj/structure/door_assembly/door_assembly_ext, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("External maintenance airlock assembly", /obj/structure/door_assembly/door_assembly_extmai, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD), \
		new /datum/stack_recipe("Freezer airlock assembly", /obj/structure/door_assembly/door_assembly_fre, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Maintenance airlock assembly", /obj/structure/door_assembly/door_assembly_mai, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Maintenance hatch assembly", /obj/structure/door_assembly/door_assembly_mhatch, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Medical airlock assembly", /obj/structure/door_assembly/door_assembly_med, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Mining airlock assembly", /obj/structure/door_assembly/door_assembly_min, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Multi-tile airlock assembly", /obj/structure/door_assembly/multi_tile, 8, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Public airlock assembly", /obj/structure/door_assembly/door_assembly_public, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Research airlock assembly", /obj/structure/door_assembly/door_assembly_research, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Science airlock assembly", /obj/structure/door_assembly/door_assembly_science, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Security airlock assembly", /obj/structure/door_assembly/door_assembly_sec, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("Standard airlock assembly", /obj/structure/door_assembly, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
	)),
	null,
	...
	new /datum/stack_recipe_list("Gym equipment", list(
		new /datum/stack_recipe("Bench press", /obj/structure/weightmachine/weightlifter, 5, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
		new /datum/stack_recipe("Chest press", /obj/structure/weightmachine/stacklifter, 5, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_signal = COMSIG_GET_BUILDING_SPEED_MOD),
	)),
))
