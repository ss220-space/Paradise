...
GLOBAL_LIST_INIT(wood_recipes, list(
	...
	new /datum/stack_recipe_list("Wooden railings", list(
		...
		new /datum/stack_recipe("Wooden railing corner (north left)", /obj/structure/railing/wooden/corner/nl, 5, time = 40, on_floor = TRUE, one_per_turf = TRUE),
		new /datum/stack_recipe("Wooden railing corner (north right)", /obj/structure/railing/wooden/corner/nr, 5, time = 40, on_floor = TRUE, one_per_turf = TRUE),
		new /datum/stack_recipe("Wooden railing corner (south left)", /obj/structure/railing/wooden/corner/sl, 5, time = 40, on_floor = TRUE, one_per_turf = TRUE),
		new /datum/stack_recipe("Wooden railing corner (south right)", /obj/structure/railing/wooden/corner/sr, 5, time = 40, on_floor = TRUE, one_per_turf = TRUE),
		new /datum/stack_recipe("Wooden railing left end (north)", /obj/structure/railing/wooden/corner/endnl, 5, time = 40, on_floor = TRUE, one_per_turf = TRUE),
		new /datum/stack_recipe("Wooden railing right end (north)", /obj/structure/railing/wooden/corner/endnr, 5, time = 40, on_floor = TRUE, one_per_turf = TRUE),
		new /datum/stack_recipe("Wooden railing left end (south)", /obj/structure/railing/wooden/corner/endsl, 5, time = 40, on_floor = TRUE, one_per_turf = TRUE),
		new /datum/stack_recipe("Wooden railing right end (south)", /obj/structure/railing/wooden/corner/endsr, 5, time = 40, on_floor = TRUE, one_per_turf = TRUE),
	)),
