...
GLOBAL_LIST_INIT(metal_recipes, list(
	new /datum/stack_recipe_list("sofas", list(
		new /datum/stack_recipe("sofa (middle)", /obj/structure/chair/sofa, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("sofa (left)", /obj/structure/chair/sofa/left, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("sofa (right)", /obj/structure/chair/sofa/right, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("sofa (corner)", /obj/structure/chair/sofa/corner, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD)
	)),
	new /datum/stack_recipe_list("corporate sofas", list(
		new /datum/stack_recipe("sofa (middle)", /obj/structure/chair/sofa/corp, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("sofa (left)", /obj/structure/chair/sofa/corp/left, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("sofa (right)", /obj/structure/chair/sofa/corp/right, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("sofa (corner)", /obj/structure/chair/sofa/corp/corner, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
	)),
	new /datum/stack_recipe_list("seats", list(
		new /datum/stack_recipe("stool", /obj/structure/chair/stool, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("barstool", /obj/structure/chair/stool/bar, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("chair", /obj/structure/chair, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("barber chair", /obj/structure/chair/barber, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("wheelchair", /obj/vehicle/ridden/wheelchair, 15, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("dark office chair", /obj/structure/chair/office/dark, 1, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("light office chair", /obj/structure/chair/office/light, 1, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("white shuttle seat", /obj/structure/chair/comfy/shuttle, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("black shuttle seat", /obj/structure/chair/comfy/shuttle/dark, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
	)),
	new /datum/stack_recipe_list("comfy chairs", list(
		new /datum/stack_recipe("beige comfy chair", /obj/structure/chair/comfy/beige, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("black comfy chair", /obj/structure/chair/comfy/black, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("blue comfy chair", /obj/structure/chair/comfy/blue, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("brown comfy chair", /obj/structure/chair/comfy/brown, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("green comfy chair", /obj/structure/chair/comfy/green, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("lime comfy chair", /obj/structure/chair/comfy/lime, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("purple comfy chair", /obj/structure/chair/comfy/purp, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("red comfy chair", /obj/structure/chair/comfy/red, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("teal comfy chair", /obj/structure/chair/comfy/teal, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
	)),
	new /datum/stack_recipe_list("wall-mounted", list(
		new /datum/stack_recipe("button frame", /obj/item/mounted/frame/door_control, time = 5 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("mass driver button frame", /obj/item/mounted/frame/driver_button, time = 5 SECONDS, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("light switch frame", /obj/item/mounted/frame/light_switch, time = 5 SECONDS, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("light fixture frame", /obj/item/mounted/frame/light_fixture, 2, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("small light fixture frame", /obj/item/mounted/frame/light_fixture/small, TRUE, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("APC frame", /obj/item/mounted/frame/apc_frame, 2, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("air alarm frame", /obj/item/mounted/frame/alarm_frame, 2, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("extinguisher cabinet frame", /obj/item/mounted/frame/extinguisher, 2, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("fire alarm frame", /obj/item/mounted/frame/firealarm, 2, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("intercom frame", /obj/item/mounted/frame/intercom, 2, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("shower", /obj/item/mounted/shower, 5, time = 1 SECONDS, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("torch holder", /obj/item/mounted/frame/torch_holder, 2, time = 3 SECONDS, modifier_name = BUILDING_SPEED_MOD),
	)),
	new /datum/stack_recipe_list("construction", list(
		new /datum/stack_recipe("crate shelf parts", /obj/item/rack_parts/cargo_shelf, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("floor tile", /obj/item/stack/tile/plasteel, TRUE, 4, 20, time = 0.5 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe/rods("metal rod", /obj/item/stack/rods, TRUE, 2, 50, time = 0.5 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("rack parts", /obj/item/rack_parts, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("gun rack parts", /obj/item/rack_parts/gunrack_parts, time = 1 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("computer frame", /obj/structure/computerframe, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("machine frame", /obj/machinery/constructable_frame/machine_frame, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("closet", /obj/structure/closet, 2, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("floor light fixture frame", /obj/item/mounted/frame/light_fixture/floor, 3, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		...
		new /datum/stack_recipe("meatspike frame", /obj/structure/kitchenspike_frame, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("reflector frame", /obj/structure/reflector, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("turret frame", /obj/machinery/porta_turret_construct, 5, time = 2.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
	...
	new /datum/stack_recipe_list("gym equipment", list(
		new /datum/stack_recipe("bench press", /obj/structure/weightmachine/weightlifter, 5, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("chest press", /obj/structure/weightmachine/stacklifter, 5, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
	)),
	new /datum/stack_recipe_list("misc", list(
		new /datum/stack_recipe("grenade casing", /obj/item/grenade/chem_grenade, time = 0.5 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("canister", /obj/machinery/portable_atmospherics/canister, 10, time = 1.5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("bed", /obj/structure/bed, 2, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("psychiatrist bed", /obj/structure/bed/psych, 5, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_name = BUILDING_SPEED_MOD),
	)),
))
...
GLOBAL_LIST_INIT(cheese_recipes, list(
	new /datum/stack_recipe("Cheesus statue", /obj/structure/statue/cheese/cheesus, 5, one_per_turf = TRUE, time = 10 SECONDS, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
))
...
GLOBAL_LIST_INIT(gingerbread_recipes, list(
	new /datum/stack_recipe("Gingerbread door", /obj/structure/mineral_door/ginger, 10, time = 2 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
))
