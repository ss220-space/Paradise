...
GLOBAL_LIST_INIT(metal_recipes, list(
	...
	new /datum/stack_recipe_list("airlock assemblies", list(
		...
		new /datum/stack_recipe("docking airlock assembly", /obj/structure/door_assembly/door_assembly_docking, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("docking support airlock assembly", /obj/structure/door_assembly/door_assembly_docking_support, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("shuttle hatch docking assembly", /obj/structure/door_assembly/door_assembly_docking_shuttle, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("shuttle hatch docking support assembly", /obj/structure/door_assembly/door_assembly_docking_shuttle_support, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("airtight hatch docking assembly", /obj/structure/door_assembly/door_assembly_docking_hatch, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
		new /datum/stack_recipe("airtight hatch docking support assembly", /obj/structure/door_assembly/door_assembly_docking_hatch_support, 4, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE, modifier_name = BUILDING_SPEED_MOD),
