...
GLOBAL_LIST_INIT(metal_recipes, list(
	...
	new /datum/stack_recipe_list("seats", list(
		...
		new /datum/stack_recipe("dark office chair", /obj/structure/chair/office/dark, 5, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
		new /datum/stack_recipe("light office chair", /obj/structure/chair/office/light, 5, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
	...
	new /datum/stack_recipe_list("construction", list(
		...
		new /datum/stack_recipe("gun rack parts", /obj/item/gunrack_parts, time = 1 SECONDS, modifier_signal = COMSIG_GET_CONSTRUCTING_SPEED_MOD),
