...
/obj/item/radio/headset/headset_mining_medic
	...
	ru_names = list(
		NOMINATIVE = "радиочастотная гарнитура шахтерского врача",
		GENITIVE = "радиочастотную гарнитуру шахтерского врача",
		DATIVE = "радиочастотной гарнитуры шахтерского врача",
		ACCUSATIVE = "радиочастотную гарнитуру шахтерского врача",
		INSTRUMENTAL = "радиочастотной гарнитурой шахтерского врача",
		PREPOSITIONAL = "радиочастотной гарнитуре шахтерского врача"
	)
