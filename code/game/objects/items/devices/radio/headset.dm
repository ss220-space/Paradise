/obj/item/radio/headset
	name = "radio headset"
	desc = "Обновленная, компактная версия интеркома, которая надевается на голову. Эта модель поддерживает установку ключей-шифраторов."
	ru_names = list(
...
/obj/item/radio/headset/alt
	name = "bowman headset"
	desc = "Обновленная, компактная версия интеркома, которая надевается на голову. Эта модель поддерживает установку ключей-шифраторов и защищает от громких звуков."
	ru_names = list(
...
/obj/item/radio/headset/heads/hos
	...
	desc = "Эта гарнитура принадлежит тому, кто защищает никчемные жизни на этой станции."
	ru_names = list(
...
/obj/item/radio/headset/heads/cmo
	...
	desc = "Эта гарнитура принадлежит высоквалифицированному медицинскому персоналу."
	ru_names = list(
...
/obj/item/radio/headset/headset_cargo
	...
	desc = "Крайне дешевая копия тактической гарнитуры, используемой службой безопасности. Данная модель не способна защитить от громких звуков, несмотря на ее внешний вид."
	ru_names = list(
...
/obj/item/radio/headset/headset_mining_medic
	...
	desc = "Гарнитура, используемая шахтерским медиком. Она пропахла как медицинским спиртом, так и пеплом."
	ru_names = list(
		NOMINATIVE = "радиочастотная гарнитура шахтерского медика",
		GENITIVE = "радиочастотную гарнитуру шахтерского медика",
		DATIVE = "радиочастотной гарнитуры шахтерского медика",
		ACCUSATIVE = "радиочастотную гарнитуру шахтерского медика",
		INSTRUMENTAL = "радиочастотной гарнитурой шахтерского медика",
		PREPOSITIONAL = "радиочастотной гарнитуре шахтерского медика"
	)
