...
/obj/item/flashlight/seclite
	name = "seclite"
	desc = "Ручной источник света. За счёт аккумулятора повышенной мощности \
			обладает повышенным радиусом освещения. Достаточно увесистый, \
...
/obj/item/flashlight/flare/glowstick
	...
	desc = "Ручной химический источник света. Активация путём сгибания корпуса обеспечивает \
			...
			Дорогая версия военного качества."
	light_range = 4
