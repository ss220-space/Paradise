	...
	if(pai)
		...
		if(looking_for_personality)
			dat += {"
				...
				<p>Запрос личностей ПИИ из центральной базы данных… Если личности не будут обнаружены, либо если не будет найдена подходящая личность, попробуйте выполнить повторный поиск новых личности ПИИ позже.</p>
