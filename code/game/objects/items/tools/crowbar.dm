...
/obj/item/crowbar/power/suicide_act(mob/user)
	user.visible_message(span_suicide("[user] помещает свою голову между лезвиями [src.declent_ru(GENITIVE)]. Похоже, [GEND_HE_SHE(user)] пытается использовать [src.declent_ru(ACCUSATIVE)] для самоубийства!"))
