...
/obj/item/crowbar/power/suicide_act(mob/user)
	user.visible_message(span_suicide("[user] помеща[PLUR_ET_UT(user)] свою голову между лезвиями [src.declent_ru(GENITIVE)]. Похоже, [GEND_HE_SHE(user)] пыта[pluralize_ru(user.gender,"ется","ются")] использовать [src.declent_ru(ACCUSATIVE)] для самоубийства!"))
