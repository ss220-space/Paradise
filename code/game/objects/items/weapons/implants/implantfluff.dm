...
/datum/implant_fluff/mindshield/ert
	name = "Nanotrasen ERT oriented Mindshield Bio-chip"
	life = "NT provides lifetime warranty on this bio-chip."
	notes = "This is the 5 iteration of a mindshiled bio-chip. Designed specifically for Nanotrasen special forces. Its not only makes you loyal but also allows to use some high-tech weapons."
	function = "Personnel injected with this device can better resist mental compulsions such as brainwashing and mindslaving. Also allows to use specialized energy weapons."
...
/datum/implant_fluff/weapons_auth
	name = "Firearms Authentication Bio-chip"
	life = "Lasts 4 hours after death of host."
	function = "Allows operation of biochip-locked weaponry, preventing equipment from falling into enemy hands."

/datum/implant_fluff/cortical
	name = "Cortical Stack"
	life = "Unknown, no collected sample has been active long enough to determine lifespan."
	notes = "A fist-sized mass of biocircuits and chips of unknown origin."
...
/datum/implant_fluff/stamina_boost
	name = "Cybersun Industries SB-2 Bio-chip"
	name = "Неизвестно: ни один из собранных образцов не был активен достаточно, чтобы определить время функционирования."
	notes = "Разработка Синдиката, позволяет использовать свой организм на \"износ\"."
	function = "Позволяет пополнить выносливость, имеет побочное действие в виде коротко временного снижения максимального запаса выносливости"
