/obj/item/weldingtool/sword
	name = "welding sword"
	desc = "Аналог энергетического меча, изготовленный из сварки неизвестным мастером из Грейтайда. Он имеет аналогичные характеристики, но наносит ожоги заместо травм в активном состоянии. Во время атаки расходует сварочное топливо."
...
/obj/item/weldingtool/sword/double
	...
	desc = "Оружие, полученное путем объединения двух сварочных мечей в один. В отличие от двухклинкового энергетического меча, не способен отражать лазеры. Во время атаки расходует сварочное топливо."
