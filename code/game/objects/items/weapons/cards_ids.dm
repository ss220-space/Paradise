...
/obj/item/card/id/attack_self(mob/user as mob)
	user.visible_message("[user] shows you: [get_examine_icon(viewers(user))] [src.name]. The assignment on the card: [src.assignment]",\
		"You flash your ID card: [get_examine_icon(user)] [src.name]. The assignment on the card: [src.assignment]")
	if(mining_points)
