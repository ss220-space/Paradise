...
/obj/item/lighter/zippo/qm
	...
	ru_names = list(
		NOMINATIVE = "зажигалка Зиппо Завхоза",
		GENITIVE = "зажигалки Зиппо Завхоза",
		DATIVE = "зажигалке Зиппо Завхоза",
		ACCUSATIVE = "зажигалку Зиппо Завхоза",
		INSTRUMENTAL = "зажигалкой Зиппо Завхоза",
		PREPOSITIONAL = "зажигалке Зиппо Завхоза"
	)
	icon_state = "zippo_qm"
	item_state = "qmzippo"
	icon_on = "zippo_qm_on"
