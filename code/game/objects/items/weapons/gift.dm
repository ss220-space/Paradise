...
/obj/item/gift/santa_special/spawn_reward(mob/user)
	...
	user.visible_message(span_notice("[user.declent_ru_cap(NOMINATIVE)] распаковыва[PLUR_ET_UT(user)] [declent_ru(ACCUSATIVE)] и обнаружива[PLUR_ET_UT(user)] что-то интересное!"))
