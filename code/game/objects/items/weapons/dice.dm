...
/obj/item/storage/pill_bottle/dice/suicide_act(mob/user)
	user.visible_message(span_suicide("[user] игра[PLUR_ET_UT(user)] со смертью! Похоже, он[genderize_ru(user.gender,"","а","о","и")] пыта[PLUR_ET_UT(user)]ся покончить жизнь самоубийством!"))
	return (OXYLOSS)
