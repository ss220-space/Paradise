...
/obj/item/restraints/handcuffs/cable/attackby(var/obj/item/I, mob/user as mob, params)
	...
	if(istype(I, /obj/item/stack/rods))
		...
		if(do_after(user, 35 * M.toolspeed * istype(user, /mob/living/carbon/human) ? istype(user, /mob/living/carbon/human) ? istype(user, /mob/living/carbon/human) ? user.dna.species.toolspeedmod : 1 : 1 : 1, target = src) && M.use(6))
