...
#undef LOCKBOX_DRILL_SPARK_CHANCE
#undef LOCKBOX_DRILL_TIME
#undef DRILLING_PERCENT_TO_ALERT
#undef DRILL_X_OFFSET
#undef DRILL_Y_OFFSET
#undef PROGRESS_BAR_Y_OFFSET
