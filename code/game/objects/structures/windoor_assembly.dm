...
GAME_VERB_SRC(/obj/structure/windoor_assembly, revrotate, oview(1), "Повернуть по часовой", null)
	if(anchored)
...
GAME_VERB_SRC(/obj/structure/windoor_assembly, flip, oview(1), "Повернуть", null)
