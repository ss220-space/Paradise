...
/obj/structure/table/proc/tablepush(mob/living/victim, mob/user)
	...
	victim.visible_message(
		span_danger("[capitalize(user.declent_ru(NOMINATIVE))] толкает [victim.declent_ru(GENITIVE)] на [src.declent_ru(ACCUSATIVE)]."),
		span_userdanger("[user] толкает вас на [src.declent_ru(ACCUSATIVE)]."),
	)
