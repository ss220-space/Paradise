...
/obj/structure/statue/mooniverse
	name = "Миднайт Блэк"
	desc = "Быстро продвинувшийся агент делавший задания быстро, хоть и не всегда эффективно. Всегда искал новые возможности в противостоянии с врагами синдиката. \
			Заслужил звание профессионального агента, тяжёлым трудом и загадочной упрямостью. Выбирался из множества казалось бы смертельных передряг и часто шёл на миссии как \"Спящий агент.\"\
			Статуя выдана за заслуги по раскрытию бесчеловечного проекта НТ под кодовым названием \"Дельта-817\""
	icon = 'icons/obj/statuelarge.dmi'
