...
/obj/structure/fluff/attackby(obj/item/I, mob/living/user, params)
	if(istype(I, /obj/item/wrench) && deconstructible)
		...
		if(do_after(src, 50 * I.toolspeed * istype(user, /mob/living/carbon/human) ? istype(user, /mob/living/carbon/human) ? istype(user, /mob/living/carbon/human) ? user.dna.species.toolspeedmod : 1 : 1 : 1, target = src))
