...
/obj/structure/proc/do_climb(mob/living/user)
	...
	user.visible_message(span_warning("[user.declent_ru_cap(NOMINATIVE)] начина[PLUR_ET_YUT(user)] забираться на [declent_ru(ACCUSATIVE)]!"))
	climber = user
	...
	if(get_turf(user) == get_turf(src))
		user.visible_message(span_warning("[user.declent_ru_cap(NOMINATIVE)] забира[PLUR_ET_YUT(user)]ся на [declent_ru(ACCUSATIVE)]!"))
