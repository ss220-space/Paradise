/datum/game_mode/proc/auto_declare_completion_morph()
	...
	var/text = span_fontsize_2("<b>Морфами были:</b>")
...
/datum/game_mode/proc/auto_declare_completion_revenant()
	...
	var/text = span_fontsize_2("<b>Ревенантами были:</b>")
...
/datum/game_mode/proc/auto_declare_completion_honksquad()
	...
	var/text = span_fontsize_2("<b>Членами Хонксквада были:</b>")
...
/datum/game_mode/proc/auto_declare_completion_deathsquad()
	...
	var/text = span_fontsize_2("<b>Бойцами Отряда Смерти были:</b>")
...
/datum/game_mode/proc/auto_declare_completion_sst()
	...
	var/text = span_fontsize_2("<b>Бойцами Ударного Отряда Синдиката были:</b>")
...
/datum/game_mode/proc/auto_declare_completion_sit()
	...
	var/text = span_fontsize_2("<b>Агентами Диверсионного Отряда Синдиката были:</b>")
