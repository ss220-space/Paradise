...
/datum/scoreboard/proc/generate_scoreboard()
	...
	<u>Прочее</u><br>
	<b>Съедено еды:</b> [score_food_eaten] укус[DECL_0_A_OV(score_food_eaten)]/глот[DECL_OK_KA_KOV(score_food_eaten)].<br>
	<b>Клоуна избили:</b> [score_clown_abuse] раз[DECL_0_A_0(score_clown_abuse)]<br><br>
