// ============================================================================
// ============================================================================
// ЧАСТЬ 1: ЯДРО И ЛОГИКА (CORE LOGIC & SYSTEM)
// В этом блоке находится базовая механика предметов контрактов, логика 
// призыва госта-ученика, генерация UI окон и базовый класс школы магии.
// ============================================================================
// ============================================================================

// ============================================================================
// БЛОК 1.1: БАЗОВЫЙ ПРЕДМЕТ И ИНТЕРФЕЙС (BASE CONTRACT & UI)
// Базовый класс контракта и формирование всплывающего окна выбора.
// ============================================================================
...
// ============================================================================
// БЛОК 1.2: КОНТРАКТ УЧЕНИКА (APPRENTICE CONTRACT)
// Вызов полла среди гостов, спавн ученика и назначение ему целей.
// ============================================================================
...
// ============================================================================
// БЛОК 1.3: МАГИЧЕСКИЙ УЧЕБНИК (APPRENTICE CHOOSE BOOK)
// Книга, позволяющая ученику самостоятельно выбрать себе школу магии.
// ============================================================================
...
// ============================================================================
// БЛОК 1.4: ЛОГИКА ВЫДАЧИ ШКОЛЫ И БАЗОВЫЙ КЛАСС (SCHOOL APPLY LOGIC)
// Обработка выбора школы магии и выдача экипировки через вызов kit().
// ============================================================================
...
// ============================================================================
// ============================================================================
// ЧАСТЬ 2: КОНТЕНТ И ДАННЫЕ (CONTENT & DATA)
// Списки доступных школ магии, а также конкретные классы школ с переопределенной 
// функцией kit() для выдачи заклинаний и уникальных предметов одежды.
// ============================================================================
// ============================================================================

// ============================================================================
// БЛОК 2.1: РЕЕСТР ШКОЛ (SCHOOL REGISTRY)
// Список всех школ, которые будут отображаться в контракте/учебнике.
// ============================================================================
...
// ============================================================================
// БЛОК 2.2: ОПРЕДЕЛЕНИЯ ШКОЛ И ИХ ЭКИПИРОВКА (SCHOOL DEFINITIONS & GEAR)
// ============================================================================
