...
/obj/item/contract/proc/used_contract()
	return span_notice("You have already summoned your apprentice.</span><br>"

/obj/item/contract/apprentice_choose_book/used_contract()
	return span_notice("Письмена стерты, а все страницы пусты. Похоже учебник уже был изучен.</span><br>"
