...
/datum/game_mode/wizard/raginmages/declare_completion()
	if(finished)
		...
		to_chat(world, span_warning(span_fontsize_3("<b> The crew has managed to hold off the Wizard attack! The Space Wizard Federation has been taught a lesson they will not soon forget!</b>")))
	..(1)
