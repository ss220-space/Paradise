...
/datum/game_mode/wizard/announce()
	to_chat(world, "<B>Текущий игровой режим - Wizard!</B>")
	to_chat(world, "<B>На станции обнаружен <font color='red'>КОСМИЧЕСКИЙ МАГ</font>. Вы не можете позволить ему достичь своей цели!</B>")
