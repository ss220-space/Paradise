...
/datum/game_mode/antag_paradise
	...
	var/list/vampire_protected_species = list(SPECIES_MACHINEPERSON, SPECIES_PLASMAMAN, SPECIES_SLIMEPERSON)
	var/list/changeling_protected_species = list(SPECIES_MACHINEPERSON, SPECIES_SLIMEPERSON)
