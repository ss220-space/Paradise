...
/datum/game_mode/meteor/announce()
	to_chat(world, "<B>Текущий игровой режим - Meteor!</B>")
	to_chat(world, "<B>Космическая станция застряла в сильном метеоритном дожде. Вы должны сбежать со станции, или хотя бы выжить.</B>")
