...
/obj/effect/proc_holder/spell/click/glare //Stuns and mutes a human target, depending on the distance relative to the shadowling
	name = "Glare"
...
/obj/effect/proc_holder/spell/reviveThrall/cast(list/targets, mob/user = usr)
	...
	if(thrallToRevive.stat == CONSCIOUS)
		...
		thrallToRevive.mind.AddSpell(new /obj/effect/proc_holder/spell/click/glare(null))
