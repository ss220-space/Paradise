...
/datum/objective/heist/kidnap/choose_target()
	var/list/roles = list("Chief Engineer","Research Director","Chief Medical Officer","Head of Security", "Head of Personel","Magistrate","Nanotrasen Representative","Roboticist","Chemist","Station Engineer")
	var/list/possible_targets = list()
