...
/obj/effect/proc_holder/spell/vampire/self/shapeshift
	...
	gain_desc = "Вы получили способность навсегда обернуться другим обликом, затратив часть накопленной крови."
...
/obj/effect/proc_holder/spell/vampire/self/screech
	...
	gain_desc = "Вы получили способность визга рукокрылых, в большом радиусе оглушающую всех, кто может слышать, и раскалывающую стёкла."
...
/obj/effect/proc_holder/spell/vampire/targetted/enthrall
	...
	gain_desc = "Вы получили способность порабощения, которая тратит много крови, но позволяет вам поработить человека, который ещё никому не служит, на случайный период времени."
...
/obj/effect/proc_holder/spell/vampire/self/cloak
	...
	gain_desc = "Вы получили способность к маскировке, которая, будучи включённой, делает вас практически невидимым в темноте."
...
/obj/effect/proc_holder/spell/vampire/shadowstep
	...
	gain_desc = "Вы получили возможность скрываться в тенях, позволяющую вам, затратив часть крови, оказаться в ближайшей доступной тени."
...
/datum/vampire_passive/regen
	gain_desc = "Ваша омолаживающая способность улучшена. Теперь она будет постепенно исцелять вас после использования."

/datum/vampire_passive/vision
	gain_desc = "Ваше вампирское зрение улучшено."

/datum/vampire_passive/full
	gain_desc = "Вы достигли полного потенциала и ничто святое больше не может ослабить вас. Ваше зрение значительно улучшилось."
