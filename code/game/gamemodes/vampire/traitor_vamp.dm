/datum/game_mode/traitor/vampire
	...
	protected_jobs = list("Peacemaker", "Peacemaker Cadet", "Warden", "Detective", "Peacemakers Leader", "Captain", "Blueshield", "Nanotrasen Representative", "Peacemaker Pod Pilot", "Magistrate", "Chaplain", "Brig Physician", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Nanotrasen Navy Field Officer", "Special Operations Officer", "Supreme Commander")
