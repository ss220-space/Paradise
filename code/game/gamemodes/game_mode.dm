...
/datum/game_mode/proc/apocalypse(god_name)
	GLOB.major_announcement.announce(
		message = "Обнаружена вторжение внепространственного бога по имени [god_name]. Помощь и инструкции по противодействию будут направлены в ближайшее время. Всему лояльному экипажу — не доспутите распостранение угрозы.",
