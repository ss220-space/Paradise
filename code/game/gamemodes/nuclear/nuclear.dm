...
/datum/game_mode/nuclear/declare_completion()
	...
	if(!disk_rescued && station_was_nuked && !syndies_didnt_escape)
		...
		to_chat(world, span_fontsize_16px("<b>Syndicate Major Victory!</b>"))
		...
		to_chat(world, span_fontsize_16px("<b>Total Annihilation</b>"))
		...
		to_chat(world, span_fontsize_16px("<b>Crew Minor Victory</b>"))
		...
		to_chat(world, span_fontsize_16px("<b>[syndicate_name()] operatives have earned Darwin Award!</b>"))
		...
		to_chat(world, span_fontsize_16px("<b>Crew Major Victory!</b>"))
		...
		to_chat(world, span_fontsize_16px("<b>Syndicate Minor Victory!</b>"))
		...
		to_chat(world, span_fontsize_16px("<b>Neutral Victory</b>"))
