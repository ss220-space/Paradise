...
/datum/game_mode/nuclear/declare_completion()
	...
	if(!disk_rescued && station_was_nuked && !syndies_didnt_escape)
		...
		to_chat(world, span_fontsize_3("<b>Syndicate Major Victory!</b>"))
		...
		to_chat(world, span_fontsize_3("<b>Total Annihilation</b>"))
		...
		to_chat(world, span_fontsize_3("<b>Crew Minor Victory</b>"))
		...
		to_chat(world, span_fontsize_3("<b>[syndicate_name()] operatives have earned Darwin Award!</b>"))
		...
		to_chat(world, span_fontsize_3("<b>Crew Major Victory!</b>"))
		...
		to_chat(world, span_fontsize_3("<b>Syndicate Minor Victory!</b>"))
		...
		to_chat(world, span_fontsize_3("<b>Neutral Victory</b>"))
...
/datum/game_mode/proc/auto_declare_completion_nuclear()
	if(syndicates.len || GAMEMODE_IS_NUCLEAR)
		var/text = span_fontsize_3("<br><b>The syndicate operatives were:</b>")
