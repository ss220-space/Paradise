...
/obj/item/nuclear_challenge/attack_self(mob/living/user)
	...
	to_chat(user, "Вы привлекли внимание влиятельных сил в Синдикате. Ваша команда получила бонусный пакет телекристаллов. Вас ждёт щедрая награда, если вы выполните задание.")
