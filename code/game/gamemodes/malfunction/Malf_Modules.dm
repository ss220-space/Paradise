...
/datum/AI_Module/large/break_air_alarms
	...
	unlock_text = "<span class='notice'>Вы снимаете протоколы безопасности всех воздушных сигнализаций, но не подтверждаете запрос. Вы можете подтвердить его когда угодно… больной ублюдок.</span>"
