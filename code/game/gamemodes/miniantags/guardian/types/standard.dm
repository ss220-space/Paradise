/mob/living/simple_animal/hostile/guardian/punch
	...
	obj_damage = 100
	damage_transfer = 0.4
	playstyle_string = "Будучи <b>Стандартом</b>, вы обладаете огромной броней, сильными ударами пробивающими даже стены и ваше присутствие ужасает врагов, замедляя их. Кричите, повергая врагов в страх!"
	environment_smash = 2
