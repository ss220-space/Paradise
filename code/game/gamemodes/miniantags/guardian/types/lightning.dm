...
/mob/living/simple_animal/hostile/guardian/beam
	...
	damage_transfer = 0.6
	range = 7
	playstyle_string = "Как тип <b>Молния</b>, вы будете иметь смертоносную цепь молнии к своему призывателю. Цепь молний поражают всех, кто находится рядом с ними. Так же с небольшим шансом вы будете накладывать эту цепь при ударе."
