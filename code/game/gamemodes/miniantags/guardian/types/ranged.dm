...
/mob/living/simple_animal/hostile/guardian/ranged
	...
	see_in_dark = 8
	playstyle_string = "Как тип <b>Ranged</b>, вы обладаете лишь легким сопротивлением урону, но способны распылять осколки кристалла с невероятно высокой скоростью. Вы также можете расставлять наблюдательные силки, чтобы следить за передвижением противника. Наконец, вы можете перейти в режим разведчика, в котором вы не можете атаковать, но можете двигаться без ограничений"
	magic_fluff_string = "...и вытаскиваете Стража, инопланетного мастера дальнего боя."
