...
/obj/item/paper/guardian
 ...
 <br>
 <b>Поддержка</b>: Имеет два режима: Боевой: урон токсинами пробивающий броню и средняя защита. Лекарь: Атаки лечат все виды урона, но становится медленным. Может поставить блюспейс маяк на пол и телепортировать всё и всех не прибитых к полу на него на Alt+Click.<br>
 <br>
 ...
 <br>
 <b>Ассасин</b>: Катастрофически высокий урон грубым уроном и ядом, может входить в невидимость для нанесения удара ещё большей силы, игнорирующего броню. Совершенно нет никакой защиты, а в невидимости получает даже больше урона чем это возможно.
 <br>
 <b>Налетчик</b>: Слабая атака и средняя броня, невероятно быстр, имеет повышенную скорость атаки по людям и имеет особый рывок, который при столкновении пробивает броню и опрокидывает жертву.
 <br>
 <b>Молния</b>: Слабая атака и средняя броня, имеет цепь молнии между собой и хозяином, что дезинтегрирует любую цель при нахождении в ней. С малым шансом накладывает эту молнию при ударе, наносящую огромный урон.
 <br>
 <b>Protector</b>: При нарушении дальности связи хозяин призывается к нему, а не наоборот. Имеет два режима: низкая атака с высокой защитой, и режим ультра-защиты, практически полностью нивелирующий входящий урон. В режиме ультра-защиты способен пережить даже взрыв бомбы, лишь слегка ранив хозяина.
"}
