...
/obj/item/clothing/suit/armor/abductor/vest
	...
	armor = list(PIERCING = 15, SLASHING = 15, BLUNT = 15, ABSORPTION = 40, LASER = 15, ENERGY = 15, BOMB = 15, BIO = 15, FIRE = 70, ACID = 70)
	...
	var/stealth_armor = list(PIERCING = 15, SLASHING = 15, BLUNT = 15, ABSORPTION = 40, LASER = 15, ENERGY = 15, BOMB = 15, BIO = 15, FIRE = 70, ACID = 70)
	var/combat_armor = list(PIERCING = 50, SLASHING = 50, BLUNT = 50, ABSORPTION = 62, LASER = 50, ENERGY = 50, BOMB = 50, BIO = 50, FIRE = 90, ACID = 90)
	sprite_sheets = null
