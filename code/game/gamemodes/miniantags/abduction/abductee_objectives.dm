...
/datum/objective/abductee/sixthsense
	explanation_text = "Вы умерли и попали на небеса... это рай или ад? Кажется, здесь никто не знает, что они мертвы. Убедите их в этом и возможно вы сможете сбежать из этого лимба."
