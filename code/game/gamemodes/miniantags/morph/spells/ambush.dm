...
/obj/effect/proc_holder/spell/morph_spell/ambush
	...
	desc = "Подготовьте засаду. Первый удар нанесёт значительно больше урона и ослабит цель. Работает только в изменённой форме. Если цель попытается взаимодействовать с вами руками, вы нанесёте ещё больше урона. \
