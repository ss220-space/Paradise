...
/mob/living/simple_animal/hostile/old_morph
	name = "old_morph"
	real_name = "morph"
...
/mob/living/simple_animal/hostile/old_morph/proc/allowed(atom/movable/A) // make it into property/proc ? not sure if worth it
...
/mob/living/simple_animal/hostile/old_morph/proc/eat(atom/movable/A)
	if(A && A.loc != src)
...
/mob/living/simple_animal/hostile/old_morph/ShiftClickOn(atom/movable/A)
...
/mob/living/simple_animal/hostile/old_morph/proc/assume(atom/movable/target)
	morphed = 1
	form = target
...
/mob/living/simple_animal/hostile/old_morph/proc/restore()
	if(!morphed)
		return
	morphed = 0
	form = null
...
/mob/living/simple_animal/hostile/old_morph/death(gibbed)
	. = ..()
	if(stat == DEAD && gibbed)
...
/mob/living/simple_animal/hostile/old_morph/Aggro() // automated only
	..()
	restore()

/mob/living/simple_animal/hostile/old_morph/LoseAggro()
	vision_range = initial(vision_range)

/mob/living/simple_animal/hostile/old_morph/AIShouldSleep(var/list/possible_targets)
	. = ..()
	if(.)
...
/mob/living/simple_animal/hostile/old_morph/AttackingTarget()
