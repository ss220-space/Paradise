...
/datum/event/spawn_swarmer/announce()
	if(prob(25)) //25% chance to announce it to the crew
		...
		GLOB.event_announcement.Announce("Новый отчёт был загружен и распечатан на всех консолях коммуникаций..", "Входящее Секретное Сообщение", 'sound/AI/announces/commandreport.ogg')
