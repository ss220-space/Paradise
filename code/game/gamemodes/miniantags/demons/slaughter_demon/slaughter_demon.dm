/mob/living/simple_animal/demon/slaughter
	...
	playstyle_string = "<span class='span_userdanger'><b>Вы — Демон Резни, ужасное существо из иного измерения. У вас одна цель: убивать.</b></span><br> \
					<b>Вы можете использовать способность 'Кровавый путь' на лужах крови, чтобы перемещаться через них, появляясь и исчезая на станции по своему желанию. \
					Если вы тащите мёртвое или находящееся в критическом состоянии существо, когда входите в лужу крови, он последует за вами, что позволит вам поглотить его. \
					Вы двигаетесь быстро, покидая лужу крови, но материальный мир скоро лишит вас сил и сделает медлительным.</b>"
