...
/mob/living/simple_animal/demon/slaughter/cult //Summoned as part of the cult objective "Bring the Slaughter"
	...
	faction = list("cult")
	playstyle_string = span_cult("<b>[span_userdanger("You are a Harbinger of the Slaughter.")] Brought forth by the servants of Nar'Sie, you have a single purpose: slaughter the heretics \
