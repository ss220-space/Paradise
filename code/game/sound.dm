...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if("punch")
				soundin = pick('sound/weapons/melee/fist.ogg', 'sound/weapons/melee/fist2.ogg', 'sound/weapons/melee/fist3.ogg', 'sound/weapons/melee/fist4.ogg', 'sound/weapons/melee/fist5.ogg',)
			if("swing_hit")
				soundin = pick('sound/weapons/melee/hit.ogg', 'sound/weapons/melee/hit2.ogg', 'sound/weapons/melee/hit3.ogg', 'sound/weapons/melee/hit4.ogg', 'sound/weapons/melee/hit5.ogg', 'sound/weapons/melee/hit7.ogg', 'sound/weapons/melee/hit8.ogg',)
			if("slice")
				soundin = pick('sound/weapons/melee/slice.ogg', 'sound/weapons/melee/slice2.ogg', 'sound/weapons/melee/slice3.ogg', 'sound/weapons/melee/slice4.ogg', 'sound/weapons/melee/slice5.ogg', 'sound/weapons/melee/slice6.ogg', 'sound/weapons/melee/slice7.ogg',)
			if("stab")
				soundin = pick('sound/weapons/melee/stab.ogg', 'sound/weapons/melee/stab2.ogg', 'sound/weapons/melee/stab3.ogg', 'sound/weapons/melee/stab4.ogg', 'sound/weapons/melee/stab5.ogg',)
			if("hiss")
