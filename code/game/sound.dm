...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			if("patchpack")
				soundin = pick('sound/effects/CC0/patchpack1.ogg', 'sound/effects/CC0/patchpack2.ogg', 'sound/effects/CC0/patchpack3.ogg',
					'sound/effects/CC0/patchpack4.ogg', 'sound/effects/CC0/patchpack5.ogg')
			if("pillbottle")
			...
			if("blade_scifi_swing")
				soundin = pick('sound/weapons/swings/blade_scifi_swing1.ogg', 'sound/weapons/swings/blade_scifi_swing2.ogg', 'sound/weapons/swings/blade_scifi_swing3.ogg', 'sound/weapons/swings/blade_scifi_swing4.ogg')
			if("blade_swing_heavy")
				soundin = pick('sound/weapons/swings/blade_swing_heavy1.ogg', 'sound/weapons/swings/blade_swing_heavy2.ogg', 'sound/weapons/swings/blade_swing_heavy3.ogg', 'sound/weapons/swings/blade_swing_heavy4.ogg')
			if("blade_swing_light")
				soundin = pick('sound/weapons/swings/blade_swing_light1.ogg', 'sound/weapons/swings/blade_swing_light2.ogg', 'sound/weapons/swings/blade_swing_light3.ogg', 'sound/weapons/swings/blade_swing_light4.ogg',)
			if("blunt_swing_heavy")
				soundin = pick('sound/weapons/swings/blunt_swing_heavy1.ogg', 'sound/weapons/swings/blunt_swing_heavy2.ogg', 'sound/weapons/swings/blunt_swing_heavy3.ogg', 'sound/weapons/swings/blunt_swing_heavy4.ogg',)
			if("blunt_swing_light")
				soundin = pick('sound/weapons/swings/blunt_swing_light1.ogg', 'sound/weapons/swings/blunt_swing_light2.ogg', 'sound/weapons/swings/blunt_swing_light3.ogg', 'sound/weapons/swings/blunt_swing_light4.ogg',)
			if("chainsaw_swing")
				soundin = pick('sound/weapons/swings/chainsaw_swing1.ogg', 'sound/weapons/swings/chainsaw_swing2.ogg', 'sound/weapons/swings/chainsaw_swing3.ogg', 'sound/weapons/swings/chainsaw_swing4.ogg',)
			if("chop_swing_heavy")
				soundin = pick('sound/weapons/swings/chop_swing_heavy1.ogg', 'sound/weapons/swings/chop_swing_heavy2.ogg', 'sound/weapons/swings/chop_swing_heavy3.ogg', 'sound/weapons/swings/chop_swing_heavy4.ogg',)
			if("chop_swing_light")
				soundin = pick('sound/weapons/swings/chop_swing_light1.ogg', 'sound/weapons/swings/chop_swing_light2.ogg', 'sound/weapons/swings/chop_swing_light3.ogg', 'sound/weapons/swings/chop_swing_light4.ogg',)
			if("double_energy_swing")
				soundin = pick('sound/weapons/swings/double_energy_swing1.ogg', 'sound/weapons/swings/double_energy_swing2.ogg', 'sound/weapons/swings/double_energy_swing3.ogg', 'sound/weapons/swings/double_energy_swing4.ogg',)
			if("energy_sword_swing")
				soundin = pick('sound/weapons/swings/energy_sword_swing1.ogg', 'sound/weapons/swings/energy_sword_swing2.ogg', 'sound/weapons/swings/energy_sword_swing3.ogg', 'sound/weapons/swings/energy_sword_swing4.ogg',)
			if("generic_swing_heavy")
				soundin = pick('sound/weapons/swings/generic_swing_heavy1.ogg', 'sound/weapons/swings/generic_swing_heavy2.ogg', 'sound/weapons/swings/generic_swing_heavy3.ogg', 'sound/weapons/swings/generic_swing_heavy4.ogg',)
			if("generic_swing_light")
				soundin = pick('sound/weapons/swings/generic_swing_light1.ogg', 'sound/weapons/swings/generic_swing_light2.ogg', 'sound/weapons/swings/generic_swing_light3.ogg', 'sound/weapons/swings/generic_swing_light4.ogg',)
			if("katana_swing")
				soundin = pick('sound/weapons/swings/katana_swing1.ogg', 'sound/weapons/swings/katana_swing2.ogg', 'sound/weapons/swings/katana_swing3.ogg', 'sound/weapons/swings/katana_swing4.ogg',)
			if("knife_swing")
				soundin = pick('sound/weapons/swings/knife_swing1.ogg', 'sound/weapons/swings/knife_swing2.ogg', 'sound/weapons/swings/knife_swing3.ogg', 'sound/weapons/swings/knife_swing4.ogg',)
			if("rapier_swing")
				soundin = pick('sound/weapons/swings/rapier_swing1.ogg', 'sound/weapons/swings/rapier_swing2.ogg', 'sound/weapons/swings/rapier_swing3.ogg', 'sound/weapons/swings/rapier_swing4.ogg',)
			if("hiss")
			...
			if("bonebreak")
				soundin = pick('sound/effects/bone_break_1.ogg', 'sound/effects/bone_break_2.ogg', 'sound/effects/bone_break_3.ogg',
					'sound/effects/bone_break_4.ogg', 'sound/effects/bone_break_5.ogg', 'sound/effects/bone_break_6.ogg')
			if("boxing")
				soundin = pick('sound/weapons/boxing1.ogg', 'sound/weapons/boxing2.ogg', 'sound/weapons/boxing3.ogg', 'sound/weapons/boxing4.ogg',
