...
/obj/machinery/dna_scannernew/attackby(obj/item/I, mob/user, params)
	...
	if(istype(I, /obj/item/reagent_containers/glass))
		...
		if(!user.drop_transfer_item_to_loc(I, src))
			return ..()
		beaker = I
		visible_message(span_notice("[user] вставляет [I.declent_ru(GENITIVE)] в [declent_ru(ACCUSATIVE)]."))
...
/obj/machinery/dna_scannernew/proc/put_in(mob/M, mob/living/user)
	...
	if(M == user)
		...
		visible_message("[user] начинает укладывать [M] в [declent_ru(ACCUSATIVE)].")
...
/obj/machinery/computer/scan_consolenew/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/disk/data)) //INSERT SOME diskS
		...
		if(!user.drop_transfer_item_to_loc(I, src))
			return ..()
		disk = I
		visible_message(span_notice("[user] вставляет [I.declent_ru(ACCUSATIVE)] в [declent_ru(ACCUSATIVE)]."))
