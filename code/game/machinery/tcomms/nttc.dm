...
/datum/nttc_configuration
	...
	var/all_jobs = list(
		...
		JOB_TITLE_CCSCAPTAIN = "dsquadradio",
	...
	var/list/cc_jobs = list(JOB_TITLE_CCOFFICER, JOB_TITLE_CCFIELD, JOB_TITLE_CCSPECOPS, JOB_TITLE_SYNDICATE_OFFICER, "Nanotrasen Navy Captain", JOB_TITLE_CCSOLGOV, "Soviet Officer", "Soviet Marine Captain", "Soviet Admiral", JOB_TITLE_CCSCAPTAIN)
