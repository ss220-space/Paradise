...
/obj/machinery/tcomms
	...
	desc = "Если вы это видите, сообщите в #баг-репорты-v2."
	ru_names = list(
...
/obj/item/paper/tcommskey
	...
	ru_names = list(
		NOMINATIVE = "памятка \"Пароль привязки телекоммуникаций\"",
		GENITIVE = "памятки \"Пароль привязки телекоммуникаций\"",
		DATIVE = "памятке \"Пароль привязки телекоммуникаций\"",
		ACCUSATIVE = "памятку \"Пароль привязки телекоммуникаций\"",
		INSTRUMENTAL = "памяткой \"Пароль привязки телекоммуникаций\"й",
		PREPOSITIONAL = "памятке \"Пароль привязки телекоммуникаций\""
	)
...
/obj/item/paper/tcommskey/LateInitialize(mapload)
	for(var/obj/machinery/tcomms/core/C in GLOB.tcomms_machines)
		if(C.network_id == "СТАНЦИЯ-ЯДРО")
			...
			Если эта записка утеряна или уничтожена, вы всегда можете найти пароль во вкладке \"Привязка к ядру\".<br> \
			Если вы захотите хотите сменить пароль, это можно сделать с помощью конфигурации ядра телекоммуникаций."
			info_links = info
			update_icon(UPDATE_ICON_STATE)
