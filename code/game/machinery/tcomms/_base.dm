...
/obj/item/paper/tcommskey
	...
	ru_names = list(
		...
		GENITIVE = "памятки \"Пароля привязки телекоммуникаций\"",
		DATIVE = "памятке \"Паролю привязки телекоммуникаций\"",
		ACCUSATIVE = "памятку \"Пароль привязки телекоммуникаций\"",
		INSTRUMENTAL = "памяткой \"Паролем привязки телекоммуникаци\"й",
		PREPOSITIONAL = "памятке \"Пароле привязки телекоммуникаций\""
	)
