...
/obj/machinery/requests_console
	...
	var/department = "Неизвестно" //The list of all departments on the station (Determined from this variable on each unit) Set this to the same thing if you want several consoles in one department
