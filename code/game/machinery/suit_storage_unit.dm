...
/obj/machinery/suit_storage_unit/anom
	...
	desc = "Устройство, предназначенное для хранения и обеззараживания оборудования. Оснащено встроенным механизмом обеззараживания. Небольшая предупреждающая этикетка гласит, что в устройство нельзя помещать органиков."
	ru_names = list(
