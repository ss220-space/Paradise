...
/obj/item/circuitboard/vendor
	...
	var/static/list/vending_names_paths = list(
		...
		/obj/machinery/vending/clothing/departament/service = "Departament Service ClothesMate",
		/obj/machinery/vending/clothing/departament/service/botanical = "Departament Service ClothesMate Botanical",
		/obj/machinery/vending/clothing/departament/service/chaplain = "Departament Service ClothesMate Chaplain")
