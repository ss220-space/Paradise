...
/obj/machinery/clonepod
	...
	var/static/list/brine_types = list(/datum/reagent/medicine/corazone, /datum/reagent/medicine/perfluorodecalin, /datum/reagent/medicine/epinephrine, /datum/reagent/medicine/salglu_solution) //stops heart attacks, heart failure, shock, and keeps their O2 levels normal
