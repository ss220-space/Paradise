/obj/machinery/autolathe
	name = "autolathe"
	desc = "Оборудование, предназначенное для печати различных изделий базового уровня сложности \
			на основе предустановленных схем. Использует металл и стекло в качестве сырья."
...
/obj/machinery/autolathe/security
	...
	desc = "Оборудование, предназначенное для печати различных изделий базового уровня сложности \
			на основе предустановленных схем. Использует металл и стекло в качестве сырья. \
			Специализированная модель для силовых структур, поставляемая с дополнительными шаблонами печати."
