...
GAME_VERB_DESC(/mob/living/silicon/ai, ai_camera_track, "Режим слежения", "Select who you would like to track.", VERB_CATEGORY_AICOMMANDS, target_name in trackable_mobs()) //Don't display it on the verb lists. This verb exists purely so you can type "track Oldman Robustin" and follow his ass
