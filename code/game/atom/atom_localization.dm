...
/**
 * Тот же `declent_ru`, но первая буква — заглавная.
 *
 * Функционально аналогично конструкции `capitalize(declent_ru(case_id))`
 */
/atom/proc/declent_ru_cap(case_id)
	return capitalize(declent_ru(case_id))
