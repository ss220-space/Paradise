...
/obj/mecha/medical/odysseus/full_load
	...
	desc = "Мех для тестов медмодулей. Всегда поставляется со всеми медмодулями чтобы не спавнить все подряд уже 100500-й раз. Если добавляете мед оборудование, не забудьте добавить его и в этот одиссей."
	max_equip = 5
	strafe_allowed = TRUE
