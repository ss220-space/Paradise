...
/obj/item/paintkit/ripley_titansfist
	...
	new_icon = "titan"
	allowed_types = list(MECH_TYPE_RIPLEY)
...
/obj/item/paintkit/gygax_syndie
	...
	allowed_types = list(MECH_TYPE_GYGAX)
...
/obj/item/paintkit/durand_shire
	...
	new_icon = "shire"
	allowed_types = list(MECH_TYPE_DURAND)
...
/obj/item/paintkit/odysseus_hermes
	...
	new_icon = "hermes"
	allowed_types = list(MECH_TYPE_ODYSSEUS)
...
/obj/item/paintkit/phazon_imperion
	...
	new_icon = "imperion"
	allowed_types = list(MECH_TYPE_PHAZON)
...
/obj/item/paintkit/clarke_orangey
	...
	new_icon = "orangey"
	allowed_types = list(MECH_TYPE_CLARKE)
...
/obj/item/paintkit/lockermech_syndie
	...
	allowed_types = list(MECH_TYPE_LOCKER)
...
/obj/item/paintkit/mauler_pirate
	...
	allowed_types = list(MECH_TYPE_MARAUDER)
...
/obj/item/paintkit/ashed
	...
	new_name = "Ashed Mech"
	new_prefix = "ashed"
	allowed_types = list(MECH_TYPE_RIPLEY, MECH_TYPE_GYGAX, MECH_TYPE_DURAND, MECH_TYPE_PHAZON, MECH_TYPE_LOCKER)
