...
/datum/job/officer
	...
	alt_titles = list("Инструктор по Безопасности","Патрульный Офицер", "Кадет Службы Безопасности")
	minimal_player_age = 14
...
/datum/job/brigdoc
	...
	alt_titles = list("Медик Службы Безопасности")
