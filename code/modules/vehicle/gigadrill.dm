...
/obj/vehicle/gigadrill
	name = "gigadrill"
	icon_state = "gigadrill"
	key_type = /obj/item/key/gigadrill
...
/obj/vehicle/gigadrill/buckle_mob(mob/M, mob/user)
  ..()
  update_icon()

/obj/vehicle/gigadrill/attack_hand()
	..()
	update_icon()

/obj/vehicle/gigadrill/to_bump()
	..()
	if(occupant)
		occupant.pixel_y += 2
		spawn(1)
...
/obj/vehicle/gigadrill/handle_layer()
	if(dir == NORTH)
		plane = OBJ_PLANE
...
/obj/vehicle/gigadrill/make_offsets()
	offsets = list(
...
/obj/vehicle/gigadrill/update_icon()
  if(occupant)
    icon_state = "gigadrill_mov"
  else
    icon_state = "gigadrill"

/obj/vehicle/gigadrill/proc/drill(atom/target)
	if(!occupant)
		return
...
/obj/vehicle/gigadrill/MouseDropTo(atom/movable/O as mob|obj, mob/user as mob)
	..()
...
/obj/vehicle/gigadrill/MouseDropFrom(over_object, src_location, var/turf/over_location, src_control, over_control, params)
	..()
	if(!OB)
		return
