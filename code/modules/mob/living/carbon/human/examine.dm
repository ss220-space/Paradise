/mob/living/carbon/human/examine(mob/user)
	...
	var/datum/strength_level/strength_level = GLOB.strength_levels[strength]
	if((rolled_down || !w_uniform || (w_uniform.item_flags & ABSTRACT)) && (!wear_suit || (wear_suit.item_flags & ABSTRACT)) && strength != STRENGTH_LEVEL_DEFAULT)
		msg += span_notice("[genderize_ru(gender, "Он", "Она", "Оно", "Они")] выгляд[pluralize_ru(gender, "ит", "ят")] [strength_level.strength_examine[strength]][genderize_ru(gender, "ым", "ой", "ым", "ыми")].\n")
