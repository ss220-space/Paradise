...
/mob/living/carbon/human/proc/get_max_strength_level()
	...
	return dna.species.max_strength


/mob/living/carbon/human/proc/get_strength()
	var/result = physiology.strength
	if(HAS_TRAIT(src, TRAIT_GENE_STRONG))
		result = max(result, 4)
...
/mob/living/carbon/human/proc/get_strength_level_part()
	var/level = get_strength()
	if(level == STRENGTH_LEVEL_SUPERHUMAN)
		return 0

	return physiology.strength_points / GLOB.strength_req_to_upgrade[level]


/mob/living/proc/get_strength_grab_speed_modifier()
	return 1

/mob/living/carbon/human/get_strength_grab_speed_modifier()
...
/mob/living/carbon/human/get_strength_pull_slowdown_modifier()
	var/strength_level_part = get_strength_level_part()
	var/level = get_strength()
	if(strength_level_part == 0)
...
/mob/living/proc/get_strength_melee_damage_delta()
	return 0

/mob/living/carbon/human/get_strength_melee_damage_delta()
	var/strength_level_part = get_strength_level_part()
	var/level = get_strength()
	if(strength_level_part == 0)
