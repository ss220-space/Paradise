...
#define DISARM_HELP_INTENT_MOVE_CHANCE 75
#define DISARM_HELP_INTENT_KNOCK_CHANCE 15
#define DISARM_HELP_INTENT_COUNTER_ATTACK_CHANCE 0
#define DISARM_HELP_INTENT_NOTHING_CHANCE 10
// Target in not help intent (disarm, grab, harm)
#define DISARM_OTHER_INTENT_MOVE_CHANCE 35
#define DISARM_OTHER_INTENT_KNOCK_CHANCE 10
#define DISARM_OTHER_INTENT_COUNTER_ATTACK_CHANCE 20
#define DISARM_OTHER_INTENT_NOTHING_CHANCE 35
// Disarm action way
