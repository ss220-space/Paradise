/datum/species/machine
	...
	species_traits = list(NO_BREATHE, NO_BLOOD, NO_SCAN, NO_INTORGANS, NO_PAIN, NO_DNA, RADIMMUNE, VIRUSIMMUNE, NO_GERMS, NO_DECAY, NOTRANSSTING, NO_THIRST) //Computers that don't decay? What a lie!
