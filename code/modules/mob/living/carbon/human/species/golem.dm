// Код генерации имён големов от Пупса — проклятая хуйня.
#define GOLEM_END_PR_1(gender) genderize_ru(gender, "ый", "ая", "ое", "ые")
#define GOLEM_END_PR_2(gender) genderize_ru(gender, "ой", "ая", "ое", "ые")
