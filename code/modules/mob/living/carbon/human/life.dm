...
/mob/living/carbon/human/proc/process_radiation_healing()
	...
	var/list/obj/item/organ/internal/int_damaged_organs = get_damaged_internal_organs(part_flags = AFFECT_INTERNAL_ORGANS)
	...
	var/list/obj/item/organ/external/factured_limbs = get_fractured_limbs()
	heal_cost = 10
