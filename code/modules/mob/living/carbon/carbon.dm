...
/mob/living/carbon/proc/check_self_for_injuries()
	...
	for(var/obj/item/organ/external/bodypart as anything in H.bodyparts)
		...
		if(bodypart.has_fracture() && bodypart.fracture_state == FRACTURE_TYPE_OPEN)
			status_list += "\t <a href='byond://?src=[UID()];open_fracture_limb=[bodypart.UID()]' class='warning'>Из ваш[GEND_EM_EI_EM_IH(bodypart)] [bodypart.declent_ru(GENITIVE)] точит кость!</a>"
