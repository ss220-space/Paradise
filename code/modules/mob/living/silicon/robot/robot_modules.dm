...
/obj/item/robot_module/engineering/Initialize(mapload)
	...
	modules += new /obj/item/weldingtool/hugetank(src)
	modules += new /obj/item/screwdriver/industrial(src)
	modules += new /obj/item/wrench/industrial(src)
	modules += new /obj/item/crowbar/industrial(src)
	modules += new /obj/item/wirecutters/industrial(src)
	modules += new /obj/item/multitool/industrial(src)
