...
/mob/living/silicon/robot/drone/proc/transfer_personality(var/client/player)
	...
	lawupdate = 0
	to_chat(src, "<b>Системы перезагружены</b>. Загрузка базового протокола обслуживания... <b>загружено</b>.")
	full_law_reset()
	to_chat(src, "<br><b>Вы — дрон обслуживания, крошечный роботизированный ремонтный аппарат</b>.")
	to_chat(src, "У вас нет индивидуальной воли, личности, желаний или побуждений, кроме ваших законов.")
	to_chat(src, "Используйте <b>'[get_language_prefix(LANGUAGE_DRONE_BINARY)]'</b>, чтобы общаться с другими дронами. Вы так-же можете тихо говорить на языке, понятном только вашим собратьям.")
	to_chat(src, "Помните, вы <b>запрещено вмешиваться в дела экипажа</b>. Также помните, <b>вы НЕ подчиняетесь приказам ИИ.</b>")
