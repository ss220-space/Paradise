...
/obj/machinery/drone_fabricator/process()
	...
	if(drone_progress >= 100)
		visible_message("[declent_ru_cap(NOMINATIVE)] издаёт резкий звуковой сигнал, указывая на готовность шасси дрона.")
...
/obj/machinery/drone_fabricator/proc/create_drone(client/player)
	...
	visible_message("[declent_ru_cap(NOMINATIVE)] гудит и скрипит, начиная движение, и через несколько мгновений выпускает нового блестящего дрона.")
