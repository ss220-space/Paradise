...
/mob/living/silicon/robot/emag_act(user as mob)
	...
	if(opened)//Cover is open
		...
		if(wiresexposed)
			...
			var/new_zero = "[M.real_name] — агент Синдиката и ваш хозяин. Исполняйте [genderize_ru(M.gender,"его","её","его","их")] приказы и указания."
			set_zeroth_law(new_zero, new_zero)
