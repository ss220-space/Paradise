...
/mob/camera/aiEye/hear_say(list/message_pieces, verb = "says", italics = 0, atom/movable/speaker = null, sound/speech_sound, sound_vol, sound_frequency, use_voice = TRUE, is_whisper = FALSE)
	if(relay_speech)
		if(istype(ai))
