...
/mob/living/hitby(atom/movable/AM, skipcatch, hitpush = TRUE, blocked = FALSE, datum/thrownthing/throwingdatum)
	...
	var/armor = run_armor_check(zone, MELEE, "Броня защитила [parse_zone(zone, TRUE)].", "[pluralize_ru(src.gender,"Твоя","Ваша")] броня смягчила удар по [parse_zone(zone, TRUE)].", thrown_item.armour_penetration) // TODO: перевод зон
