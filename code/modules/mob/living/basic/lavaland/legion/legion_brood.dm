...
/mob/living/basic/mining/legion_brood/Initialize(mapload)
	...
	// AddComponent(/datum/component/clickbox, icon_state = "sphere", max_scale = 2) Похуй потом
...
/mob/living/basic/mining/legion_brood/melee_attack(mob/living/target, list/modifiers, ignore_cooldown)
	...
	if(isliving(target) && faction_check_mob(target) && !istype(target, mob_creator?.type))
...
/mob/living/basic/mining/legion_brood/advanced
	ai_controller = /datum/ai_controller/basic_controller/legion_brood/advanced
