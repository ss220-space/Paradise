...
/mob/living/basic/mining/legion/monkey
	...
	// icon_state = "legion_monkey" // Похуй потом Спрайт не родился
	...
	corpse_type = /obj/effect/mob_spawn/human/corpse/damaged/legioninfested/monkey
	ai_controller = /datum/ai_controller/basic_controller/legion_monkey

/mob/living/basic/mining/legion/monkey/Initialize(mapload)
	. = ..()
	// ADD_TRAIT(src, TRAIT_VENTCRAWLER_ALWAYS, INNATE_TRAIT) // Похуй потом
