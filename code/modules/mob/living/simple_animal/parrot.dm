...
/mob/living/simple_animal/parrot/show_inv(mob/user as mob)
	...
	if(can_collar)
		dat += "<tr><td>&nbsp;</td></tr>"
		dat += "<tr><td><B>Collar:</B></td><td><A href='?src=[UID()];[inventory_collar ? "remove_inv" : "add_inv"]=collar'>[(inventory_collar && !(inventory_collar.flags&ABSTRACT)) ? inventory_collar : "<font color=grey>Empty</font>"]</A></td></tr>"
