/mob/living/simple_animal/frog
	...
	emote_see = list("лежит расслабленным", "увлажнен", "издает гортанные звуки", "лупает глазками")
...
/mob/living/simple_animal/frog/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/squeak, list("[squeak_sound]" = 1, "[scream_sound]" = 1), 100, extrarange = SHORT_RANGE_SOUND_EXTRARANGE) //as quiet as a frog or whatever
