...
/mob/living/simple_animal/bot/secbot/set_custom_texts()
	...
	text_dehack_fail = "[declent_ru_cap(NOMINATIVE)] отказывается признавать вашу власть!"
...
/mob/living/simple_animal/bot/secbot/proc/stun_attack(mob/living/carbon/C)
	...
	C.visible_message(span_danger("[declent_ru_cap(NOMINATIVE)] [harmbaton ? "ударил" : "оглушил"] [C]!"),
					span_userdanger("[declent_ru_cap(NOMINATIVE)] [harmbaton ? "ударил" : "оглушил"] вас!"))
