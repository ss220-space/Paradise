...
/mob/living/simple_animal/hostile/netherworld/migo/say(message, verb = "says", sanitize = TRUE, ignore_speech_problems = FALSE, ignore_atmospherics = FALSE, ignore_languages = FALSE)
	. = ..()
	if(stat)
		return
...
/obj/structure/spawner/nether/examine(mob/user)
	. = ..()
	if(isskeleton(user))
		. += span_notice("A direct link to another dimension full of creatures very happy to see you.</span> <span class='nicegreen'>You can see your house from here!</span>"
	else
		. += span_notice("A direct link to another dimension full of creatures not very happy to see you.</span> <span class='warning'>Entering the link would be a very bad idea.")
