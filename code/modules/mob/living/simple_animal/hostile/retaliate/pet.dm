/mob/living/simple_animal/hostile/retaliate/araneus
	...
	desc = "Свирепый компаньон любого влиятельного лица, этот паук был тщательно обучен специалистами Нанотрасен. Его пристальные глаза-бусинки вызывают мурашки у вас по спине."
