...
/obj/item/clothing/suit/hooded/explorer/blood
	...
	armor = list(MELEE = 55, BULLET = 15, LASER = 10, ENERGY = 10, BOMB = 75, BIO = 100, RAD = 50, FIRE = 100, ACID = 100)
...
/obj/item/clothing/head/hooded/explorer/blood
	...
	armor = list(MELEE = 55, BULLET = 10, LASER = 5, ENERGY = 10, BOMB = 75, BIO = 100, RAD = 50, FIRE = 100, ACID = 100)
