...
/mob/living/simple_animal/hostile/megafauna/hierophant/proc/blink(mob/victim) //blink to a target
	...
	visible_message(span_hierophant_warning("[src.declent_ru(NOMINATIVE)] растворяется в воздухе!"))
	...
	visible_message(span_hierophant_warning("[src.declent_ru(NOMINATIVE)] материализуется!"))
