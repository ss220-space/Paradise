...
/mob/living/simple_animal/hostile/megafauna/bubblegum/Bump(atom/bumped_atom)
	...
	bumped_living.visible_message(span_danger("[declent_ru_cap(NOMINATIVE)] врезается в [bumped_living.declent_ru(ACCUSATIVE)]!"), span_userdanger("[declent_ru_cap(NOMINATIVE)] втаптывает вас в землю!"))
