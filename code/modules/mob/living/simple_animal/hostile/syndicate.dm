...
/mob/living/simple_animal/hostile/syndicate/ranged
	...
	loot = list(/obj/effect/mob_spawn/human/corpse/syndicatesoldier, /obj/item/gun/ballistic/automatic/c20r/rusted)
...
/mob/living/simple_animal/hostile/syndicate/ranged/space
	...
	atmos_requirements = list("min_oxy" = 0, "max_oxy" = 0, "min_tox" = 0, "max_tox" = 0, "min_co2" = 0, "max_co2" = 0, "min_n2" = 0, "max_n2" = 0)
	speed = 1
	loot = list(/obj/effect/mob_spawn/human/corpse/syndicatecommando, /obj/item/gun/ballistic/automatic/c20r/rusted)
