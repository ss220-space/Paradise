...
/mob/living/simple_animal/hostile/winter/santa/stage_1		//stage 1: slow melee
	...
	death_message = span_danger("HO HO HO! YOU THOUGHT IT WOULD BE THIS EASY?!?</span>"
	speed = 2
...
/mob/living/simple_animal/hostile/winter/santa/stage_2		//stage 2: slow ranged
	...
	death_message = span_danger("YOU'VE BEEN VERY NAUGHTY! PREPARE TO DIE!</span>"
...
/mob/living/simple_animal/hostile/winter/santa/stage_3		//stage 3: fast rapidfire ranged
	...
	death_message = span_danger("FACE MY FINAL FORM AND KNOW DESPAIR!</span>"
	maxHealth = 250
	health = 250
	ranged = 1
	rapid = 3
