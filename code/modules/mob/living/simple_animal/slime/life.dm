...
/mob/living/simple_animal/slime
	...
	var/static/list/follow_commands = list("follow", "пошли", "пойдём", "за мной", "идём")
	var/static/list/stop_commands = list("stop", "фу", "нельзя", "хватит", "перестань")
	...
	var/static/list/no_follow_phrases = list("Нет...", "Не пойду...", "Не хочу...")
