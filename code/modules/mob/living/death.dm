...
/mob/living/proc/delayed_gib()
	visible_message(span_danger("<b>[src.declent_ru(NOMINATIVE)]</b> дико сотрясается в мучительных спазмах!"), span_userdanger("Каждая клетка вашего тела кричит от невыносимой боли!"))
	Weaken(30 SECONDS)
