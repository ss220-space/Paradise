...
/mob/living/proc/delayed_gib()
	visible_message(span_danger("<b>[declent_ru_cap(NOMINATIVE)]</b> дико сотрясается в мучительных спазмах!"), span_userdanger("Каждая клетка вашего тела кричит от невыносимой боли!"))
	Weaken(30 SECONDS)
