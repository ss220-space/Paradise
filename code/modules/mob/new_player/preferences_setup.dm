		...
		switch(job_support_high)
			...
			if(JOB_CLOWN)
				...
				switch(backbag)
					...
					if(3)
						clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-clown"), ICON_OVERLAY)
					if(4)
						clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel"), ICON_OVERLAY)
			if(JOB_MIME)
				...
				switch(backbag)
					...
					if(3)
						clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-mime"), ICON_OVERLAY)
					if(4)
						clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel"), ICON_OVERLAY)
			...
			if(JOB_DETECTIVE)
				...
				switch(backbag)
					if(2)
						clothes_s.Blend(new /icon('icons/mob/back.dmi', "backpack"), ICON_OVERLAY)
					if(3)
						clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel-detective"), ICON_OVERLAY)
					if(4)
						clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel"), ICON_OVERLAY)
			if(JOB_OFFICER)
