...
/datum/preferences/proc/update_preview_icon(for_observer = FALSE)	// seriously. This is horrendous.
	...
	var/uniform_dmi='icons/mob/clothing/jumpsuit.dmi'
	if(job_support_low & JOB_FLAG_CIVILIAN)//This gives the preview icon clothes depending on which job(if any) is set to 'high'
		...
		switch(job_support_high)
			...
			if(JOB_FLAG_BOTANIST)
				...
				clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
				clothes_s.Blend(new /icon('icons/mob/clothing/gloves.dmi', "ggloves"), ICON_UNDERLAY)
			...
			if(JOB_FLAG_QUARTERMASTER)
				...
				clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "brown"), ICON_UNDERLAY)
				clothes_s.Blend(new /icon('icons/mob/clothing/gloves.dmi', "bgloves"), ICON_UNDERLAY)
				if(prob(1))
			...
			if(JOB_FLAG_MIME)
				...
				clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "black"), ICON_UNDERLAY)
				clothes_s.Blend(new /icon('icons/mob/clothing/gloves.dmi', "lgloves"), ICON_UNDERLAY)
		...
		switch(job_engsec_high)
			...
			if(JOB_FLAG_WARDEN)
				...
				if(prob(1))
					clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "slippers_worn"), ICON_OVERLAY)
				else
					clothes_s.Blend(new /icon('icons/mob/clothing/shoes.dmi', "jackboots"), ICON_UNDERLAY)
				clothes_s.Blend(new /icon('icons/mob/clothing/gloves.dmi', "bgloves"), ICON_UNDERLAY)
				switch(backbag)
	...
	if(disabilities & DISABILITY_FLAG_NEARSIGHTED)
		preview_icon.Blend(new /icon('icons/mob/clothing/glasses.dmi', "glasses"), ICON_OVERLAY)
