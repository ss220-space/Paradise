...
/datum/language/grey/check_can_speak(mob/living/speaker)
	...
	speaker.visible_message( span_notice("[speaker] прикладывает пальцы к виску.")) //If placed in grey/broadcast, it will happen regardless of the success of the action.
