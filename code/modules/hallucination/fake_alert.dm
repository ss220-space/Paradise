...
/datum/hallucination/fake_alert/need_plasma
	alert_category = ALERT_NOT_ENOUGH_TOX
...
/datum/hallucination/fake_alert/bad_plasma
	alert_category = ALERT_TOO_MUCH_TOX
