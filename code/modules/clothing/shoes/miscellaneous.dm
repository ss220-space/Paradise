...
/obj/item/clothing/shoes/galoshes
	...
	put_on_delay = 50
	resistance_flags = NONE
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 15, ACID = 75)
...
/obj/item/clothing/shoes/jackboots/armored
	...
	armor = list(MELEE = 5, BULLET = 20, LASER = 5, ENERGY = 5, BOMB = 5, BIO = 0, RAD = 0, FIRE = 50, ACID = 50)
	sprite_sheets = list(
		SPECIES_VOX = 'icons/mob/clothing/species/vox/shoes.dmi',
		SPECIES_DRASK = 'icons/mob/clothing/species/drask/shoes.dmi',
		SPECIES_MONKEY = 'icons/mob/clothing/species/monkey/shoes.dmi',
...
/obj/item/clothing/shoes/cowboy/lizard
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 15, ACID = 0) //lizards like to stay warm
...
/obj/item/clothing/shoes/footwraps/goliath
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 5, ENERGY = 5, BOMB = 5, BIO = 0, RAD = 0, FIRE = 15, ACID = 0)
	resistance_flags = FIRE_PROOF
	paintable = FALSE
...
/obj/item/clothing/shoes/footwraps/dragon
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 5, ENERGY = 8, BOMB = 0, BIO = 0, RAD = 0, FIRE = 25, ACID = 5)
	resistance_flags = FIRE_PROOF | ACID_PROOF
	paintable = FALSE
