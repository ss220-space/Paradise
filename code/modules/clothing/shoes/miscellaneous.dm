...
/obj/item/clothing/shoes/combat //basic syndicate combat boots for nuke ops and mob corpses
	...
	armor = list(PIERCING = 25, SLASHING = 25, BLUNT = 25, ABSORPTION = 11, LASER = 25, ENERGY = 25, BOMB = 50, BIO = 10, FIRE = 70, ACID = 50)
	strip_delay = 70
...
/obj/item/clothing/shoes/combat/swat //overpowered boots for death squads
	...
	armor = list(PIERCING = 30, SLASHING = 40, BLUNT = 40, ABSORPTION = 16, LASER = 25, ENERGY = 25, BOMB = 50, BIO = 30, FIRE = 90, ACID = 50)
...
/obj/item/clothing/shoes/galoshes
	...
	put_on_delay = 50
	resistance_flags = NONE
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 5, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 40, ACID = 75)
...
/obj/item/clothing/shoes/jackboots/armored
	...
	armor = list(PIERCING = 25, SLASHING = 5, BLUNT = 5, ABSORPTION = 40, LASER = 10, ENERGY = 5, BOMB = 5, BIO = 0, FIRE = 75, ACID = 75)
	sprite_sheets = list(
		SPECIES_VOX = 'icons/mob/clothing/species/vox/shoes.dmi',
		SPECIES_DRASK = 'icons/mob/clothing/species/drask/shoes.dmi',
		SPECIES_MONKEY = 'icons/mob/clothing/species/monkey/shoes.dmi',
...
/obj/item/clothing/shoes/cowboy/lizard
	...
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 5, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 40, ACID = 0) //lizards like to stay warm
...
/obj/item/clothing/shoes/footwraps/goliath
	...
	armor = list(PIERCING = 10, SLASHING = 10, BLUNT = 10, ABSORPTION = 12, LASER = 15, ENERGY = 5, BOMB = 10, BIO = 0, FIRE = 10, ACID = 0)
	resistance_flags = FIRE_PROOF
	paintable = FALSE
...
/obj/item/clothing/shoes/footwraps/dragon
	...
	armor = list(PIERCING = 10, SLASHING = 10, BLUNT = 10, ABSORPTION = 6, LASER = 15, ENERGY = 10, BOMB = 0, BIO = 10, FIRE = 15, ACID = 0)
	resistance_flags = FIRE_PROOF | ACID_PROOF
	paintable = FALSE
