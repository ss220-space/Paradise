...
/obj/item/clothing/head/beret/minmed
	...
	ru_names = list(
		NOMINATIVE = "берет шахтерского врача",
		GENITIVE = "берета шахтерского врача",
		DATIVE = "берету шахтерского врача",
		ACCUSATIVE = "берет шахтерского врача",
		INSTRUMENTAL = "беретом шахтерского врача",
		PREPOSITIONAL = "берете шахтерского врача"
	)
