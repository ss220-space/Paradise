...
/obj/item/clothing/head/det_hat
	...
	armor = list(MELEE = 25, BULLET = 0, LASER = 0, ENERGY = 10, BOMB = 0, BIO = 0, RAD = 0, FIRE = 30, ACID = 50)
...
/obj/item/clothing/head/beret/durathread
	...
	item_color = null
	armor = list(MELEE = 15, BULLET = 0, LASER = 0, ENERGY = 5, BOMB = 10, BIO = 0, RAD = 0, FIRE = 30, ACID = 5)
