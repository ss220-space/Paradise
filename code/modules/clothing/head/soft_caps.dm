...
/obj/item/clothing/head/soft/sec
	...
	item_color = "sec"
	item_state = "secsoft"
	armor = list(MELEE = 25, BULLET = 5, LASER = 15, ENERGY = 10, BOMB = 0, BIO = 0, RAD = 0, FIRE = 20, ACID = 50)
	strip_delay = 60
	dog_fashion = null
...
/obj/item/clothing/head/soft/solgov/elite
	...
	armor = list(MELEE = 30, BULLET = 5, LASER = 15, ENERGY = 10, BOMB = 5, BIO = 10, RAD = 0, FIRE = 50, ACID = 60)
