...
/obj/item/clothing/head/centhat
	...
	item_state = "centhat"
	armor = list(PIERCING = 15, SLASHING = 30, BLUNT = 30, ABSORPTION = 26, LASER = 30, ENERGY = 10, BOMB = 25, BIO = 0, FIRE = 50, ACID = 50)
	strip_delay = 80
...
/obj/item/clothing/head/beret/centcom/officer
	...
	armor = list(PIERCING = 30, SLASHING = 40, BLUNT = 40, ABSORPTION = 40, LASER = 30, ENERGY = 10, BOMB = 25, BIO = 0, FIRE = 20, ACID = 50)
	strip_delay = 60
...
/obj/item/clothing/head/crown
	...
	icon_state = "crown"
	armor = list(PIERCING = 0, SLASHING = 15, BLUNT = 15, ABSORPTION = 12, LASER = 0, ENERGY = 15, BOMB = 0, BIO = 0, FIRE = 100, ACID = 50)
...
/obj/item/clothing/head/scorched_skull
	...
	armor = list(PIERCING = 10, SLASHING = 50, BLUNT = 50, ABSORPTION = 34, LASER = 10, ENERGY = 10, BOMB = 10, BIO = 0, FIRE = 60, ACID = 60)
