...
/obj/item/clothing/under/plasmaman/chameleon
	...
	resistance_flags = NONE
	random_sensor = FALSE
	armor = list(PIERCING = 10, SLASHING = 10, BLUNT = 10, ABSORPTION = 10, LASER = 10, ENERGY = 0, BOMB = 0, BIO = 100, FIRE = 95, ACID = 95)
	actions_types = list(/datum/action/item_action/chameleon/change/jumpsuit)
...
/obj/item/clothing/suit/chameleon
	...
	resistance_flags = NONE
	armor = list(PIERCING = 10, SLASHING = 10, BLUNT = 10, ABSORPTION = 12, LASER = 10, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 50, ACID = 50)
...
/obj/item/clothing/gloves/chameleon
	...
	item_state = "ygloves"
	resistance_flags = NONE
	armor = list(PIERCING = 10, SLASHING = 10, BLUNT = 10, ABSORPTION = 6, LASER = 10, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 50, ACID = 50)
...
/obj/item/clothing/head/chameleon
	...
	item_color = "grey"
	resistance_flags = NONE
	armor = list(PIERCING = 5, SLASHING = 5, BLUNT = 5, ABSORPTION = 12, LASER = 5, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 50, ACID = 50)
...
/obj/item/clothing/mask/chameleon
	...
	item_state = "gas_alt"
	resistance_flags = NONE
	armor = list(PIERCING = 5, SLASHING = 5, BLUNT = 5, ABSORPTION = 5, LASER = 5, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 50, ACID = 50)
