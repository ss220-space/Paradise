...
/obj/item/clothing/neck/cloak/sec_cape
	...
	desc = "Темная вытянутая накидка из армированной ткани с красной окантовкой. На заклепке виднеется логотип НТ. Красная окантовка выполнена из материала, что темнеет при контакте с кровью...правда вы все равно этого не заметите покуда будете ходить в крови с ног до головы."
	icon_state = "sec_cape"
...
/obj/item/clothing/neck/cloak/hos_cape
	...
	desc = "Накидка из матовой ткани, почти не отражающая свет. Заклепка выглядит как медаль за проявленный героизм. Края накидки у ног выглядят так будто их выжигали кислотой. Пахнет напалмом. Изнутри накидки золотыми нитями вышито \"Gloria dei T.S.F.\"."
	icon_state = "hos_cape"
