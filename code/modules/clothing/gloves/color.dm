...
/obj/item/clothing/gloves/color/black/goliath
	...
	armor = list(PIERCING = 10, SLASHING = 20, BLUNT = 20, ABSORPTION = 12, LASER = 10, ENERGY = 5, BOMB = 0, BIO = 0, FIRE = 50, ACID = 50)
	can_be_cut = FALSE
...
/obj/item/clothing/gloves/color/black/ballistic
	...
	armor = list(PIERCING = 25, SLASHING = 5, BLUNT = 5, ABSORPTION = 7, LASER = 10, ENERGY = 5, BOMB = 5, BIO = 0, FIRE = 75, ACID = 75)
	can_be_cut = FALSE
	sprite_sheets = list(
...
/obj/item/clothing/gloves/color/captain
	...
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	strip_delay = 60
	armor = list(PIERCING = 15, SLASHING = 15, BLUNT = 15, ABSORPTION = 12, LASER = 15, ENERGY = 30, BOMB = 30, BIO = 30, FIRE = 75, ACID = 75)
