...
/obj/item/clothing/gloves/color/black/goliath
	...
	armor = list(MELEE = 20, BULLET = 0, LASER = 0, ENERGY = 5, BOMB = 0, BIO = 0, RAD = 20, FIRE = 50, ACID = 50)
	can_be_cut = FALSE
...
/obj/item/clothing/gloves/color/black/ballistic
	...
	armor = list(MELEE = 5, BULLET = 5, LASER = 0, ENERGY = 5, BOMB = 5, BIO = 0, RAD = 0, FIRE = 75, ACID = 75)
	can_be_cut = FALSE
	sprite_sheets = list(
...
/obj/item/clothing/gloves/color/captain
	...
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	strip_delay = 60
	armor = list(MELEE = 15, BULLET = 5, LASER = 0, ENERGY = 30, BOMB = 30, BIO = 30, RAD = 30, FIRE = 75, ACID = 75)
