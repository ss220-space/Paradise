...
/obj/item/clothing/gloves/color/latex
	name = "latex gloves"
	desc = "Дешёвые стерильные перчатки белого цвета, изготовленные из натурального латекса. \
			Обеспечивают защиту от биологических загрязнений и вредных веществ."
	ru_names = list(
...
/obj/item/clothing/gloves/color/latex/nitrile
	...
	desc = "Высокопрочные стерильные перчатки, изготовленные из синтетического нитрила. \
			Обеспечивают защиту от биологических загрязнений и вредных веществ. \
			За счёт плотности материала не оставляют отпечатков пальцев, что делает их \
			предпочтительным вариантом для врачей и криминалистов."
	ru_names = list(
...
/obj/item/clothing/gloves/color/latex/modified
	...
	desc = "Передовые медицинские перчатки, созданные из сверхтонкого гибридного полимера, \
			сочетающего эластичность латекса и прочность нитрила. \
			Обеспечивают защиту от биологических загрязнений и вредных веществ. \
			Благодаря своей повышенной гибкости, они обеспечивают удобство и повышенную точность \
			при работе руками, что делает их предпочтительным выбором для медицинского персонала и хирургов в особенности."
	ru_names = list(
...
/obj/item/clothing/gloves/color/latex/inugami
	...
	desc = "Перчатки медицинского назначения серии Inugami — высокотехнологичный прототип, разработанный для использования хирургами. \
			Изготовлены из полимерного материала, обеспечивающего защиту от биологических загрязнений и вредных веществ. \
			Перчатки оборудованы встроенными наночипами, а также биометрической системой обратной связи, \
			которые вкупе усиливают тактильное восприятие тканей пользователя и позволяют более точно контролировать движение рук. \
			Благодаря этому скорость выполнения хирургических операций существенно возрастает."
	ru_names = list(
