...
/obj/item/clothing/gloves/color/black/goliath
	...
	armor = list(MELEE = 20, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, RAD = 20, FIRE = 50, ACID = 50)
	can_be_cut = FALSE
...
/obj/item/clothing/gloves/color/black/ballistic
	...
	armor = list(MELEE = 5, BULLET = 20, LASER = 5, ENERGY = 5, BOMB = 5, BIO = 0, RAD = 0, FIRE = 75, ACID = 75)
	can_be_cut = FALSE
	sprite_sheets = list(
