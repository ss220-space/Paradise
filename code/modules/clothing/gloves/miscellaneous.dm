...
/obj/item/clothing/gloves/combat
	...
	armor = list(PIERCING = 5, SLASHING = 25, BLUNT = 25, ABSORPTION = 7, LASER = 5, ENERGY = 10, BOMB = 10, BIO = 0, FIRE = 70, ACID = 70)
...
/obj/item/clothing/gloves/bracer
	...
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	resistance_flags = NONE
	armor = list(PIERCING = 15, SLASHING = 10, BLUNT = 10, ABSORPTION = 6, LASER = 10, ENERGY = 10, BOMB = 15, BIO = 10, FIRE = 0, ACID = 0)
...
/obj/item/clothing/gloves/botanic_leather
	...
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	resistance_flags = NONE
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 5, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 70, ACID = 30)
...
/obj/item/clothing/gloves/color/black/razorgloves/Touch(atom/A, proximity)
	...
	if(ishuman(A))
		...
		target.apply_kinetic_attack(damage, affecting, SLASHING, 0, damage, 0, src, BRUTE)
		return TRUE
	...
	if(isobj(A) && !isitem(A))
		...
		obj.take_damage(damage, BRUTE, SLASHING, 1, get_dir(src, user))
		return TRUE
...
/obj/item/clothing/gloves/knuckles
	...
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 5, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 100, ACID = 0)
	sprite_sheets = list(
...
/obj/item/clothing/gloves/combat/swat
	...
	armor = list(PIERCING = 15, SLASHING = 15, BLUNT = 15, ABSORPTION = 7, LASER = 15, ENERGY = 15, BOMB = 15, BIO = 0, FIRE = 75, ACID = 75)
	sprite_sheets = list(
		SPECIES_VOX = 'icons/mob/clothing/species/vox/gloves.dmi',
		SPECIES_DRASK = 'icons/mob/clothing/species/drask/gloves.dmi',
		SPECIES_GREY = 'icons/mob/clothing/species/grey/gloves.dmi',
...
/obj/item/clothing/gloves/reflector
	...
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 20, LASER = 50, ENERGY = 50, BOMB = 0, BIO = 0, FIRE = 50, ACID = 100)
...
/obj/item/clothing/head/helmet/reflector
	...
	dog_fashion = null
	armor = list(PIERCING = 10, SLASHING = 10, BLUNT = 10, ABSORPTION = 20, LASER = 60, ENERGY = 60, BOMB = 0, BIO = 0, FIRE = 90, ACID = 100)
	resistance_flags = INDESTRUCTIBLE | LAVA_PROOF | FIRE_PROOF | ACID_PROOF
	sprite_sheets = list(
