...
/obj/item/clothing/head/helmet/reflector
	...
	sprite_sheets = list(
		...
		SPECIES_MONKEY = 'icons/mob/clothing/species/monkey/helmet.dmi',
		SPECIES_FARWA = 'icons/mob/clothing/species/monkey/helmet.dmi',
		SPECIES_WOLPIN = 'icons/mob/clothing/species/monkey/helmet.dmi',
		SPECIES_NEARA = 'icons/mob/clothing/species/monkey/helmet.dmi',
		SPECIES_STOK = 'icons/mob/clothing/species/monkey/helmet.dmi',
