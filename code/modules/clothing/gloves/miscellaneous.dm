...
/obj/item/clothing/gloves/reflector
	...
	desc = "Созданные из твёрдых сплавов перчатки, способные с высокой эффективностью отражать выстрелы лазеров. Носить эти перчатки крайне неудобно!"
	ru_names = list(
		NOMINATIVE = "светоотражающие перчатки",
		GENITIVE = "светоотражающих перчаток",
		DATIVE = "светоотражающим перчаткам",
		ACCUSATIVE = "светоотражающие перчатки",
		INSTRUMENTAL = "светоотражающими перчатками",
		PREPOSITIONAL = "светоотражающих перчатках"
	)
...
/obj/item/clothing/head/helmet/reflector
	...
	ru_names = list(
		NOMINATIVE = "светоотражающая шляпа",
		GENITIVE = "светоотражающей шляпы",
		DATIVE = "светоотражающей шляпе",
		ACCUSATIVE = "светоотражающую шляпу",
		INSTRUMENTAL = "светоотражающей шляпой",
		PREPOSITIONAL = "светоотражающей шляпе"
	)
	icon_state = "reflector"
	item_state = "reflector"
...
/obj/item/clothing/shoes/reflector
	...
	desc = "Довольно лёгкая, хоть и неудобная обувь, изготовленная из сплавов инновационных материалов. Впрочем, вряд ли она защитит от чего-то серьёзнее лазеров."
	ru_names = list(
		NOMINATIVE = "светоотражающие ботинки",
		GENITIVE = "светоотражающих ботинок",
		DATIVE = "светоотражающим ботинкам",
		ACCUSATIVE = "светоотражающие ботинки",
		INSTRUMENTAL = "светоотражающими ботинками",
		PREPOSITIONAL = "светоотражающих ботинках"
	)
	icon_state = "reflector"
	item_state = "reflector"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 50, "energy" = 50, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 100)
