...
/obj/item/clothing/gloves/combat
	...
	armor = list(MELEE = 25, BULLET = 2, LASER = 2, ENERGY = 5, BOMB = 5, BIO = 0, RAD = 0, FIRE = 70, ACID = 70)
...
/obj/item/clothing/gloves/bracer
	...
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	resistance_flags = NONE
	armor = list(MELEE = 25, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 20, BIO = 10, RAD = 0, FIRE = 0, ACID = 0)
...
/obj/item/clothing/gloves/knuckles
	...
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 10, ACID = 0)
	sprite_sheets = list(
...
/obj/item/clothing/gloves/combat/swat
	...
	armor = list(MELEE = 15, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 15, BIO = 0, RAD = 0, FIRE = 75, ACID = 75)
	sprite_sheets = list(
		SPECIES_VOX = 'icons/mob/clothing/species/vox/gloves.dmi',
		SPECIES_DRASK = 'icons/mob/clothing/species/drask/gloves.dmi',
		SPECIES_GREY = 'icons/mob/clothing/species/grey/gloves.dmi',
...
/obj/item/clothing/head/helmet/reflector
	...
	dog_fashion = null
	armor = list(MELEE = 10, BULLET = 0, LASER = 60, ENERGY = 60, BOMB = 0, BIO = 0, RAD = 0, FIRE = 90, ACID = 100)
	resistance_flags = INDESTRUCTIBLE | LAVA_PROOF | FIRE_PROOF | ACID_PROOF
	sprite_sheets = list(
