/obj/item/clothing/mask/breath
	name = "breath mask"
	desc = "Стандартная дыхательная маска, выполненная из полимерного материала с уплотнённым ободком для герметичности. \
			...
			Обладает средней степенью проницаемости веществ и минимальным коэффициентом передачи атмосферных газов."
	ru_names = list(
...
/obj/item/clothing/mask/breath/medical
	name = "medical mask"
	desc = "Стерильная медицинская маска, выполненная из полимерного материала повышенной герметичности. \
			Обладает минимальным коэффициентом передачи атмосферных газов и практически не пропускает вредные вещества. \
...
/obj/item/clothing/mask/breath/vox
	...
	desc = "Специализированная дыхательная маска, созданная с учётом анатомии воксов. \
			Ношение представителями других рас невозможно. \
			Выполнена из полимерного материала с уплотнённым ободком для герметичности. \
			Предназначена для защиты дыхательных путей от загрязнённого воздуха и обеспечения подачи дыхательной смеси через подключение к баллону с газом. \
			Обладает минимальным коэффициентом передачи атмосферных газов и практически не пропускает вредные вещества."
	ru_names = list(
