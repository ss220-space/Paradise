...
/obj/item/clothing/mask/gas/explorer
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 50, RAD = 0, FIRE = 30, ACID = 40)
	resistance_flags = FIRE_PROOF
	can_toggle = TRUE
...
/obj/item/clothing/mask/gas/plaguedoctor
	...
	item_state = "gas_mask"
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 75, RAD = 0, FIRE = 0, ACID = 0)
...
/obj/item/clothing/mask/gas/swat
	...
	gender = FEMALE
	icon_state = "swat"
	armor = list(MELEE = 15, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 15, BIO = 50, RAD = 0, FIRE = 100, ACID = 50)
...
/obj/item/clothing/mask/gas/sechailer/tactical
	...
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 50, RAD = 0, FIRE = 10, ACID = 30)
	aggressiveness = 3
	phrase = 12
	can_toggle = FALSE
...
/obj/item/clothing/mask/gas/sechailer/hos
	...
	icon_state = "hosmask"
	armor = list(MELEE = 10, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 10, BIO = 50, RAD = 0, FIRE = 100, ACID = 50)
	aggressiveness = 3
	phrase = 12
	can_toggle = FALSE
	actions_types = list(/datum/action/item_action/halt, /datum/action/item_action/selectphrase)
...
/obj/item/clothing/mask/gas/sechailer/warden
	...
	armor = list(MELEE = 10, BULLET = 3, LASER = 3, ENERGY = 3, BOMB = 10, BIO = 50, RAD = 0, FIRE = 100, ACID = 50)
	aggressiveness = 3
	phrase = 12
	can_toggle = FALSE
	actions_types = list(/datum/action/item_action/halt, /datum/action/item_action/selectphrase)
...
/obj/item/clothing/mask/gas/ghostface/true
	armor = list(melee = 20, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 0, rad = 0, fire = 10, acid = 10)
