...
/obj/item/clothing/mask/gas/mining_medic
	...
	ru_names = list(
		NOMINATIVE = "шахтерский респиратор",
		GENITIVE = "шахтерского респиратора",
		DATIVE = "шахтерскому респиратору",
		ACCUSATIVE = "шахтерский респиратор",
		INSTRUMENTAL = "шахтерским респиратоом",
		PREPOSITIONAL = "шахтерском распираторе"
	)
	flags_inv = HIDENAME
	flags_cover = MASKCOVERSMOUTH
