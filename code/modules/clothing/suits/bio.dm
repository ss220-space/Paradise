...
/obj/item/clothing/head/bio_hood
	...
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 10, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 100, FIRE = 30, ACID = 100)
...
/obj/item/clothing/head/bio_hood/security
	armor = list(PIERCING = 15, SLASHING = 25, BLUNT = 25, ABSORPTION = 10, LASER = 25, ENERGY = 10, BOMB = 25, BIO = 100, FIRE = 30, ACID = 100)
