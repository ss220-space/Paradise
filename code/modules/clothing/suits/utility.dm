...
/obj/item/clothing/suit/fire
	...
	slowdown = 1
	armor = list(PIERCING = 5, SLASHING = 15, BLUNT = 15, ABSORPTION = 22, LASER = 20, ENERGY = 10, BOMB = 20, BIO = 10, FIRE = 100, ACID = 50)
...
/obj/item/clothing/head/bomb_hood
	...
	icon_state = "bombsuit"
	armor = list(PIERCING = 0, SLASHING = 20, BLUNT = 20, ABSORPTION = 28, LASER = 20, ENERGY = 10, BOMB = 100, BIO = 0, FIRE = 80, ACID = 50)
...
/obj/item/clothing/head/radiation
	...
	flags_inv = HIDEHAIR|HIDEMASK|HIDEHEADSETS|HIDEGLASSES
	flags_cover = HEADCOVERSEYES|HEADCOVERSMOUTH
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 5, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 60, FIRE = 30, ACID = 30)
	strip_delay = 60
	put_on_delay = 60
	resistance_flags = NONE
