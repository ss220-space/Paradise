...
/obj/item/clothing/suit/armor/laserproof
	...
	desc = "Экспериментальный прототип лазеро-отражающей брони. Устаревшая аммуниция, была списана с вооружения Нанотрейзен."
	ru_names = list(
...
/obj/item/clothing/suit/armor/reflector
	name = "reflector coat"
	desc = "Передовая разработка Нанотрейзен в сфере защиты от лазерного излучения: высокотехнологичное пальто, отражающее половину попадающих лучей без риска для владельца."
	ru_names = list(
