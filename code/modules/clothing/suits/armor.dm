/obj/item/clothing/suit/armor
	...
	armor = list(MELEE = 20, BULLET = 20, LASER = 20, ENERGY = 20, BOMB = 25, BIO = 0, RAD = 0, FIRE = 50, ACID = 50)
	sprite_sheets = list(
...
/obj/item/clothing/suit/armor/secjacket
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
	armor = list(melee = 15, bullet = 15, laser = 35, energy = 10, bomb = 25, bio = 0, rad = 0, fire = 50, acid = 50)
...
/obj/item/clothing/suit/armor/bulletproof
	...
	armor = list(MELEE = 15, BULLET = 40, LASER = 10, ENERGY = 20, BOMB = 40, BIO = 0, RAD = 0, FIRE = 50, ACID = 50)
	strip_delay = 70
	put_on_delay = 50
	sprite_sheets = list(
