...
/obj/item/clothing/suit/hooded/drake
	...
	armor = list(MELEE = 70, BULLET = 10, LASER = 20, ENERGY = 10, BOMB = 70, BIO = 60, RAD = 50, FIRE = 100, ACID = 100)
...
/obj/item/clothing/suit/hooded/goliath
	...
	armor = list(MELEE = 40, BULLET = 5, LASER = 15, ENERGY = 5, BOMB = 35, BIO = 0, RAD = 0, FIRE = 80, ACID = 60) //a fair alternative to bone armor, requiring alternative materials and gaining a suit slot
...
/obj/item/clothing/head/hooded/goliath
	...
	armor = list(MELEE = 40, BULLET = 5, LASER = 15, ENERGY = 5, BOMB = 35, BIO = 0, RAD = 0, FIRE = 80, ACID = 60)
	flags_cover = HEADCOVERSEYES
...
/obj/item/clothing/suit/armor/bone
	...
	blood_overlay_type = "armor"
	armor = list(MELEE = 45, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 40, BIO = 0, RAD = 0, FIRE = 50, ACID = 50)
	allowed = list(/obj/item/flashlight, /obj/item/tank/internals, /obj/item/pickaxe, /obj/item/twohanded/spear, /obj/item/organ/internal/regenerative_core/legion, /obj/item/kitchen/knife/combat/survival, /obj/item/twohanded/kinetic_crusher, /obj/item/hierophant_club, /obj/item/twohanded/fireaxe/boneaxe)
...
/obj/item/clothing/suit/armor/makeshift_armor
	...
	resistance_flags = FIRE_PROOF
	armor = list(MELEE = 8, BULLET = 1, LASER = 1, ENERGY = 5, BOMB = 0, BIO = 0, RAD = 0, FIRE = 0, ACID = 0)
...
/obj/item/clothing/suit/armor/cartilage //parent type, used in order not to copy-paste same lines in 3 same armors
	...
	blood_overlay_type = "armor"
	allowed = list(/obj/item/flashlight, /obj/item/tank/internals, /obj/item/pickaxe, /obj/item/twohanded/spear, /obj/item/organ/internal/regenerative_core/legion, /obj/item/kitchen/knife/combat/survival, /obj/item/twohanded/kinetic_crusher, /obj/item/hierophant_club, /obj/item/twohanded/fireaxe/boneaxe)
	armor = list(MELEE = 50, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 10, BIO = 0, RAD = 0, FIRE = 60, ACID = 60)
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	sprite_sheets = list(
		SPECIES_UNATHI = 'icons/mob/clothing/species/unathi/suit.dmi',
		SPECIES_ASHWALKER_BASIC = 'icons/mob/clothing/species/unathi/suit.dmi',
