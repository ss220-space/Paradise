...
/obj/item/clothing/head/helmet/space
	...
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 18, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 100, FIRE = 80, ACID = 70)
...
/obj/item/clothing/suit/space
	...
	slowdown = 1
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 20, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 100, FIRE = 80, ACID = 70)
