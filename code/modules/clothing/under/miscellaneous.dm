...
/obj/item/clothing/under/solgov/forest/civ
	desc = "Комфортная, воссоздающая военный камуфляж, одежда. Не похоже, что бы она защищала."
	armor = list(melee = 0, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 0, rad = 0, fire = 0, acid = 0)
...
/obj/item/clothing/under/solgov/command/elite
	...
	desc = "Комфортная и удобная униформа спецназа военно-морских сил Транс-Солнечной Федерациии. Имеет дополнительные погоны на плечах."
