...
/obj/item/clothing/under/rank/research_director
	...
	item_state = "g_suit"
	item_color = "director"
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 8, LASER = 0, ENERGY = 0, BOMB = 10, BIO = 10, FIRE = 0, ACID = 35)
...
/obj/item/clothing/under/rank/scientist
	...
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 8, LASER = 0, ENERGY = 0, BOMB = 10, BIO = 0, FIRE = 0, ACID = 0)
...
/obj/item/clothing/under/rank/chemist
	...
	permeability_coefficient = 0.50
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 8, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 10, FIRE = 50, ACID = 65)
