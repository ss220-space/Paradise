...
/obj/item/clothing/under/rank/medical/mining_medic
	...
	desc = "Этот комбинезон обладает специальными знаками, которые обозначают то, что его владелец - шахтерский врач. Он сделан из специальной ткани, предоставляющей некоторую защиту от биологического загрязнения."
	ru_names = list(
		NOMINATIVE = "комбинезон шахтерского врача",
		GENITIVE = "комбинезона шахтерского врача",
		DATIVE = "комбинезону шахтерского врача",
		ACCUSATIVE = "комбинезон шахтерского врача",
		INSTRUMENTAL = "комбинезоном шахтерского врача",
		PREPOSITIONAL = "комбинезоне шахтерского врача"
	)
...
/obj/item/clothing/under/rank/medical/mining_medic/skirt
	...
	desc = "Эта юбка обладает специальными знаками, которые обозначают то, что её владелец - шахтерский врач. Она сделана из специальной ткани, предоставляющей некоторую защиту от биологического загрязнения."
	ru_names = list(
		NOMINATIVE = "комбинезон-юбка шахтерского врача",
		GENITIVE = "комбинезона-юбки шахтерского врача",
		DATIVE = "комбинезону-юбке шахтерского врача",
		ACCUSATIVE = "комбинезон-юбку шахтерского врача",
		INSTRUMENTAL = "комбинезоном-юбкой шахтерского врача",
		PREPOSITIONAL = "комбинезоне-юбке шахтерского врача"
	)
	species_restricted = list("exclude", "lesser form")
...
/obj/item/clothing/under/rank/medical/mining_paramedic
	...
	desc = "Этот комбинезон обладает специальными знаками, которые обозначают то, что его владелец - шахтерский врач. Он сделан из специальной ткани, предоставляющей некоторую защиту от биологического загрязнения."
	ru_names = list(
		NOMINATIVE = "комбинезон шахтерского парамедика",
		GENITIVE = "комбинезона шахтерского парамедика",
		DATIVE = "комбинезону шахтерского парамедика",
		ACCUSATIVE = "комбинезон шахтерского парамедика",
		INSTRUMENTAL = "комбинезоном шахтерского парамедика",
		PREPOSITIONAL = "комбинезоне шахтерского парамедика"
	)
	species_restricted = list("exclude", "lesser form")
...
/obj/item/clothing/under/rank/medical/mining_paramedic/skirt
	...
	desc = "Эта юбка обладает специальными знаками, которые обозначают то, что её владелец - шахтерский врач. Она сделана из специальной ткани, предоставляющей некоторую защиту от биологического загрязнения."
	ru_names = list(
		NOMINATIVE = "комбинезон-юбка шахтерского парамедика",
		GENITIVE = "комбинезона-юбки шахтерского парамедика",
		DATIVE = "комбинезону-юбке шахтерского парамедика",
		ACCUSATIVE = "комбинезон-юбку шахтерского парамедика",
		INSTRUMENTAL = "комбинезоном-юбкой шахтерского парамедика",
		PREPOSITIONAL = "комбинезоне-юбке шахтерского парамедика"
	)
	species_restricted = list("exclude", "lesser form")
