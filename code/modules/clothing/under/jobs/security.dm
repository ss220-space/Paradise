...
/obj/item/clothing/under/rank/head_of_security
	...
	icon_state = "hos"
	item_state = "r_suit"
	armor = list(PIERCING = 0, SLASHING = 10, BLUNT = 10, ABSORPTION = 10, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 50, ACID = 50)
	strip_delay = 60
...
/obj/item/clothing/under/rank/security/brigphys
	...
	armor = list(PIERCING = 0, SLASHING = 10, BLUNT = 10, ABSORPTION = 10, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 10, FIRE = 30, ACID = 30)
