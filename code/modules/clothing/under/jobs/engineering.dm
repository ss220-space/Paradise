...
/obj/item/clothing/under/rank/chief_engineer
	...
	icon_state = "chief"
	item_state = "chief"
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 8, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 80, ACID = 40)
...
/obj/item/clothing/under/rank/engineer
	...
	item_color = "engine"
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 8, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 60, ACID = 20)
	resistance_flags = NONE
