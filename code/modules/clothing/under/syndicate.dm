/obj/item/clothing/under/syndicate
	...
	has_sensor = 0
	armor = list(PIERCING = 0, SLASHING = 10, BLUNT = 10, ABSORPTION = 10, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 50, ACID = 40)
...
/obj/item/clothing/under/syndicate/tacticool
	...
	has_sensor = TRUE
	armor = list(PIERCING = 0, SLASHING = 0, BLUNT = 0, ABSORPTION = 8, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 50, ACID = 40)
...
/obj/item/clothing/under/syndicate/blackops
	...
	icon_state = "blackops"
	item_state = "blackops"
	armor = list(PIERCING = 10, SLASHING = 10, BLUNT = 10, ABSORPTION = 10, LASER = 15, ENERGY = 0, BOMB = 10, BIO = 0, FIRE = 10, ACID = 0)
