...
/obj/item/clothing/under/color/orange/prison 
	...
	desc = "Старая одежда заключенных из Нанотразен. Датчики костюма зафиксированы в максимальном режиме отслеживания" 
	icon_state = "orange"
	item_state = "o_suit"
	item_color = "orange"
	has_sensor = 2
...
/obj/item/clothing/under/prison
	...
	desc = "Cтандартная одежда заключенных из Нанотразен. Датчики костюма зафиксированы в максимальном режиме отслеживания"
	icon_state = "prison"
	item_state = "prison"
	item_color = "prison"
	has_sensor = 2
