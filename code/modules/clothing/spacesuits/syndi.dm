...
/obj/item/clothing/head/helmet/space/syndicate
	...
	armor = list(MELEE = 40, BULLET = 50, LASER = 30,ENERGY = 25, BOMB = 30, BIO = 30, FIRE = 80, ACID = 85)
	sprite_sheets = list(
...
/obj/item/clothing/head/helmet/space/syndicate/black/strike
	...
	armor = list(melee = 80, bullet = 80, laser = 50, energy = 50, bomb = 100, bio = 100, fire = 100, acid = 100) //Matches DS gear.
