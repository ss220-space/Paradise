...
/obj/item/clothing/head/helmet/space/syndicate
	...
	armor = list(PIERCING = 50, SLASHING = 40, BLUNT = 40, ABSORPTION = 75, LASER = 30, ENERGY = 25, BOMB = 30, BIO = 30, FIRE = 80, ACID = 85)
	sprite_sheets = list(
...
/obj/item/clothing/head/helmet/space/syndicate/black/strike
	...
	armor = list(PIERCING = 80, SLASHING = 80, BLUNT = 80, ABSORPTION = 75, LASER = 50, ENERGY = 50, BOMB = 100, BIO = 100, FIRE = 100, ACID = 100) //Matches DS gear.
