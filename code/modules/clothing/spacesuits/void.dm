...
/obj/item/clothing/head/helmet/space/nasavoid/green
	...
	desc = "Штурмовой гермошлем для боевого скафандра. Титановая сфера с многослойным баллистическим остеклением. Герметичный шарнирный подголовник усилен композитом. Произведён TSF."
