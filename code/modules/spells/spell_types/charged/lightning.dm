/datum/action/cooldown/spell/charged/beam/tesla
	...
	channel_message = span_notice_alt("You start gathering power...")
...
/datum/action/cooldown/spell/charged/beam/tesla/guardian
	name = "Малая молния"
	desc = "Копит в себе заряд электричества, поражающий всех врагов. Не так силен как оригинал, но все ещё опасен."
	spell_requirements = SPELL_REQUIRES_NO_ANTIMAGIC
	invocation = "За С+инд+ик+ат!"
	energy_lost_per_bounce = 10
