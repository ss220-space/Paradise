...
/obj/item/reagent_containers/hypospray/autoinjector/sanguis
	...
	desc = "Маленький инъектор в форме ручки, содержащий внутри дозу сангвиния. Экстренный способ пополнить объем циркулирующей крови." + span_boldwarning("ПРЕДУПРЕЖДЕНИЕ: Потребляет большое количество питательных веществ пользователя для стимуляции выработки крови!")
