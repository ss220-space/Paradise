/obj/machinery/reagentgrinder
	...
	var/list/blend_items = list (
			...
			/obj/item/grown/nettle/basic = list(/datum/reagent/acid = 0),
			...
			/obj/item/reagent_containers/food/snacks/grown/buckwheat = list(/datum/reagent/consumable/buckwheat = -5),
			...
			/obj/item/reagent_containers/food/snacks/grown/moonlight = list(/datum/reagent/moonlin = 0),
	...
	var/list/juice_items = list (
			...
			/obj/item/reagent_containers/food/snacks/grown/citrus/orange_3d = list(/datum/reagent/consumable/drink/orangejuice = 0),
			...
			/obj/item/reagent_containers/food/snacks/grown/apple = list(/datum/reagent/consumable/drink/applejuice = 0),
			...
			/obj/item/reagent_containers/food/snacks/grown/peaslaugh = list(/datum/reagent/consumable/drink/laughsyrup = 0)
	)
