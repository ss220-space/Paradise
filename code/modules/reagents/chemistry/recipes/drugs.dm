...
/datum/chemical_reaction/methamphetamine/on_reaction(datum/reagents/holder, created_volume)
	make_vaporation(list(/datum/reagent/toxin,/datum/reagent/neurotoxin2), holder, created_volume, 1)
...
/datum/chemical_reaction/jenkem/on_reaction(datum/reagents/holder, created_volume)
	make_vaporation(list(/datum/reagent/jenkem), holder, created_volume, 1)
...
/datum/chemical_reaction/crack
	name = "Crack"
	id = "crack"
	result = /datum/reagent/crack
	required_reagents = list(/datum/reagent/coca_extract = 5, /datum/reagent/ammonia = 3, /datum/reagent/fuel = 2, /datum/reagent/water = 5)
	result_amount = 5

/datum/chemical_reaction/cocaine
	name = "Cocaine"
	id = "cocaine"
	result = /datum/reagent/cocaine
	required_reagents = list(/datum/reagent/crack = 1, /datum/reagent/diethylamine=1)
	result_amount = 1

/datum/chemical_reaction/matedecoca
	name = "Mate de Coca"
	id = "matedecoca"
	result = /datum/reagent/matedecoca
	required_reagents = list(/datum/reagent/coca_extract = 1, /datum/reagent/water=5)
	result_amount = 5
	min_temp = T80C
