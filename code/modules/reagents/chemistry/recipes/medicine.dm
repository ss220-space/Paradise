...
/datum/chemical_reaction/ab_stimulant
	...
	result = /datum/reagent/medicine/ab_stimulant
	required_reagents = list(/datum/reagent/medicine/synthflesh = 40)
	result_amount = 1
	min_temp = T0C + 200
...
/datum/chemical_reaction/traneksam_acid
	...
	id = "traneksam_acid"
	result = /datum/reagent/medicine/traneksam_acid
	required_reagents = list(/datum/reagent/medicine/synthflesh = 1, /datum/reagent/ammonia = 1, /datum/reagent/medicine/sal_acid = 1, /datum/reagent/water = 1)
	result_amount = 3
...
/datum/chemical_reaction/traneksam_acid/on_reaction(datum/reagents/holder, created_volume)
	make_vaporation(list(/datum/reagent/cyanide), holder, created_volume * 0.25, 1)

/datum/chemical_reaction/neuromatin
	name = "Нейроматин"
	id = "neuromatin"
	result = /datum/reagent/medicine/neuromatin
	required_reagents = list(/datum/reagent/formaldehyde = 1, /datum/reagent/medicine/mannitol = 5, /datum/reagent/medicine/teporone = 1, /datum/reagent/medicine/atropine = 3)
	result_amount = 10
	min_temp = 350 //K
...
/datum/chemical_reaction/fomepizole
	name = "Fomepizole"
	id = "fomepizole"
	result = /datum/reagent/medicine/fomepizole
	required_reagents = list(/datum/reagent/ammonia = 1, /datum/reagent/medicine/mannitol = 1, /datum/reagent/acetic_acid = 1)
	result_amount = 3
...
/datum/chemical_reaction/sbloodoxy
	name = "Syntetic Blood"
	id = "sbloodoxy"
	result = /datum/reagent/blood/synthetic/oxy
	required_reagents = list(/datum/reagent/blood = 1, /datum/reagent/medicine/perfluorodecalin = 1)
...
/datum/chemical_reaction/coolant
	name = "Coolant"
	id = "coolant"
	result = /datum/reagent/medicine/coolant
	required_reagents = list(/datum/reagent/cryostylane = 1, /datum/reagent/medicine/liquid_solder = 1)
	result_amount = 2
...
/datum/chemical_reaction/syntmorphine
	name = "Syntmorphine"
	id = "syntmorphine"
	result = /datum/reagent/medicine/morphine/syntmorphine
...
/datum/chemical_reaction/helbital
	name = "Хельбитал"
	id = "helbital"
	result = /datum/reagent/medicine/c2
	required_reagents = list(/datum/reagent/carbon = 1, /datum/reagent/consumable/sugar = 1, /datum/reagent/fluorine = 1)
	result_amount = 3
	min_temp = T0C + 250
...
/datum/chemical_reaction/bikaridine
	...
	required_reagents = list(/datum/reagent/phenol = 1, /datum/reagent/carbon = 1)
	result_amount = 1
	min_temp = T0C + 100
...
/datum/chemical_reaction/kelotane
	...
	required_reagents = list(/datum/reagent/acetaldehyde = 1, /datum/reagent/carbon = 1)
	result_amount = 1
...
/datum/chemical_reaction/sanguinius
	name = "Сангвиний"
	id = "sanguinius"
	result = /datum/reagent/medicine/sanguinius
	required_reagents = list(/datum/reagent/medicine/omnizine = 1, /datum/reagent/medicine/synthflesh = 2, /datum/reagent/iron = 2)
	result_amount = 5
