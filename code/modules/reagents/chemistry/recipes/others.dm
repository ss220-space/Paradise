...
/datum/chemical_reaction/firefighting_foam_liguid
	...
	required_reagents = list(/datum/reagent/firefighting_foam = 1, /datum/reagent/water = 1)
	result_amount = 2
...
/datum/chemical_reaction/smart_foam
	id = "smart_foam"
	required_reagents = list(/datum/reagent/aluminum = 3, /datum/reagent/smart_foaming_agent = 1, /datum/reagent/acid/facid = 1)
	result_amount = 1
...
/datum/chemical_reaction/resinfoam
	...
	id = "resinfoam"
	result = null
	required_reagents = list(/datum/reagent/oil = 3, /datum/reagent/fluorosurfactant = 1, /datum/reagent/acid = 1)
	result_amount = 5
...
/datum/chemical_reaction/steroids
	name = "Стероиды"
	id = "steroids"
	result = /datum/reagent/status_effect/steroids
	required_reagents = list(/datum/reagent/consumable/nutriment/protein = 2, /datum/reagent/oil = 1, /datum/reagent/consumable/ethanol = 1)
	result_amount = 3
...
/datum/chemical_reaction/soapification_apple
	...
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/applejuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_potato
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/potato_juice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_pumpkin
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/pumpkinjuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_silver
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/silver = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_tomato
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/tomatojuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_uran
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/uranium = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_watermelon
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/watermelonjuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_whiskey
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/ethanol/whiskey = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_banana
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/banana = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_beer
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/ethanol/beer = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_berry
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/berryjuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_carrot
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/carrotjuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_chocolate
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/cocoa = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_cola
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/cold/space_cola = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_corn
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/corn_starch = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_golden
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/gold = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_grape
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/grapejuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_lemon
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/lemonjuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_lime
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/limejuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_milk
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/milk = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_orange
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/orangejuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
...
/datum/chemical_reaction/soapification_pineapple
	...
	id = "soapification"
	result = null
	required_reagents = list(/datum/reagent/liquidgibs = 10, /datum/reagent/lye  = 10, /datum/reagent/consumable/drink/pineapplejuice = 10) // requires two scooped gib tiles
	min_temp = T0C + 100
	result_amount = 1
