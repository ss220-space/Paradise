...
/datum/chemical_reaction/cheesewheel
	...
	id = "cheesewheel"
	result = null
	required_reagents = list(/datum/reagent/consumable/drink/milk = 90, /datum/reagent/consumable/enzyme = 5)
	result_amount = 1
...
/datum/chemical_reaction/protein_water
	...
	id = "protein_water"
	result = /datum/reagent/consumable/nutriment/protein/liquid
	required_reagents = list(/datum/reagent/consumable/nutriment/protein = 1, /datum/reagent/water = 4)
	result_amount = 5

/datum/chemical_reaction/protein_milk
	name = "Разбавление протеина молоком"
	id = "protein_milk"
	result = /datum/reagent/consumable/nutriment/protein/liquid/milk
	required_reagents = list(/datum/reagent/consumable/nutriment/protein = 1, /datum/reagent/consumable/drink/milk = 4)
	result_amount = 5

/datum/chemical_reaction/creatine_water
	name = "Разбавление креатина"
	id = "creatine_water"
	result = /datum/reagent/status_effect/creatine/liquid
	required_reagents = list(/datum/reagent/status_effect/creatine = 3, /datum/reagent/water = 2)
	result_amount = 5
