...
/datum/chemical_reaction/cyanide/on_reaction(datum/reagents/holder, created_volume)
	make_vaporation(list(/datum/reagent/cyanide), holder, created_volume, 1)
...
/datum/chemical_reaction/sarin/on_reaction(datum/reagents/holder, created_volume)
	make_vaporation(list(/datum/reagent/sarin), holder, created_volume, 2)
...
/datum/chemical_reaction/stable_mustagen
	name = "Stable mutagen"
	id = "stable_mutagen"
	result = /datum/reagent/stable_mutagen
	required_reagents = list(/datum/reagent/mutagen = 1, /datum/reagent/lithium = 1, /datum/reagent/acetone = 1, /datum/reagent/bromine = 1)
	result_amount = 3
...
/datum/chemical_reaction/stable_mustagen/stable_mustagen2
	id = "stable_mutagen2"
	required_reagents = list(/datum/reagent/medicine/mutadone = 3, /datum/reagent/lithium = 1)
	result_amount = 4
