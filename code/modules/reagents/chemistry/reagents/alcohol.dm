...
/datum/reagent/consumable/ethanol/red_moondrin
	...
	id = "red_moondrin"
	description = "Illegal tajaran drink in Adomai, but not here! Dangerous moon'drin based drink with secret ingridient."
	color = "#960202"
	alcohol_perc = 0.9
	drink_icon = "red_moondrin"
	drink_name = "Redwater Moon'drin"
	drink_desc = "Dangerous moon'drin based tajaran drink with secret ingridient."
