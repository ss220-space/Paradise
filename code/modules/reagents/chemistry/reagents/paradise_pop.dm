...
/datum/reagent/consumable/drink/blackeye_brew/on_mob_life(mob/living/M)
	if(prob(25))
		var/list/tider_talk = list("ПО РП, ПО РП БЛЯДЬ! МНЕ ПОХУЙ НА ТВОЁ РП!",
									"ПРОКЛЯТИЕ 220!",
									"ПЕДАЛИ СУКИ!",
									"ДА У МЕНЯ ЕЩЁ 10 ТВИНКОВ В ЗАПАСЕ!",
									"АДМИН ПО ОПРЕДЕЛЕНИЮ МУДАК БЛЯДЬ!",
									"ЁБАНЫЕ [pick("КАЗУАЛЫ", "ПЕДАЛИ", "АДМИНЫ", "ЩИТКУРЫ", "РАБОТКОЁБЫ", "ПИДАРАСЫ", "ШУССОИДЫ", "ШАТТЛОЁБЫ")]!",
									"СРАТЬ ВЕЧНО!",
									"КАЗУАЛУ ПО ЕБАЛУ!",
									"ГРЕЙТАЙД ВОРЛДВАЙД!!!",
									"ЗАБАНЬ МЕНЯ, СУЧКА!",
									"ЩАС ТУТ ВСЁ ВЗЛЕТИТ НА ВОЗДУХ НАХУЙ!",
									"ГДЕ МОЙ ТУЛБОКС?!",
									"300 НА 300 В МЕДБЕЙ, ХАХАХА!!!")
