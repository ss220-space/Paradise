...
/datum/reagent/medicine/ephedrine/on_mob_life(mob/living/M)
	...
	update_flags |= M.AdjustStunned(-1, FALSE)
	update_flags |= M.AdjustWeakened(-1, FALSE)
	update_flags |= M.adjustStaminaLoss(-PRIME(1,3)*REAGENTS_EFFECT_MULTIPLIER, FALSE)
...
/datum/reagent/medicine/stimulative_agent/on_mob_life(mob/living/M)
	...
	update_flags |= M.adjustStaminaLoss(-PRIME(5,15)*REAGENTS_EFFECT_MULTIPLIER, FALSE)
	return ..() | update_flags
...
/datum/reagent/medicine/earthsblood/on_mob_life(mob/living/M)
	...
	update_flags |= M.adjustStaminaLoss(-PRIME(30,9) * REAGENTS_EFFECT_MULTIPLIER, FALSE)
