...
/obj/machinery/computer/account_database/proc/accounting_letterhead(report_name)
	var/datum/ui_login/ui_login = ui_login_get()
	return {"
		<center><h1><b>[report_name]</b></h1></center>
		<center><small><i>[station_name()] Accounting Report</i></small></center>
		<u>Generated By:</u> [ui_login?.id?.registered_name ? ui_login.id.registered_name : UNKNOWN_NAME_RUS], [ui_login?.id?.assignment ? ui_login.id.assignment : UNKNOWN_STATUS_RUS]<br>
		<hr>
	"}
