...
/datum/trade_destination/biesel
	name = "\"Бизель\""
	description = "Крупные верфи, сильная экономика и стабильное, образованное население. Бизель в основном сохраняет верность ТСФ и с неохотой терпит \"Нанотрейзен\". Столица — Лоуэлл-Сити."
	distance = 2.3
	willing_to_buy = list()
	willing_to_sell = list()
