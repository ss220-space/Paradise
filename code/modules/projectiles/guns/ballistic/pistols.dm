...
/obj/item/gun/ballistic/automatic/pistol/enforcer/get_ru_names()
	return list(
...
/obj/item/gun/ballistic/automatic/pistol/enforcer/ComponentInitialize()
	. = ..()
	AddElement(/datum/element/item_skins, item_path = /obj/item/gun/ballistic/automatic/pistol/enforcer)
...
/obj/item/gun/ballistic/automatic/pistol/enforcer/lethal

/obj/item/gun/ballistic/automatic/pistol/enforcer/lethal/Initialize(mapload)
...
/obj/item/gun/ballistic/automatic/pistol/sp8/ComponentInitialize()
	. = ..()
	AddElement(/datum/element/item_skins)

/obj/item/gun/ballistic/automatic/pistol/sp8/update_icon_state()
	if(current_skin)
		icon_state = "[current_skin][chambered ? "" : "-e"]"
	else
		icon_state = "[initial(icon_state)][chambered ? "" : "-e"]"

/obj/item/gun/ballistic/automatic/pistol/sp8/sp8t
	name = "SP-8-T"
...
/obj/item/gun/ballistic/automatic/pistol/sp8/sp8t/ComponentInitialize()
	. = ..()
	AddElement(/datum/element/item_skins)

/obj/item/gun/ballistic/automatic/pistol/sp8/sp8ar
	name = "SP-8-AR"
