...
/obj/item/gun/projectile/shotgun/riot/add_deep_lore()
	AddElement(/datum/element/examine_lore, \
		lore = "RS-870 — помповый дробовик 12-го калибра, производимый \
		...
		<br>\
		Трубчатый магазин увеличенной длины вмещает до 6 патронов. Стандартные крепления \
		на дульном срезе, верхней планке и под стволом позволяют адаптировать дробовик под конкретную задачу.<br>\
		<br>\
...
/obj/item/gun/projectile/shotgun/winchester/cargo/add_deep_lore()
	AddElement(/datum/element/examine_lore, \
		...
		что перед вами не рядовое изделие.<br>\
		<br>\
