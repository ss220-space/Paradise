...
/obj/item/gun/projectile/bombarda/bombplet/get_ru_names()
	return list(
		NOMINATIVE = "импровизированный гранатомет",
		GENITIVE = "импровизированного гранатомета",
		DATIVE = "импровизированному гранатомету",
		ACCUSATIVE = "импровизированный гранатомет",
		INSTRUMENTAL = "импровизированным гранатометом",
		PREPOSITIONAL = "импровизированном гранатомете",
	)
...
/obj/item/gun/projectile/bombarda/bombplet/get_ru_names()
	return list(
		NOMINATIVE = "импровизированный двуствольный гранатомет 40 мм",
		GENITIVE = "импровизированного двуствольного гранатомета 40 мм",
		DATIVE = "импровизированному двуствольному гранатомету 40 мм",
		ACCUSATIVE = "импровизированный двуствольный гранатомет 40 мм",
		INSTRUMENTAL = "импровизированным двуствольным гранатометом 40 мм",
		PREPOSITIONAL = "импровизированном двуствольном гранатомете 40 мм",
	)
