...
/obj/item/gun/energy/nucle_inator
	name = "Nucle-inator"
	desc = "С виду похожа на разработку сумасшедшего учёного, и тут даже есть кнопка самоуничтожения с надписью 'НЕ РАБОТАЕТ'. Имеет два самовосстанавливающихся заряда и при стрельбе излучает радиацию особой интенсивности, способную превратить любого органика в нуклеацию, заражая особым вирусом."
