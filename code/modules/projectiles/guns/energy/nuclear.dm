...
/obj/item/gun/energy/gun/mini
	...
	desc = "Небольшой энергетический пистолет со встроенным фонариком. У него два режима: оглушающий и летальный."
	icon_state = "mini"
...
/obj/item/gun/energy/gun/hos
	name = "\improper Многофазный энергетический пистолет X-01"
	desc = "Это дорогая, современная версия старинного лазерного пистолета. У этого оружия есть несколько уникальных режимов ведения огня, но нет возможности самостоятельно перезаряжаться с течением времени."
	icon_state = "hoslaser"
	origin_tech = null
	force = 10
