...
/obj/item/gun/energy/specter
	name = "Specter"
	desc = "Современный пистолет \"Спектр\", энергетический пистолет работающий на съемных аккумуляторах, имеет магнитные приводы для быстрой смены аккумулятора. Поставляется только силовым структурам Нанотрейзен."
	ru_names = list(
		NOMINATIVE = "Спектр",
		GENITIVE = "Спектра",
		DATIVE = "Спектру",
