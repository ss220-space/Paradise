...
/obj/item/gun/energy/laser/practice
	...
	desc = "Модифицированная версия базового лазерного карабина. Стреляет менее концентрированными лучами и предназначена для тренировок."
...
/obj/item/gun/energy/laser/retro
	name ="Устаревший лазерный карабин"
	icon_state = "retro"
	desc = "Устаревшая модель базового лазерного карабина, больше не используемая охранными и военными силами NanoTrasen. Тем не менее, он всё же обладает приличной убойной силой, что, вместе с простотой обслуживания, делает эту модель любимым оружием пиратов и прочих преступников."
	ammo_x_offset = 3
