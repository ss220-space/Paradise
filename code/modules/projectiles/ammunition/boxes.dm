...
/obj/item/ammo_box/p45nr
	name = "ammo box (45n&r)"
	desc = "Коробка, содержащая  патроны калибра 45n&r."
...
/obj/item/ammo_box/c9mmte/get_ru_names()
	return list(
		NOMINATIVE = "коробка патронов (45n&r)",
		GENITIVE = "коробки патронов (45n&r)",
		DATIVE = "коробке патронов (45n&r)",
		ACCUSATIVE = "коробку патронов (45n&r)",
		INSTRUMENTAL = "коробкой патронов (45n&r)",
		PREPOSITIONAL = "коробке патронов (45n&r)"
	)
