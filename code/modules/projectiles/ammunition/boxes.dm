...
/obj/item/ammo_box/a357
	name = "ammo box (.357)"
	desc = "Коробка, содержащая патроны .357 калибра \"Магнум\". В неё вмещается 20 патронов."
	ru_names = list(
...
/obj/item/ammo_box/fortynr
	name = "ammo box 40N&R"
	desc = "Коробка, содержащая патроны  .40 N&R калибра. В неё вмещается 40 патронов."
	ru_names = list(
...
/obj/item/ammo_box/c45
	name = "ammo box (.45)"
	desc = "Коробка, содержащая патроны .45 калибра. В неё вмещается 20 патронов."
	ru_names = list(
...
/obj/item/ammo_box/c45/ext
	...
	desc = "Большая коробка, содержащая патроны .45 калибра. В неё вмещается 40 патронов."
	ru_names = list(
...
/obj/item/ammo_box/rubber45
	...
	desc = "Коробка, содержащая нелетальные патроны .45 калибра. В неё вмещается 16 патронов."
	ru_names = list(
...
/obj/item/ammo_box/rubber45/ext
	...
	desc = "Большая коробка, содержащая нелетальные патроны .45 калибра. В неё вмещается 40 патронов."
	ru_names = list(
...
/obj/item/ammo_box/tox46x30mm
	...
	desc = "Коробка, содержащая отравляющие патроны калибра 4,6x30 мм. В неё вмещается 40 патронов."
	ru_names = list(
...
/obj/item/ammo_box/sniper_rounds_compact
	...
	desc = "Коробка, содержащая компактные снайперские патроны .50L калибра COMP. В неё вмещается 20 патронов."
	ru_names = list(
...
/obj/item/ammo_box/sniper_rounds_penetrator
	...
	desc = "Коробка, содержащая бронебойные патроны .50 калибра. В неё вмещается 20 патронов."
	ru_names = list(
