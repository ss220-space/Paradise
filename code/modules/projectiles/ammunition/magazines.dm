...
/obj/item/ammo_box/magazine/m45
	...
	desc = "Магазин пистолета \"M1911\", снаряженный патронами калибра .45. Эти патроны обладают сильным останавливающим действием, способным сбить с ног большинство целей, однако они не наносят серьёзных повреждений."
	ru_names = list(
...
/obj/item/ammo_box/magazine/enforcer/lethal
	...
	desc = "Магазин пистолета \"M1911\", снаряженный патронами калибра 9 мм. Стандартные патроны для пистолета \"Блюститель\" службы безопасности."
	ru_names = list(
...
/obj/item/ammo_box/magazine/sp8
	...
	desc = "Магазин пистолета \"SP-8\", снаряженный патронами калибра 40N&R."
	ru_names = list(
		NOMINATIVE = "магазин пистолета \"SP-8\" (40N&R)",
		GENITIVE = "магазина пистолета \"SP-8\" (40N&R)",
		DATIVE = "магазину пистолета \"SP-8\" (40N&R)",
		ACCUSATIVE = "магазин пистолета \"SP-8\" (40N&R)",
		INSTRUMENTAL = "магазином пистолета \"SP-8\" (40N&R)",
		PREPOSITIONAL = "магазине пистолета \"SP-8\" (40N&R)"
	)
	icon_state = "sp8mag"
...
/obj/item/ammo_box/magazine/wt550m9
	...
	desc = "Магазин пистолета-пулемета \"WT-550 PDW\", снаряженный патронами калибра 4.6x30 мм."
	ru_names = list(
		NOMINATIVE = "пистолета-пулемета \"WT-550 PDW\" (4.6x30 мм)",
		GENITIVE = "магазина пистолета-пулемета \"WT-550 PDW\" (4.6x30 мм)",
		DATIVE = "магазину пистолета-пулемета \"WT-550 PDW\" (4.6x30 мм)",
		ACCUSATIVE = "магазин пистолета-пулемета \"WT-550 PDW\" (4.6x30 мм)",
		INSTRUMENTAL = "магазином пистолета-пулемета \"WT-550 PDW\" (4.6x30 мм)",
		PREPOSITIONAL = "магазине пистолета-пулемета \"WT-550 PDW\" (4.6x30 мм)"
	)
...
/obj/item/ammo_box/magazine/wt550m9/wtap
	...
	desc = "Магазин пистолета-пулемета \"WT-550 PDW\", снаряженный бронебойными патронами калибра 4.6x30 мм."
	ru_names = list(
		NOMINATIVE = "магазин пистолета-пулемета \"WT-550 PDW\" (бронебойные 4.6x30 мм)",
		GENITIVE = "магазина пистолета-пулемета \"WT-550 PDW\" (бронебойные 4.6x30 мм)",
		DATIVE = "магазину пистолета-пулемета \"WT-550 PDW\" (бронебойные 4.6x30 мм)",
		ACCUSATIVE = "магазин пистолета-пулемета \"WT-550 PDW\" (бронебойные 4.6x30 мм)",
		INSTRUMENTAL = "магазином пистолета-пулемета \"WT-550 PDW\" (бронебойные 4.6x30 мм)",
		PREPOSITIONAL = "магазине пистолета-пулемета \"WT-550 PDW\" (бронебойные 4.6x30 мм)"
	)
	ammo_type = /obj/item/ammo_casing/c46x30mm/ap

/obj/item/ammo_box/magazine/wt550m9/wttx
	name = "wt550 magazine (Toxin Tipped 4.6x30mm)"
	desc = "Магазин пистолета-пулемета \"WT-550 PDW\", снаряженный токсичными патронами калибра 4.6x30 мм."
	ru_names = list(
		NOMINATIVE = "магазин пистолета-пулемета \"WT-550 PDW\" (токсичные 4.6x30 мм)",
		GENITIVE = "магазина пистолета-пулемета \"WT-550 PDW\" (токсичные 4.6x30 мм)",
		DATIVE = "магазину пистолета-пулемета \"WT-550 PDW\" (токсичные 4.6x30 мм)",
		ACCUSATIVE = "магазин пистолета-пулемета \"WT-550 PDW\" (токсичные 4.6x30 мм)",
		INSTRUMENTAL = "магазином пистолета-пулемета \"WT-550 PDW\" (токсичные 4.6x30 мм)",
		PREPOSITIONAL = "магазине пистолета-пулемета \"WT-550 PDW\" (токсичные 4.6x30 мм)"
	)
	ammo_type = /obj/item/ammo_casing/c46x30mm/tox

/obj/item/ammo_box/magazine/wt550m9/wtic
	name = "wt550 magazine (Incendiary 4.6x30mm)"
	desc = "Магазин пистолета-пулемета \"WT-550 PDW\", снаряженный зажигательными патронами калибра 4.6x30 мм."
	ru_names = list(
		NOMINATIVE = "магазин пистолета-пулемета \"WT-550 PDW\" (зажигательные 4.6x30 мм)",
		GENITIVE = "магазина пистолета-пулемета \"WT-550 PDW\" (зажигательные 4.6x30 мм)",
		DATIVE = "магазину пистолета-пулемета \"WT-550 PDW\" (зажигательные 4.6x30 мм)",
		ACCUSATIVE = "магазин пистолета-пулемета \"WT-550 PDW\" (зажигательные 4.6x30 мм)",
		INSTRUMENTAL = "магазином пистолета-пулемета \"WT-550 PDW\" (зажигательные 4.6x30 мм)",
		PREPOSITIONAL = "магазине пистолета-пулемета \"WT-550 PDW\" (зажигательные 4.6x30 мм)"
	)
	ammo_type = /obj/item/ammo_casing/c46x30mm/inc

/obj/item/ammo_box/magazine/sp91rc
	name = "SP-91-RC magazine (9mm TE)"
	desc = "Магазин пистолета-пулемета \"SP-91-RC\", снаряженный нелетальными патронами калибра 9 мм TE."
	ru_names = list(
		NOMINATIVE = "магазин пистолета-пулемета \"SP-91-RC\" (9 мм TE)",
		GENITIVE = "магазина пистолета-пулемета \"SP-91-RC\" (9 мм TE)",
		DATIVE = "магазину пистолета-пулемета \"SP-91-RC\" (9 мм TE)",
		ACCUSATIVE = "магазин пистолета-пулемета \"SP-91-RC\" (9 мм TE)",
		INSTRUMENTAL = "магазином пистолета-пулемета \"SP-91-RC\" (9 мм TE)",
		PREPOSITIONAL = "магазине пистолета-пулемета \"SP-91-RC\" (9 мм TE)"
	)
	icon_state = "9mm-te"
...
/obj/item/ammo_box/magazine/uzim9mm
	...
	desc = "Магазин пистолета-пулемета \"UZI\", снаряженный патронами калибра 9 мм."
	ru_names = list(
		NOMINATIVE = "магазин пистолета-пулемета \"UZI\" (9 мм)",
		GENITIVE = "магазина пистолета-пулемета \"UZI\" (9 мм)",
		DATIVE = "магазину пистолета-пулемета \"UZI\" (9 мм)",
		ACCUSATIVE = "магазин пистолета-пулемета \"UZI\"(9 мм)",
		INSTRUMENTAL = "магазином пистолета-пулемета \"UZI\" (9 мм)",
		PREPOSITIONAL = "магазине пистолета-пулемета \"UZI\" (9 мм)"
	)
