...
/obj/item/ammo_box/magazine/sp8
	...
	desc = "Магазин пистолета \"SP-8\", снаряженный патронами .40 калибра N&R."
	ru_names = list(
		NOMINATIVE = "магазин пистолета \"SP-8\" (.40 N&R)",
		GENITIVE = "магазина пистолета \"SP-8\" (.40 N&R)",
		DATIVE = "магазину пистолета \"SP-8\" (.40 N&R)",
		ACCUSATIVE = "магазин пистолета \"SP-8\" (.40 N&R)",
		INSTRUMENTAL = "магазином пистолета \"SP-8\" (.40 N&R)",
		PREPOSITIONAL = "магазине пистолета \"SP-8\" (.40 N&R)"
	)
	icon_state = "sp8mag"
