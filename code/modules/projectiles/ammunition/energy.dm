...
/obj/item/ammo_casing/energy/anomaly
	...
	delay = 0.4
	e_cost = 100
	projectile_type = /obj/item/projectile/beam/anomaly
	muzzle_flash_color = LIGHT_COLOR_GREEN

/obj/item/ammo_casing/energy/anomaly/stabilizer
	projectile_type = /obj/item/projectile/beam/anomaly/stabilizer
	muzzle_flash_color = LIGHT_COLOR_BLUE

/obj/item/ammo_casing/energy/anomaly/destabilizer
	projectile_type = /obj/item/projectile/beam/anomaly/destabilizer
