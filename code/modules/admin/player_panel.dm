	...
	if(SSticker && SSticker.current_state >= GAME_STATE_PLAYING)
		...
		if(blob_infected && blob_infected.len)
			...
			if(check_rights(R_EVENT))
				dat += "<tr><td><a href='?src=[UID()];delay_blob_end=1'>Delay blob end</a> Now: [mode.delay_blob_end? "ON" : "OFF"]<br></td></tr>"
				dat += "<tr><td><a href='?src=[UID()];toggle_auto_gamma=1'>Toggle auto GAMMA</a> Now: [mode.off_auto_gamma? "OFF" : "ON"]<br></td></tr>"
			dat += "<tr><td><a href='?src=[UID()];toggle_auto_nuke_codes=1'>Toggle auto nuke codes</a> Now: [mode.off_auto_nuke_codes? "OFF" : "ON"]<br></td></tr>"
			dat += "</table>"
