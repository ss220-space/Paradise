...
//Regular jobs
	...
	if(href_list["convert_ticket"])
		...
		switch(href_list["secretsfun"])
			...
			if("power")
				switch(tgui_alert(usr, "What Would You Like to Do?", "Make All Areas Powered", list("Power all APCs", "Repair all APCs", "Repair and Power APCs")))
					if("Power all APCs")
			...
			if("unpower")
				if(tgui_alert(usr, "What Would You Like to Do?", "Make All Areas Unpowered", list("Depower all APCs", "Short out APCs")) == "Depower all APCs")
					depower_apcs()
