...
//Regular jobs
	...
	if(href_list["convert_ticket"])
		...
		var/stypes = list("Разберитесь с этим сами!","Неразборчивый факс","Неразборчивый факс, переделывай","Факс не подписан","Факс не подписан, переделывай","Не сейчас","Вы напрасно тратите наше время", "Продолжайте в том же духе", "Инструкции ОБР")
		...
		else if(stype == "Неразборчивый факс, переделывай")
			tmsg += "Приветствую вас, уважаемый член экипажа. Ваш факс был <b><I>ОТКЛОНЁН</I></b> автоматически службой регистрации факсов УСН 'Трурль'.<BR><BR>Согласно отчету нашего контроля качества:Грамматика, синтаксис и/или типография вашего факса находятся на низком уровне и не позволяют нам понять содержание сообщения.<BR><BR>Пожалуйста, обратитесь к ближайшему словарю и/или тезаурусу и повторите попытку, уникальный штамп для Вас прилагается.<BR><BR><i><small>Это автоматическое сообщение.</small>"
			P.stamps += "<hr><img src='large_stamp-ploho.png'>"
		...
		else if(stype == "Факс не подписан, переделывай")
			tmsg += "Приветствую вас, уважаемый член экипажа. Ваш факс был <b><I>ОТКЛОНЁН</I></b> автоматически службой регистрации факсов УСН 'Трурль'.<BR><BR>Согласно отчету нашего контроля качества: Ваш факс был неправильно подписан, и поэтому мы не можем подтвердить вашу личность.<BR><BR>Пожалуйста, подпишите свои факсы перед их отправкой, чтобы мы могли вас идентифицировать, уникальный штамп для Вас прилагается.<BR><BR><i><small>Это автоматическое сообщение.</small>"
			P.stamps += "<hr><img src='large_stamp-ploho.png'>"
