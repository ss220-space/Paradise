...
//Regular jobs
	...
	if(href_list["convert_ticket"])
		...
		if(istype(H) && H.stat == CONSCIOUS && (istype(H.l_ear, /obj/item/radio/headset) || istype(H.r_ear, /obj/item/radio/headset)))
			to_chat(H, span_specialnoticebold("Ваши наушники издают гудки, уведомляя вас о получении ответа на ваш факс."))
		...
		if(notify == "Yes")
			...
			if(istype(H) && H.stat == CONSCIOUS && (istype(H.l_ear, /obj/item/radio/headset) || istype(H.r_ear, /obj/item/radio/headset)))
				to_chat(sender, span_specialnoticebold("Ваши наушники издают гудки, уведомляя вас о получении ответа на ваш факс."), confidential=TRUE)
