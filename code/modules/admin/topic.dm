...
//knock yourself out to stop the ghosts
			...
			if("eagles")//SCRAW
				...
				GLOB.event_announcement.Announce("Centcomm airlock control override activated. Please take this time to get acquainted with your coworkers.", new_sound = 'sound/AI/announces/commandreport.ogg')
			if("onlyone")
