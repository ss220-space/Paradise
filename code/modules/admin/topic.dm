...
//Regular jobs
	...
	if(href_list["convert_ticket"])
		...
		if(istype(H) && H.stat == CONSCIOUS && (istype(H.l_ear, /obj/item/radio/headset) || istype(H.r_ear, /obj/item/radio/headset)))
			to_chat(H, span_specialnoticebold("Ваши наушники издают гудки, сигнализирующий о том, что пришёл ответ на ваш факс."))
		...
		fax.receivefax(P)
		if(istype(H) && H.stat == CONSCIOUS && (istype(H.l_ear, /obj/item/radio/headset) || istype(H.r_ear, /obj/item/radio/headset)))
			to_chat(H, span_specialnoticebold("Ваши наушники издают гудки, сигнализирующий о том, что пришёл ответ ответа на ваш факс."))
			H.playsound_local(H, 'sound/items/new_fax_message.ogg', 50, FALSE, use_reverb = FALSE)
		...
		if(notify == "Yes")
			...
			if(istype(H) && H.stat == CONSCIOUS && (istype(H.l_ear, /obj/item/radio/headset) || istype(H.r_ear, /obj/item/radio/headset)))
				to_chat(sender, span_specialnoticebold("Ваши наушники издают гудки, сигнализирующий о том, что пришёл ответ на ваш факс."), confidential=TRUE)
		...
		var/mob/living/carbon/human/H = sender
		if(istype(H) && H.stat == CONSCIOUS && (istype(H.l_ear, /obj/item/radio/headset) || istype(H.r_ear, /obj/item/radio/headset)))
			to_chat(sender, span_specialnoticebold("Ваши наушники издают гудки, сигнализирующий о том, что пришёл ответ ответа на ваш факс."))
			sender.playsound_local(sender, 'sound/items/new_fax_message.ogg', 50, FALSE, use_reverb = FALSE)
		return
