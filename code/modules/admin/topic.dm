/datum/admins/Topic(href, href_list)
	...
	if(href_list["rejectadminhelp"])
		...
		to_chat(C, span_fontsize_4(span_fontcolor_red("<b>- AdminHelp Rejected! -</b>")), confidential=TRUE)
...
//Regular jobs
	...
	if(href_list["convert_ticket"])
		...
		var/tmsg = "<span style='font-face: \"Verdana\"; color: black;'><center><img src = 'ntlogo.png'><br><br><br><span style='font-size: 18px;'><b>Научная станция NanoTrasen [SSmapping.map_datum.station_short]</b></span><br><br><br>[span_fontsize_4("Отчет отдела коммуникаций АКН 'Трурль'")]</center><br><br>"
