...
/mob/living/carbon/human/proc/equip_syndicate_commando(is_leader = FALSE, full_gear = FALSE)
	...
	equip_to_slot(R, slot_l_ear)
	equip_to_slot(new /obj/item/clothing/under/syndicate(src), slot_w_uniform)
	if(!full_gear)
		equip_to_slot(new /obj/item/clothing/shoes/combat(src), slot_shoes)
	equip_to_slot(new /obj/item/clothing/gloves/combat(src), slot_gloves)

	equip_to_slot(new /obj/item/storage/backpack/security(src), slot_back)
	equip_to_slot(new /obj/item/storage/box/survival_syndi(src), slot_in_backpack)

	equip_to_slot(new /obj/item/gun/projectile/revolver(src), slot_in_backpack)
	equip_to_slot(new /obj/item/ammo_box/a357(src), slot_in_backpack)
	equip_to_slot(new /obj/item/reagent_containers/hypospray/combat/nanites(src), slot_in_backpack)
	equip_to_slot(new /obj/item/grenade/plastic/x4(src), slot_in_backpack)
	if(is_leader)
		equip_to_slot(new /obj/item/pinpointer(src), slot_in_backpack)
		equip_to_slot(new /obj/item/disk/nuclear/unrestricted(src), slot_in_backpack)
	else
		equip_to_slot(new /obj/item/grenade/plastic/x4(src), slot_in_backpack)
	equip_to_slot(new /obj/item/card/emag(src), slot_r_store)
	equip_to_slot(new /obj/item/melee/energy/sword/saber/red(src), slot_l_store)

	if(full_gear)
		equip_to_slot(new /obj/item/clothing/mask/gas/syndicate(src), slot_wear_mask)
		equip_to_slot(new /obj/item/clothing/suit/space/hardsuit/syndi/elite/sst(src), slot_wear_suit)
		equip_to_slot(new /obj/item/clothing/glasses/thermal/sunglasses(src), slot_glasses)
		equip_to_slot(new /obj/item/storage/belt/military/sst(src), slot_belt)
		equip_to_slot(new /obj/item/tank/jetpack/oxygen/harness(src), slot_s_store)
		equip_to_slot(new /obj/item/clothing/shoes/magboots/syndie/advance(src), slot_shoes)
		equip_to_slot(new /obj/item/gun/projectile/automatic/l6_saw(src), slot_r_hand)
		equip_to_slot(new /obj/item/ammo_box/magazine/mm556x45(src), slot_in_backpack)
