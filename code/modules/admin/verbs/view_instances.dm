ADMIN_VERB(view_server_instances, R_DEBUG, "View Server Instances", "View the running server instances.", ADMIN_CATEGORY_DEBUG)
	to_chat(user, span_bold("Server instances info"))
