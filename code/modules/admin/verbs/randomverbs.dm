...
/client/proc/cmd_admin_local_narrate(var/atom/A)
	...
	message_admins("<span class='boldnotice'> LocalNarrate: [key_name_admin(usr)] at [ADMIN_VERBOSEJMP(A)]: [msg]<BR></span>")
...
/client/proc/admin_delete(datum/D)
	...
	if(alert(src, "Are you sure you want to delete:\n[D]\nat [COORD(A)]?", "Confirmation", "Yes", "No") == "Yes")
		log_admin("[key_name(usr)] deleted [D] at [COORD(A)]")
		message_admins("[key_name_admin(usr)] deleted [D] at [COORD(A)]")
...
/client/proc/cmd_admin_explosion(atom/O as obj|mob|turf in view())
	...
	if((devastation != -1) || (heavy != -1) || (light != -1) || (flash != -1) || (flames != -1))
		...
		log_admin("[key_name(usr)] created an explosion ([devastation],[heavy],[light],[flames]) at [COORD(O)]")
		message_admins("[key_name_admin(usr)] created an explosion ([devastation],[heavy],[light],[flames]) at [COORD(O)]")
...
/client/proc/cmd_admin_emp(atom/O as obj|mob|turf in view())
	...
	if(heavy || light)
		...
		log_and_message_admins("[key_name_admin(usr)] created an EM pulse ([heavy], [light]) at [COORD(O)]")
