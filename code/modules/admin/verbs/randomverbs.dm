...
/client/proc/admin_headset_message(mob/M in GLOB.mob_list, sender = null)
	...
	to_chat(H, "[span_specialnoticebold("Incoming priority transmission from [sender == "Syndicate" ? "your benefactor" : "Central Command"].  Message as follows[sender == "Syndicate" ? ", agent." : ":"]")] [span_specialnotice(input)]")
