...
ADMIN_VERB(play_fax_spam_fun, R_EVENT, "Play Fax Spam Sound", "Воспроизвести звук оповещения ЦК на всю станцию.", ADMIN_CATEGORY_FUN)
	...
	BLACKBOX_LOG_ADMIN_VERB("Play Fax Spam Fun")
