...
/datum/admins/proc/show_player_panel(var/mob/M in GLOB.mob_list)
	...
	if(check_rights(R_ADMIN|R_MOD, 0))
		...
		body += "<a href='byond://?_src_=holder;adminalert=[M.UID()]'>SEND ALERT</a>"
	body += "\]<br>"
	...
	"}
	if(check_rights(R_ADMIN|R_MOD, 0))
		body += {"<A href='byond://?_src_=holder;narrateto=[M.UID()]'>Narrate to</A> |
...
/datum/admins/proc/Game()
	...
	if(check_rights(R_ADMIN, FALSE))
		dat += "<A href='byond://?src=[UID()];c_mode=1'>Change Game Mode</A><br>"
