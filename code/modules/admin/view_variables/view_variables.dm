		...
		<div align='center'>
			<table width='100%'>
				<tr>
					...
					<td width='50%'>
						<div align='center'>
							<a id='refresh_link' href='byond://?_src_=vars;datumrefresh=[refid]'>Refresh</a>
...
/client/proc/vv_update_display(datum/thing, span, content)
	src << output("[span]:[content]", "variables[UID_of(thing)].browser:replace_span")
