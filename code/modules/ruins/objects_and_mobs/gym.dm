...
/obj/structure/punching_bag
	...
	desc = "Боксёрская груша. Ходят слухи, что использование становится эффективней если вы представляете на её месте своего начальника."
	gender = FEMALE
...
/obj/structure/weightmachine
	...
	desc = "От одного взгляда на этот тренажёр вы чувствуете усталость."
	gender = MALE
	density = TRUE
	anchored = TRUE
...
/obj/structure/weightmachine/attack_hand(mob/living/user)
	...
	var/bragmessage = pick(
		"раздвигает границы своих возможностей",
		"превосходит самого себя",
		"горит решимостью",
		"бросает вызов своим возможностям",
		"становится сильнее",
		"обливается потом",
	)
