...
/obj/item/clothing/shoes/magboots/hermit
	name = "retro magboots"
	desc = "Магнитные ботинки от корпорации \"Двигатели Энштейна\" выполненые в старом стиле со всеми нюансами. Они не такие удобные как современные модели, но надёжности им не занимать."
...
/obj/item/documents/hermit/einstein_engine
	...
	desc = "\"Совершенно секретные\" документы корпорации \"Двигатели Энштейна\", напечатанные на специальной бумаге, защищенной от копирования. Эти документы содержат технические характеристики, чертежи проекта \"Прометей\". Эти бумаги могут сильно ударить по активам НаноТрайзен и всех причастных к её плазменной промышленности. Тут... Есть печати ТСФ и СССП?"
	icon_state = "docs_red"
	sell_multiplier = 1
...
/obj/item/card/id/away/hermit/medic
	...
	desc = "Карточка, используемая для удостоверения личности и определения доступа на ИСН \"Ананси\"."
	icon_state = "CMO"
	item_state = "CMO"
...
/obj/item/documents/hermit/medical
	...
	desc = "\"Совершенно секретные\" архивные документы корпорации \"НаноТрайзен\", напечатанные на специальной бумаге, защищенной от копирования. Здесь содержится компоментирующая информация о неэтичных опытах над преступниками со всеми подробностями. Подписаны как вторым красным крестом, так и Нанотрейзен."
