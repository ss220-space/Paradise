...
/obj/effect/mob_spawn/human/hermit/Initialize(mapload)
	...
	switch(background_choice)
		...
		if(2)
			...
			Рассчёты не сходились. Реакция была не контролируема, она была суждена стать катастрофой. Вы возмутились, но вам вежливо предложили \"не вмешиваться не в своё дело\". \
