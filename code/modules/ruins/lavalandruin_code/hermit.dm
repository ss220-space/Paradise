...
/obj/effect/mob_spawn/human/hermit/Initialize(mapload)
	...
	switch(background_choice)
		...
		if(2)
			...
			Тогда вы приняли решение, на презентации вопреки закону вы выгрузили все свои разработки на диск и скрылись, вас сразу же объявили вором, и несостоявшимся сотрудником что хочет заполучить всю славу себе, \
