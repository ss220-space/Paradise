...
/obj/machinery/smartfridge/ui_interact(mob/user, datum/tgui/ui = null)
	...
	if(!ui)
		ui = new(user, src, "Smartfridge", declent_ru_cap(NOMINATIVE))
		ui.open()
...
/obj/machinery/smartfridge/proc/throw_item()
	...
	visible_message(span_warning("[declent_ru_cap(NOMINATIVE)] кидает [throw_item.declent_ru(ACCUSATIVE)] в [target]!"))
	return TRUE
