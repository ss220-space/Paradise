...
/obj/machinery/monkey_recycler/attack_hand(mob/user)
	...
	if(grinded >= required_grind)
		...
		to_chat(user, span_warning("Для производства <b>[cube_production] кубик[declension_ru(cube_production, "а", "ов", "ов")]</b> машине требуется как минимум материал от <b>[required_grind] обезьян[DECL_Y(required_grind)]</b>."))
	return
