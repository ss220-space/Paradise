...
/obj/item/reagent_containers/cup/glass/cans/get_short_name() // Override if `list_reagents` has more than 1 element.
	if(!length(reagents.reagent_list))
		return declent_ru(NOMINATIVE)
	var/datum/reagent/reagent = reagents.reagent_list[1]
	return reagent.name

/obj/item/reagent_containers/cup/glass/cans/empty()
	if(!canopened)
		balloon_alert(usr, "сначала откройте!")
		return
	..()

/obj/item/reagent_containers/cup/glass/cans/examine(mob/user)
	. = ..()
	. += span_notice("<b>[canopened ? "Открыто" : "Закрыто"]</b>")
	if(!canopened)
		. += span_notice("Используйте <b>Ctrl+ЛКМ</b>, чтобы встряхнуть!")

/obj/item/reagent_containers/cup/glass/cans/attack_self(mob/user)
	if(canopened)
		return ..()
	if(times_shaken)
		fizzy_open(user)
...
/obj/item/reagent_containers/cup/glass/cans/proc/crush(mob/user)
...
/obj/item/reagent_containers/cup/glass/cans/CtrlClick(mob/living/user)
...
/obj/item/reagent_containers/cup/glass/cans/attack(mob/living/target, mob/living/user, params, def_zone, skip_attack_anim = FALSE)
	if(!canopened)
...
/obj/item/reagent_containers/cup/glass/cans/attackby(obj/item/I, mob/user, params)
...
/obj/item/reagent_containers/cup/glass/cans/afterattack(atom/target, mob/user, proximity_flag, list/modifiers, status)
	if(!proximity_flag)
		return
...
/obj/item/reagent_containers/cup/glass/cans/throw_impact(atom/A, datum/thrownthing/throwingdatum)
	. = ..()
	if(times_shaken < 5)
		times_shaken++
	else
...
/obj/item/reagent_containers/cup/glass/cans/proc/fizzy_open(mob/user, burstopen = FALSE)
...
/obj/item/reagent_containers/cup/glass/cans/proc/handle_bursting(mob/user)
...
/obj/item/reagent_containers/cup/glass/cans/proc/reset_shakable()
	can_shake = TRUE

/obj/item/reagent_containers/cup/glass/cans/proc/reset_shaken()
	times_shaken--
	if(can_burst)
		can_burst = FALSE
		burst_chance = 0
...
/obj/item/reagent_containers/cup/glass/cans/cola/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/energy
	name = "heart attack"
...
/obj/item/reagent_containers/cup/glass/cans/energy/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/energy/trop
	name = "tropical spasm"
...
/obj/item/reagent_containers/cup/glass/cans/energy/trop/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/energy/milk
	name = "milk flow"
...
/obj/item/reagent_containers/cup/glass/cans/energy/milk/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/energy/grey
	name = "GreyPower"
...
/obj/item/reagent_containers/cup/glass/cans/energy/grey/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/beer/almost_empty
	list_reagents = list("beer" = 1)

/obj/item/reagent_containers/cup/glass/cans/beer/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/non_alcoholic_beer
	name = "non-alcoholic beer"
	desc = "Любимое пойло студентов и тех, кто за рулём."
	icon_state = "alcoholfreebeercan"
	list_reagents = list("noalco_beer" = 30)

/obj/item/reagent_containers/cup/glass/cans/non_alcoholic_beer/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/adminbooze
	name = "admin booze"
...
/obj/item/reagent_containers/cup/glass/cans/adminbooze/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/madminmalt/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/badminbrew
	name = "badmin brew"
...
/obj/item/reagent_containers/cup/glass/cans/badminbrew/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/ale/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/space_mountain_wind
	name = "Space Mountain Wind"
	desc = "Проходит насквозь, словно космический ветер."
	icon_state = "space_mountain_wind"
	list_reagents = list("spacemountainwind" = 30)

/obj/item/reagent_containers/cup/glass/cans/space_mountain_wind/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/thirteenloko
	name = "Thirteen Loko"
...
/obj/item/reagent_containers/cup/glass/cans/thirteenloko/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/dr_gibb/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/starkist
	name = "Star-kist"
	desc = "Вкус звёзд в жидком виде. И тунца..?"
	icon_state = "starkist"
	list_reagents = list("brownstar" = 30)

/obj/item/reagent_containers/cup/glass/cans/starkist/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/space_up
	name = "Space-Up"
	desc = "На вкус как дыра в обшивке у вас во рту. Да, звучит странно."
	icon_state = "space-up"
	list_reagents = list("space_up" = 30)

/obj/item/reagent_containers/cup/glass/cans/space_up/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/lemon_lime
	name = "Lemon-Lime"
	desc = "Терпкая газировка, состоящяя на 0,5% из натуральных цитрусовых!"
	icon_state = "lemon-lime"
	list_reagents = list("lemon_lime" = 30)

/obj/item/reagent_containers/cup/glass/cans/lemon_lime/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/iced_tea
...
/obj/item/reagent_containers/cup/glass/cans/iced_tea/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/grape_juice/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/tonic
	name = "T-Borg's Tonic Water"
	desc = "Вкус странный, но, по крайней мере, хинин держит Космическую Малярию на расстоянии."
	icon_state = "tonic"
	list_reagents = list("tonic" = 50)

/obj/item/reagent_containers/cup/glass/cans/tonic/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/sodawater
	name = "soda water"
	desc = "Вода с газами. Освежает и приятно щекочет во рту."
	icon_state = "sodawater"
	list_reagents = list("sodawater" = 50)

/obj/item/reagent_containers/cup/glass/cans/sodawater/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/synthanol
...
/obj/item/reagent_containers/cup/glass/cans/synthanol/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/bottler
	name = "generic beverage container"
	desc = "Это даже не должно быть заспавненным. Позор тебе, педаль."
	icon_state = "glass_bottle"

/obj/item/reagent_containers/cup/glass/cans/bottler/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/bottler/on_reagent_change()
	update_icon(UPDATE_OVERLAYS)

/obj/item/reagent_containers/cup/glass/cans/bottler/update_overlays()
	. = ..()
	if(reagents.total_volume)
...
/obj/item/reagent_containers/cup/glass/cans/bottler/glass_bottle
	name = "glass bottle"
	desc = "Стеклянная бутылка, подходящая для напитков."
	is_glass = 1

/obj/item/reagent_containers/cup/glass/cans/bottler/glass_bottle/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/bottler/plastic_bottle
	name = "plastic bottle"
	desc = "Пластиковая бутылка, подходящая для напитков."
	icon_state = "plastic_bottle"
	is_plastic = 1

/obj/item/reagent_containers/cup/glass/cans/bottler/plastic_bottle/get_ru_names()
	return alist(
...
/obj/item/reagent_containers/cup/glass/cans/bottler/metal_can
	name = "metal can"
	desc = "A metal can suitable for beverages."
	icon_state = "metal_can"

/obj/item/reagent_containers/cup/glass/cans/bottler/metal_can/get_ru_names()
	return alist(
