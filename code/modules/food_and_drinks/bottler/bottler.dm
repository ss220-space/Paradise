...
/obj/machinery/bottler/Initialize(mapload)
	...
	if(!available_recipes)
		...
		acceptable_items |= /obj/item/reagent_containers/cup/soda_cans
...
/obj/machinery/bottler/attackby(obj/item/I, mob/user, params)
	...
	if(is_type_in_list(I, acceptable_items))
		...
		if(istype(I, /obj/item/reagent_containers/cup/soda_cans))
			var/obj/item/reagent_containers/cup/soda_cans/can = I
			if(!can.reagents)
...
/obj/machinery/bottler/proc/recycle_container(obj/item/O)
	...
	else if(istype(O, /obj/item/reagent_containers/cup/soda_cans))
		var/obj/item/reagent_containers/cup/soda_cans/C = O
		if(C.is_glass)
			con_type = "glass bottle"
			max_define = MAX_GLASS
		else if(C.is_plastic)
...
/obj/machinery/bottler/proc/dispense_empty_container(container)
	var/con_type
	var/obj/item/reagent_containers/cup/soda_cans/bottler/drink_container
	switch(container)
		if(1)	//glass bottle
			con_type = "glass bottle"
			drink_container = /obj/item/reagent_containers/cup/soda_cans/bottler/glass_bottle
		if(2)	//plastic bottle
			con_type = "plastic bottle"
			drink_container = /obj/item/reagent_containers/cup/soda_cans/bottler/plastic_bottle
		if(3)	//metal can
			con_type = "metal can"
			drink_container = /obj/item/reagent_containers/cup/soda_cans/bottler/metal_can
