...
/obj/item/reagent_containers/food/snacks/fishburger
	...
	filling_color = "#FFDEFE"
	bitesize = 3
	list_reagents = list("protein" = 3, "plantmatter" = 3, "vitamin" = 1)
...
/obj/item/reagent_containers/food/snacks/cubancarp
	...
	bitesize = 3
	list_reagents = list("protein" = 3, "plantmatter" = 3, "capsaicin" = 1)
...
/obj/item/reagent_containers/food/snacks/fishandchips
	...
	bitesize = 3
	list_reagents = list("protein" = 3, "plantmatter" = 3)
...
/obj/item/reagent_containers/food/snacks/sashimi
	...
	icon_state = "sashimi"
	bitesize = 3
	list_reagents = list("protein" = 6, "capsaicin" = 5)
...
/obj/item/reagent_containers/food/snacks/sliceable/Ebi_maki
	...
	slices_num = 4
	bitesize = 3
	list_reagents = list("protein" = 4, "plantmatter" = 4)
...
/obj/item/reagent_containers/food/snacks/sushi_Ebi
	...
	bitesize = 3
	list_reagents = list("protein" = 1, "plantmatter" = 1)
	tastes = list("shrimp" = 1, "rice" = 1, "seaweed" = 1)
...
/obj/item/reagent_containers/food/snacks/sliceable/Ikura_maki
	...
	slices_num = 4
	bitesize = 3
	list_reagents = list("plantmatter" = 8, "protein" = 4)
...
/obj/item/reagent_containers/food/snacks/sushi_Ikura
	...
	bitesize = 3
	list_reagents = list("plantmatter" = 2, "protein" = 1)
	tastes = list("salmon roe" = 1, "rice" = 1, "seaweed" = 1)
