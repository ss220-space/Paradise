...
/obj/item/reagent_containers/food/snacks/meat/burn()
	visible_message(span_notice("[declent_ru_cap(NOMINATIVE)] приготовился!"))
...
/obj/item/reagent_containers/food/snacks/monstermeat/spiderleg/burn()
	visible_message(span_notice("[declent_ru_cap(NOMINATIVE)] приготовилась!"))
...
/obj/item/reagent_containers/food/snacks/monstermeat/goliath/burn()
	visible_message(span_notice("[declent_ru_cap(NOMINATIVE)] приготовилось!"))
