...
/obj/item/reagent_containers/food/snacks/icecream
	...
	bitesize = 3
	list_reagents = list("cream" = 1, "sugar" = 1)
...
/obj/item/reagent_containers/food/snacks/icecream/icecreamcone
	...
	volume = 50
	bitesize = 3
	list_reagents = list("cream" = 3, "sugar" = 7, "ice" = 2)
...
/obj/item/reagent_containers/food/snacks/icecream/icecreamcup
	...
	volume = 50
	bitesize = 6
	list_reagents = list("cream" = 5, "chocolate" = 8, "ice" = 2)
...
/obj/item/reagent_containers/food/snacks/friedbanana
	...
	list_reagents = list("sugar" = 5, "plantmatter" = 8, "cornoil" = 4)
...
/obj/item/reagent_containers/food/snacks/amanitajelly
	...
	bitesize = 3
	list_reagents = list("plantmatter" = 6, "amanitin" = 6, "psilocybin" = 3)
	tastes = list("jelly" = 1, "mushroom" = 1)
