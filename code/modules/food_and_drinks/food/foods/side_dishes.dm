...
/obj/item/reagent_containers/food/snacks/cheesyfries
	...
	trash = /obj/item/trash/plate
	filling_color = "#EDDD00"
	list_reagents = list("plantmatter" = 5, "protein" = 1)
...
/obj/item/reagent_containers/food/snacks/beans
	...
	icon_state = "beans"
	list_reagents = list("plantmatter" = 10, "beans" = 10, "vitamin" = 3)
	tastes = list("beans" = 1)
...
/obj/item/reagent_containers/food/snacks/mashed_potatoes //mashed taters
	...
	list_reagents = list("plantmatter" = 5, "gravy" = 5, "mashedpotatoes" = 10, "vitamin" = 2)
...
/obj/item/reagent_containers/food/snacks/loadedbakedpotato
	...
	list_reagents = list("plantmatter" = 6, "protein" = 1)
...
/obj/item/reagent_containers/food/snacks/roastparsnip
	...
	trash = /obj/item/trash/plate
	list_reagents = list("plantmatter" = 3, "vitamin" = 4)
