...
/obj/item/reagent_containers/food/snacks/proteinbar_banana
	...
	tastes = list("банан" = 1, "удовольствие" = 1)
	foodtype = JUNKFOOD
	opened = FALSE


/obj/item/reagent_containers/food/snacks/proteinbar_cherry
	name = "протеиновый батончик \"Слаймодевочка\""
	ru_names = list(
		NOMINATIVE = "протеиновый батончик \"Слаймодевочка\"",
		GENITIVE = "протеинового батончика \"Слаймодевочка\"",
		DATIVE = "протеиновому батончику \"Слаймодевочка\"",
		ACCUSATIVE = "протеиновый батончик \"Слаймодевочка\"",
		INSTRUMENTAL = "протеиновым батончиком \"Слаймодевочка\"",
		PREPOSITIONAL = "протеиновом батончике \"Слаймодевочка\"",
	)
	desc = "Специализированный пищевой продукт с высоким содержанием белка. \
