...
/obj/item/paper/deltainfo
	...
	info = "<font face=\"Verdana\" color=black><center><H1>Буклет нового сотрудника \
			...
			<BR><li>Мостик - <B>Синий</B> - Отсек командования и ВИПов.\
			<BR><li>Двор - <B>Зелёный</B> - Отсек сферы услуг.\
			<BR><li>Карго - <B>Оранжевый</B> - Отсек снабжения и поставок.\
			<BR><li>Инженерия - <B>Жёлтый</B> - Отсек тех. обслуживания и систем станции.\
			...
			<BR><li>Медбей - <B>Голубой</B> - Отсек мед. услуг и разработок.\
			<BR><li>Спутник ИИ - <B>Тёмно-синий</B> - Отсек интеллектуальных систем станции.\
			<BR><li>Отбытие - <B>Салатовый</B> - Отсек прибытия шаттла и церковь.\
			...
			были построены <B>доп. автолаты</B>, в том числе <B>публичные</B> \
