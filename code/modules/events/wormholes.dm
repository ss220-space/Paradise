...
/datum/event/wormholes/announce()
	GLOB.event_announcement.Announce("Зафиксированы пространственно-временные аномалии на борту станции. Дополнительная информация отсутствует.", "ВНИМАНИЕ: АНОМАЛИЯ", new_sound = 'sound/AI/event/wormholes.ogg')
