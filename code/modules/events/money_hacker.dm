...
без вмешательства эта атака будет успешной примерно через 10 минут. Требуемое вмешательство: временно приостановтье любую активность затронутой учетной записи до тех пор, пока атака не прекратится. \
