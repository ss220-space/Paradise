...
/datum/event/sentience/proc/greet_sentient(mob/living/carbon/human/M)
	to_chat(M, custom_boxed_message("green_box", "[span_userdanger("Hello world!")]<br>[span_warning("Due to freak radiation, you have gained human level intelligence and the ability to speak and understand human language!")]"))
