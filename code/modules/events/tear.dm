...
/obj/effect/tear/proc/spawn_leader()
	...
	visible_message(span_danger("С оглушительным рёвом, [mob.declent_ru(NOMINATIVE)] выходит из портала!"))
...
/obj/effect/tear/proc/make_mob(mob_type)
	...
	if(prob(30))
		visible_message(span_danger("[capitalize(mob.declent_ru(NOMINATIVE))] выходит из портала!"))
