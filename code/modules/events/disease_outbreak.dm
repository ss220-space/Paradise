...
/datum/event/disease_outbreak/setup()
	...
	if(virus_type == /datum/disease/virus/advance)
		...
		V = CreateRandomVirus(count_of_symptoms = rand(4, 6), resistance = rand(0,11), stealth = pick(0,0,1,1,2),
...
/datum/event/disease_outbreak/announce()
	...
	for(var/mob/M in GLOB.dead_mob_list)
		to_chat(M, "<span class='deadsay'><b>[patient_zero]</b> был(а) заражён(а) <b>[V.name]</b> ([ghost_follow_link(patient_zero, M)])</span>")
