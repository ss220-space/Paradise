...
/datum/event/brand_intelligence/announce()
	GLOB.event_announcement.Announce("Ожидайте важное сообщение от нашего сотрудника. Дополнение к сообщению: [originMachine.name].", "ВНИМАНИЕ: ЦИФРОВОЙ ВИРУС.", 'sound/announcer/brand_intel.ogg')
