...
/datum/event/alien_infestation/announce()
	if(successSpawn)
		GLOB.event_announcement.Announce("Обнаружены неопознанные формы жизни на борту станции [station_name()]. Обезопасьте все наружные входы и выходы, включая трубопроводы и вентиляцию.", "ВНИМАНИЕ: НЕОПОЗНАННЫЕ ФОРМЫ ЖИЗНИ", new_sound = pick('sound/AI/event/lifesigns1.ogg','sound/AI/event/lifesigns2.ogg','sound/AI/event/lifesigns3.ogg'))
	else
