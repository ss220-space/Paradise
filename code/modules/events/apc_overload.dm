...
/proc/apc_overload_failure(announce=TRUE)
	...
	if(announce)
		GLOB.event_announcement.Announce("Зафиксирована неизвестная активность в станции [station_name()]. В качестве меры предосторожности, питание на станции было временно отключено.", "КРИТИЧЕСКИЙ СБОЙ СИСТЕМЫ ПИТАНИЯ", new_sound = pick('sound/AI/event/poweroff1.ogg','sound/AI/event/poweroff2.ogg'))
