...
/datum/event/apc_overload/announce()
	GLOB.event_announcement.Announce("Зафиксирована перегрузка энергосети станции [station_name ()]. Инженерному отделу надлежит проверить все терминалы ЛКП под напольным покрытием.", "КРИТИЧЕСКИЙ СБОЙ СИСТЕМЫ ПИТАНИЯ", new_sound = 'sound/AI/attention.ogg')
