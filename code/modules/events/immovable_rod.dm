...
/datum/event/immovable_rod/announce()
	GLOB.event_announcement.Announce("Огромный металлический стержень проходит через станцию, разрезая её пополам и уничтожая всё на своём пути", "ВНИМАНИЕ: ОБЩАЯ ТРЕВОГА")
