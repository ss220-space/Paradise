...
/obj/effect/immovablerod/smite/penetrate(mob/living/smeared_mob)
	...
	to_chat(smeared_mob, span_userdanger("Чувствуя как [declent_ru(NOMINATIVE)] проходит через ваши внутренности, вы внезапно осознаёте — боги наказали вас за [reason]!"))
