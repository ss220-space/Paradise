/datum/event/dust/meaty/announce()
	if(prob(16))
		...
		GLOB.event_announcement.Announce("На пути станции были обнаружены мясориты.", "ВНИМАНИЕ: МЯСОРИТЫ", new_sound = pick('sound/AI/event/meteors.ogg','sound/AI/event/meteors2.ogg'))
