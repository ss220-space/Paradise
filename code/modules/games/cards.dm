...
/datum/action/item_action/draw_card/Trigger(left_click = TRUE, attack_self = TRUE)
...
/datum/action/item_action/deal_card/Trigger(left_click = TRUE, attack_self = TRUE)
	if(istype(target, /obj/item/deck))
		var/obj/item/deck/D = target
		return D.deal_card()
	return ..()
...
/datum/action/item_action/deal_card_multi/Trigger(left_click = TRUE, attack_self = TRUE)
	if(istype(target, /obj/item/deck))
		var/obj/item/deck/D = target
...
/datum/action/item_action/shuffle/Trigger(left_click = TRUE, attack_self = TRUE)
	if(istype(target, /obj/item/deck))
		var/obj/item/deck/D = target
...
/datum/action/item_action/remove_card/Trigger(left_click = TRUE, attack_self = TRUE)
...
/datum/action/item_action/discard/Trigger(left_click = TRUE, attack_self = TRUE)
	if(istype(target, /obj/item/cardhand))
		var/obj/item/cardhand/C = target
		return C.discard()
	return ..()
