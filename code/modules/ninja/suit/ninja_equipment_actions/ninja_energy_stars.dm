...
/datum/action/item_action/toggle_shuriken_fire_mode
	...
	desc = "Enable special suit system that generates Shurikens made of pure energy and capable of slowing and damaging enemies far away from you! Energy cost: 450 per burst"
	use_itemicon = FALSE
