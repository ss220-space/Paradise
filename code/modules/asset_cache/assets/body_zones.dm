...
/datum/asset/simple/body_zones/register()
	assets["body_zones.base_midnight.png"] = icon('icons/mob/screen_midnight.dmi', "zone_sel")
	assets["body_zones.base_slimecore.png"] = icon('icons/mob/screen_slimecore.dmi', "zone_sel")

	add_limb(BODY_ZONE_HEAD)
	add_limb(BODY_ZONE_CHEST)
	add_limb(BODY_ZONE_L_ARM)
	add_limb(BODY_ZONE_PRECISE_L_HAND)
	add_limb(BODY_ZONE_R_ARM)
	add_limb(BODY_ZONE_PRECISE_R_HAND)
	add_limb(BODY_ZONE_L_LEG)
	add_limb(BODY_ZONE_PRECISE_L_FOOT)
	add_limb(BODY_ZONE_R_LEG)
	add_limb(BODY_ZONE_PRECISE_R_FOOT)
	add_limb(BODY_ZONE_PRECISE_EYES)
	add_limb(BODY_ZONE_PRECISE_MOUTH)
	add_limb(BODY_ZONE_PRECISE_GROIN)
	add_limb(BODY_ZONE_TAIL)
	add_limb(BODY_ZONE_WING)

	return ..()

/datum/asset/simple/body_zones/proc/add_limb(limb)
	assets[SANITIZE_FILENAME("body_zones.[limb].png")] = icon('icons/mob/zone_sel.dmi', limb)
