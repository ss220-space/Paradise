...
/obj/item/mod/control
	...
	desc = "Устройство управления модульным костюмом - высокотехнологичной одеждой, используемой для защиты пользователя от опасной внешней среды."
...
/obj/item/mod/control/get_ru_names()
	return list(
		NOMINATIVE = "блок управления модульным костюмом",
		GENITIVE = "блока управления модульным костюмом",
		DATIVE = "блоку управления модульным костюмом",
		ACCUSATIVE = "блок управления модульным костюмом",
		INSTRUMENTAL = "блоком управления модульным костюмом",
		PREPOSITIONAL = "блоке управления модульным костюмом"
	)
...
/obj/item/mod/control/examine(mob/user)
	...
	if(!open && !active)
		...
		if(core)
			...
			. += "Ядро отсутствует. Вы можете установить новое <b>ядро модульного костюма</b>."
