...
/datum/mod_theme/loader
	...
	extended_desc = "Данный модульный костюм значительно отличается от стандартных костюмов на рынке. Он представляет из себя \
		...
		Костюм не обладает какой бы то ни было защитой от космоса, однако этот недостаток с лихвой покрывается мощностью и простотой костюма. \
		...
		позволяя носителю передвигаться быстрее и на более длинные расстояния. Нельзя сказать, что этот костюм хоть как-то защищён, \
		однако сама компоновка экзоскелета позволяет сохранить наиболее ценные части костюма в случае смерти пользователя. \
		Многие говорят, что погрузка и разгрузка ящиков — одна из самых тяжёлых и скучных работ в галактике. С данным костюмом \
		это утверждение становится не более чем глупой шуткой."
	default_skin = "loader"
...
/datum/mod_theme/medical
	...
	extended_desc = "Модульный костюм, созданный корпорацией \"Вей-мед\" в сотрудничестве с \"Кибернетикой Бишопа\". \
		...
		за счёт улучшенных сервоприводов и актуаторов. Хотя у костюма практически отсутствует какое бы то ни было бронирование, \
...
/datum/mod_theme/rescue
	...
	extended_desc = "Значительно доработанная версия стандартного медицинского модульного костюма, \
		...
		теперь установлены по всему костюму, отчего парамедик при использовании данного костюма способен быстро поднимать \
		и перемещать даже самых тучных членов экипажа в безопасное место, при этом костюм обладает полной защитой от \
...
/datum/mod_theme/magnate
	...
	extended_desc = "Говорят, что поддержание этого костюма активным стоит сорок тысяч кредитов... в секунду. \
		...
		а для движения задействованы только самые лучшие приводы. Внешнее сходство со шлемом \"Мародёров Горлекса\" является чистейшим [span_warning("совпадением")]."
...
/datum/mod_theme/syndicate
	...
	extended_desc = "Продвинутый боевой костюм, ставший воплощением многих инновационных решений. Создан на пике современных технологий. \
		...
		Все права защищены, нарушение целостности внутренней системы костюма повлечёт аннулирование гарантии\"."
...
/datum/mod_theme/elite
	name = "elite"
	desc = "Элитный боевой костюм, модернизированный корпорацией \"Киберсан\"An elite suit upgraded by Cybersun Industries, offering upgraded armor values."
