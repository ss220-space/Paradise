...
/datum/mod_theme/brig_pilot
	name = "модели \"Часовой\""
	desc = "Продвинутый боевой МЭК, производимый корпорацией \"Стальная Гвардия\" для пилотов космических кораблей. Обладает повышенной мобильностью за счёт \
		снижения грузоподъемности и брони."
	extended_desc = "Продвинутый тактический костюм от \"Стальной Гвардии\", производимый для пилотов космических истребителей и десантных кораблей. \
		Продвинутый визор костюма, внешне напоминающий старинные шлемы пилотов Земли, выводит тактическую информацию в режиме реального времени, \
		а использование синтетической кожи и облегченных сплавов обеспечивает дополнительную мобильность с минимальной потерей защитных свойств костюма. \
		Костюм обеспечивает полную герметичность и активируется значительно быстрее своих аналогов, что не раз спасало пилотов от мучительной смерти в случае \
		\"неожиданной\" разгерметизации кабины пилота. Хотя прямое попадание из крупнокалиберного вооружения средних и крупных кораблей всё еще разорвёт пилота \
		на части, впрочем как и весь челнок вместе с ним, пилоты по всей Галактике отдают предпочтение именно данной модели."
