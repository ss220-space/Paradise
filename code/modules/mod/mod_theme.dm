...
/obj/item/mod/armor/mod_theme_safeguard_one
	armor = list(MELEE = 25, BULLET = 25, LASER = 25, ENERGY = 25, BOMB = 20, RAD = 20, FIRE = INFINITY, ACID = 150)
...
/obj/item/mod/armor/mod_theme_safeguard_two
	armor = list(MELEE = 35, BULLET = 25, LASER = 25, ENERGY = 20, BOMB = 40, RAD = 25, FIRE = INFINITY, ACID = 150)
...
/obj/item/mod/armor/mod_theme_secmed
	armor = list(MELEE = 15, BULLET = 15, LASER = 15, ENERGY = 10, BOMB = 25, RAD = 0, FIRE = 150, ACID = 150)
...
/obj/item/mod/armor/praetorian
	armor = list(MELEE = 25, BULLET = 20, LASER = 20, ENERGY = 15, BOMB = 25, RAD = 0, FIRE = 150, ACID = 150) //Equivalent armor to Security MODsuits
