...
/obj/item/mod/armor/mod_theme
	armor = list(MELEE = 15, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 0, BIO = 100, RAD = 25, FIRE = 33, ACID = 33)
...
/obj/item/mod/armor/mod_theme_engineering
	armor = list(MELEE = 20, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 30, BIO = 100, RAD = 100, FIRE = 100, ACID = 100) //Bomb armor bumped up a bit, as the modsuit describes it with blast-dampening
...
/obj/item/mod/armor/mod_theme_atmospheric
	armor = list(MELEE = 20, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 15, BIO = 100, RAD = 15, FIRE = 100, ACID = 100)
...
/obj/item/mod/armor/mod_theme_advanced
	armor = list(MELEE = 35, BULLET = 10, LASER = 10, ENERGY = 10, BOMB = 50, BIO = 100, RAD = 100, FIRE = 100, ACID = 100)
...
/obj/item/mod/armor/mod_theme_mining
	armor = list(MELEE = 30, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 50, BIO = 100, RAD = 50, FIRE = 50, ACID = 50)
...
/obj/item/mod/armor/mod_theme_loader
	armor = list(MELEE = 20, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 10, BIO = 100, RAD = 0, FIRE = 25, ACID = 25)
...
/obj/item/mod/armor/mod_theme_medical
	armor = list(MELEE = 10, BULLET = 5, LASER = 5, ENERGY = 5, BOMB = 10, BIO = 100, RAD = 0, FIRE = 75, ACID = 100)
...
/obj/item/mod/armor/mod_theme_rescue
	armor = list(MELEE = 20, BULLET = 20, LASER = 5, ENERGY = 5, BOMB = 10, BIO = 100, RAD = 50, FIRE = 100, ACID = 100) //Extra melee / bullet armor for if they get caught in a fight. Of course, no laser armor.
...
/obj/item/mod/armor/mod_theme_research
	armor = list(MELEE = 30, BULLET = 30, LASER = 5, ENERGY = 5, BOMB = 100, BIO = 100, RAD = 75, FIRE = 75, ACID = 100) //Slow balistic / explosive testing armor. Not laser testing however!
