...
/datum/mod_theme/civilian
	...
	desc = "Лёгкий гражданский МЭК, предоставляющий невероятную свободу движений, но не обеспечивает какой-либо защиты от давления."
	extended_desc = "Экспериментальная разработка компании \"Накамура Инженеринг\", предназначенная для путешествий по дружелюбным планетам. \
...
/datum/mod_theme/engineering
	...
	extended_desc = "Один из самых известных костюмов от \"Киберсан\". Прямой потомок морально устаревших ИКС-ов, данный \
		модульный костюм обладает огромным множеством функций, превосходя своих родителей практически во всём. \
		...
		неблагоприятных условиях, не переживая за своё здоровье. Однако сам костюм недалеко ушёл от гражданской версии и его модификация, как и \
...
/datum/mod_theme/atmospheric
	...
	extended_desc = "Данный костюм, выпущенный на рынок \"Киберсан\" является прямой модификацией инженерного костюма. \
		Данная модель была усовершенствована с помощью новейших жаропрочных сплавов, продвинутых радиаторов и охлаждающих контуров. \
