...
/datum/mod_theme/corporate
	...
	extended_desc = "Передовой корпоративный костюм, разработанный для членов высшего управляющего состава \"Нанотрейзен\". \
		...
		Интерьер обтянут передовым микроволокном, поддерживающим микроклимат с регулируемой температурой, влажностью и ароматическим фоном. \
		...
		акт агрессии против корпорации и служит достаточным основанием для применения <b>крайних</b> мер в пределах всех юрисдикций, подконтрольных корпорации. \
