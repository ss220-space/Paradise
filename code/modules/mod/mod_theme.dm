...
/datum/mod_theme/civilian
	name = "модели \"Путник\""
	desc = "Лёгкий гражданский МЭК без герметизации, произведённый \"Накамура Инженеринг\". \
			Обеспечивает высокую подвижность, но не защищает от вакуума, химических или биологических агентов."
	extended_desc = "Разработка компании \"Накамура Инженеринг\", созданная для путешествий по безопасным планетам. \
		\"Путник\" сознательно отказывается от тяжёлой брони, систем жизнеобеспечения и расширенной модульности ради минимального веса, бесшумной работы и максимальной \
		манёвренности в пригодной для дыхания атмосфере. Благодаря уменьшенному профилю он обладает меньшими возможностями для модификации по сравнению с \
		основными моделями МЭК. Использование в зонах с агрессивной средой не рекомендуется."
...
/datum/mod_theme/mining
	...
	extended_desc = "Разработка корпорации \"Нанотрейзен\", созданная на основе ранних индустриальных платформ \"Киберсан Индастриз\" с учётом \
		...
		способный выдержать кратковременное экстремальное воздействие, но быстрой разрушающийся при физическом контакте. Ключевая особенность — \
...
/datum/mod_theme/loader
	...
	extended_desc = "Специализированный модульный экзокостюм от концерна \"Скарборо\", предназначенный для высокоскоростной погрузки, разгрузки \
		...
		зарекомендовал себя эффективное и относительно доступное снаряжение для грузовых работ. \
		...
		Две дополнительные манипуляторные руки синхронизиуруются с нервной системой пользователя, \
...
/datum/mod_theme/medical
	...
	extended_desc = "Модульный костюм медицинской специализации, ориентированный на работу в зонах биологического \
		...
		гарантирующей полную изоляцию от патогенов и коррозионных агентов, включая концентрированные кислоты. Повышенная скорость передвижения \
...
/datum/mod_theme/safeguard_mk_one
	...
	extended_desc = "Легендарная модель от \"Стальной Гвардии\", некогда бывшая стандартом для элитных подразделений. Несмотря на высокую себестоимость \
		...
		плеч, что придаёт оператору внушительный профиль и дополнительную устойчивость к осколочным поражениям. Визорная система заменена на \
		взрывостойкий композитный блок с оптической передачей изображения через миниатюрную камеру на левом плече, что исключает риск ослепления \
		осколками. Все стыки герметизированы укреплёнными уплотнителями, а встроенные боковые радиаторы обеспечивают отвод тепла от активных модулей. \
		Не смотря на то, что \"Защитник\" снята с производства в пользу более современных моделей, данный костюм всё ещё используется \
		охранными и военными структурами."
...
/datum/mod_theme/prototype
	...
	extended_desc = "Это прототип силового экзоскелета, дизайн, устаревший уже на сотни лет. Считается самой первой версией модульного экзо-костюма, \
		...
		хотя ему и не достаёт множества современных технологических решений и удобств, уже ставших привычными по костюмам \"Киберсан Индастриз\". \
...
/datum/mod_theme/gamma_responsory
	...
	extended_desc = "Многократно улучшенный вариант обычного костюма для отрядов быстрого реагирования. \
		...
		ставит этот костюм на один уровень с передовыми разработками \"Киберсан Индастриз\" и \"Мародёров Горлекса\". Ходят слухи, что \
...
/datum/mod_theme/apocryphal
	...
	extended_desc = "Громоздкий, словно танк, и легальный только в техническом смысле боевой костюм в зловещёй черно-красной расцветке. \
