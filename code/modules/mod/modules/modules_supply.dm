...
/obj/item/mod/module/gps/get_ru_names()
	return list(
		NOMINATIVE = "модуль ГПС для модульного костюма",
		GENITIVE = "модуля ГПС для модульного костюма",
		DATIVE = "модулю ГПС для модульного костюма",
		ACCUSATIVE = "модуль ГПС для модульного костюма",
		INSTRUMENTAL = "модулем ГПС для модульного костюма",
		PREPOSITIONAL = "модуле ГПС для модульного костюма",
	)
...
/obj/item/mod/module/clamp/get_ru_names()
	return list(
		NOMINATIVE = "модуль гидравлической клешни для модульного костюма",
		GENITIVE = "модуля гидравлической клешни для модульного костюма",
		DATIVE = "модулю гидравлической клешни для модульного костюма",
		ACCUSATIVE = "модуль гидравлической клешни для модульного костюма",
		INSTRUMENTAL = "модулем гидравлической клешни для модульного костюма",
		PREPOSITIONAL = "модуле гидравлической клешни для модульного костюма",
	)
...
/obj/item/mod/module/clamp/loader/get_ru_names()
	return list(
		NOMINATIVE = "модуль грузовой гидравлической клешни для модульного костюма",
		GENITIVE = "модуля грузовой гидравлической клешни для модульного костюма",
		DATIVE = "модулю грузовой гидравлической клешни для модульного костюма",
		ACCUSATIVE = "модуль грузовой гидравлической клешни для модульного костюма",
		INSTRUMENTAL = "модулем грузовой гидравлической клешни для модульного костюма",
		PREPOSITIONAL = "модуле грузовой гидравлической клешни для модульного костюма",
	)
...
/obj/item/mod/module/drill/get_ru_names()
	return list(
		NOMINATIVE = "модуль дрели для модульного костюма",
		GENITIVE = "модуля дрели для модульного костюма",
		DATIVE = "модулю дрели для модульного костюма",
		ACCUSATIVE = "модуль дрели для модульного костюма",
		INSTRUMENTAL = "модулем дрели для модульного костюма",
		PREPOSITIONAL = "модуле дрели для модульного костюма",
	)
...
/obj/item/mod/module/orebag/get_ru_names()
	return list(
		NOMINATIVE = "модуль рудного хранилища для модульного костюма",
		GENITIVE = "модуля рудного хранилища для модульного костюма",
		DATIVE = "модулю рудного хранилища для модульного костюма",
		ACCUSATIVE = "модуль рудного хранилища для модульного костюма",
		INSTRUMENTAL = "модулем рудного хранилища для модульного костюма",
		PREPOSITIONAL = "модуле рудного хранилища для модульного костюма",
	)
...
/obj/item/mod/module/hydraulic/get_ru_names()
	return list(
		NOMINATIVE = "модуль грузовых гидравлических рук для модульного костюма",
		GENITIVE = "модуля грузовых гидравлических рук для модульного костюма",
		DATIVE = "модулю грузовых гидравлических рук для модульного костюма",
		ACCUSATIVE = "модуль грузовых гидравлических рук для модульного костюма",
		INSTRUMENTAL = "модулем грузовых гидравлических рук для модульного костюма",
		PREPOSITIONAL = "модуле грузовых гидравлических рук для модульного костюма",
	)
...
/obj/item/mod/module/magnet/get_ru_names()
	return list(
		NOMINATIVE = "модуль грузового гидравлического магнита для модульного костюма",
		GENITIVE = "модуля грузового гидравлического магнита для модульного костюма",
		DATIVE = "модулю грузового гидравлического магнита для модульного костюма",
		ACCUSATIVE = "модуль грузового гидравлического магнита для модульного костюма",
		INSTRUMENTAL = "модулем грузового гидравлического магнита для модульного костюма",
		PREPOSITIONAL = "модуле грузового гидравлического магнита для модульного костюма",
	)
...
/obj/item/mod/module/ash_accretion/get_ru_names()
	return list(
		NOMINATIVE = "модуль пепельного аттрактора для модульного костюма",
		GENITIVE = "модуля пепельного аттрактора для модульного костюма",
		DATIVE = "модулю пепельного аттрактора для модульного костюма",
		ACCUSATIVE = "модуль пепельного аттрактора для модульного костюма",
		INSTRUMENTAL = "модулем пепельного аттрактора для модульного костюма",
		PREPOSITIONAL = "модуле пепельного аттрактора для модульного костюма",
	)
...
/obj/item/mod/module/sphere_transform/get_ru_names()
	return list(
		NOMINATIVE = "модуль превращения в сферу для модульного костюма",
		GENITIVE = "модуля превращения в сферу для модульного костюма",
		DATIVE = "модулю превращения в сферу для модульного костюма",
		ACCUSATIVE = "модуль превращения в сферу для модульного костюма",
		INSTRUMENTAL = "модулем превращения в сферу для модульного костюма",
		PREPOSITIONAL = "модуле превращения в сферу для модульного костюма",
	)
