...
/obj/item/mod/module/injector/get_ru_names()
	return list(
		NOMINATIVE = "инжекторный модуль для модульного костюма",
		GENITIVE = "инжекторного модуля для модульного костюма",
		DATIVE = "инжекторному модулю для модульного костюма",
		ACCUSATIVE = "инжекторный модуль для модульного костюма",
		INSTRUMENTAL = "инжекторным модулем для модульного костюма",
		PREPOSITIONAL = "инжекторном модуле для модульного костюма",
	)
...
/obj/item/reagent_containers/syringe/mod/get_ru_names()
	return list(
		NOMINATIVE = "шприц-инъектор для модульного костюма",
		GENITIVE = "шприца-инъектора для модульного костюма",
		DATIVE = "шприцу-инъектору для модульного костюма",
		ACCUSATIVE = "шприц-инъектор для модульного костюма",
		INSTRUMENTAL = "шприцом-инъектором для модульного костюма",
		PREPOSITIONAL = "шприце-инъекторе для модульного костюма",
	)
...
/obj/item/mod/module/defibrillator/get_ru_names()
	return list(
		NOMINATIVE = "модуль-дефибриллятор для модульного костюма",
		GENITIVE = "модуля-дефибриллятора для модульного костюма",
		DATIVE = "модулю-дефибриллятору для модульного костюма",
		ACCUSATIVE = "модуль-дефибриллятор для модульного костюма",
		INSTRUMENTAL = "модулем-дефибриллятором для модульного костюма",
		PREPOSITIONAL = "модуле-дефибрилляторе для модульного костюма",
	)
...
/obj/item/mod/module/defibrillator/combat/get_ru_names()
	return list(
		NOMINATIVE = "боевой модуль-дефибриллятор для модульного костюма",
		GENITIVE = "боевого модуля-дефибриллятора для модульного костюма",
		DATIVE = "боевому модулю-дефибриллятору для модульного костюма",
		ACCUSATIVE = "боевой модуль-дефибриллятор для модульного костюма",
		INSTRUMENTAL = "боевым модулем-дефибриллятором для модульного костюма",
		PREPOSITIONAL = "боевом модуле-дефибрилляторе для модульного костюма",
	)
...
/obj/item/mod/module/monitor/get_ru_names()
	return list(
		NOMINATIVE = "модуль монитора наблюдения за экипажем для модульного костюма",
		GENITIVE = "модуля монитора наблюдения за экипажем для модульного костюма",
		DATIVE = "модулю монитора наблюдения за экипажем для модульного костюма",
		ACCUSATIVE = "модуль монитора наблюдения за экипажем для модульного костюма",
		INSTRUMENTAL = "модулем монитора наблюдения за экипажем для модульного костюма",
		PREPOSITIONAL = "модуле монитора наблюдения за экипажем для модульного костюма",
	)
...
/obj/item/sensor_device/mod/get_ru_names()
	return list(
		NOMINATIVE = "ручной монитор экипажа для модульного костюма",
		GENITIVE = "ручного монитора экипажа для модульного костюма",
		DATIVE = "ручному монитору экипажа для модульного костюма",
		ACCUSATIVE = "ручной монитор экипажа для модульного костюма",
		INSTRUMENTAL = "ручным монитором экипажа для модульного костюма",
		PREPOSITIONAL = "ручном мониторе экипажа для модульного костюма"
	)
