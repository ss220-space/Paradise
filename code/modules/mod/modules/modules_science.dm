...
/obj/item/mod/module/reagent_scanner/get_ru_names()
	return list(
		NOMINATIVE = "модуль сканера реагентов для модульного костюма",
		GENITIVE = "модуля сканера реагентов для модульного костюма",
		DATIVE = "модулю сканера реагентов для модульного костюма",
		ACCUSATIVE = "модуль сканера реагентов для модульного костюма",
		INSTRUMENTAL = "модулем сканера реагентов для модульного костюма",
		PREPOSITIONAL = "модуле сканера реагентов для модульного костюма",
	)
...
/obj/item/mod/module/reagent_scanner/advanced/get_ru_names()
	return list(
		NOMINATIVE = "модуль продвинутого сканера реагентов для модульного костюма",
		GENITIVE = "модуля продвинутого сканера реагентов для модульного костюма",
		DATIVE = "модулю продвинутого сканера реагентов для модульного костюма",
		ACCUSATIVE = "модуль продвинутого сканера реагентов для модульного костюма",
		INSTRUMENTAL = "модулем продвинутого сканера реагентов для модульного костюма",
		PREPOSITIONAL = "модуле продвинутого сканера реагентов для модульного костюма",
	)
...
/obj/item/mod/module/anomaly_locked/teleporter/get_ru_names()
	return list(
		NOMINATIVE = "модуль телепортера для модульного костюма",
		GENITIVE = "модуля телепортера для модульного костюма",
		DATIVE = "модулю телепортера для модульного костюма",
		ACCUSATIVE = "модуль телепортера для модульного костюма",
		INSTRUMENTAL = "модулем телепортера для модульного костюма",
		PREPOSITIONAL = "модуле телепортера для модульного костюма",
	)
