...
/obj/item/mod/module/bikehorn/get_ru_names()
	return list(
		NOMINATIVE = "модуль гудка для модульного костюма",
		GENITIVE = "модуля гудка для модульного костюма",
		DATIVE = "модулю гудка для модульного костюма",
		ACCUSATIVE = "модуль гудка для модульного костюма",
		INSTRUMENTAL = "модулем гудка для модульного костюма",
		PREPOSITIONAL = "модуле гудка для модульного костюма",
	)
...
/obj/item/mod/module/waddle/get_ru_names()
	return list(
		NOMINATIVE = "модуль покачивания для модульного костюма",
		GENITIVE = "модуля покачивания для модульного костюма",
		DATIVE = "модулю покачивания для модульного костюма",
		ACCUSATIVE = "модуль покачивания для модульного костюма",
		INSTRUMENTAL = "модулем покачивания для модульного костюма",
		PREPOSITIONAL = "модуле покачивания для модульного костюма",
	)
...
/obj/item/mod/module/boot_heating/get_ru_names()
	return list(
		NOMINATIVE = "модуль согревающей обуви для модульного костюма",
		GENITIVE = "модуля согревающей обуви для модульного костюма",
		DATIVE = "модулю согревающей обуви для модульного костюма",
		ACCUSATIVE = "модуль согревающей обуви для модульного костюма",
		INSTRUMENTAL = "модулем согревающей обуви для модульного костюма",
		PREPOSITIONAL = "модуле согревающей обуви для модульного костюма",
	)
