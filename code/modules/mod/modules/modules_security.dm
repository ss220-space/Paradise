...
/obj/item/mod/module/holster/get_ru_names()
	return list(
		NOMINATIVE = "модуль кобуры для модульного костюма",
		GENITIVE = "модуля кобуры для модульного костюма",
		DATIVE = "модулю кобуры для модульного костюма",
		ACCUSATIVE = "модуль кобуры для модульного костюма",
		INSTRUMENTAL = "модулем кобуры для модульного костюма",
		PREPOSITIONAL = "модуле кобуры для модульного костюма",
	)
...
/obj/item/mod/module/holster/get_ru_names()
	return list(
		NOMINATIVE = "модуль диспенсера гранат класса \"Мираж\" для модульного костюма",
		GENITIVE = "модуля диспенсера гранат класса \"Мираж\" для модульного костюма",
		DATIVE = "модулю диспенсера гранат класса \"Мираж\" для модульного костюма",
		ACCUSATIVE = "модуль диспенсера гранат класса \"Мираж\" для модульного костюма",
		INSTRUMENTAL = "модулем диспенсера гранат класса \"Мираж\" для модульного костюма",
		PREPOSITIONAL = "модуле диспенсера гранат класса \"Мираж\" для модульного костюма",
	)
...
/obj/item/mod/module/active_sonar/get_ru_names()
	return list(
		NOMINATIVE = "модуль сонара для модульного костюма",
		GENITIVE = "модуля сонара для модульного костюма",
		DATIVE = "модулю сонара для модульного костюма",
		ACCUSATIVE = "модуль сонара для модульного костюма",
		INSTRUMENTAL = "модулем сонара для модульного костюма",
		PREPOSITIONAL = "модуле сонара для модульного костюма",
	)
...
/obj/item/mod/module/anomaly_locked/firewall/get_ru_names()
	return list(
		NOMINATIVE = "модуль огненного щита для модульного костюма",
		GENITIVE = "модуля огненного щита для модульного костюма",
		DATIVE = "модулю огненного щита для модульного костюма",
		ACCUSATIVE = "модуль огненного щита для модульного костюма",
		INSTRUMENTAL = "модулем огненного щита для модульного костюма",
		PREPOSITIONAL = "модуле огненного щита для модульного костюма",
	)
...
/obj/item/mod/module/anomaly_locked/vortex_shotgun/get_ru_names()
	return list(
		NOMINATIVE = "модуль вихревого дробовика для модульного костюма",
		GENITIVE = "модуля вихревого дробовика для модульного костюма",
		DATIVE = "модулю вихревого дробовика для модульного костюма",
		ACCUSATIVE = "модуль вихревого дробовика для модульного костюма",
		INSTRUMENTAL = "модулем вихревого дробовика для модульного костюма",
		PREPOSITIONAL = "модуле вихревого дробовика для модульного костюма",
	)
