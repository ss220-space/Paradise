...
/obj/item/mod/module/active_sonar/on_use()
	...
	to_chat(mod.wearer, (span_notice("Вы бьёте кулаком в пол, запуская звуковую волну сонара, которая обнаруживает [creatures_detected] жив[DECL_OJE_YH_YH(creatures_detected)] существ[DECL_O_A_0(creatures_detected)] поблизости!")))
