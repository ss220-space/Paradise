...
/obj/item/mod/module/anomaly_locked/kinesis
	...
	desc = "Модульное устройство, подключаемое к предплечью костюма. Восстановленная технология, \
		...
		или тяжелую промышленную технику. Судя по всему, модуль способен перемещать и живых существ, однако \
...
/obj/item/mod/module/anomaly_locked/kinesis/get_ru_names()
	return list(
		NOMINATIVE = "Модуль для модульного костюма \"Кинезис\"",
		GENITIVE = "Модуля для модульного костюма \"Кинезис\"",
		DATIVE = "Модулю для модульного костюма \"Кинезис\"",
		ACCUSATIVE = "Модуль для модульного костюма \"Кинезис\"",
		INSTRUMENTAL = "Модулем для модульного костюма \"Кинезис\"",
		PREPOSITIONAL = "Модуле для модульного костюма \"Кинезис\"",
	)
...
/obj/item/mod/module/anomaly_locked/kinesis/on_select_use(atom/target)
	...
	beam.chain = beam.Beam(grabbed_atom, "kinesis")
