...
/obj/item/mod/module/welding/get_ru_names()
	return list(
		NOMINATIVE = "модуль защиты от сварки для МЭК",
		GENITIVE = "модуля защиты от сварки для МЭК",
		DATIVE = "модулю защиты от сварки для МЭК",
		ACCUSATIVE = "модуль защиты от сварки для МЭК",
		INSTRUMENTAL = "модулем защиты от сварки для МЭК",
		PREPOSITIONAL = "модуле защиты от сварки для МЭК",
	)
...
/obj/item/mod/module/t_ray/get_ru_names()
	return list(
		NOMINATIVE = "модуль терагерцового сканирования для МЭК",
		GENITIVE = "модуля терагерцового сканирования для МЭК",
		DATIVE = "модулю терагерцового сканирования для МЭК",
		ACCUSATIVE = "модуль терагерцового сканирования для МЭК",
		INSTRUMENTAL = "модулем терагерцового сканирования для МЭК",
		PREPOSITIONAL = "модуле терагерцового сканирования для МЭК",
	)
...
/obj/item/mod/module/magboot/get_ru_names()
	return list(
		NOMINATIVE = "модуль магнитных усилителей для МЭК",
		GENITIVE = "модуля магнитных усилителей для МЭК",
		DATIVE = "модулю магнитных усилителей для МЭК",
		ACCUSATIVE = "модуль магнитных усилителей для МЭК",
		INSTRUMENTAL = "модулем магнитных усилителей для МЭК",
		PREPOSITIONAL = "модуле магнитных усилителей для МЭК",
	)
...
/obj/item/mod/module/magboot/advanced/get_ru_names()
	return list(
		NOMINATIVE = "модуль продвинутых магнитных усилителей для МЭК",
		GENITIVE = "модуля продвинутых магнитных усилителей для МЭК",
		DATIVE = "модулю продвинутых магнитных усилителей для МЭК",
		ACCUSATIVE = "модуль продвинутых магнитных усилителей для МЭК",
		INSTRUMENTAL = "модулем продвинутых магнитных усилителей для МЭК",
		PREPOSITIONAL = "модуле продвинутых магнитных усилителей для МЭК",
	)
...
/obj/item/mod/module/rad_protection/get_ru_names()
	return list(
		NOMINATIVE = "модуль радиационного сканирования для МЭК",
		GENITIVE = "модуля радиационного сканирования для МЭК",
		DATIVE = "модулю радиационного сканирования для МЭК",
		ACCUSATIVE = "модуль радиационного сканирования для МЭК",
		INSTRUMENTAL = "модулем радиационного сканирования для МЭК",
		PREPOSITIONAL = "модуле радиационного сканирования для МЭК",
	)
...
/obj/item/mod/module/tether/get_ru_names()
	return list(
		NOMINATIVE = "модуль аварийного троса для МЭК",
		GENITIVE = "модуля аварийного троса для МЭК",
		DATIVE = "модулю аварийного троса для МЭК",
		ACCUSATIVE = "модуль аварийного троса для МЭК",
		INSTRUMENTAL = "модулем аварийного троса для МЭК",
		PREPOSITIONAL = "модуле аварийного троса для МЭК",
	)
...
/obj/item/mod/module/firefighting_tank/get_ru_names()
	return list(
		NOMINATIVE = "модуль пожаротушения для МЭК",
		GENITIVE = "модуля пожаротушения для МЭК",
		DATIVE = "модулю пожаротушения для МЭК",
		ACCUSATIVE = "модуль пожаротушения для МЭК",
		INSTRUMENTAL = "модулем пожаротушения для МЭК",
		PREPOSITIONAL = "модуле пожаротушения для МЭК",
	)
