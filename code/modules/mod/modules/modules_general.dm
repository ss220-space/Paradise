...
/obj/item/mod/module/storage/get_ru_names()
	return list(
		NOMINATIVE = "модуль вместимости для модульного костюма",
		GENITIVE = "модуля вместимости для модульного костюма",
		DATIVE = "модулю вместимости для модульного костюма",
		ACCUSATIVE = "модуль вместимости для модульного костюма",
		INSTRUMENTAL = "модулем вместимости для модульного костюма",
		PREPOSITIONAL = "модуле вместимости для модульного костюма",
	)
...
/obj/item/mod/module/storage/large_capacity/get_ru_names()
	return list(
		NOMINATIVE = "модуль повышенной вместимости для модульного костюма",
		GENITIVE = "модуля повышенной вместимости для модульного костюма",
		DATIVE = "модулю повышенной вместимости для модульного костюма",
		ACCUSATIVE = "модуль повышенной вместимости для модульного костюма",
		INSTRUMENTAL = "модулем повышенной вместимости для модульного костюма",
		PREPOSITIONAL = "модуле повышенной вместимости для модульного костюма",
	)
...
/obj/item/mod/module/storage/syndicate/get_ru_names()
	return list(
		NOMINATIVE = "модуль вместимости синдиката для модульного костюма",
		GENITIVE = "модуля вместимости синдиката для модульного костюма",
		DATIVE = "модулю вместимости синдиката для модульного костюма",
		ACCUSATIVE = "модуль вместимости синдиката для модульного костюма",
		INSTRUMENTAL = "модулем вместимости синдиката для модульного костюма",
		PREPOSITIONAL = "модуле вместимости синдиката для модульного костюма",
	)
...
/obj/item/mod/module/storage/belt/get_ru_names()
	return list(
		NOMINATIVE = "модуль пониженной вместимости для модульного костюма",
		GENITIVE = "модуля пониженной вместимости для модульного костюма",
		DATIVE = "модулю пониженной вместимости для модульного костюма",
		ACCUSATIVE = "модуль пониженной вместимости для модульного костюма",
		INSTRUMENTAL = "модулем пониженной вместимости для модульного костюма",
		PREPOSITIONAL = "модуле пониженной вместимости для модульного костюма",
	)
...
/obj/item/mod/module/storage/bluespace/get_ru_names()
	return list(
		NOMINATIVE = "модуль блюспейс-хранилища для модульного костюма",
		GENITIVE = "модуля блюспейс-хранилища для модульного костюма",
		DATIVE = "модулю блюспейс-хранилища для модульного костюма",
		ACCUSATIVE = "модуль блюспейс-хранилища для модульного костюма",
		INSTRUMENTAL = "модулем блюспейс-хранилища для модульного костюма",
		PREPOSITIONAL = "модуле блюспейс-хранилища для модульного костюма",
	)
...
/obj/item/mod/module/jetpack/get_ru_names()
	return list(
		NOMINATIVE = "модуль ионного джетпака для модульного костюма",
		GENITIVE = "модуля ионного джетпака для модульного костюма",
		DATIVE = "модулю ионного джетпака для модульного костюма",
		ACCUSATIVE = "модуль ионного джетпака для модульного костюма",
		INSTRUMENTAL = "модулем ионного джетпака для модульного костюма",
		PREPOSITIONAL = "модуле ионного джетпака для модульного костюма",
	)
...
/obj/item/mod/module/jetpack/advanced/get_ru_names()
	return list(
		NOMINATIVE = "модуль продвинутого ионного джетпака для модульного костюма",
		GENITIVE = "модуля продвинутого ионного джетпака для модульного костюма",
		DATIVE = "модулю продвинутого ионного джетпака для модульного костюма",
		ACCUSATIVE = "модуль продвинутого ионного джетпака для модульного костюма",
		INSTRUMENTAL = "модулем продвинутого ионного джетпака для модульного костюма",
		PREPOSITIONAL = "модуле продвинутого ионного джетпака для модульного костюма",
	)
...
/obj/item/mod/module/emp_shield/get_ru_names()
	return list(
		NOMINATIVE = "модуль защиты от ЭМИ для модульного костюма",
		GENITIVE = "модуля защиты от ЭМИ для модульного костюма",
		DATIVE = "модулю защиты от ЭМИ для модульного костюма",
		ACCUSATIVE = "модуль защиты от ЭМИ для модульного костюма",
		INSTRUMENTAL = "модулем защиты от ЭМИ для модульного костюма",
		PREPOSITIONAL = "модуле защиты от ЭМИ для модульного костюма",
	)
...
/obj/item/mod/module/flashlight/get_ru_names()
	return list(
		NOMINATIVE = "модуль фонарика для модульного костюма",
		GENITIVE = "модуля фонарика для модульного костюма",
		DATIVE = "модулю фонарика для модульного костюма",
		ACCUSATIVE = "модуль фонарика для модульного костюма",
		INSTRUMENTAL = "модулем фонарика для модульного костюма",
		PREPOSITIONAL = "модуле фонарика для модульного костюма",
	)
...
/obj/item/mod/module/dispenser/get_ru_names()
	return list(
		NOMINATIVE = "модуль раздатчика бургеров для модульного костюма",
		GENITIVE = "модуля раздатчика бургеров для модульного костюма",
		DATIVE = "модулю раздатчика бургеров для модульного костюма",
		ACCUSATIVE = "модуль раздатчика бургеров для модульного костюма",
		INSTRUMENTAL = "модулем раздатчика бургеров для модульного костюма",
		PREPOSITIONAL = "модуле раздатчика бургеров для модульного костюма",
	)
...
/obj/item/mod/module/thermal_regulator/get_ru_names()
	return list(
		NOMINATIVE = "модуль температурного регулятора для модульного костюма",
		GENITIVE = "модуля температурного регулятора для модульного костюма",
		DATIVE = "модулю температурного регулятора для модульного костюма",
		ACCUSATIVE = "модуль температурного регулятора для модульного костюма",
		INSTRUMENTAL = "модулем температурного регулятора для модульного костюма",
		PREPOSITIONAL = "модуле ртемпературного регулятора для модульного костюма",
	)
...
/obj/item/mod/module/dna_lock/get_ru_names()
	return list(
		NOMINATIVE = "модуль ДНК-блокировки для модульного костюма",
		GENITIVE = "модуля ДНК-блокировки для модульного костюма",
		DATIVE = "модулю ДНК-блокировки для модульного костюма",
		ACCUSATIVE = "модуль ДНК-блокировки для модульного костюма",
		INSTRUMENTAL = "модулем ДНК-блокировки для модульного костюма",
		PREPOSITIONAL = "модуле ДНК-блокировки для модульного костюма",
	)
...
/obj/item/mod/module/dna_lock/emp_shield/get_ru_names()
	return list(
		NOMINATIVE = "модуль ДНК-блокировки и защиты от ЭМИ для модульного костюма",
		GENITIVE = "модуля ДНК-блокировки и защиты от ЭМИ для модульного костюма",
		DATIVE = "модулю ДНК-блокировки и защиты от ЭМИ для модульного костюма",
		ACCUSATIVE = "модуль ДНК-блокировки и защиты от ЭМИ для модульного костюма",
		INSTRUMENTAL = "модулем ДНК-блокировки и защиты от ЭМИ для модульного костюма",
		PREPOSITIONAL = "модуле ДНК-блокировки и защиты от ЭМИ для модульного костюма",
	)
...
/obj/item/mod/module/plasma_stabilizer/get_ru_names()
	return list(
		NOMINATIVE = "модуль стабилизации плазмы для модульного костюма",
		GENITIVE = "модуля стабилизации плазмы для модульного костюма",
		DATIVE = "модулю стабилизации плазмы для модульного костюма",
		ACCUSATIVE = "модуль стабилизации плазмы для модульного костюма",
		INSTRUMENTAL = "модулем стабилизации плазмы для модульного костюма",
		PREPOSITIONAL = "модуле стабилизации плазмы для модульного костюма",
	)
