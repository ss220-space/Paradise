...
/obj/structure/cable/multilayer/attack_hand(mob/living/user, list/modifiers)
	...
	if(!GLOB.hub_radial_layer_list)
		GLOB.hub_radial_layer_list = list(
			"Layer 1" = image(icon = 'icons/hud/radial.dmi', icon_state = "coil-yellow"),
			"Layer 2" = image(icon = 'icons/hud/radial.dmi', icon_state = "coil-red"),
...
/obj/structure/cable/multilayer/multiz/layer1
	color = CABLE_HEX_COLOR_YELLOW
	cable_layer = CABLE_LAYER_1

/obj/structure/cable/multilayer/multiz/layer2
	color = CABLE_HEX_COLOR_RED
	cable_layer = CABLE_LAYER_2

/obj/structure/cable/multilayer/multiz/layer3
