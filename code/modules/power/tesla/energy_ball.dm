...
/obj/singularity/energy_ball/process()
	if(!orbiting)
		...
		playsound(src.loc, 'sound/effects/magic/lightningbolt.ogg', 100, 1, extrarange = 30)
...
/obj/singularity/energy_ball/proc/handle_energy()
	if(energy >= energy_to_raise)
		...
		playsound(src.loc, 'sound/effects/magic/lightning_chargeup.ogg', 100, 1, extrarange = 30)
