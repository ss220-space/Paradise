...
/obj/machinery/power/supermatter_shard
	...
	desc = "A strangely translucent and iridescent crystal that looks like it used to be part of a larger structure. [span_danger("You get headaches just from looking at it.")]"
...
/obj/machinery/power/supermatter_shard/anchored
	...
	desc = "A strangely translucent and iridescent crystal that looks like it used to be part of a larger structure. Apparently the structure is attached to the surface with industrial equipment, it cannot be unanchored with simple equipment. [span_danger("You get headaches just from looking at it.")]"
	anchored = TRUE
