...
/proc/supermatter_anomaly_gen(turf/anomalycenter, type = FLUX_ANOMALY, anomalyrange = 5, has_changed_lifespan = TRUE)
	...
	switch(type)
		if(FLUX_ANOMALY)
			...
			new /obj/effect/anomaly/energetic/tier2(local_turf)
		if(GRAVITATIONAL_ANOMALY)
			new /obj/effect/anomaly/gravitational/tier2(local_turf)
		if(PYRO_ANOMALY)
			new /obj/effect/anomaly/atmospheric/tier2(local_turf)
		...
		if(VORTEX_ANOMALY)
			new /obj/effect/anomaly/vortex/tier2(local_turf)
