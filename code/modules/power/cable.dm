...
/obj/structure/cable/add_context(atom/source, list/context, obj/item/held_item, mob/user)
	. = NONE
	switch(held_item.tool_behaviour)
		if(TOOL_WIRECUTTER)
			context[SCREENTIP_CONTEXT_LMB] = "Разобрать"
			context[SCREENTIP_CONTEXT_RMB] = "Поменять соединения"
...
/obj/structure/cable/wirecutter_act_secondary(mob/living/user, obj/item/tool)
	...
	var/obj/item/cutters = user.get_active_hand()
