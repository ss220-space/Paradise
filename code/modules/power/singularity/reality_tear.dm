/**
 * Typically spawned by placing two bags of holding into one another,
 * collapsing into a wandering singularity after a brief period as a stationary singularity.
 */
/obj/reality_tear
...
/obj/reality_tear/proc/start_disaster()
	...
	playsound(loc, 'sound/magic/clockwork/clockcult_gateway_disrupted.ogg', 200, vary = TRUE, extrarange = 3, falloff_exponent = 1, frequency = 0.33, pressure_affected = FALSE, ignore_walls = TRUE, falloff_distance = 7)
	AddComponent(
