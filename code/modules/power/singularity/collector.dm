...
/obj/machinery/power/rad_collector/attack_hand(mob/user)
	...
	if(anchored)
		if(!src.locked)
			...
			investigate_log("turned [active?"<font color='green'>on</font>":"<font color='red'>off</font>"] by [key_name_log(user)]. [P?"Fuel: [round(P.air_contents.gases[GAS_PL][MOLES] / 0.29)]%":"<font color='red'>It is empty</font>"].", INVESTIGATE_ENGINE)
			return
		else
