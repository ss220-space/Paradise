...
/datum/addition_goal/prisoners/setup()
	...
	description = "Запрос исполнения наказания №[request_number]. На станцию прибудет шаттл с [prisoners_count] заключенным[DECL_0_I_I(prisoners_count)] для исполнения наказания."
