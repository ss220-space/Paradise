...
ADMIN_VERB(set_holiday, R_SERVER, "Задать праздник", "Принудительно задать переменную \"Праздник\", чтобы игра считала, что сегодня определённый день.", ADMIN_CATEGORY_EVENTS)
