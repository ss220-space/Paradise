...
/datum/crafting_recipe/assemble_alternative_drill
	name = "assemble thermal drill (alternative)"
	reqs = list(
		/obj/item/stack/cable_coil = 5,
...
/datum/crafting_recipe/assemble_diamond_drill
	name = "assemble diamond tipped thermal drill"
	reqs = list(
		/obj/item/stack/cable_coil = 5,
...
/datum/crafting_recipe/assemble_tuned_anomalous_teleporter
	name = "assemble tuned anomalous teleporter"
	reqs = list(
...
/datum/crafting_recipe/disassembly_voice_modulator
...
/datum/crafting_recipe/disassembly_radio
	name = "disassemble radio"
	result = list(
		/obj/item/stack/cable_coil = 5,
		/obj/item/stock_parts/cell = 1,
...
/datum/crafting_recipe/disassembly_flashlight
	name = "disassemble flashlight"
	result = list(
		/obj/item/light/bulb = 1,
...
/datum/crafting_recipe/disassembly_lamp
	name = "disassemble desk lamp"
	result = list(
		/obj/item/light/bulb = 1,
		/obj/item/mounted/frame/light_fixture/small = 1,
		/obj/item/stack/cable_coil = 5,
