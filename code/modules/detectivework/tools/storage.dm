/obj/item/storage/box/swabs
	...
	desc = "Коробка с наборами стерильных ватных палочек для проведения криминалистических исследований."
	ru_names = list(
...
/obj/item/storage/box/fingerprints
	...
	desc = "Коробка с дактилоскопическими картами для снятия отпечатков пальцев."
	ru_names = list(
