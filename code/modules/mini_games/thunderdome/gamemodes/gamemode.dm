...
/datum/thunderdome_gamemode/ranged
	...
	item_pool = list(
		...
		/obj/item/gun/ballistic/automatic/ik60 = 2,
		/obj/item/gun/ballistic/automatic/shotgun/bulldog = 2,
		/obj/item/gun/ballistic/revolver/mateba = 4,
		/obj/item/gun/ballistic/shotgun/automatic = 2,
		/obj/item/gun/ballistic/shotgun/riot = 2,
		/obj/item/gun/ballistic/automatic/ak814 = 2,
		/obj/item/gun/ballistic/shotgun/riot/buckshot = 3,
		/obj/item/gun/ballistic/shotgun/boltaction = 1,
		/obj/item/gun/ballistic/shotgun/automatic/combat = 2,
		/obj/item/gun/ballistic/automatic/pistol/APS = 2,
		/obj/item/gun/ballistic/automatic/pistol/sp8/sp8ar = 1,
		/obj/item/gun/ballistic/automatic/pistol/m1911 = 2,
		/obj/item/gun/ballistic/revolver/golden = 2,
		...
		/obj/item/gun/ballistic/shotgun/automatic/dual_tube = 2,
		/obj/item/gun/ballistic/automatic/gyropistol = 2,
		/obj/item/gun/ballistic/automatic/sfg = 2,
		/obj/item/gun/ballistic/automatic/sp91rc = 2,
		/obj/item/gun/ballistic/automatic/sparkle_a12 = 2,
		/obj/item/gun/ballistic/automatic/m90 = 2,
		/obj/item/gun/ballistic/automatic/aks74u = 2,
		/obj/item/gun/ballistic/automatic/ppsh = 2,
		/obj/item/gun/ballistic/automatic/shotgun/minotaur = 2,
		/obj/item/gun/ballistic/automatic/lr30 = 2,
...
/datum/thunderdome_gamemode/mixed
	...
	item_pool = list(
		...
		/obj/item/gun/ballistic/automatic/l6_saw = 1,
		/obj/item/gun/ballistic/automatic/ik60 = 1,
		/obj/item/gun/ballistic/automatic/shotgun/bulldog = 1,
		/obj/item/gun/magic/staff/slipping = 1,
		/obj/item/gun/ballistic/revolver/mateba = 3,
		/obj/item/gun/ballistic/shotgun/automatic = 2,
		/obj/item/gun/ballistic/shotgun/riot = 2,
		/obj/item/gun/ballistic/automatic/ak814 = 1,
		/obj/item/gun/ballistic/shotgun/riot/buckshot = 3,
		/obj/item/gun/ballistic/shotgun/boltaction = 1,
		/obj/item/gun/ballistic/shotgun/automatic/combat = 2,
		...
		/obj/item/gun/ballistic/automatic/sfg = 1,
		/obj/item/gun/ballistic/automatic/sp91rc = 1,
		/obj/item/gun/ballistic/automatic/sparkle_a12 = 2,
		/obj/item/gun/ballistic/automatic/m90 = 1,
		/obj/item/gun/ballistic/automatic/aks74u = 1,
		/obj/item/gun/ballistic/automatic/ppsh = 1,
		/obj/item/gun/ballistic/automatic/shotgun/minotaur = 1,
		/obj/item/gun/ballistic/automatic/lr30 = 1,
		/obj/item/gun/energy/sniperrifle = 1,
		/obj/item/gun/energy/sniperrifle/pod_pilot = 1,
