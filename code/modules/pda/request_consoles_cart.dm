...
/obj/item/cartridge/request_console/medical
	...
	programs = list(new/datum/data/pda/app/request_console/medical)

/obj/item/cartridge/request_console/viro
	name = "Virology Request"
	programs = list(new/datum/data/pda/app/request_console/viro)

/obj/item/cartridge/request_console/engineering
	name = "Engineering Request"
	programs = list(new/datum/data/pda/app/request_console/engineering)
...
/obj/item/cartridge/request_console/detective
	...
	programs = list(new/datum/data/pda/app/request_console/detective)
...
/obj/item/cartridge/request_console/janitor
	...
	programs = list(new/datum/data/pda/app/request_console/janitor)

/obj/item/cartridge/request_console/toxins
	name = "Sciense Request"
	programs = list(new/datum/data/pda/app/request_console/toxins)

/obj/item/cartridge/request_console/hop
	name = "HOP Request"
	programs = list(new/datum/data/pda/app/request_console/hop)

/obj/item/cartridge/request_console/hos
	name = "HOS Request"
	programs = list(new/datum/data/pda/app/request_console/hos)

/obj/item/cartridge/request_console/ce
	name = "CE Request"
	programs = list(new/datum/data/pda/app/request_console/ce)

/obj/item/cartridge/request_console/cmo
	name = "CMO Request"
	programs = list(new/datum/data/pda/app/request_console/cmo)

/obj/item/cartridge/request_console/rd
	name = "RD Request"
	programs = list(new/datum/data/pda/app/request_console/rd)
...
/obj/item/cartridge/request_console/magistrate
	...
	programs = list(new/datum/data/pda/app/request_console/magistrate)
...
/obj/item/cartridge/request_console/cargo
	name = "Cargo Request"
	programs = list(new/datum/data/pda/app/request_console/cargo)

/obj/item/cartridge/request_console/quartermaster
	name = "QM Request"
	programs = list(new/datum/data/pda/app/request_console/quartermaster)

/obj/item/cartridge/request_console/shaftminer
	name = "Shaftminer Request"
	programs = list(new/datum/data/pda/app/request_console/shaftminer)
...
/obj/item/cartridge/request_console/botanist
	...
	programs = list(new/datum/data/pda/app/request_console/botanist)

/obj/item/cartridge/request_console/roboticist
	name = "Roboticist Request"
	programs = list(new/datum/data/pda/app/request_console/roboticist)

/obj/item/cartridge/request_console/chef
	name = "Chef Request"
	programs = list(new/datum/data/pda/app/request_console/chef)
...
/obj/item/cartridge/request_console/atmos
	...
	programs = list(new/datum/data/pda/app/request_console/atmos)

/obj/item/cartridge/request_console/chemist
	name = "Chemist Request"
	programs = list(new/datum/data/pda/app/request_console/chemist)

/obj/item/cartridge/request_console/geneticist
	name = "Geneticist Request"
	programs = list(new/datum/data/pda/app/request_console/geneticist)

/obj/item/cartridge/request_console/clown_security
	name = "Clown Security Request"
	programs = list(new/datum/data/pda/app/request_console/clown_security)

/obj/item/cartridge/request_console/centcom
	name = "Centcom Request"
	programs = list(new/datum/data/pda/app/request_console/centcom)
