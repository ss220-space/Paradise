...
/datum/design/syndie_access_control
	...
	category = list(CATEGORY_HACKED, CATEGORY_ELECTRONICS)
...
/datum/design/metal
	...
	category = list(CATEGORY_INITIAL, CATEGORY_CONSTRUCTION)
	maxstack = 50
...
/datum/design/signaler
	...
	category = list(CATEGORY_INITIAL, CATEGORY_COMMUNICATION)
...
/datum/design/rpd
	...
	category = list(CATEGORY_HACKED, CATEGORY_CONSTRUCTION)
