...
/obj/machinery/atmospherics/unary/vent_pump
	description_info = "По необходимости выкачивает содержимое подключенной трубы в атмосферу. Управляется атмосферной панелью."
...
/obj/machinery/atmospherics/unary/vent_scrubber
	...
	Можно настроить для быстрой откачки всего воздуха в режиме «Экстренной откачки». Управляется атмосферной панелью."
