...
/obj/machinery/atmospherics/pipe/heat_exchanging/junction/atmos_init() //it pains me that this must be hardcoded, but the alternative is super hacky
...
/obj/machinery/atmospherics/pipe/heat_exchanging/junction/hidden
	level = 1
	icon_state = "intact-f"
	plane = GAME_PLANE
