...
/datum/hfr_fuel/plasma_oxy_fuel
	...
	requirements = list(TLV_PL, TLV_O2)
	primary_products = list(TLV_CO2, TLV_H2O)
	secondary_products = list(TLV_CO2, TLV_H2O, TLV_FREON, TLV_N2O, TLV_PLUOXIUM, TLV_HALON)
...
/datum/hfr_fuel/hydrogen_oxy_fuel
	...
	requirements = list(TLV_H2, TLV_O2)
	primary_products = list(TLV_HELIUM, TLV_N2)
	secondary_products = list(TLV_HELIUM, TLV_PL, TLV_O2, TLV_N2, TLV_BZ, TLV_HYPERNOBLIUM)
...
/datum/hfr_fuel/tritium_oxy_fuel
	...
	requirements = list(TLV_TRITIUM, TLV_O2)
	primary_products = list(TLV_HELIUM, TLV_PLUOXIUM)
	secondary_products = list(TLV_HELIUM, TLV_PL, TLV_O2, TLV_N2, TLV_BZ, TLV_HYPERNOBLIUM)
...
/datum/hfr_fuel/hypernob_hydrogen_fuel
	...
	requirements = list(TLV_HYPERNOBLIUM, TLV_H2)
	primary_products = list(TLV_ANTINOBLIUM)
	secondary_products = list(TLV_ANTINOBLIUM, TLV_HELIUM, TLV_PROTO_NITRATE, TLV_ZAUKER, TLV_HEALIUM, TLV_MIASMA)
...
/datum/hfr_fuel/hypernob_trit_fuel
	...
	requirements = list(TLV_HYPERNOBLIUM, TLV_TRITIUM)
	primary_products = list(TLV_ANTINOBLIUM)
	secondary_products = list(TLV_ANTINOBLIUM, TLV_HELIUM, TLV_PROTO_NITRATE, TLV_ZAUKER, TLV_HEALIUM, TLV_MIASMA)
	meltdown_flags = HYPERTORUS_FLAG_DEVASTATING_EXPLOSION | HYPERTORUS_FLAG_RADIATION_PULSE | HYPERTORUS_FLAG_EMP | HYPERTORUS_FLAG_BIG_SPREAD
