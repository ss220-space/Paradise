 ...
 */
/obj/machinery/atmospherics/unary/hypertorus/core
	name = "HFR core"
	...
	var/obj/machinery/atmospherics/unary/hypertorus/moderator_input/linked_moderator
	///Stores the information of the fuel input
	var/obj/machinery/atmospherics/unary/hypertorus/fuel_input/linked_input
	///Stores the information of the waste output
	var/obj/machinery/atmospherics/unary/hypertorus/waste_output/linked_output
	...
	**/
	...
	var/engineering_channel = ENG_FREQ
	///The common channel
...
/obj/machinery/atmospherics/unary/hypertorus/core/Initialize(mapload)
	. = ..()
	internal_fusion = new
...
/obj/machinery/atmospherics/unary/hypertorus/core/Destroy()
...
/obj/machinery/atmospherics/unary/hypertorus/core/on_deconstruction(disassembled)
...
/obj/machinery/atmospherics/unary/hypertorus/core/crowbar_deconstruction_act(mob/living/user, obj/item/tool, internal_pressure = 0)
	...
	if(internal_pressure)
		atom_say("WARNING - Core can contain hazardous gases, deconstruct with caution!")
