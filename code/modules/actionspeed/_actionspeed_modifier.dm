...
When update actionspeed is called, the list of items is iterated, according to priority and a bunch of conditions
this spits out a final calculated value which is used as a modifer in [/proc/do_after()]
*/
