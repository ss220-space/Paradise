...
/obj/machinery/disposal/proc/update()
	...
	// flush handle
	if(flush)
		overlays += image('icons/obj/not_atmos_pipes/disposal.dmi', "dispover-handle")
	...
	if(contents.len > 0)
		overlays += image('icons/obj/not_atmos_pipes/disposal.dmi', "dispover-full")

	// charging and ready light
	if(mode == CHARGING)
		overlays += image('icons/obj/not_atmos_pipes/disposal.dmi', "dispover-charge")
	else if(mode == CHARGED)
		overlays += image('icons/obj/not_atmos_pipes/disposal.dmi', "dispover-ready")
