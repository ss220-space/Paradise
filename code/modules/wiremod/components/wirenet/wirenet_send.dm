/obj/item/circuit_component/wirenet_send
	...
	desc = "Отправляет пакет данных через WireNet. Если установлен ключ шифрования, переданные данные будут приняты только получателями с таким же ключом шифрования."
	category = "Utility"
