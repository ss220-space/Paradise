...
/obj/item/circuit_component/format
	...
	desc = "Компонент, который форматирует списки, заменяя \"n\" в строке формата \
			соответствующим n-ным элементом списка."
	category = "List"
...
/obj/item/circuit_component/format/assoc
	...
	desc = "Компонент, который форматирует ассоциативные списки, \
			заменяя key в строке формата соответствующим элементом списка\[key]."
