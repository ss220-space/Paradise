...
/obj/item/clothing/shoes/magboots/gravity/suicide_act(mob/user)
	...
	user.visible_message(span_suicide("[user] прижимает подошвы [declent_ru(GENITIVE)] к своему торсу с двух сторон и активирует. Похоже [GEND_HE_SHE(user)] пытаеттся убить себя!"))
