...
<html>
		...
		<h4>Verbs</h4>
		<p>
			Подключится — открывает вкладку, используя Ваш основной браузер<br>
			Подключится вручную — генерирует ссылку для подключения, если Join не смог открыть вкладку самостоятельно<br>
			Отключиться — отключает Вас от голосового чата. Вкладку эта кнопка не закрывает<br>
			Заглушиться — заглушает Ваш микрофон<br>
			Выключить звук — отключает звук голосового чата в целом<br>
