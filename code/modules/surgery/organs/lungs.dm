...
/obj/item/organ/internal/lungs/cybernetic/upgraded
	...
	desc = "Продвинутая версия кибернетических лёгких. Оснащены системой фильтрации, удаляющей токсины и углекислый газ и поступаемого газа. Очень уязвимы к ЭМИ."
