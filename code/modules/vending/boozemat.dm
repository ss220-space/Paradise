	...
	product_categories = list(
		list(
			...
			"products" = list(
				...
				/obj/item/reagent_containers/cup/soda_cans/beer = 7,
				/obj/item/reagent_containers/cup/soda_cans/ale = 7,
				/obj/item/reagent_containers/cup/soda_cans/synthanol = 7,
			),
		),
		...
		list(
			...
			"products" = list(
				...
				/obj/item/reagent_containers/cup/soda_cans/non_alcoholic_beer = 7,
