/obj/machinery/vending/cola
	...
	products = list(
		...
		/obj/item/reagent_containers/cup/soda_cans/grape_juice = 10,
	)
	premium = list(
		/obj/item/reagent_containers/cup/soda_cans/energy = 10,
		/obj/item/reagent_containers/cup/soda_cans/energy/trop = 10,
		/obj/item/reagent_containers/cup/soda_cans/energy/milk = 10,
		/obj/item/reagent_containers/cup/soda_cans/energy/grey = 10,
