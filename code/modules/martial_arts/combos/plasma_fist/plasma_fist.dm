/datum/martial_combo/plasma_fist/plasma_fist
	...
	explaination_text = "Выбивает мозги из оппонента, разрывая его тело на части, если он достаточно поражен и прожжен. Иначе заставляет его ослепительно вспыхнуть!"
