/datum/martial_combo/cqc/restrain
	...
	explaination_text = "Вы обездвиживаете цель. Продолжите комбо \"обезоруживанием\" чтобы усыпить её."
...
/datum/martial_combo/cqc/restrain/perform_combo(mob/living/carbon/human/user, mob/living/target, datum/martial_art/MA)
	...
	target.visible_message(
		span_warning("[capitalize(user.declent_ru(NOMINATIVE))] захватыва[PLUR_ET_YUT(user)] и обездвижива[PLUR_ET_YUT(user)] [target.declent_ru(ACCUSATIVE)]!"), \
