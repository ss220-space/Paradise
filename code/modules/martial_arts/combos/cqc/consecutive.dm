/datum/martial_combo/cqc/consecutive
	...
	explaination_text = "Несколько молниеносных травмирующих ударов. По окончанию цель получит огромный урон по выносливости."
...
/datum/martial_combo/cqc/consecutive/perform_combo(mob/living/carbon/human/user, mob/living/target, datum/martial_art/MA)
	...
	target.visible_message(
		span_warning("[capitalize(user.declent_ru(NOMINATIVE))] нанос[PLUR_IT_YAT(user)] серию быстрых ударов по животу, шее и спине [target.declent_ru(ACCUSATIVE)]"), \
		span_userdanger("[capitalize(user.declent_ru(NOMINATIVE))] нанос[PLUR_IT_YAT(user)]] серию быстрых ударов по вашим животу, шее и спине!"))
