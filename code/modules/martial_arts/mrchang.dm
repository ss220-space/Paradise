...
/datum/martial_art/mr_chang/explaination_footer(user)
	to_chat(user, "[span_notice("Business lunch")]: Глутамат натрия теперь восстанавливает 0,75 ожогового/физического урона. (Содержится в малом количестве в еде Mr. Chang)")
	to_chat(user, "[span_notice("TAKEYOMONEY")]: Пачка купюр при броске наносит урон, пропорциональный толщине пачки.")
	to_chat(user, "[span_notice("Change please!")]: Монеты при броске имеют шанс в 30% застрять в теле жертвы, нанося малый периодический урон")
