...
/client/proc/set_stat_panel()
	var/has_stat_panel = winget(src, SKIN_INFOWINDOW_CHILD, "left") == "statwindow"
	if(/*prefs.read_preference(/datum/preference/toggle/statpanel) ||*/ !has_stat_panel /*|| needs_stat_panel()*/)
