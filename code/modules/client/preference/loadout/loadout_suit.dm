...
/datum/gear/suit/coat/job/sci
	...
	allowed_roles = list(JOB_TITLE_SCIENTIST, JOB_TITLE_RD, JOB_TITLE_SCIENCE_ASSISTANT)
...
/datum/gear/suit/coat/job/engi
	...
	allowed_roles = list(JOB_TITLE_CHIEF_ENGINEER, JOB_TITLE_ENGINEER, JOB_TITLE_ENGINEERING_ASSISTANT, JOB_TITLE_MECHANIC)
...
/datum/gear/suit/suragi_jacket/eng
	...
	allowed_roles = list(JOB_TITLE_ENGINEER, JOB_TITLE_ENGINEERING_ASSISTANT, JOB_TITLE_MECHANIC)
...
/datum/gear/suit/suragi_jacket/medic
	...
	allowed_roles = list(JOB_TITLE_DOCTOR, JOB_TITLE_MINING_MEDIC, JOB_TITLE_MEDICAL_ASSISTANT, JOB_TITLE_PSYCHIATRIST, JOB_TITLE_PARAMEDIC, JOB_TITLE_CORONER)
...
/datum/gear/suit/suragi_jacket/sci
	...
	allowed_roles = list(JOB_TITLE_SCIENTIST, JOB_TITLE_SCIENCE_ASSISTANT)
