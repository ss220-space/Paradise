...
/datum/gear/suit/coat/job/sec
	...
	allowed_roles = list("Head of Security", "Warden", "Detective", "Security Officer", "Security Pod Pilot", "Brig Physician", "Brig Officer")
...
/datum/gear/suit/suragi_jacket/sec
	...
	allowed_roles = list("Warden", "Detective", "Security Officer", "Security Pod Pilot", "Brig Officer")
