...
/datum/gear/donor/heart_meson
	...
	cost = 2
	slot = ITEM_SLOT_EYES
	allowed_roles = list(JOB_TITLE_CHIEF_ENGINEER, JOB_TITLE_ENGINEER, JOB_TITLE_ATMOSTECH, JOB_TITLE_MECHANIC, JOB_TITLE_QUARTERMASTER, JOB_TITLE_MINER, JOB_TITLE_MINING_MEDIC, JOB_TITLE_CAPTAIN, JOB_TITLE_ENGINEER_TRAINEE)
...
/datum/gear/donor/visor_meson
	...
	donator_tier = 3
	slot = ITEM_SLOT_EYES
	allowed_roles = list(JOB_TITLE_CHIEF_ENGINEER, JOB_TITLE_ENGINEER, JOB_TITLE_ENGINEER_TRAINEE, JOB_TITLE_ATMOSTECH, JOB_TITLE_MECHANIC, JOB_TITLE_QUARTERMASTER, JOB_TITLE_MINER, JOB_TITLE_MINING_MEDIC)
