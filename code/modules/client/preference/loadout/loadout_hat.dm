...
/datum/gear/hat/beret_job/sci
	...
	allowed_roles = list(JOB_TITLE_RD, JOB_TITLE_SCIENTIST, JOB_TITLE_SCIENCE_ASSISTANT, JOB_TITLE_ROBOTICIST, JOB_TITLE_GENETICIST)

/datum/gear/hat/beret_job/med
	index_name = "medical beret"
	path = /obj/item/clothing/head/beret/med
	allowed_roles = list(JOB_TITLE_CMO, JOB_TITLE_DOCTOR, JOB_TITLE_MINING_MEDIC, JOB_TITLE_MEDICAL_ASSISTANT, JOB_TITLE_VIROLOGIST, JOB_TITLE_BRIGDOC, JOB_TITLE_CORONER, JOB_TITLE_PARAMEDIC, JOB_TITLE_CHEMIST, JOB_TITLE_GENETICIST, JOB_TITLE_PSYCHIATRIST)

/datum/gear/hat/beret_job/eng
	index_name = "engineering beret"
	path = /obj/item/clothing/head/beret/eng
	allowed_roles = list(JOB_TITLE_CHIEF_ENGINEER, JOB_TITLE_ENGINEER, JOB_TITLE_ENGINEERING_ASSISTANT)
