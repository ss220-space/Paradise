...
/datum/gear/racial/taj/sec
	...
	description = "A common traditional nano-fiber veil worn by many Tajaran, It is rare and offensive to see it on other races. This one has an in-built peacemakers HUD."
	path = /obj/item/clothing/glasses/hud/security/tajblind
	allowed_roles = list("Peacemakers Leader", "Warden", "Peacemaker", "Peacemaker Cadet", "Peacemaker Pod Pilot", "Internal Affairs Agent", "Magistrate")
	cost = 2
