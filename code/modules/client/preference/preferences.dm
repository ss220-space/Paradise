	...
	switch(href_list["task"])
		...
		if("input")
			switch(href_list["preference"])
				...
				if("species")
					var/list/new_species = list(SPECIES_HUMAN, SPECIES_TAJARAN, SPECIES_SKRELL, SPECIES_UNATHI, SPECIES_DIONA, "Vulpkanin", SPECIES_MOTH)
...
*/
				...
				if("hair")
					if(species in list(SPECIES_HUMAN, SPECIES_UNATHI, SPECIES_TAJARAN, SPECIES_SKRELL, SPECIES_MACNINEPERSON, "Vulpkanin", SPECIES_VOX)) //Species that have hair. (No HAS_HAIR flag)
				...
				if("secondary_hair")
					if(species in list(SPECIES_HUMAN, SPECIES_UNATHI, SPECIES_TAJARAN, SPECIES_SKRELL, SPECIES_MACNINEPERSON, "Vulpkanin", SPECIES_VOX))
				...
				if("facial")
					if(species in list(SPECIES_HUMAN, SPECIES_UNATHI, SPECIES_TAJARAN, SPECIES_SKRELL, SPECIES_MACNINEPERSON, "Vulpkanin", SPECIES_VOX)) //Species that have facial hair. (No HAS_HAIR_FACIAL flag)
