...
/datum/preferences/proc/SetDisabilities(mob/user)
	...
	if(CAN_WINGDINGS in S.species_traits)
		HTML += ShowDisabilityState(user, DISABILITY_FLAG_WINGDINGS, "Голос инопланетян")
	...
	HTML += ShowDisabilityState(user, DISABILITY_FLAG_NICOTINE_ADDICT, "Никотиновая зависимость")
	HTML += ShowDisabilityState(user, DISABILITY_FLAG_TEA_ADDICT, "Чайная зависимость")
	HTML += ShowDisabilityState(user, DISABILITY_FLAG_COFFEE_ADDICT, "Кофеиновая зависимость")
	HTML += ShowDisabilityState(user, DISABILITY_FLAG_ALCOHOLE_ADDICT, "Алкогольная зависимость")
	HTML += ShowDisabilityState(user, DISABILITY_FLAG_LEGPARALYSIS, "Паралич ног")
