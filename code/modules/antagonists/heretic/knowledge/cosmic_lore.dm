...
/datum/heretic_knowledge/ultimate/cosmic_final
	...
	desc = "Ритуал вознесения Пути Космоса. \
			...
			После завершения ритуала вы станете владельцем Звездного Глашатоя. \
			Вы сможете управлять Звёздным Глашатаем, нажимая Alt+клик, \
			а также отдавать ему голосовые команды. \
			Звёздный Наблюдатель — сильный союзник, способный разрушать укреплённые стены. \
			У Звездного Глашатоя есть аура, исцеляющая вас и наносящая урон противникам. \
