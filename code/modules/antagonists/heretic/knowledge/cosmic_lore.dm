...
/datum/heretic_knowledge/spell/cosmic_runes
	...
	desc = "Даёт вам \"Космические руны\" — заклинание, создающее две руны телепортирующие друг на друга. \
...
/datum/heretic_knowledge/spell/star_blast
	name = "Звездный взрыв"
	desc = "Выпускает очень медленный снаряд, создающий стену космических полей. \
