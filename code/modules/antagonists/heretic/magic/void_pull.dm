/datum/action/innate/aoe/void_pull
	name = "Void Pull"
...
/datum/action/innate/aoe/void_pull/before_cast(atom/cast_on)
	. = ..()
...
/datum/action/innate/aoe/void_pull/cast_on_thing_in_aoe(mob/living/victim, atom/caster)
