/datum/action/innate/pointed/manse_link
	name = "Manse Link"
...
/datum/action/innate/pointed/manse_link/New(Target)
	. = ..()
...
/datum/action/innate/pointed/manse_link/is_valid_target(atom/cast_on)
	. = ..()
	if(!.)
		return FALSE
...
/datum/action/innate/pointed/manse_link/before_cast(mob/living/cast_on)
	. = ..()
 ...
 */
/datum/action/innate/pointed/manse_link/proc/do_linking(mob/living/linkee)
