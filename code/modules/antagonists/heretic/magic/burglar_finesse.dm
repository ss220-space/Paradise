/datum/action/innate/pointed/burglar_finesse
...
/datum/action/innate/pointed/burglar_finesse/is_valid_target(mob/living/carbon/human/cast_on)
	if(!istype(cast_on))
		return FALSE
	var/obj/item/back_item = cast_on.get_item_by_slot(ITEM_SLOT_BACK)
	return ..() && back_item?.atom_storage

/datum/action/innate/pointed/burglar_finesse/cast(mob/living/carbon/human/cast_on)
	. = ..()
