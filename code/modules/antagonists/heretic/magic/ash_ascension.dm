...
/datum/action/innate/fire_sworn
	name = "Oath of Flame"
...
/datum/action/innate/fire_sworn/Remove(mob/living/remove_from)
	remove_from.remove_status_effect(/datum/status_effect/fire_ring)
	return ..()

/datum/action/innate/fire_sworn/is_valid_target(atom/cast_on)
	return isliving(cast_on)

/datum/action/innate/fire_sworn/cast(mob/living/cast_on)
	. = ..()
...
/datum/action/innate/fire_cascade
...
/datum/action/innate/fire_cascade/cast(atom/cast_on)
	. = ..()
...
/datum/action/innate/fire_cascade/proc/fire_cascade(atom/centre, flame_radius = 1)
...
/datum/action/innate/pointed/ash_beams/is_valid_target(atom/cast_on)
	return TRUE

/datum/action/innate/pointed/ash_beams/cast(atom/target)
	. = ..()
...
/datum/action/innate/pointed/ash_beams/proc/line_target(offset, range, atom/at, atom/user)
