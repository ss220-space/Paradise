/datum/action/innate/pointed/mind_gate
	name = "Mind Gate"
...
/datum/action/innate/pointed/mind_gate/can_cast_spell(feedback = TRUE)
	return ..() && isliving(owner)

/datum/action/innate/pointed/mind_gate/is_valid_target(atom/cast_on)
	return ..() && ishuman(cast_on)

/datum/action/innate/pointed/mind_gate/cast(mob/living/carbon/human/cast_on)
	. = ..()
