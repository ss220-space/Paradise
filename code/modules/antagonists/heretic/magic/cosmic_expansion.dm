/datum/action/innate/conjure/cosmic_expansion
...
/datum/action/innate/conjure/cosmic_expansion/cast(mob/living/cast_on)
...
/datum/action/innate/conjure/cosmic_expansion/proc/get_turfs(turf/target_turf)
