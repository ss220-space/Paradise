...
/datum/action/innate/caretaker/Remove(mob/living/remove_from)
...
/datum/action/innate/caretaker/is_valid_target(atom/cast_on)
	return isliving(cast_on)

/datum/action/innate/caretaker/before_cast(mob/living/cast_on)
	. = ..()
...
/datum/action/innate/caretaker/cast(mob/living/cast_on)
	. = ..()
