...
/datum/devil_ban/hurtwoman
	...
	law = "Никогда не причиняйте вреда существу женского пола, если это не необходимо для самообороны."
...
/datum/devil_ban/hurtlizard
	...
	law = "Никогда не причиняйте вред ящерам, если это не необходимо для самообороны."
