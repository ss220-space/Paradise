...
/datum/vox_pack/consumables/food
	...
	reference = "CO_FOOD"
	cost = 5
	contains = list(/obj/item/reagent_containers/food/snacks/soup/stew)
...
/datum/vox_pack/consumables/x4
	...
	reference = "CO_X4"
	cost = 450
	contains = list(/obj/item/grenade/plastic/x4)
...
/datum/vox_pack/consumables/t4
	...
	reference = "CO_T4"
	cost = 700
	contains = list(/obj/item/grenade/plastic/x4/thermite)
