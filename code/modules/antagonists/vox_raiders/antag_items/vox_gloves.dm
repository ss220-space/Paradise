/obj/item/clothing/gloves/vox
	...
	armor = list(PIERCING = 0, SLASHING = 30, BLUNT = 30, ABSORPTION = 12, LASER = 10, ENERGY = 10, BOMB = 0, FIRE = 200, ACID = 50)
...
/obj/item/clothing/gloves/color/yellow/vox
	...
	heat_protection = HANDS
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	armor = list(PIERCING = 0, SLASHING = 30, BLUNT = 30, ABSORPTION = 12, LASER = 25, ENERGY = 25, BOMB = 0, FIRE = 200, ACID = 50)
