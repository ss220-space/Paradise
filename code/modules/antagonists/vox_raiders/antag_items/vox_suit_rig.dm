...
/obj/item/clothing/suit/space/hardsuit/vox/ComponentInitialize()
	. = ..()
...
/obj/item/clothing/head/helmet/space/hardsuit/vox/update_icon_state()
	icon_state = "[initial(icon_state)][light_on ? "_light" : ""]"
