...
/datum/antagonist/changeling/farewell()
	if(issilicon(owner.current))
		...
		to_chat(owner.current, span_fontsize_16px(span_fontcolor_red("<b>You lose your powers! You are no longer a changeling and are stuck in your current form!</b>")))
