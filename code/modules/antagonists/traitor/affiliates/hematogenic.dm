...
/datum/affiliate/hematogenic
	...
	hij_desc = "Вы - опытный наёмный агент " + AFFIL_HEMATOGENIC + ".\n\
				Основатель " + AFFIL_HEMATOGENIC + " высоко оценил ваши прошлые заслуги, а потому, дал вам возможность купить инжектор наполненный его собственной кровью... \n\
...
/obj/item/hemophagus_extract
	...
	desc = "Инжектор странной формы, с неестественно двигающейся алой жидкостью внутри. На боку едва заметная гравировка \"" + AFFIL_HEMATOGENIC + "\". Конкретно на этом инжекторе установлена блокировка, не позволяющая исспользовать его на случайном гуманойде."
...
/obj/item/blood_harvester
	...
	desc = "Большой шприц для быстрого сбора больших объемов крови. На боку едва заметная гравировка \"" + AFFIL_HEMATOGENIC + "\""
	icon = 'icons/obj/affiliates.dmi'
