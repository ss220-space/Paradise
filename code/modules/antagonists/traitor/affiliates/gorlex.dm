/datum/affiliate/gorlex
	...
	desc = "Преимущества: \n\
			Скидка 40% на клинки богомола\n\
			Скидка 30% на стимулянты\n\
			Скидка 25% на Хардсьют Синдиката\n\
			Вы знакомы с остальными агентами вашего подрядчика и можете их узнать\n\
			Недостатки: \n\
