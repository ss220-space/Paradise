...
/datum/contractor_hub/proc/on_completion(tc, creds)
	...
	owner?.initial_account?.credit(creds, pick(list(
		...
		"Ваш запрос на возврат 100 таблеток \"Доктор Макс\" с причиной \"Мне нужно гораздо больше, чем 100 таблеток!\" был принят. Мы зачислили на ваш счёт [creds] кредит[declension_ru(creds, "", "а", "ов")].",
