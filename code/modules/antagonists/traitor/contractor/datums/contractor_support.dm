/datum/antagonist/contractor_support
	name = "Агент поддержки Контрактора"
...
/datum/antagonist/contractor_support/on_gain()
	...
	generic_objective.explanation_text = "Выполняйте приказы, получаемые от назначенного вам контрактора. Помогайте другим агентам в этом районе миссии.<br>"
