...
/datum/antagonist/swarmer/greet()
	...
	messages.Add("4. Интент \"Разбор\", или же \"четвёртый\", используется для уничтожения структур \"Свармеров\" строителями.\n")
	...
	messages.Add("Вы можете обработать только те вещи, что созданы из металла, стекла, пластика или титания.\n")
