...
/obj/item/clothing/suit/space/space_ninja/proc/toggle_stealth()
	...
	if(stealth)
		...
		if(!s_busy)
			...
			ninja.visible_message(span_warning("[ninja.name] расстворил[GEND_ENDING_SYA_AS_OS_IS(ninja) ] в воздухе!"), span_notice("Теперь вас практически невозможно увидеть невооружённым глазом. Ровно как и стандартными оптическими приборами. Нагрузка костюма начала увеличиваться..."))
...
/obj/item/clothing/suit/space/space_ninja/proc/cancel_stealth()
	...
	if(stealth)
		...
		ninja.visible_message(span_warning("[ninja.name] появил[GEND_ENDING_SYA_AS_OS_IS(ninja) ] из воздуха!"), span_notice("Теперь вас снова видно невооружённым глазом."))
