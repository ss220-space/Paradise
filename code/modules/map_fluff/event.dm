...
/datum/map/delta_low_orbit
	...
	traits = list(
		list(STATION_LEVEL = MINING, STATION_CONTACT, INJECT_AS_LAVALAND, ORE_LEVEL, REACHABLE, HAS_WEATHER, AI_OK, ZTRAIT_UP, ZTRAIT_BASETURF = /turf/simulated/openspace/lavaland),
