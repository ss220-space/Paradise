...
/obj/machinery/bfl_receiver/proc/icon_change()
	var/contents_length = length(internal.contents)
	if(last_icon_change == contents_length)
		return
	receiver_light.light_amount = contents_length
	last_icon_change = contents_length
