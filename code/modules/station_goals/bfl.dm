...
/datum/station_goal/bfl/get_report()
	...
	Наши дроны слежки засекли огромное месторождение, с которого сочится плазма. Нам надо чтобы вы сооружили систему БФЛ для сбора плазмы и отправили её на ЦК по шаттлу снабжения.
	<br>
