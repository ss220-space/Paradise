...
/datum/station_goal/proc/send_report()
	...
	GLOB.minor_announcement.Announce("Поступила приоритетная директива НаноТрейзен. Отправлены подробности проекта \"[html_decode(name)]\".", ANNOUNCE_RU_PRIORITY_ANNOUNCEMENT, 'sound/AI/commandreport.ogg')
