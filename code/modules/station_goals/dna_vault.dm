...
/datum/station_goal/dna_vault/get_report()
	...
	Наши системы долгосрочного предсказывания говорят, что с шансом 99% должен произойти катаклизм с масштабом в систему в ближайшем будущем. По этому, нам нужно, чтобы вы построили ДНК хранилище на вашей станции.
	<br><br>
	ДНК хранилище должно иметь образцы:
	<ul style='margin-top: 10px; margin-bottom: 10px;'>
	<li>[animal_count] уникальных животных образцов.</li>
	<li>[plant_count] уникальных нестандартных растительных образцов.</li>
	<li>[human_count] уникальных разумных гуманоидных образцов.</li>
	</ul>
