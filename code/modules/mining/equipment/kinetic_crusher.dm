...
/obj/item/twohanded/kinetic_crusher/examine(mob/living/user)
	...
	. += span_notice("Удары по отмеченной фауне наносят <b>[force + detonation_damage]</b> единиц[DECL_U_Y(force + detonation_damage)] урона.")
	. += span_notice("Наносит <b>[force + detonation_damage + backstab_bonus]</b> единиц[DECL_U_Y(force + detonation_damage + backstab_bonus)] урона при ударе в спину.\n")
...
/obj/item/crusher_trophy/goliath_tentacle/effect_desc()
	return "Взрыв метки наносит <b>[bonus_value]</b> едениц[DECL_U_Y(bonus_value)] дополнительного урона за каждые <b>[missing_health_desc]</b> единиц[DECL_U_Y(missing_health_desc)] недостающего у вас здоровья"
...
/obj/item/crusher_trophy/watcher_wing/effect_desc()
	return "Взрыв метки не позволяет фауне использовать дальние атаки в течении <b>[bonus_value * 0.1]</b> секунд[DECL_Y(bonus_value * 0.1)]"
...
/obj/item/crusher_trophy/blaster_tubes/magma_wing/effect_desc()
	return "Следующий за взрывом метки заряд дестабилизатора наносит <b>[bonus_value]</b> единиц[DECL_U_Y(bonus_value)] урона"
...
/obj/item/crusher_trophy/legion_skull/effect_desc()
	return "Перезарядка дестабилизатора ускорена на <b>[bonus_value * 0.1]</b> секунд[DECL_U_Y(bonus_value * 0.1)]"
...
/obj/item/crusher_trophy/tail_spike/effect_desc()
	return "Взрыв метки отталкивает врага и наносит близлежащим существам <b>[bonus_value]</b> единиц[DECL_U_Y(bonus_value)] урона"
...
/obj/item/crusher_trophy/demon_claws/effect_desc()
	return "Ваши удары наносят <b>[bonus_value * 0.2]</b> бонусного урона и восстанавливают вам <b>[bonus_value * 0.1]</b> единиц[DECL_U_Y(bonus_value * 0.1)] здоровья. При взрыве метки сила эффекта увеличена в 5 раз"
...
/obj/item/crusher_trophy/blaster_tubes/effect_desc()
	return "После взрыва метки, заменяет дестабилизатор медленным снарядом, наносящим <b>[bonus_value]</b> единиц[DECL_U_Y(bonus_value)] урона"
...
/obj/item/crusher_trophy/adaptive_intelligence_core/effect_desc()
	return "Увеличивает ваш урон на <b>[bonus_value]</b> единиц[DECL_U_Y(bonus_value)] с каждой атакой, до максимума в <b>[bonus_value * 10]</b> единиц[DECL_U_Y(bonus_value)]"
