...
/obj/effect/temp_visual/resonance/proc/burst()
	...
	for(var/mob/living/living in src_turf)
		if(creator)
			add_attack_logs(creator, living, "Resonance field'ed")
		to_chat(living, span_userdanger("[DECLENT_RU_CAP(src, NOMINATIVE)] разрывается с вами внутри!"))
		living.apply_damage(resonance_damage, BRUTE)
