...
/obj/item/twohanded/required/gibtonite
	name = "gibtonite ore"
	desc = "Чрезвычайно взрывоопасна при ударе шахтёрских оборудованием. Шахтёры используют гибтонит как заряд для ускорения работ. Хранение запрещено космическим законодательством для неуполномоченного персонала."
	ru_names = list(
		NOMINATIVE = "гибтонит",
		GENITIVE = "гибтонита",
		DATIVE = "гибтониту",
