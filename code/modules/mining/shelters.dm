...
/datum/map_template/shelter/beta
	...
	description = "Невероятно роскошное убежище со всеми удобствами: ковровые покрытия, горячая и холодная вода, изысканный трехразовый рацион, кухонное оборудование и элитный компаньон, чтобы вам не было одиноко во время пепловой бури."
...
/datum/map_template/shelter/charlie
	...
	description = "Элитное убежище класса люкс с полноценным баром, двумя торговыми автоматами, столиками и санузлом с раковиной. Это не аварийная капсула, поэтому не рассчитывайте, что она спасет вас в случае смертельного кровотечения."
