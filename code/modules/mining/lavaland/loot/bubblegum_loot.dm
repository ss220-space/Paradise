...
/obj/item/soulscythe/proc/shoot_target(atom/attacked_atom)
	...
	visible_message(span_danger("[capitalize(declent_ru(NOMINATIVE))] стреляет в [attacked_atom.declent_ru(ACCUSATIVE)]!"), span_notice("Вы стреляете в [attacked_atom.declent_ru(ACCUSATIVE)]!"))
...
/obj/item/soulscythe/proc/slash_target(atom/attacked_atom)
	if(isliving(attacked_atom) && use_blood(10))
		...
		to_chat(attacked_mob, span_userdanger("Вас разрубает [declent_ru(NOMINATIVE)]!"))
		visible_message(span_danger("[capitalize(declent_ru(NOMINATIVE))] разрубает [attacked_atom.declent_ru(ACCUSATIVE)]!"), span_notice("Вы разрубаете [attacked_atom.declent_ru(ACCUSATIVE)]!"))
		...
		visible_message(span_danger("[capitalize(declent_ru(NOMINATIVE))] бьёт [attacked_atom.declent_ru(ACCUSATIVE)]!"), span_notice("Вы бьёте [attacked_atom.declent_ru(ACCUSATIVE)]!"))
