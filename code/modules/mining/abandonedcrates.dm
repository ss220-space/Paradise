...
/obj/structure/closet/crate/secure/loot/attack_hand(mob/user)
	if(locked)
		...
		var/input = clean_input("Введите [codelen] цифр.", "Цифровой замок Deca-Code", "")
	...
	for(var/i in 1 to codelen)
		...
		if(g)
			...
			if(g == i)
				...
				++cows
	to_chat(user, span_notice("В последней попытке [bulls] [declension_ru(bulls,"цифра","цирфы","яиц")] на правильных позициях и [cows] [declension_ru(cows,"правильная цифра","правильные цирфы","правильных цифр")] на неправильных позициях."))
