...
/obj/effect/mob_spawn/human/golem/Initialize(mapload, datum/species/golem/species = null, mob/creator = null)
	...
	if(has_owner && creator)
		...
		description = "Вы – голем. Вы двигаетесь медленно, но достаточно устойчивы к жаре, холоду и травмам. Вы не можете носить одежду, но можете использовать большинство инструментов. Служите <b>[creator]</b> и помогайте ему в достижении его целей любой ценой."
		owner = creator
