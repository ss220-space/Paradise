...
/obj/item/golem_shell/attackby(obj/item/I, mob/user, params)
	...
	if(!isturf(loc))
		to_chat(user, span_warning("Вы должны поместить оболочку на землю, чтобы завершить голема."))
		return .
...
/obj/effect/mob_spawn/human/golem/Initialize(mapload, datum/species/golem/species = null, mob/creator = null)
	...
	if(has_owner && creator)
		...
		description = "Вы - голем. Вы двигаетесь медленно, но достаточно устойчивы к жаре, холоду и травмам. Вы не можете носить одежду, но можете использовать большинство инструментов. Служите [creator] и помогайте [genderize_ru(creator.gender(), "ему", "ей", "им", "им")] в достижении [genderize_ru(creator.gender(), "его", "её", "их", "их")] целей любой ценой."
		owner = creator
...
/obj/effect/mob_spawn/human/golem/special(mob/living/new_spawn, name)
	...
	if(!owner)
		...
		to_chat(new_spawn, span_warning("Вы не антагонист, но и не член экипажа. Вы можете взаимодействовать или торговать с экипажем, а также защищать себя и свой корабль, но избегайте активного вмешательства в дела станции, если у вас нет веской ролевой причины, например, приглашения от членов экипажа."))
	else
