 ...
 */
#define is_jaunting(atom) (istype(atom.loc, /obj/effect/dummy/spell_jaunt))
...
/// Sent from /obj/effect/proc_holder/spell/set_click_ability() to the caster: (obj/effect/proc_holder/spell/spell)
