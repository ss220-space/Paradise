...
#define DEFAULT_ICON_LEFT_EAR 'icons/mob/clothing/ear_left.dmi'
#define DEFAULT_ICON_RIGHT_EAR 'icons/mob/clothing/ear_right.dmi'
...
#define DEFAULT_ICON_JUMPSUIT 'icons/mob/clothing/jumpsuit.dmi'
#define DEFAULT_ICON_GLOVES 'icons/mob/clothing/gloves.dmi'
#define DEFAULT_ICON_GLASSES 'icons/mob/clothing/glasses.dmi'
#define DEFAULT_ICON_WEAR_MASK 'icons/mob/clothing/mask.dmi'
#define DEFAULT_ICON_HEAD 'icons/mob/clothing/head.dmi'
#define DEFAULT_ICON_HANDCUFFED 'icons/mob/clothing/handcuffed.dmi'
#define DEFAULT_ICON_SHOES 'icons/mob/clothing/shoes.dmi'
#define DEFAULT_ICON_WEAR_ID 'icons/mob/clothing/id.dmi'
#define DEFAULT_ICON_NECK 'icons/mob/clothing/neck.dmi'
#define DEFAULT_ICON_SUITSTORE 'icons/mob/clothing/suitstore.dmi'
#define DEFAULT_ICON_LEGCUFFED 'icons/mob/clothing/legcuffed.dmi'
#define DEFAULT_ICON_ACCESSORY 'icons/mob/clothing/accessory.dmi'
