...
#define MATERIAL_CLASS_FULL		(MATERIAL_CLASS_CLOTH|MATERIAL_CLASS_TECH|MATERIAL_CLASS_SOAP)
#define MATERIAL_CLASS_ALL      (MATERIAL_CLASS_NONE|MATERIAL_CLASS_CLOTH|MATERIAL_CLASS_TECH|MATERIAL_CLASS_SOAP)
