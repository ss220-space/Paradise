...
#define PREFTOGGLE_2_RANDOMSLOT			(1<<0)
#define PREFTOGGLE_2_FANCYUI			(1<<1)
#define PREFTOGGLE_2_ITEMATTACK			(1<<2)
#define PREFTOGGLE_2_WINDOWFLASHING		(1<<3)
#define PREFTOGGLE_2_ANON				(1<<4)
#define PREFTOGGLE_2_AFKWATCH			(1<<5)
#define PREFTOGGLE_2_RUNECHAT			(1<<6)
#define PREFTOGGLE_2_DEATHMESSAGE		(1<<7)
#define PREFTOGGLE_2_EMOTE_BUBBLE		(1<<8)
#define PREFTOGGLE_2_SEE_ITEM_OUTLINES 	(1<<9)
// Yes I know this being an "enable to disable" is misleading, but it avoids having to tweak all existing pref entries
#define PREFTOGGLE_2_REVERB_DISABLE		(1<<10)
#define PREFTOGGLE_2_MC_TABS			(1<<11)
#define PREFTOGGLE_2_DISABLE_TGUI_LISTS	(1<<12)
