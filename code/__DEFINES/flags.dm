...
#define PASSFENCE 64
#define PASSEVERYTHINGELSE 128
#define PASS_COMPLETELY_EVERYTHING PASSTABLE|PASSGLASS|PASSGRILLE|PASSBLOB|PASSMOB|LETPASSTHROW|PASSFENCE|PASSEVERYTHINGELSE
