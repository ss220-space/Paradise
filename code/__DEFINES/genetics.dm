...
#define DISABILITY_FLAG_COFFEE_ADDICT 4096
#define DISABILITY_FLAG_TEA_ADDICT    8192
#define DISABILITY_FLAG_ALCOHOLE_ADDICT 16384
#define DISABILITY_FLAG_NICOTINE_ADDICT 32768
