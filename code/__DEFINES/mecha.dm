...
#define MECH_EQUIPMENT_WORKING (1<<0)
#define MECH_EQUIPMENT_COMBAT (1<<1)
#define MECH_EQUIPMENT_MEDICAL (1<<2)
#define MECH_EQUIPMENT_MAKESHIFT (1<<3)
#define MECH_EQUIPMENT_MIME (1<<4)
#define MECH_EQUIPMENT_CLOWN (1<<5)
