...
#define MECH_EQUIPMENT_COMBAT (MECH_EQUIPMENT_GYGAX | MECH_EQUIPMENT_GYGAX)
#define MECH_EQUIPMENT_RIPPLEY (1<<2)
#define MECH_EQUIPMENT_PHAZON (1<<3)
#define MECH_EQUIPMENT_MARAUDER (1<<2)
#define MECH_EQUIPMENT_FIREFIGHTER (1<<4)
#define MECH_EQUIPMENT_WORKING (MECH_EQUIPMENT_RIPPLEY | MECH_EQUIPMENT_FIREFIGHTER)
#define MECH_EQUIPMENT_MEDICAL (1<<5)
#define MECH_EQUIPMENT_MAKESHIFT (1<<6)
#define MECH_EQUIPMENT_MIME (1<<7)
#define MECH_EQUIPMENT_CLOWN (1<<8)
