...
// Rocket systems
/// Used in light rocket launcher like RPG-232
#define CALIBER_ROCKET_70MM "ракета 70 мм"
...
/// Laser pistol accuracy
#define GUN_ACCURACY_PISTOL_LASER new /datum/gun_accuracy/pistol/laser()
...
#define GUN_ACCURACY_BOW new /datum/gun_accuracy/bow()
#define GUN_ACCURACY_BOW_ADVANCED new /datum/gun_accuracy/bow/advanced()
#define GUN_ACCURACY_BOW_MASTER new /datum/gun_accuracy/bow/master()
